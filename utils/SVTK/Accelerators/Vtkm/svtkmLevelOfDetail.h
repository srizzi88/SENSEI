...
//=============================================================================
/**
 * @class   svtkmLevelOfDetail
 * @brief   reduce the number of triangles in a mesh
 *
 * svtkmLevelOfDetail is a filter to reduce the number of triangles in a
 * triangle mesh, forming a good approximation to the original geometry. The
 * input to svtkmLevelOfDetail is a svtkPolyData or svtkUnstrcutredGrid object,
 * and only triangles are treated. If you desire to decimate polygonal meshes,
 * first triangulate the polygons with svtkTriangleFilter object.
 *
...
#ifndef svtkmLevelOfDetail_h
#define svtkmLevelOfDetail_h

#include "svtkAcceleratorsSVTKmModule.h" //required for correct implementation
#include "svtkPolyDataAlgorithm.h"

class SVTKACCELERATORSSVTKM_EXPORT svtkmLevelOfDetail : public svtkPolyDataAlgorithm
{
public:
  svtkTypeMacro(svtkmLevelOfDetail, svtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkmLevelOfDetail* New();
...
private:
  ...
  svtkmLevelOfDetail(const svtkmLevelOfDetail&) = delete;
  void operator=(const svtkmLevelOfDetail&) = delete;
};

#endif // svtkmLevelOfDetail_h
// SVTK-HeaderTest-Exclude: svtkmLevelOfDetail.h
