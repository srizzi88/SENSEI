...
int TestAreaPlot(int, char*[])
{
  ...
  svtkNew<svtkCharArray> validMask;
  ...
  svtkPlotArea* area = svtkPlotArea::SafeDownCast(chart->AddPlot(svtkChart::AREA));
  ...
  chart->GetAxis(svtkAxis::LEFT)->SetLogScale(true);
