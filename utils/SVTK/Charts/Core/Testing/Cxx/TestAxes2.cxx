...
int TestAxes2(int, char*[])
{
  ...
  svtkNew<svtkAxis> axisVertical;

  axisVertical->LogScaleOn();
  axisVertical->SetPoint1(svtkVector2f(180, 16));
  axisVertical->SetPoint2(svtkVector2f(180, 184));
  axisVertical->SetPosition(svtkAxis::LEFT);

  axisVertical->SetNotation(svtkAxis::SCIENTIFIC_NOTATION);
  axisVertical->SetPosition(svtkAxis::LEFT);
