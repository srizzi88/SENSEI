...
//----------------------------------------------------------------------------
class ContextTest : public svtkContextItem
{
public:
  static ContextTest* New();
  svtkTypeMacro(ContextTest, svtkContextItem);
...
svtkStandardNewMacro(ContextTest);
// This function aims to test the primitives provided by the 2D API.
bool ContextTest::Paint(svtkContext2D* painter)
{
