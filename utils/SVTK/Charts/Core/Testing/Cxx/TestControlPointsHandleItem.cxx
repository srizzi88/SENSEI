...
int TestControlPointsHandleItem(int, char*[])
{
  ...
  //  chart->SetActionToButton(svtkChart::PAN, svtkContextMouseEvent::MIDDLE_BUTTON);
  //  chart->SetActionToButton(svtkChart::SELECT, svtkContextMouseEvent::RIGHT_BUTTON);
  for (int i = 0; i < 4; ++i)
  {
  ...
  svtkNew<svtkCompositeControlPointsItem> controlPoints;
