...
class TestBarGraph(svtk.test.Testing.svtkTest):
    def testBarGraph(self):
        ...
        arr2008 = svtk.svtkIntArray()
        arr2008.SetName("2008")

        arr2009 = svtk.svtkIntArray()
        arr2009.SetName("2009")

        arr2010 = svtk.svtkIntArray()
...
if __name__ == "__main__":
    svtk.test.Testing.main([(TestBarGraph, 'test')])
