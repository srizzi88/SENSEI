...
class TestParallelCoordinatesColors(svtk.test.Testing.svtkTest):
    def testLinePlot(self):
        ...
        chart = svtk.svtkChartParallelCoordinates()
...
if __name__ == "__main__":
    svtk.test.Testing.main([(TestParallelCoordinatesColors, 'test')])
