...
//-----------------------------------------------------------------------------
svtkStandardNewMacro(svtkCategoryLegend);

//-----------------------------------------------------------------------------
svtkCategoryLegend::svtkCategoryLegend()
{
...
//-----------------------------------------------------------------------------
svtkCategoryLegend::~svtkCategoryLegend() = default;

//-----------------------------------------------------------------------------
bool svtkCategoryLegend::Paint(svtkContext2D* painter)
{
  ...
  for (svtkIdType l = 0; l < this->Values->GetNumberOfTuples(); ++l)
  {
    svtkStdString currentString = this->Values->GetValue(l).ToString();
...
//-----------------------------------------------------------------------------
void svtkCategoryLegend::SetScalarsToColors(svtkScalarsToColors* stc)
{
  this->ScalarsToColors = stc;
}

//-----------------------------------------------------------------------------
svtkScalarsToColors* svtkCategoryLegend::GetScalarsToColors()
{
  return this->ScalarsToColors;
}

//-----------------------------------------------------------------------------
svtkRectf svtkCategoryLegend::GetBoundingRect(svtkContext2D* painter)
{
  ...
  this->Rect = svtkRectf(x, y, w, h);
  this->RectTime.Modified();
  return this->Rect;
}

//-----------------------------------------------------------------------------
void svtkCategoryLegend::SetTitle(const svtkStdString& title)
{
  this->Title = title;
}

//-----------------------------------------------------------------------------
svtkStdString svtkCategoryLegend::GetTitle()
{
  return this->Title;
}
