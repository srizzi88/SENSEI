/*=========================================================================
  ...
  Module:    svtkPartitionedArchiver.h
...
=========================================================================*/
/**
 * @class   svtkPartitionedArchiver
 * @brief   Writes an archive to several buffers
 *
 * svtkPartitionedArchiver is a specialized archiver for writing datasets into
...
#ifndef svtkPartitionedArchiver_h
#define svtkPartitionedArchiver_h

#include "svtkCommonArchiveModule.h" // For export macro

#include "svtkArchiver.h"

class SVTKCOMMONARCHIVE_EXPORT svtkPartitionedArchiver : public svtkArchiver
{
public:
  static svtkPartitionedArchiver* New();
  svtkTypeMacro(svtkPartitionedArchiver, svtkArchiver);
...
protected:
  svtkPartitionedArchiver();
  ~svtkPartitionedArchiver() override;

  struct Internal;
  Internal* Internals;

private:
  svtkPartitionedArchiver(const svtkPartitionedArchiver&) = delete;
  void operator=(const svtkPartitionedArchiver&) = delete;
};
