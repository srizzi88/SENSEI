...
=========================================================================*/
/**
 * @class   svtkNamedColors
 * @brief   A class holding colors and their names.
 *
 * For a web page of SVTK Named Colors and their RGB values, see:
 * <a
 * href="http://htmlpreview.github.io/?https://github.com/lorensen/SVTKExamples/blob/master/src/Python/Visualization/SVTKNamedColorPatches.html">SVTKNamedColorPatches</a>.
 * Use
 * <a
 * href="https://lorensen.github.io/SVTKExamples/site/Python/Visualization/NamedColorPatches/">NamedColorPatches</a>
 ...
 * Wrapping/Tcl/svtktesting/colors.tcl and Wrapping/Python/svtk/util/colors.py.
 *
...
#ifndef svtkNamedColors_h
#define svtkNamedColors_h

#include "svtkColor.h"             // Needed for svtkColor[34]ub
#include "svtkCommonColorModule.h" // For export macro
#include "svtkObject.h"
#include "svtkStdString.h"   // Needed for arguments
#include "svtkStringArray.h" // For returning color names

class svtkNamedColorsDataStore;
class svtkColorStringParser;

class SVTKCOMMONCOLOR_EXPORT svtkNamedColors : public svtkObject
{
public:
  svtkTypeMacro(svtkNamedColors, svtkObject);
  ...
  /**
   * Create a new svtkNamedColors object.
   */
  static svtkNamedColors* New();
   ...
   * The color is returned as a svtkColor4ub class.
   * The color black is returned if the color is not found.
   */
  svtkColor4ub GetColor4ub(const svtkStdString& name);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, unsigned char& r, unsigned char& g, unsigned char& b,
    unsigned char& a);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, unsigned char rgba[4]);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, svtkColor4ub& rgba);

  /**
   * Get the color by name.
   * The name is treated as being case-insensitive.
   * The color is returned as a svtkColor4d class.
   * The color black is returned if the color is not found.
   */
  svtkColor4d GetColor4d(const svtkStdString& name);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, double& r, double& g, double& b, double& a);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, double rgba[4]);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, svtkColor4d& rgba);

  /**
   * Get the color by name.
   * The name is treated as being case-insensitive.
   * The color is returned as a svtkColor3ub class.
   * The color black is returned if the color is not found.
   */
  svtkColor3ub GetColor3ub(const svtkStdString& name);

  /**
   * Get the color by name.
   * The name is treated as being case-insensitive.
   * The color is returned as a svtkColor3d class.
   * The color black is returned if the color is not found.
   */
  svtkColor3d GetColor3d(const svtkStdString& name);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, double& r, double& g, double& b);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColorRGB(const svtkStdString& name, double rgb[3]);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, svtkColor3ub& rgb);
   ...
   * The color black is returned if the color is not found.
   */
  void GetColor(const svtkStdString& name, svtkColor3d& rgb);
   ...
   */
  virtual void SetColor(const svtkStdString& name, const unsigned char& r, const unsigned char& g,
   ...
   * No color is set if the name is empty.
   */
  virtual void SetColor(const svtkStdString& name, const double& r, const double& g, const double& b,
    const double& a = 1);
   ...
   * No color is set if the name is empty.
   */
  virtual void SetColor(const svtkStdString& name, const unsigned char rgba[4]);
   ...
   * No color is set if the name is empty.
   */
  virtual void SetColor(const svtkStdString& name, const svtkColor4ub& rgba);
   ...
   * No color is set if the name is empty.
   */
  virtual void SetColor(const svtkStdString& name, const svtkColor3ub& rgb);
   ...
   * No color is set if the name is empty.
   */
  virtual void SetColor(const svtkStdString& name, const double rgba[4]);
   ...
   * No color is set if the name is empty.
   */
  virtual void SetColor(const svtkStdString& name, const svtkColor4d& rgba);
   ...
   * No color is set if the name is empty.
   */
  virtual void SetColor(const svtkStdString& name, const svtkColor3d& rgb);
   ...
   * TestNamedColors.cxx and TestNamedColorsIntegration.py
   */
  svtkStdString GetColorNames();

  /**
   * Return a string array of color names.
   */
  void GetColorNames(svtkStringArray* colorNames);
   ...
   * data structure they require.
   */
  svtkStdString GetSynonyms();

  /**
   * Return a svtkColor4ub instance from an HTML color string in any of
   ...
   */
  svtkColor4ub HTMLColorToRGBA(const svtkStdString& colorString);

  /**
   * Return a svtkColor3ub instance from an HTML color string in any of
   * the following formats:
   * - #RGB
   * - #RRGGBB
   * - rgb(r, g, b)
   ...
   * black.
   */
  svtkColor3ub HTMLColorToRGB(const svtkStdString& colorString);

  /**
   * Given a svtkColor3ub instance as input color return a valid HTML color
   * string in the `#RRGGBB` format.
   */
  svtkStdString RGBToHTMLColor(const svtkColor3ub& rgb);

  /**
   * Given a svtkColor4ub instance as input color return a valid HTML color
   * string in the `rgba(r, g, b, a)` format.
   */
  svtkStdString RGBAToHTMLColor(const svtkColor4ub& rgba);
   ...
   * HTML color string.
   */
  void SetColor(const svtkStdString& name, const svtkStdString& htmlString);

protected:
  svtkNamedColors();
  ~svtkNamedColors() override;
...
private:
   ...
   */
  svtkNamedColorsDataStore* Colors;
  svtkColorStringParser* Parser;
  //@}

  svtkNamedColors(const svtkNamedColors&) = delete;
  void operator=(const svtkNamedColors&) = delete;
};

#endif /* svtkNamedColors_h */
