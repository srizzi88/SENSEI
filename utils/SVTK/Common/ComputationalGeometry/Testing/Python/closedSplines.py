...
aKSplineX = svtk.svtkKochanekSpline()
aKSplineX.ClosedOn()
aKSplineY = svtk.svtkKochanekSpline()
aKSplineY.ClosedOn()
aKSplineZ = svtk.svtkKochanekSpline()
aKSplineZ.ClosedOn()

aCSplineX = svtk.svtkCardinalSpline()
aCSplineX.ClosedOn()
aCSplineY = svtk.svtkCardinalSpline()
aCSplineY.ClosedOn()
aCSplineZ = svtk.svtkCardinalSpline()
aCSplineZ.ClosedOn()
...
Kpoints = svtk.svtkPoints()
Cpoints = svtk.svtkPoints()
profileKData = svtk.svtkPolyData()
profileCData = svtk.svtkPolyData()
