...
svtkStandardNewMacro(svtkCardinalSpline);

//----------------------------------------------------------------------------
// Construct a Cardinal Spline.
svtkCardinalSpline::svtkCardinalSpline() = default;

//----------------------------------------------------------------------------
// Evaluate a 1D Spline
double svtkCardinalSpline::Evaluate(double t)
{
  int index;
  double* intervals;
  double* coefficients;
...
void svtkCardinalSpline::Compute()
{
  double *ts, *xs;
  ...
  if (size < 2)
  {
    svtkErrorMacro("Cannot compute a spline with less than 2 points. # of points is: " << size);
    return;
  }
...
void svtkCardinalSpline::Fit1D(int size, double* x, double* y, double* work,
...
void svtkCardinalSpline::FitClosed1D(
...
//----------------------------------------------------------------------------
void svtkCardinalSpline::DeepCopy(svtkSpline* s)
{
  svtkCardinalSpline* spline = svtkCardinalSpline::SafeDownCast(s);
...
//----------------------------------------------------------------------------
void svtkCardinalSpline::PrintSelf(ostream& os, svtkIndent indent)
{
