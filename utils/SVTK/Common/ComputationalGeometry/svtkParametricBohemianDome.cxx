/*=========================================================================
  ...
  Module:    svtkParametricBohemianDome.cxx
...
=========================================================================*/
#include "svtkParametricBohemianDome.h"
#include "svtkMath.h"
#include "svtkObjectFactory.h"

svtkStandardNewMacro(svtkParametricBohemianDome);
//----------------------------------------------------------------------------//
svtkParametricBohemianDome::svtkParametricBohemianDome()
  : A(0.5)
  , B(1.5)
  , C(1.0)
{
...
//----------------------------------------------------------------------------//
svtkParametricBohemianDome::~svtkParametricBohemianDome() = default;

//----------------------------------------------------------------------------//
void svtkParametricBohemianDome::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
...
//----------------------------------------------------------------------------//
double svtkParametricBohemianDome::EvaluateScalar(double*, double*, double*)
{
  return 0;
}

//----------------------------------------------------------------------------//
void svtkParametricBohemianDome::PrintSelf(ostream& os, svtkIndent indent)
{
