...
=========================================================================*/
#include "svtkParametricBour.h"
#include "svtkMath.h"
#include "svtkObjectFactory.h"

svtkStandardNewMacro(svtkParametricBour);
//----------------------------------------------------------------------------//
svtkParametricBour::svtkParametricBour()
{
  // Preset triangulation parameters
  this->MinimumU = 0.;
  this->MaximumU = 1.0;
  this->MinimumV = 0.;
  this->MaximumV = 4. * svtkMath::Pi();
...
//----------------------------------------------------------------------------//
svtkParametricBour::~svtkParametricBour() = default;

//----------------------------------------------------------------------------//
void svtkParametricBour::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
...
//----------------------------------------------------------------------------//
double svtkParametricBour::EvaluateScalar(double*, double*, double*)
{
  return 0;
}

//----------------------------------------------------------------------------//
void svtkParametricBour::PrintSelf(ostream& os, svtkIndent indent)
{
