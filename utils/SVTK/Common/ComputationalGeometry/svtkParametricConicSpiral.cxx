/*=========================================================================
  ...
  Module:    svtkParametricConicSpiral.cxx
...
svtkStandardNewMacro(svtkParametricConicSpiral);

//----------------------------------------------------------------------------
svtkParametricConicSpiral::svtkParametricConicSpiral()
{
...
//----------------------------------------------------------------------------
svtkParametricConicSpiral::~svtkParametricConicSpiral() = default;

//----------------------------------------------------------------------------
void svtkParametricConicSpiral::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
  double u = uvw[0];
  double v = uvw[1];
  double* Du = Duvw;
  ...
  double inv2pi = 1.0 / (2.0 * svtkMath::Pi());
...
//----------------------------------------------------------------------------
double svtkParametricConicSpiral::EvaluateScalar(double*, double*, double*)
{
  return 0;
}

//----------------------------------------------------------------------------
void svtkParametricConicSpiral::PrintSelf(ostream& os, svtkIndent indent)
{
