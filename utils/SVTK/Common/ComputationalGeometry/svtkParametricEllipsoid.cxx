/*=========================================================================
  ...
  Module:    svtkParametricEllipsoid.cxx
...
svtkStandardNewMacro(svtkParametricEllipsoid);

//----------------------------------------------------------------------------
svtkParametricEllipsoid::svtkParametricEllipsoid()
  : XRadius(1)
  , YRadius(1)
  , ZRadius(1)
{
...
//----------------------------------------------------------------------------
svtkParametricEllipsoid::~svtkParametricEllipsoid() = default;

//----------------------------------------------------------------------------
void svtkParametricEllipsoid::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
  double u = uvw[0];
  double v = uvw[1];
  double* Du = Duvw;
...
//----------------------------------------------------------------------------
double svtkParametricEllipsoid::EvaluateScalar(double*, double*, double*)
{
  return 0;
}

//----------------------------------------------------------------------------
void svtkParametricEllipsoid::PrintSelf(ostream& os, svtkIndent indent)
{
