/*=========================================================================
  ...
  Module:    svtkParametricEllipsoid.h
...
=========================================================================*/
/**
 * @class   svtkParametricEllipsoid
 * @brief   Generate an ellipsoid.
 *
 * svtkParametricEllipsoid generates an ellipsoid.
...
#ifndef svtkParametricEllipsoid_h
#define svtkParametricEllipsoid_h

#include "svtkCommonComputationalGeometryModule.h" // For export macro
#include "svtkParametricFunction.h"

class SVTKCOMMONCOMPUTATIONALGEOMETRY_EXPORT svtkParametricEllipsoid : public svtkParametricFunction
{
public:
  svtkTypeMacro(svtkParametricEllipsoid, svtkParametricFunction);
   ...
   */
  static svtkParametricEllipsoid* New();
...
protected:
  svtkParametricEllipsoid();
  ~svtkParametricEllipsoid() override;
...
private:
  svtkParametricEllipsoid(const svtkParametricEllipsoid&) = delete;
  void operator=(const svtkParametricEllipsoid&) = delete;
};
