/*=========================================================================
  ...
  Module:    svtkParametricFunction.cxx
...
//----------------------------------------------------------------------------
svtkParametricFunction::svtkParametricFunction()
  : MinimumU(0.0)
  , MaximumU(1.0)
  , MinimumV(0.0)
  , MaximumV(1.0)
...
//----------------------------------------------------------------------------
svtkParametricFunction::~svtkParametricFunction() = default;

//----------------------------------------------------------------------------
void svtkParametricFunction::PrintSelf(ostream& os, svtkIndent indent)
{
