/*=========================================================================
  ...
  Module:    svtkParametricHenneberg.cxx
...
=========================================================================*/
#include "svtkParametricHenneberg.h"
#include "svtkMath.h"
#include "svtkObjectFactory.h"

svtkStandardNewMacro(svtkParametricHenneberg);
//----------------------------------------------------------------------------//
svtkParametricHenneberg::svtkParametricHenneberg()
{
  // Preset triangulation parameters
  this->MinimumU = -1.0;
  this->MaximumU = 1.0;
  this->MinimumV = -svtkMath::Pi() / 2.;
  this->MaximumV = svtkMath::Pi() / 2.;
...
//----------------------------------------------------------------------------//
svtkParametricHenneberg::~svtkParametricHenneberg() = default;

//----------------------------------------------------------------------------//
void svtkParametricHenneberg::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
...
//----------------------------------------------------------------------------//
double svtkParametricHenneberg::EvaluateScalar(double*, double*, double*)
{
  return 0;
}

//----------------------------------------------------------------------------//
void svtkParametricHenneberg::PrintSelf(ostream& os, svtkIndent indent)
{
