...
svtkStandardNewMacro(svtkParametricKuen);
//----------------------------------------------------------------------------//
svtkParametricKuen::svtkParametricKuen()
{
...
//----------------------------------------------------------------------------//
svtkParametricKuen::~svtkParametricKuen() = default;

//----------------------------------------------------------------------------//
void svtkParametricKuen::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
  ...
  double logTanvO2 =
    ((svtkMath::Pi() - FLT_EPSILON <= v) && (v <= svtkMath::Pi() + FLT_EPSILON) ? 1.0
                                                                              : log(tan(v / 2.0)));
...
//----------------------------------------------------------------------------//
double svtkParametricKuen::EvaluateScalar(double*, double*, double*)
{
  return 0;
}

//----------------------------------------------------------------------------//
void svtkParametricKuen::PrintSelf(ostream& os, svtkIndent indent)
{
