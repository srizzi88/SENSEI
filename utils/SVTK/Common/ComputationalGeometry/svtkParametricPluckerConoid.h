/*=========================================================================
  ...
  Module:    svtkParametricPluckerConoid.h
...
=========================================================================*/
/**
 * @class   svtkParametricPluckerConoid
 * @brief   Generate Plucker's conoid surface.
 *
 * svtkParametricPluckerConoid generates Plucker's conoid surface parametrically.
...
#ifndef svtkParametricPluckerConoid_h
#define svtkParametricPluckerConoid_h

#include "svtkCommonComputationalGeometryModule.h" // For export macro
#include "svtkParametricFunction.h"

class SVTKCOMMONCOMPUTATIONALGEOMETRY_EXPORT svtkParametricPluckerConoid
  : public svtkParametricFunction
{
public:
  svtkTypeMacro(svtkParametricPluckerConoid, svtkParametricFunction);
   ...
   */
  static svtkParametricPluckerConoid* New();
...
protected:
  svtkParametricPluckerConoid();
  ~svtkParametricPluckerConoid() override;

  // Variables
  int N;

private:
  svtkParametricPluckerConoid(const svtkParametricPluckerConoid&) = delete;
  void operator=(const svtkParametricPluckerConoid&) = delete;
};
