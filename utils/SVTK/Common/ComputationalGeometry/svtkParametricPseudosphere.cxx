/*=========================================================================
  ...
  Module:    svtkParametricPseudosphere.cxx
...
=========================================================================*/
#include "svtkParametricPseudosphere.h"
#include "svtkMath.h"
#include "svtkObjectFactory.h"

svtkStandardNewMacro(svtkParametricPseudosphere);
//----------------------------------------------------------------------------//
svtkParametricPseudosphere::svtkParametricPseudosphere()
{
...
//----------------------------------------------------------------------------//
svtkParametricPseudosphere::~svtkParametricPseudosphere() = default;

//----------------------------------------------------------------------------//
void svtkParametricPseudosphere::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
...
//----------------------------------------------------------------------------//
double svtkParametricPseudosphere::EvaluateScalar(double*, double*, double*)
{
  return 0;
}

//----------------------------------------------------------------------------//
void svtkParametricPseudosphere::PrintSelf(ostream& os, svtkIndent indent)
{
