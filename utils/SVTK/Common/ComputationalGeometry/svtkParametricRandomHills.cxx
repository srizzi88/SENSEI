/*=========================================================================
  ...
  Module:    svtkParametricRandomHills.cxx
...
svtkStandardNewMacro(svtkParametricRandomHills);

//----------------------------------------------------------------------------
svtkParametricRandomHills::svtkParametricRandomHills()
  : NumberOfHills(30)
  , HillXVariance(2.5)
  , HillYVariance(2.5)
  , HillAmplitude(2)
  ...
  , AllowRandomGeneration(1)
{
  ...
  this->hillData = svtkDoubleArray::New();
  ...
  this->randomSequenceGenerator = svtkMinimalStandardRandomSequence::New();
...
//----------------------------------------------------------------------------
void svtkParametricRandomHills::InitRNG(int randomSeed)
{
...
//----------------------------------------------------------------------------
double svtkParametricRandomHills::Rand()
{
...
//----------------------------------------------------------------------------
void svtkParametricRandomHills::Evaluate(double uvw[3], double Pt[3], double Duvw[9])
{
...
//----------------------------------------------------------------------------
double svtkParametricRandomHills::EvaluateScalar(
  double* svtkNotUsed(uv[3]), double* svtkNotUsed(Pt[3]), double* svtkNotUsed(Duv[9]))
{
  return 0;
}

void svtkParametricRandomHills::MakeTheHillData()
{
...
//----------------------------------------------------------------------------
bool svtkParametricRandomHills::ParametersChanged()
{
...
//----------------------------------------------------------------------------
void svtkParametricRandomHills::CopyParameters()
{
...
//----------------------------------------------------------------------------
void svtkParametricRandomHills::PrintSelf(ostream& os, svtkIndent indent)
{
