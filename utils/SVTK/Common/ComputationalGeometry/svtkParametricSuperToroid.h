/*=========================================================================
  ...
  Module:    svtkParametricSuperToroid.h
...
=========================================================================*/
/**
 * @class   svtkParametricSuperToroid
 * @brief   Generate a supertoroid.
 *
 * svtkParametricSuperToroid generates a supertoroid.  Essentially a
...
#ifndef svtkParametricSuperToroid_h
#define svtkParametricSuperToroid_h

#include "svtkCommonComputationalGeometryModule.h" // For export macro
#include "svtkParametricFunction.h"

class SVTKCOMMONCOMPUTATIONALGEOMETRY_EXPORT svtkParametricSuperToroid : public svtkParametricFunction
{
public:
  svtkTypeMacro(svtkParametricSuperToroid, svtkParametricFunction);
   ...
   */
  static svtkParametricSuperToroid* New();
...
protected:
  svtkParametricSuperToroid();
  ~svtkParametricSuperToroid() override;
...
private:
  svtkParametricSuperToroid(const svtkParametricSuperToroid&) = delete;
  void operator=(const svtkParametricSuperToroid&) = delete;
};
