/*=========================================================================
 ...
 Module:    svtkExtentRCBPartitioner.h
 ...
 =========================================================================*/
/**
 * @class   svtkExtentRCBPartitioner
 *
 *
...
#ifndef svtkExtentRCBPartitioner_h
#define svtkExtentRCBPartitioner_h
...
class SVTKCOMMONEXECUTIONMODEL_EXPORT svtkExtentRCBPartitioner : public svtkObject
{
public:
  static svtkExtentRCBPartitioner* New();
  svtkTypeMacro(svtkExtentRCBPartitioner, svtkObject);
...
protected:
  svtkExtentRCBPartitioner();
  ~svtkExtentRCBPartitioner() override;
  ...
  svtkTypeBool DuplicateNodes; // indicates whether nodes are duplicated between
...
private:
  svtkExtentRCBPartitioner(const svtkExtentRCBPartitioner&) = delete;
  void operator=(const svtkExtentRCBPartitioner&) = delete;
};

#endif /* SVTKEXTENTRCBPARTITIONER_H_ */
