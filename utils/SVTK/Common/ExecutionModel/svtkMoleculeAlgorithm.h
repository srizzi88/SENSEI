/*=========================================================================
  ...
  Module:    svtkMoleculeAlgorithm.h
...
=========================================================================*/
/**
 * @class   svtkMoleculeAlgorithm
 * @brief   Superclass for algorithms that operate on
 * svtkMolecules
 *
 *
 *
 * svtkMoleculeAlgorithm is a convenience class to make writing algorithms
 ...
 * default says that all inputs will be svtkMolecules. If that isn't the case
...
#ifndef svtkMoleculeAlgorithm_h
#define svtkMoleculeAlgorithm_h
...
class SVTKCOMMONEXECUTIONMODEL_EXPORT svtkMoleculeAlgorithm : public svtkAlgorithm
{
public:
  static svtkMoleculeAlgorithm* New();
  svtkTypeMacro(svtkMoleculeAlgorithm, svtkAlgorithm);
  ...
  svtkMolecule* GetOutput(int);
  virtual void SetOutput(svtkMolecule* d);
  //@}
  ...
  svtkMolecule* GetMoleculeInput(int port);
   ...
   * svtkAlgorithm::SetInputConnection().  These methods transform the
   ...
   * use the more general svtkAlgorithm::AddInputConnection().  See
...
protected:
  svtkMoleculeAlgorithm();
  ~svtkMoleculeAlgorithm() override;
...
private:
  svtkMoleculeAlgorithm(const svtkMoleculeAlgorithm&) = delete;
  void operator=(const svtkMoleculeAlgorithm&) = delete;
};
