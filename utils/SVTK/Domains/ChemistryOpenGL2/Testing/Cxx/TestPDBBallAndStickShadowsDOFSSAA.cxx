...
int TestPDBBallAndStickShadowsDOFSSAA(int argc, char* argv[])
{
  ...
  sp->AddFragmentShaderReplacement("//SVTK::Color::Impl",
  ...
  svtkOpenGLRenderer* glrenderer = svtkOpenGLRenderer::SafeDownCast(ren);
