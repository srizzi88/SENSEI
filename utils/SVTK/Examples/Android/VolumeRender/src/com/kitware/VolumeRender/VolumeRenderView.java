...
class VolumeRenderView extends GLSurfaceView
{
    ...
    private static class Renderer implements GLSurfaceView.Renderer
    {
        ...
        {
            VolumeRenderLib.render(svtkContext);
        }

        // forward events to SVTK for it to handle
        public void onKeyEvent(boolean down, KeyEvent ke)
        {
            VolumeRenderLib.onKeyEvent(svtkContext, down, ke.getKeyCode(),
                ke.getMetaState(),
                ke.getRepeatCount());
        }
        ...
        public void onMotionEvent(final MotionEvent me)
        {
            try {
                ...
                VolumeRenderLib.onMotionEvent(svtkContext,
                                         actionMasked,
                                         actionId,
        ...
        {
            svtkContext = VolumeRenderLib.init(width, height);
        }
