 ...
 */
class JavaSVTKView extends GLSurfaceView
{
    private static String TAG = "JavaSVTKView";
    private Renderer myRenderer;

    public JavaSVTKView(Context context)
    {
        super(context);
        setFocusable(true);
    ...
    {
        private long svtkContext;

        public void onDrawFrame(GL10 gl)
        {
            JavaSVTKLib.render(svtkContext);
        }

        // forward events to SVTK for it to handle
        public void onKeyEvent(boolean down, KeyEvent ke)
        {
            JavaSVTKLib.onKeyEvent(svtkContext, down, ke.getKeyCode(),
                ke.getMetaState(),
                ke.getRepeatCount());
        }
        ...
        public void onMotionEvent(final MotionEvent me)
        {
            try {
                ...
                JavaSVTKLib.onMotionEvent(svtkContext,
                                         actionMasked,
                                         actionId,
        ...
        {
            svtkContext = JavaSVTKLib.init(width, height);
        }
