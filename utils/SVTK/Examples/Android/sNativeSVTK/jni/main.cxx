...
void android_main(struct android_app* state)
{
  ...
  /**************************************************
   *  THIS BLOCK IS JUST FOR SVTK's REGRESSIONS TESTING
   ...
   **************************************************/
  {
    ...
    jstring jsParam1 =
      (jstring)env->CallObjectMethod(intent, gseid, env->NewStringUTF("SVTKTesting"));
    int testing = 0;
    if (jsParam1)
    {
    ...
    if (testing)
    {
      ...
      std::string outputFile = dataPath + "/NativeSVTKResult.png";
      ...
      svtkNew<svtkImageExtractComponents> iec;
      ...
      svtkNew<svtkTesting> tst;
      std::string outputText = dataPath + "/NativeSVTKResult.txt";
      std::ofstream ofs;
      ofs.open(outputText.c_str(), std::ofstream::out);
      std::string validFile = dataPath + "/NativeSVTKValid.png";
      tst->AddArgument("-V");
