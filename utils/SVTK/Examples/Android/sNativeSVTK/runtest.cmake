...
#load the app
execute_process(
  COMMAND adb install -r NativeSVTK-debug.apk
...
# run the app
execute_process(
  COMMAND adb shell am start -n com.kitware.NativeSVTK/android.app.NativeActivity --es SVTKTesting Testing
  WORKING_DIRECTORY ${WORKINGDIR}
  OUTPUT_VARIABLE CMD_OUTPUT
  ERROR_VARIABLE CMD_ERROR
  RESULT_VARIABLE CMD_RESULT
...
# get the valid image
execute_process(
  COMMAND adb pull /storage/emulated/legacy/Android/data/com.kitware.NativeSVTK/files/NativeSVTKResult.png
  WORKING_DIRECTORY ${WORKINGDIR}
  OUTPUT_VARIABLE CMD_OUTPUT
  ERROR_VARIABLE CMD_ERROR
  RESULT_VARIABLE CMD_RESULT
...
# get the output text
execute_process(
  COMMAND adb pull /storage/emulated/legacy/Android/data/com.kitware.NativeSVTK/files/NativeSVTKResult.txt
  WORKING_DIRECTORY ${WORKINGDIR}
  OUTPUT_VARIABLE CMD_OUTPUT
  ERROR_VARIABLE CMD_ERROR
  RESULT_VARIABLE CMD_RESULT
...
if(CMD_RESULT)
  ...
  file(READ NativeSVTKResult.txt TextResult)
  message("${TextResult}")
endif()
