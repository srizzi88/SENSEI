...
# This example demonstrates the use of svtkXYPlotActor to display three
# probe lines using three different techniques.  In this example, we
# are loading data using the svtkPLOT3DReader.  We are using the
# svtkProbeFilter to extract the underlying point data along three
# probe lines.
...
# svtkProbeFilter, the probe line is the input, and the underlying data
# set is the source.
...
# Create a svtkAppendPolyData to merge the output of the three probe
