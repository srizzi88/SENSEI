...
# svtkProgrammableDataObjectSource. It creates fields the hard way (as
# compared to reading a svtk field file), but shows you how to
...
def parseFile():
    global SVTK_DATA_ROOT, dos

    # Use Python to read an ASCII file
    file = open(os.path.join(SVTK_DATA_ROOT, "Data/financial.txt"), "r")
...
popSurface = svtk.svtkContourFilter()
