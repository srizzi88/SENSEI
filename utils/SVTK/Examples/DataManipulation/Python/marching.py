...
# This example demonstrates the use of the svtkTransformPolyDataFilter
...
triangleEdgeTubes = svtk.svtkTubeFilter()
...
aShrinker = svtk.svtkShrinkPolyData()
aShrinker.SetShrinkFactor(1)
aShrinker.SetInputConnection(Marching.GetOutputPort())
aMapper = svtk.svtkPolyDataMapper()
aMapper.ScalarVisibilityOff()
aMapper.SetInputConnection(aShrinker.GetOutputPort())
Triangles = svtk.svtkActor()
...
# the outline of the cube.  Pass the edges through a svtkTubeFilter so
...
# Create a sphere to use as a glyph source for svtkGlyph3D.
...
# it was passed through svtkThresholdPoints.
...
# algorithm (routine translated from svtktesting/mccases.tcl).
