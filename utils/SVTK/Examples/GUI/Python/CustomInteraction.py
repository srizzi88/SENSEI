...
# new styles by subclassing svtkInteractorStyle. This is just an
# illustrative example.) If you really want trackball behavior, look
# at the svtkInteractorStyleTrackballCamera class.

import svtk
import sys

# We create an instance of svtkConeSource and set some of its
...
# object.  (Intermediate filters such as svtkShrinkPolyData could be
# inserted in between the source and the mapper.)  We create an
# instance of svtkPolyDataMapper to map the polygonal data into
...
# to properties via a svtkProperty instance, and includes an internal
