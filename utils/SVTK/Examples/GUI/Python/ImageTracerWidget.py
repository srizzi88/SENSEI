...
# initial translation from the tcl by SVTK/Utilities/tcl2py.py
...
# This example demonstrates how to use the svtkImageTracerWidget
...
v16.SetFilePrefix("%s/Data/headsq/quarter" % (SVTK_DATA_ROOT,))
v16.Update()
#
...
shifter = svtk.svtkImageShiftScale()
...
interactor = svtk.svtkInteractorStyleImage()
#
...
imageActor2 = svtk.svtkImageActor()
imageActor2.GetMapper().SetInputConnection(extract.GetOutputPort())
...
#
itw = svtk.svtkImageTracerWidget()
#
...
#
# When the underlying svtkDataSet is a svtkImageData, the widget can be
...
svtk.svtkMapper.SetResolveCoincidentTopologyToPolygonOffset()
svtk.svtkMapper.SetResolveCoincidentTopologyPolygonOffsetParameters(10,10)
