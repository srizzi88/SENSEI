...
# interactor designed to be used with svtkImageActor in a rendering
...
reader.SetFileName(SVTK_DATA_ROOT + "/Data/fullhead15.png")
...
pd.SetPoints(pts)
pd.SetLines(lines)
bboxMapper = svtk.svtkPolyDataMapper2D()
bboxMapper.SetInputData(pd)
bboxActor = svtk.svtkActor2D()
