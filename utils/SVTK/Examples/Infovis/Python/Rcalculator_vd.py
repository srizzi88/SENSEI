...
if __name__ == "__main__":
  ...
  # Connect to the svtkVertexDegree filter to compute vertex degree
  ...
  rcalculator = svtkRCalculatorFilter()
  ...
  # Copy new vertex degree array back into the SVTK graph
