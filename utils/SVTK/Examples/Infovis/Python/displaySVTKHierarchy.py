...
# The tree that will hold svtk class hierarchy
builder = svtk.svtkMutableDirectedGraph()
names = svtk.svtkStringArray()
names.SetName("name")
...
# load svtk class information
reader = csv.reader(open(SVTK_DATA_ROOT + "/Data/Infovis/classes.csv", 'r'))
...
win = svtk.svtkRenderWindow()
interact = svtk.svtkRenderWindowInteractor()
