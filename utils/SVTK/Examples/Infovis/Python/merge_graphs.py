...
if __name__ == "__main__":
    ...
    print("svtkGraph Example 1: Building a svtkMutableDirectedGraph from scratch.")

    #----------------------------------------------------------
    # Create a graph (see graph1.py for explanations)

    G1 = svtkMutableDirectedGraph()
    vertID1 = svtkIntArray()
    vertID1.SetName("ID")
    ...
    vertID2 = svtkIntArray()
    G2 = svtkMutableDirectedGraph()
    vertID2 = svtkIntArray()
    vertID2.SetName("ID")
