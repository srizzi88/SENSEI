...
psuedoStreamingData = svtkProgrammableFilter()
...
if __name__ == "__main__":
    ...
    streamingExec = svtkThreadedStreamingPipeline()
    svtkAlgorithm.SetDefaultExecutivePrototype(streamingExec)
    streamingExec.FastDelete()
    svtkThreadedStreamingPipeline.SetAutoPropagatePush(True)
