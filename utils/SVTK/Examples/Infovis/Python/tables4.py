#!/usr/bin/env python
"""
This file provides a more advanced example of svtkTable access and
...
if __name__ == "__main__":
    ...
    print("svtkTable Example 4: Accessing svtkTable data elements")
    ...
    print("svtkTable Example 4: Finished.")
