...
int main(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkImageWrapPad> pad = svtkSmartPointer<svtkImageWrapPad>::New();
  ...
  svtkSmartPointer<svtkTransformFilter> transformModel = svtkSmartPointer<svtkTransformFilter>::New();
