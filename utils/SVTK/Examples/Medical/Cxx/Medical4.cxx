...
int main(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkColorTransferFunction> volumeColor =
  ...
  svtkSmartPointer<svtkPiecewiseFunction> volumeScalarOpacity =
  ...
  svtkSmartPointer<svtkPiecewiseFunction> volumeGradientOpacity =
    svtkSmartPointer<svtkPiecewiseFunction>::New();
  ...
  // The svtkVolume is a svtkProp3D (like a svtkActor) and controls the position
