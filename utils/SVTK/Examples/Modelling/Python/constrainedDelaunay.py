...
import svtk
from svtk.util.colors import peacock
...
# Notice this trick. The SetInput() method accepts a svtkPolyData that
# is also the input to the Delaunay filter. The points of the
# svtkPolyData are used to generate the triangulation; the polygons are
