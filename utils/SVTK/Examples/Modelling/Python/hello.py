...
# Create implicit model with svtkImplicitModeller. This computes a
...
impMapper = svtk.svtkPolyDataMapper()
impMapper.SetInputConnection(contour.GetOutputPort())
impMapper.ScalarVisibilityOff()
impActor = svtk.svtkActor()
