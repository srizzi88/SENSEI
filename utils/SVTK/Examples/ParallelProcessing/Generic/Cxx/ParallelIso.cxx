...
// pipeline ( svtkImageReader -> svtkContourFilter -> svtkElevationFilter )
...
void MyMain(svtkMultiProcessController* controller, void* arg)
{
  ...
  char* fname = svtkTestUtilities::ExpandDataFileName(args->argc, args->argv, "Data/headsq/quarter");
  reader = svtkImageReader::New();
