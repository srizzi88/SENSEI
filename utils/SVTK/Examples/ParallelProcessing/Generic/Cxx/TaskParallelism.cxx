...
// with SVTK. It creates two different pipelines and assigns each to
...
void process(svtkMultiProcessController* controller, void* svtkNotUsed(arg))
{
  taskFunction task;
  ...
  svtkCompositeRenderManager* tc = svtkCompositeRenderManager::New();
  tc->SetRenderWindow(renWin);

  // Generate the pipeline see task1.cxx and task2.cxx)
  svtkPolyDataMapper* mapper = (*task)(renWin, EXTENT, cam);
...
int main(int argc, char* argv[])
{
  ...
  if (controller->IsA("svtkThreadedController"))
  {
