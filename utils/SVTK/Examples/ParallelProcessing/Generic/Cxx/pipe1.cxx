...
static void IncrementXFreq(
  svtkObject* svtkNotUsed(caller), unsigned long svtkNotUsed(eventId), void* sr, void*)
{
  svtkRTAnalyticSource* source1 = reinterpret_cast<svtkRTAnalyticSource*>(sr);
  XFreq = XFreq + 10;
...
void pipe1(svtkMultiProcessController* svtkNotUsed(controller), void* svtkNotUsed(arg))
{
  double extent = 20;
  ...
  op->AddObserver(svtkCommand::EndEvent, cbc);
  cbc->Delete();
