...
# properties. The instance of svtkConeSource "cone" is part of a visualization
# pipeline (it is a source process object); it produces data (output type is
# svtkPolyData) which other filters may process.
#
...
# exits the event loop. (Look in svtkInteractorStyle.h for a summary of events, or
