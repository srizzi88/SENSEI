...
##
# This is an example of how to use the svtkVolumePicker.
##
...
boneLocator = svtk.svtkCellLocator()
...
coneMapper = svtk.svtkDataSetMapper()
coneMapper.SetInputConnection(coneSource.GetOutputPort())

redCone = svtk.svtkActor()
redCone.PickableOff()
redCone.SetMapper(coneMapper)
redCone.GetProperty().SetColor(1,0,0)

greenCone = svtk.svtkActor()
