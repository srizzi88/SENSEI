...
- (IBAction)EnableProbeChanged:(id)sender
{
  ...
  SVTKViewController* svtkVC =
    (SVTKViewController*)[self.navigationController.viewControllers firstObject];
  [svtkVC setProbeEnabled:[sender isOn]];
}
...
- (void)viewDidLoad
{
  ...
  SVTKViewController* svtkVC =
    (SVTKViewController*)[self.navigationController.viewControllers firstObject];
  [self.enableprobeSwitch setOn:[svtkVC getProbeEnabled]];
