...
namespace
{
svtkSmartPointer<svtkPolyData> ConstructLines()
{
  svtkIdType ptIds[4];
  ...
  svtkSmartPointer<svtkCellArray> degeneratedLines = svtkSmartPointer<svtkCellArray>::New();
...
svtkSmartPointer<svtkPolyData> ConstructPolys()
{
  svtkIdType ptIds[4];
  svtkSmartPointer<svtkPoints> points = svtkSmartPointer<svtkPoints>::New();
  points->InsertNextPoint(0.0, 0.0, 0.0);
  ...
  svtkSmartPointer<svtkCellArray> degeneratedPolys = svtkSmartPointer<svtkCellArray>::New();
...
svtkSmartPointer<svtkPolyData> ConstructStrips()
{
  svtkIdType ptIds[4];
  svtkSmartPointer<svtkPoints> points = svtkSmartPointer<svtkPoints>::New();
  points->InsertNextPoint(0.0, 0.0, 0.0);
  ...
  svtkSmartPointer<svtkCellArray> degeneratedStrips = svtkSmartPointer<svtkCellArray>::New();
...
bool UpdateAndTestCleanPolyData(svtkSmartPointer<svtkCleanPolyData> clean, int numExpectedPoints,
...
int TestCleanPolyData2(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
