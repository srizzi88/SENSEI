...
int FeatureEdges(int dataType, int outputPointsPrecision)
{
  ...
  svtkSmartPointer<svtkFeatureEdges> featureEdges = svtkSmartPointer<svtkFeatureEdges>::New();
  featureEdges->SetOutputPointsPrecision(outputPointsPrecision);
  featureEdges->SetInputData(inputPolyData);

  featureEdges->Update();

  svtkSmartPointer<svtkPolyData> outputPolyData = featureEdges->GetOutput();
...
int TestFeatureEdges(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  int dataType = FeatureEdges(SVTK_FLOAT, svtkAlgorithm::DEFAULT_PRECISION);
  ...
  dataType = FeatureEdges(SVTK_DOUBLE, svtkAlgorithm::DEFAULT_PRECISION);
  ...
  dataType = FeatureEdges(SVTK_FLOAT, svtkAlgorithm::SINGLE_PRECISION);
  ...
  dataType = FeatureEdges(SVTK_DOUBLE, svtkAlgorithm::SINGLE_PRECISION);
  ...
  dataType = FeatureEdges(SVTK_FLOAT, svtkAlgorithm::DOUBLE_PRECISION);
  ...
  dataType = FeatureEdges(SVTK_DOUBLE, svtkAlgorithm::DOUBLE_PRECISION);
