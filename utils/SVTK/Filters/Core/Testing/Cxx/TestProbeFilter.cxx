...
int GetNumberOfValidPoints(svtkDataSet* pd)
{
  svtkDataArray* data = pd->GetPointData()->GetScalars("svtkValidPointMask");
  int numValid = 0;
...
// Tests the CompteThreshold and Threshold parameters on the svtkProbeFilter
