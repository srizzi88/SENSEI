...
int SmoothPolyData(int dataType, int outputPointsPrecision)
{
  ...
  svtkSmartPointer<svtkSmoothPolyDataFilter> smoothPolyDataFilter =
    svtkSmartPointer<svtkSmoothPolyDataFilter>::New();
  ...
  svtkSmartPointer<svtkPolyData> outputPolyData = smoothPolyDataFilter->GetOutput();
...
int TestSmoothPolyDataFilter(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  int dataType = SmoothPolyData(SVTK_FLOAT, svtkAlgorithm::DEFAULT_PRECISION);
  ...
  dataType = SmoothPolyData(SVTK_DOUBLE, svtkAlgorithm::DEFAULT_PRECISION);
  ...
  dataType = SmoothPolyData(SVTK_FLOAT, svtkAlgorithm::SINGLE_PRECISION);
  ...
  dataType = SmoothPolyData(SVTK_DOUBLE, svtkAlgorithm::SINGLE_PRECISION);
  ...
  dataType = SmoothPolyData(SVTK_FLOAT, svtkAlgorithm::DOUBLE_PRECISION);
  ...
  dataType = SmoothPolyData(SVTK_DOUBLE, svtkAlgorithm::DOUBLE_PRECISION);
