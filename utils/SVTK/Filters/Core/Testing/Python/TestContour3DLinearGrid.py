...
# Test svtkContour3DLinearGrid on tests, hexes, voxels.
# Also compare timing against svtkContourGrid.
...
assert(svtk.svtkContour3DLinearGrid.CanFullyProcessDataObject(clip.GetOutput(), "scalars"))
...
contour2 = svtk.svtkContour3DLinearGrid()
