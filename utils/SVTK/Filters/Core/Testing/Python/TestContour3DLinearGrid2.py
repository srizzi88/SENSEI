...
linearCells = svtk.svtkCellTypeSource()
linearCells.SetCellType(svtk.SVTK_HEXAHEDRON)
linearCells.Update()
assert(svtk.svtkContour3DLinearGrid.CanFullyProcessDataObject(linearCells.GetOutput(), 'DistanceToCenter'))

# Test filter input validity check on datasets with linear and nonlinear cells
quadraticCells = svtk.svtkCellTypeSource()
quadraticCells.SetCellType(svtk.SVTK_QUADRATIC_HEXAHEDRON)
quadraticCells.Update()
assert(not svtk.svtkContour3DLinearGrid.CanFullyProcessDataObject(quadraticCells.GetOutput(), 'DistanceToCenter'))

# Test svtkContour3DLinearGrid on mixed cell types as well as on wedges and
# pyramids.
