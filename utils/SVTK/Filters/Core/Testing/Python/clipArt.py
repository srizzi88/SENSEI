...
imageIn = svtk.svtkTIFFReader()
imageIn.SetFileName(SVTK_DATA_ROOT + "/Data/beach.tif")
...
threshold1 = svtk.svtkImageThreshold()
...
connect = svtk.svtkImageSeedConnectivity()
...
geometryTexture = svtk.svtkTextureMapToPlane()
...
geometryPD = svtk.svtkCastToConcrete()
geometryPD.SetInputConnection(geometryTexture.GetOutputPort())
geometryPD.Update()

clip = svtk.svtkClipPolyData()
