...
edgeContours = svtk.svtkContourFilter()
edgeContours.SetInputData(aEdgeGrid)
edgeContours.SetValue(0, 0.5)
aEdgeContourMapper = svtk.svtkDataSetMapper()
...
aEdgeContourActor = svtk.svtkActor()
...
triContours = svtk.svtkContourFilter()
triContours.SetInputData(aTriGrid)
triContours.SetValue(0, 0.5)
aTriContourMapper = svtk.svtkDataSetMapper()
...
aTriContourActor = svtk.svtkActor()
...
BquadContours = svtk.svtkContourFilter()
BquadContours.SetInputData(BQuadGrid)
BquadContours.SetValue(0, 0.5)
BQuadContourMapper = svtk.svtkDataSetMapper()
...
BQuadContourActor = svtk.svtkActor()
...
QLquadContours = svtk.svtkContourFilter()
QLquadContours.SetInputData(QLQuadGrid)
QLquadContours.SetValue(0, 0.5)
QLQuadContourMapper = svtk.svtkDataSetMapper()
...
QLQuadContourActor = svtk.svtkActor()
...
hexContours = svtk.svtkContourFilter()
hexContours.SetInputData(aHexGrid)
hexContours.SetValue(0, 0.5)
aHexContourMapper = svtk.svtkDataSetMapper()
...
aHexContourActor = svtk.svtkActor()
...
TQhexContours = svtk.svtkContourFilter()
TQhexContours.SetInputData(TQHexGrid)
TQhexContours.SetValue(0, 0.5)
TQHexContourMapper = svtk.svtkDataSetMapper()
...
TQHexContourActor = svtk.svtkActor()
...
BQhexContours = svtk.svtkContourFilter()
BQhexContours.SetInputData(BQHexGrid)
BQhexContours.SetValue(0, 0.5)
BQHexContourMapper = svtk.svtkDataSetMapper()
...
BQHexContourActor = svtk.svtkActor()
...
QLwedgeContours = svtk.svtkContourFilter()
QLwedgeContours.SetInputData(QLWedgeGrid)
QLwedgeContours.SetValue(0, 0.5)
QLWedgeContourMapper = svtk.svtkDataSetMapper()
...
QLWedgeContourActor = svtk.svtkActor()
...
BQwedgeContours = svtk.svtkContourFilter()
BQwedgeContours.SetInputData(BQWedgeGrid)
BQwedgeContours.SetValue(0, 0.5)
BQWedgeContourMapper = svtk.svtkDataSetMapper()
...
BQWedgeContourActor = svtk.svtkActor()
...
pyraContours = svtk.svtkContourFilter()
