...
class deciPlane(svtk.test.Testing.svtkTest):
    ...
    def testDeciPlane(self):
        ...
        #
        adjustPoints = svtk.svtkProgrammableFilter()
        ...
        #        idx = i * sz + j
                ...
                plane.update({idx: svtk.svtkActor()})
...
if __name__ == "__main__":
     svtk.test.Testing.main([(deciPlane, 'test')])
