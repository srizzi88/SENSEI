...
class financialField3(svtk.test.Testing.svtkTest):
    ...
    def testFinancialField(self):
        ...
        lateSurface = svtk.svtkContourFilter()
...
if __name__ == "__main__":
     svtk.test.Testing.main([(financialField3, 'test')])
