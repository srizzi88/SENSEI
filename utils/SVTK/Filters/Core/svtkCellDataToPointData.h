/*=========================================================================
  ...
  Module:    svtkCellDataToPointData.h
...
=========================================================================*/
/**
 * @class   svtkCellDataToPointData
 * @brief   map cell data to point data
 *
 * svtkCellDataToPointData is a filter that transforms cell data (i.e., data
 ...
 *
 * @sa
 * svtkPointData svtkCellData svtkPointDataToCellData
 */

#ifndef svtkCellDataToPointData_h
#define svtkCellDataToPointData_h
...
class SVTKFILTERSCORE_EXPORT svtkCellDataToPointData : public svtkDataSetAlgorithm
{
public:
  static svtkCellDataToPointData* New();
  svtkTypeMacro(svtkCellDataToPointData, svtkDataSetAlgorithm);
   ...
   */
  svtkSetMacro(PassCellData, bool);
  svtkGetMacro(PassCellData, bool);
  svtkBooleanMacro(PassCellData, bool);
  //@}
...
protected:
  svtkCellDataToPointData();
  ~svtkCellDataToPointData() override;
  ...
  int InterpolatePointData(svtkDataSet* input, svtkDataSet* output);
...
private:
  svtkCellDataToPointData(const svtkCellDataToPointData&) = delete;
  void operator=(const svtkCellDataToPointData&) = delete;
};
