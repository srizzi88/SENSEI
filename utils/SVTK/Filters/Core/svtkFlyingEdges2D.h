...
=========================================================================*/
/**
 * @class   svtkFlyingEdges2D
 * @brief   generate isoline(s) from a structured points (image) dataset
 *
 * svtkFlyingEdges2D is a reference implementation of the 2D version of the
 ...
 * consider using svtkDiscreteFlyingEdges2D.
 *
 * @warning
 ...
 *
 * @sa
 * svtkFlyingEdges3D svtkContourFilter svtkSynchronizedTemplates2D
 * svtkMarchingSquares svtkDiscreteFlyingEdges2D
 */

#ifndef svtkFlyingEdges2D_h
#define svtkFlyingEdges2D_h
...
class SVTKFILTERSCORE_EXPORT svtkFlyingEdges2D : public svtkPolyDataAlgorithm
{
public:
  static svtkFlyingEdges2D* New();
  svtkTypeMacro(svtkFlyingEdges2D, svtkPolyDataAlgorithm);
...
private:
  svtkFlyingEdges2D(const svtkFlyingEdges2D&) = delete;
  void operator=(const svtkFlyingEdges2D&) = delete;
};
