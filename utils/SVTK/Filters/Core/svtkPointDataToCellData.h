/*=========================================================================
  ...
  Module:    svtkPointDataToCellData.h
...
=========================================================================*/
/**
 * @class   svtkPointDataToCellData
 * @brief   map point data to cell data
 *
 * svtkPointDataToCellData is a filter that transforms point data (i.e., data
 ...
 * (i.e., svtkDataSet). Use the convenience methods (e.g.,
 * GetPolyDataOutput(), GetStructuredPointsOutput(), etc.) to get the type
 * of output you want.
 *
 * @sa
 * svtkPointData svtkCellData svtkCellDataToPointData
 */

#ifndef svtkPointDataToCellData_h
#define svtkPointDataToCellData_h

#include "svtkDataSetAlgorithm.h"
#include "svtkFiltersCoreModule.h" // For export macro

class SVTKFILTERSCORE_EXPORT svtkPointDataToCellData : public svtkDataSetAlgorithm
{
public:
  static svtkPointDataToCellData* New();
  svtkTypeMacro(svtkPointDataToCellData, svtkDataSetAlgorithm);
   ...
   */
  svtkSetMacro(PassPointData, bool);
  svtkGetMacro(PassPointData, bool);
  svtkBooleanMacro(PassPointData, bool);
  //@}
   ...
   */
  svtkSetMacro(CategoricalData, bool);
  svtkGetMacro(CategoricalData, bool);
  svtkBooleanMacro(CategoricalData, bool);
  //@}
   ...
   */
  svtkSetMacro(ProcessAllArrays, bool);
  svtkGetMacro(ProcessAllArrays, bool);
  svtkBooleanMacro(ProcessAllArrays, bool);
  //@}
...
protected:
  svtkPointDataToCellData();
  ~svtkPointDataToCellData() override;
...
private:
  svtkPointDataToCellData(const svtkPointDataToCellData&) = delete;
  void operator=(const svtkPointDataToCellData&) = delete;
};
