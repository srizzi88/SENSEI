/*=========================================================================
  ...
  Module:    svtkQuadricClustering.h
...
=========================================================================*/
/**
 * @class   svtkQuadricClustering
 * @brief   reduce the number of triangles in a mesh
 *
 * svtkQuadricClustering is a filter to reduce the number of triangles in a
 * triangle mesh, forming a good approximation to the original geometry.  The
 * input to svtkQuadricClustering is a svtkPolyData object, and all types of
 ...
 * in the x, y, and z directions. You must also specify an input svtkPolyData.
 ...
 * concave, this can produce bad results. In this case, use svtkTriangleFilter
 ...
 *
 * @sa
 * svtkQuadricDecimation svtkDecimatePro svtkDecimate svtkQuadricLODActor
 */

#ifndef svtkQuadricClustering_h
#define svtkQuadricClustering_h
...
class SVTKFILTERSCORE_EXPORT svtkQuadricClustering : public svtkPolyDataAlgorithm
{
public:
  //@{
  /**
   ...
   */
  svtkTypeMacro(svtkQuadricClustering, svtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkQuadricClustering* New();
  //@}
  ...
  svtkGetMacro(NumberOfXDivisions, int);
  svtkGetMacro(NumberOfYDivisions, int);
  svtkGetMacro(NumberOfZDivisions, int);
  void SetNumberOfDivisions(int div[3]) { this->SetNumberOfDivisions(div[0], div[1], div[2]); }
  void SetNumberOfDivisions(int div0, int div1, int div2);
  int* GetNumberOfDivisions() SVTK_SIZEHINT(3);
   ...
   * The default is On
   */
  svtkSetMacro(AutoAdjustNumberOfDivisions, svtkTypeBool);
  svtkGetMacro(AutoAdjustNumberOfDivisions, svtkTypeBool);
  svtkBooleanMacro(AutoAdjustNumberOfDivisions, svtkTypeBool);
  //@}
  ...
  svtkGetVector3Macro(DivisionOrigin, double);
  void SetDivisionSpacing(double x, double y, double z);
  void SetDivisionSpacing(double s[3]) { this->SetDivisionSpacing(s[0], s[1], s[2]); }
  svtkGetVector3Macro(DivisionSpacing, double);
  //@}
   ...
   * called directly.
   */
  svtkSetMacro(UseInputPoints, svtkTypeBool);
  svtkGetMacro(UseInputPoints, svtkTypeBool);
  svtkBooleanMacro(UseInputPoints, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(UseFeatureEdges, svtkTypeBool);
  svtkGetMacro(UseFeatureEdges, svtkTypeBool);
  svtkBooleanMacro(UseFeatureEdges, svtkTypeBool);
  svtkFeatureEdges* GetFeatureEdges() { return this->FeatureEdges; }
  //@}
   ...
   * not the mesh.
   */
  svtkSetMacro(UseFeaturePoints, svtkTypeBool);
  svtkGetMacro(UseFeaturePoints, svtkTypeBool);
  svtkBooleanMacro(UseFeaturePoints, svtkTypeBool);
  //@}
   ...
   */
  svtkSetClampMacro(FeaturePointsAngle, double, 0.0, 180.0);
  svtkGetMacro(FeaturePointsAngle, double);
  //@}
   ...
   * as well behaved.
   */
  svtkSetMacro(UseInternalTriangles, svtkTypeBool);
  svtkGetMacro(UseInternalTriangles, svtkTypeBool);
  svtkBooleanMacro(UseInternalTriangles, svtkTypeBool);
  //@}
  ...
  void Append(svtkPolyData* piece);
  void EndAppend();
  //@}
   ...
   */
  svtkSetMacro(CopyCellData, svtkTypeBool);
  svtkGetMacro(CopyCellData, svtkTypeBool);
  svtkBooleanMacro(CopyCellData, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(PreventDuplicateCells, svtkTypeBool);
  svtkGetMacro(PreventDuplicateCells, svtkTypeBool);
  svtkBooleanMacro(PreventDuplicateCells, svtkTypeBool);
  //@}

protected:
  svtkQuadricClustering();
  ~svtkQuadricClustering() override;
   ...
   */
  svtkIdType HashPoint(double point[3]);

  /**
   * Determine the representative point for this bin.
   */
  void ComputeRepresentativePoint(double quadric[9], svtkIdType binId, double point[3]);
   ...
   */
  void AddPolygons(svtkCellArray* polys, svtkPoints* points, int geometryFlag, svtkPolyData* input,
    svtkPolyData* output);
  void AddStrips(svtkCellArray* strips, svtkPoints* points, int geometryFlag, svtkPolyData* input,
    svtkPolyData* output);
  void AddTriangle(svtkIdType* binIds, double* pt0, double* pt1, double* pt2, int geometeryFlag,
   ...
   */
  void AddEdges(svtkCellArray* edges, svtkPoints* points, int geometryFlag, svtkPolyData* input,
    svtkPolyData* output);
  void AddEdge(svtkIdType* binIds, double* pt0, double* pt1, int geometeryFlag, svtkPolyData* input,
    svtkPolyData* output);
  //@}
   ...
   */
  void AddVertices(svtkCellArray* verts, svtkPoints* points, int geometryFlag, svtkPolyData* input,
    svtkPolyData* output);
  void AddVertex(
   ...
   */
  void AddQuadric(svtkIdType binId, double quadric[9]);
   ...
   */
  void FindFeaturePoints(svtkCellArray* edges, svtkPoints* edgePts, double angle);
   ...
   */
  void EndAppendUsingPoints(svtkPolyData* input, svtkPolyData* output);
  svtkTypeBool UseInputPoints;
  //@}
   ...
   */
  void EndAppendVertexGeometry(svtkPolyData* input, svtkPolyData* output);

  // Unfinished option to handle boundary edges differently.
  void AppendFeatureQuadrics(svtkPolyData* pd, svtkPolyData* output);
  svtkTypeBool UseFeatureEdges;
  svtkTypeBool UseFeaturePoints;
  svtkTypeBool UseInternalTriangles;
  ...
  svtkTypeBool PreventDuplicateCells;
  svtkQuadricClusteringCellSet* CellSet; // PIMPLd stl set for tracking inserted cells
  svtkIdType NumberOfBins;
  ...
  svtkTypeBool AutoAdjustNumberOfDivisions;
  ...
  double YBinStep;
  double ZBinStep;
  svtkIdType SliceSize; // eliminate one multiplication
  ...
  svtkIdType NumberOfBinsUsed;

  // Have to make these instance variables if we are going to allow
  // the algorithm to be driven by the Append methods.
  svtkCellArray* OutputTriangleArray;
  svtkCellArray* OutputLines;

  svtkFeatureEdges* FeatureEdges;
  svtkPoints* FeaturePoints;
  double FeaturePointsAngle;

  svtkTypeBool CopyCellData;
  int InCellCount;
  int OutCellCount;

private:
  svtkQuadricClustering(const svtkQuadricClustering&) = delete;
  void operator=(const svtkQuadricClustering&) = delete;
};
