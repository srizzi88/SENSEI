...
=========================================================================*/
/**
 * @class   svtkRearrangeFields
 * @brief   Move/copy fields between field data, point data and cell data
 *
 * svtkRearrangeFields is used to copy/move fields (svtkDataArrays) between
 ...
 * @verbatim
 * rf->AddOperation(svtkRearrangeFields::COPY, "foo",
 *                  svtkRearrangeFields::DATA_OBJECT,
 *                  svtkRearrangeFields::POINT_DATA);
 * @endverbatim
 ...
 * svtkDataSetAttributes svtkDataArray svtkAssignAttribute
 * svtkSplitField svtkMergeFields
 */

#ifndef svtkRearrangeFields_h
#define svtkRearrangeFields_h
...
class SVTKFILTERSCORE_EXPORT svtkRearrangeFields : public svtkDataSetAlgorithm
{
public:
  svtkTypeMacro(svtkRearrangeFields, svtkDataSetAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Create a new svtkRearrangeFields with an empty operation list.
   */
  static svtkRearrangeFields* New();
...
protected:
  ...
  void ApplyOperation(Operation* op, svtkDataSet* input, svtkDataSet* output);
  // Given location (DATA_OBJECT, CELL_DATA, POINT_DATA) return the
  // pointer to the corresponding field data.
  svtkFieldData* GetFieldDataFromLocation(svtkDataSet* ds, int fieldLoc);
  ...
  void PrintAllOperations(ostream& os, svtkIndent indent);
  void PrintOperation(Operation* op, ostream& os, svtkIndent indent);

private:
  svtkRearrangeFields(const svtkRearrangeFields&) = delete;
  void operator=(const svtkRearrangeFields&) = delete;
};
