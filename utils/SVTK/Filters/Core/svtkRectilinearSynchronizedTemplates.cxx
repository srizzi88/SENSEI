/*=========================================================================
  ...
  Module:    svtkRectilinearSynchronizedTemplates.cxx
...
svtkStandardNewMacro(svtkRectilinearSynchronizedTemplates);
...
svtkRectilinearSynchronizedTemplates::svtkRectilinearSynchronizedTemplates()
{
...
svtkMTimeType svtkRectilinearSynchronizedTemplates::GetMTime()
{
...
//----------------------------------------------------------------------------
static void svtkRectilinearSynchronizedTemplatesInitializeOutput(int* ext, svtkRectilinearGrid* input,
...
template <class T>
void svtkRSTComputePointGradient(
...
//----------------------------------------------------------------------------
#define SVTK_RECT_CSP3PA(i2, j2, k2, s)                                                             \
  if (NeedGradients)                                                                               \
  {                                                                                                \
    if (!g0)                                                                                       \
    {                                                                                              \
      self->ComputeSpacing(data, i, j, k, exExt, spacing);                                         \
      svtkRSTComputePointGradient(i, j, k, s0, inExt, xInc, yInc, zInc, spacing, n0);               \
      g0 = 1;                                                                                      \
    }                                                                                              \
    self->ComputeSpacing(data, i2, j2, k2, exExt, spacing);                                        \
    svtkRSTComputePointGradient(i2, j2, k2, s, inExt, xInc, yInc, zInc, spacing, n1);               \
    for (jj = 0; jj < 3; jj++)                                                                     \
    {                                                                                              \
...
//
template <class T>
void ContourRectilinearGrid(svtkRectilinearSynchronizedTemplates* self, int* exExt,
  svtkRectilinearGrid* data, svtkPolyData* output, T* ptr, svtkDataArray* inScalars,
  bool outputTriangles)
{
  ...
  svtkDataArray* xCoords = data->GetXCoordinates();
  svtkDataArray* yCoords = data->GetYCoordinates();
  svtkDataArray* zCoords = data->GetZCoordinates();
  double x1, x2, y2, z2;
  double spacing[6];
  ...
  svtkRectilinearSynchronizedTemplatesInitializeOutput(
...
//
int svtkRectilinearSynchronizedTemplates::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  {
    svtkErrorMacro("No scalars for contouring.");
    return 1;
  }
  ...
  {
    svtkTemplateMacro(ContourRectilinearGrid(
...
//----------------------------------------------------------------------------
int svtkRectilinearSynchronizedTemplates::RequestUpdateExtent(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
...
//----------------------------------------------------------------------------
void* svtkRectilinearSynchronizedTemplates::GetScalarsForExtent(
  svtkDataArray* array, int extent[6], svtkRectilinearGrid* input)
{
  if (!array)
  {
    return nullptr;
  ...
  for (idx = 0; idx < 3; idx++)
  {
    ...
    {
      svtkErrorMacro("requested extent not in input's extent");
      return nullptr;
    }
  }
  ...
  {
    svtkErrorMacro("computed coordinate outside of array bounds");
    return nullptr;
  }
...
//----------------------------------------------------------------------------
void svtkRectilinearSynchronizedTemplates::ComputeSpacing(
...
//----------------------------------------------------------------------------
int svtkRectilinearSynchronizedTemplates::FillInputPortInformation(int, svtkInformation* info)
{
...
//----------------------------------------------------------------------------
void svtkRectilinearSynchronizedTemplates::PrintSelf(ostream& os, svtkIndent indent)
{
