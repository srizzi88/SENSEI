 ...
 *
 *
 * svtkStripper is a filter that generates triangle strips and/or poly-lines
 ...
 * svtkTriangleFilter to triangulate non-triangular polygons prior to running
 ...
 * to strip these use svtkTriangleFilter to fragment the input into triangles
 * and lines prior to running svtkStripper.)
 *
...
#ifndef svtkStripper_h
#define svtkStripper_h

#include "svtkFiltersCoreModule.h" // For export macro
#include "svtkPolyDataAlgorithm.h"

class SVTKFILTERSCORE_EXPORT svtkStripper : public svtkPolyDataAlgorithm
{
public:
  svtkTypeMacro(svtkStripper, svtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Construct object with MaximumLength set to 1000.
   */
  static svtkStripper* New();
   ...
   */
  svtkSetClampMacro(MaximumLength, int, 4, 100000);
  svtkGetMacro(MaximumLength, int);
  //@}
   ...
   */
  svtkBooleanMacro(PassCellDataAsFieldData, svtkTypeBool);
  svtkSetMacro(PassCellDataAsFieldData, svtkTypeBool);
  svtkGetMacro(PassCellDataAsFieldData, svtkTypeBool);
  //@}
   ...
   * is off.
   */
  svtkSetMacro(JoinContiguousSegments, svtkTypeBool);
  svtkGetMacro(JoinContiguousSegments, svtkTypeBool);
  svtkBooleanMacro(JoinContiguousSegments, svtkTypeBool);
  //@}

protected:
  svtkStripper();
  ~svtkStripper() override {}

  // Usual data generation method
  int RequestData(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;

  int MaximumLength;
  svtkTypeBool PassCellDataAsFieldData;
  svtkTypeBool PassThroughCellIds;
  svtkTypeBool PassThroughPointIds;
  svtkTypeBool JoinContiguousSegments;

private:
  svtkStripper(const svtkStripper&) = delete;
  void operator=(const svtkStripper&) = delete;
};
