/*=========================================================================
  ...
  Module:    svtkSynchronizedTemplates2D.cxx
...
svtkStandardNewMacro(svtkSynchronizedTemplates2D);
...
svtkSynchronizedTemplates2D::svtkSynchronizedTemplates2D()
{
...
svtkMTimeType svtkSynchronizedTemplates2D::GetMTime()
{
...
//
template <class T>
void svtkContourImage(svtkSynchronizedTemplates2D* self, T* scalars, svtkPoints* newPts,
  svtkDataArray* newScalars, svtkCellArray* lines, svtkImageData* input, int* updateExt)
{
...
//
int svtkSynchronizedTemplates2D::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  svtkDebugMacro(<< "Executing 2D structured contour");

  ext = inInfo->Get(svtkStreamingDemandDrivenPipeline::UPDATE_EXTENT());
  ...
  {
    svtkTemplateMacro(
      svtkContourImage(this, (SVTK_TT*)scalars, newPts, newScalars, newLines, input, ext));
  } // switch
...
//----------------------------------------------------------------------------
int svtkSynchronizedTemplates2D::FillInputPortInformation(int, svtkInformation* info)
{
...
//----------------------------------------------------------------------------
void svtkSynchronizedTemplates2D::PrintSelf(ostream& os, svtkIndent indent)
{
