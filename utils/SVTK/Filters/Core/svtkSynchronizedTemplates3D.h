/*=========================================================================
  ...
  Module:    svtkSynchronizedTemplates3D.h
 ...
 *
 * svtkSynchronizedTemplates3D is a 3D implementation of the synchronized
 ...
 *
 * @sa
 * svtkContourFilter svtkFlyingEdges3D svtkMarchingCubes
 * svtkSynchronizedTemplates2D svtkDiscreteFlyingEdges3D
 */

#ifndef svtkSynchronizedTemplates3D_h
#define svtkSynchronizedTemplates3D_h
...
class SVTKFILTERSCORE_EXPORT svtkSynchronizedTemplates3D : public svtkPolyDataAlgorithm
{
public:
  static svtkSynchronizedTemplates3D* New();

  svtkTypeMacro(svtkSynchronizedTemplates3D, svtkPolyDataAlgorithm);
...
protected:
  svtkSynchronizedTemplates3D();
  ~svtkSynchronizedTemplates3D() override;
...
private:
  svtkSynchronizedTemplates3D(const svtkSynchronizedTemplates3D&) = delete;
  void operator=(const svtkSynchronizedTemplates3D&) = delete;
};

// template table.

extern int SVTKFILTERSCORE_EXPORT SVTK_SYNCHRONIZED_TEMPLATES_3D_TABLE_1[];
extern int SVTKFILTERSCORE_EXPORT SVTK_SYNCHRONIZED_TEMPLATES_3D_TABLE_2[];
