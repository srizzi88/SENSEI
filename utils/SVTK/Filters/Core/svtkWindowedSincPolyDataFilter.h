/*=========================================================================
  ...
  Module:    svtkWindowedSincPolyDataFilter.h
...
=========================================================================*/
/**
 * @class   svtkWindowedSincPolyDataFilter
 * @brief   adjust point positions using a windowed sinc function interpolation kernel
 *
 * svtkWindowedSincPolyDataFiler adjust point coordinate using a windowed
 ...
 * composing an instance of svtkPolyData.  Vertex or poly-vertex cells are
 * never modified.
 *
 ...
 * svtkSmoothPolyDataFilter which usually requires 100 to 200 smoothing
 * iterations. svtkSmoothPolyDataFilter is also not an approximation to
 ...
 *
 * @sa
 * svtkSmoothPolyDataFilter svtkDecimate svtkDecimatePro
 */

#ifndef svtkWindowedSincPolyDataFilter_h
#define svtkWindowedSincPolyDataFilter_h

#include "svtkFiltersCoreModule.h" // For export macro
#include "svtkPolyDataAlgorithm.h"

class SVTKFILTERSCORE_EXPORT svtkWindowedSincPolyDataFilter : public svtkPolyDataAlgorithm
{
public:
  svtkTypeMacro(svtkWindowedSincPolyDataFilter, svtkPolyDataAlgorithm);
   ...
   */
  static svtkWindowedSincPolyDataFilter* New();
   ...
   */
  svtkSetClampMacro(PassBand, double, 0.0, 2.0);
  svtkGetMacro(PassBand, double);
  //@}
   ...
   * completed.
   */
  svtkSetMacro(NormalizeCoordinates, svtkTypeBool);
  svtkGetMacro(NormalizeCoordinates, svtkTypeBool);
  svtkBooleanMacro(NormalizeCoordinates, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(NonManifoldSmoothing, svtkTypeBool);
  svtkGetMacro(NonManifoldSmoothing, svtkTypeBool);
  svtkBooleanMacro(NonManifoldSmoothing, svtkTypeBool);
  //@}
...
protected:
  svtkWindowedSincPolyDataFilter();
  ~svtkWindowedSincPolyDataFilter() override {}
  ...
  svtkTypeBool NonManifoldSmoothing;
  svtkTypeBool GenerateErrorScalars;
  svtkTypeBool GenerateErrorVectors;
  svtkTypeBool NormalizeCoordinates;

private:
  svtkWindowedSincPolyDataFilter(const svtkWindowedSincPolyDataFilter&) = delete;
  void operator=(const svtkWindowedSincPolyDataFilter&) = delete;
};
