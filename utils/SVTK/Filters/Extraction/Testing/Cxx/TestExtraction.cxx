...
=========================================================================*/
// This tests svtkSelection and svtkExtractSelection.
//
...
static svtkImageData* sampleData = nullptr;
...
void showMe(svtkDataSet* result, int X, int Y, int CellOrPoint, svtkDataArray* array)
{
  svtkDataSet* copy = result->NewInstance();
  ...
  if (DrawSampleData)
  {
    svtkDataSetMapper* mapper2 = svtkDataSetMapper::New();
...
int TestExtraction(int argc, char* argv[])
{
  ...
  svtkRenderWindowInteractor* rwi = svtkRenderWindowInteractor::New();
  ...
  svtkXMLDataSetWriter* xwriter = svtkXMLDataSetWriter::New();
  ...
  svtkSelectionNode* sel = svtkSelectionNode::New();
  ...
  svtkUnstructuredGridWriter* writer = svtkUnstructuredGridWriter::New();

  svtkUnstructuredGrid* extGrid;
  svtkImageData* extIData;
  svtkDataArray* insideArray;

  //-------------------------------------------------------------------------
  // Test extract GLOBALIDS filter on cells
  svtkIdTypeArray* cellIds = nullptr;

  sel->Initialize();
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::GLOBALIDS);
  sel->SetFieldType(svtkSelectionNode::CELL);
  ...
  ext->Update();
  extGrid = svtkUnstructuredGrid::SafeDownCast(ext->GetOutput());
  if (DoWrite)
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_GID.svtk");
    writer->Write();
  }
  showMe(extGrid, 0, 0, COLORBYCELL, ciaF);

  sel->GetProperties()->Set(svtkSelectionNode::INVERSE(), 1);
  ext->Update();
  extGrid = svtkUnstructuredGrid::SafeDownCast(ext->GetOutput());
  if (DoWrite)
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_GID_I.svtk");
    writer->Write();
  }
  showMe(extGrid, 1, 0, COLORBYCELL, ciaF);

  sel->GetProperties()->Set(svtkSelectionNode::INVERSE(), 0);
  ext->PreserveTopologyOn();
  ext->Update();
  extIData = svtkImageData::SafeDownCast(ext->GetOutput());
  if (DoWrite)
  {
  ...
  insideArray = extIData->GetCellData()->GetArray("svtkInsidedness");
  ...
  ext->PreserveTopologyOff();
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::GLOBALIDS);
  sel->GetProperties()->Set(svtkSelectionNode::FIELD_TYPE(), svtkSelectionNode::POINT);
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_GID.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_GID_I.svtk");
    writer->Write();
  }
  showMe(extGrid, 4, 0, COLORBYPOINT, piaF);

  sel->GetProperties()->Set(svtkSelectionNode::INVERSE(), 0);
  sel->GetProperties()->Set(svtkSelectionNode::CONTAINING_CELLS(), 1);
  ext->Update();
  extGrid = svtkUnstructuredGrid::SafeDownCast(ext->GetOutput());
  if (DoWrite)
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_GID_WC.svtk");
    writer->Write();
  }
  showMe(extGrid, 5, 0, COLORBYPOINT, piaF);

  sel->GetProperties()->Set(svtkSelectionNode::CONTAINING_CELLS(), 0);
  ext->PreserveTopologyOn();
  ext->Update();
  extIData = svtkImageData::SafeDownCast(ext->GetOutput());
  if (DoWrite)
  ...
  insideArray = extIData->GetPointData()->GetArray("svtkInsidedness");
  ...
  {
    xwriter->SetInputConnection(ext->GetOutputPort());
    xwriter->SetFileName("ext_P_GID_WC_PT.svtk");
    xwriter->Write();
  }
  insideArray = extIData->GetCellData()->GetArray("svtkInsidedness");
  ...
  sel->Initialize();
  ext->PreserveTopologyOff();
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::INDICES);
  sel->SetFieldType(svtkSelectionNode::CELL);
  cellIds = svtkIdTypeArray::New();
  cellIds->SetNumberOfComponents(1);
  cellIds->SetNumberOfTuples(5);
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Ind.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Ind_I.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Ind_I.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Ind_WC.svtk");
    writer->Write();
  }
  ...
  sel->Initialize();
  ext->PreserveTopologyOff();
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::VALUES);
  sel->SetFieldType(svtkSelectionNode::CELL);
  cellIds = svtkIdTypeArray::New();
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Val.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Val_I.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Val.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Val_I.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Val_WC.svtk");
    writer->Write();
  }
  ...
  {
    xwriter->SetInputConnection(ext->GetOutputPort());
    xwriter->SetFileName("ext_P_Val_PT.svtk");
    xwriter->Write();
  }
  insideArray = extIData->GetCellData()->GetArray("svtkInsidedness");
  if (insideArray)
  ...
  {
    xwriter->SetInputConnection(ext->GetOutputPort());
    xwriter->SetFileName("ext_P_Val_PT_WC.svtk");
    xwriter->Write();
  }
  insideArray = extIData->GetCellData()->GetArray("svtkInsidedness");
  ...
  sel->Initialize();
  ext->PreserveTopologyOff();
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::THRESHOLDS);
  sel->SetFieldType(svtkSelectionNode::CELL);
  svtkDoubleArray* cellThresh = svtkDoubleArray::New();
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Thr.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Thr_I.svtk");
    writer->Write();
  }
  ...
  {
    xwriter->SetInputConnection(ext->GetOutputPort());
    xwriter->SetFileName("ext_C_Thr_PT.svtk");
    xwriter->Write();
  }
  insideArray = extIData->GetCellData()->GetArray("svtkInsidedness");
  ...
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::THRESHOLDS);
  sel->GetProperties()->Set(svtkSelectionNode::FIELD_TYPE(), svtkSelectionNode::POINT);
  svtkDoubleArray* pointThresh = svtkDoubleArray::New();
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Thr.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Thr_I.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Thr_WC.svtk");
    writer->Write();
  }
  ...
  {
    xwriter->SetInputConnection(ext->GetOutputPort());
    xwriter->SetFileName("ext_P_Thr_PT.svtk");
    xwriter->Write();
  }
  insideArray = extIData->GetCellData()->GetArray("svtkInsidedness");
  if (insideArray)
  ...
  {
    xwriter->SetInputConnection(ext->GetOutputPort());
    xwriter->SetFileName("ext_P_Thr_PT_WC.svtk");
    xwriter->Write();
  }
  insideArray = extIData->GetCellData()->GetArray("svtkInsidedness");
  ...
  sel->Initialize();
  ext->PreserveTopologyOff();
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::LOCATIONS);
  sel->SetFieldType(svtkSelectionNode::CELL);
  svtkDoubleArray* cellLocs = svtkDoubleArray::New();
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Loc.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_C_Loc_I.svtk");
    writer->Write();
  }
  ...
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::LOCATIONS);
  sel->GetProperties()->Set(svtkSelectionNode::FIELD_TYPE(), svtkSelectionNode::POINT);
  sel->GetProperties()->Set(svtkSelectionNode::EPSILON(), 0.3);
  svtkDoubleArray* pointLocs = svtkDoubleArray::New();
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Loc.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Loc_I.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Loc_WC.svtk");
    writer->Write();
  }
  ...
  sel->Initialize();
  ext->PreserveTopologyOff();
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::FRUSTUM);
  sel->SetFieldType(svtkSelectionNode::CELL);
  svtkDoubleArray* frustcorners = svtkDoubleArray::New();
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_Fru.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_Fru_I.svtk");
    writer->Write();
  }
  ...
  sel->GetProperties()->Set(svtkSelectionNode::CONTENT_TYPE(), svtkSelectionNode::FRUSTUM);
  sel->GetProperties()->Set(svtkSelectionNode::FIELD_TYPE(), svtkSelectionNode::POINT);
  frustcorners = svtkDoubleArray::New();
  frustcorners->SetNumberOfComponents(4);
  frustcorners->SetNumberOfTuples(8);
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Fru.svtk");
    writer->Write();
  }
  ...
  {
    writer->SetInputConnection(ext->GetOutputPort());
    writer->SetFileName("ext_P_Fru_I.svtk");
    writer->Write();
  }
...
int TestExtraction(int argc, char* argv[])
{
  return TestExtraction<svtkExtractSelection>(argc, argv);
}
