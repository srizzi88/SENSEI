...
int TestLagrangianIntegrationModel(int, char*[])
{
  ...
  svtkPointData* pdFlow = waveletImg->GetPointData();
  ...
  svtkNew<svtkDataSetTriangleFilter> triangle;
  ...
  int seedIdx = 13;
  odeWavelet->SetInputArrayToProcess(2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "");
  odeWavelet->SetInputArrayToProcess(
    3, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "FlowVelocity");
  odeWavelet->SetInputArrayToProcess(
    4, 0, 0, svtkDataObject::FIELD_ASSOCIATION_POINTS, "FlowDensity");
  odeWavelet->SetInputArrayToProcess(
  ...
  std::unique_ptr<svtkLagrangianThreadedData> data(new svtkLagrangianThreadedData);
  svtkLagrangianParticle part(nvar, seedIdx, seedIdx, 0, 0, pd, odeWavelet->GetWeightsSize(), 3);
  std::unique_ptr<svtkBilinearQuadIntersection> bqi(new svtkBilinearQuadIntersection);
  ...
  svtkPolyData* tmpPd = nullptr;
  svtkDataObject* tmpDo = nullptr;
  ...
  // Test on a svtkUnstructuredGrid
  svtkNew<svtkLagrangianMatidaIntegrationModel> odeTriangle;
  odeTriangle->SetTracker(tracker);
  odeTriangle->SetInputArrayToProcess(2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "");
  ...
  svtkNew<svtkLagrangianMatidaIntegrationModel> odeTransform;
  odeTransform->SetTracker(tracker);
  odeTransform->SetInputArrayToProcess(2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "");
  ...
  normals->Update();
  svtkPolyData* surfacePd = normals->GetOutput();

  // Create Surface data
  svtkNew<svtkDoubleArray> surfaceTypeModel;
  ...
  surfaceTypeModel->FillComponent(0, svtkLagrangianBasicIntegrationModel::SURFACE_TYPE_MODEL);
  ...
  svtkNew<svtkDoubleArray> surfaceTypeBreak;
  ...
  surfaceTypeBreak->FillComponent(0, svtkLagrangianBasicIntegrationModel::SURFACE_TYPE_BREAK);
  ...
  nextPos[2] = 0;
  odeWavelet->SetInputArrayToProcess(
    2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "SurfaceTypeModel");
  svtkLagrangianParticle* interactionParticle = odeWavelet->ComputeSurfaceInteraction(
  ...
  nextPos[2] = 0;
  odeWavelet->SetInputArrayToProcess(
    2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "SurfaceTypeTerm");
  svtkLagrangianParticle* interactionParticle2 = odeWavelet->ComputeSurfaceInteraction(
    &part, particles, interactedSurfaceFlatIndex, passThroughParticles);
  ...
  nextPos[2] = 0;
  odeWavelet->SetInputArrayToProcess(
    2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "SurfaceTypeBounce");
  svtkLagrangianParticle* interactionParticle3 = odeWavelet->ComputeSurfaceInteraction(
    &part, particles, interactedSurfaceFlatIndex, passThroughParticles);
  ...
  nextPos[1] = 0;
  nextPos[2] = 0;
  svtkLagrangianParticle* interactionParticle4 = odeWavelet->ComputeSurfaceInteraction(
    &part, particles, interactedSurfaceFlatIndex, passThroughParticles);
  ...
  nextPos[2] = 0;
  odeWavelet->SetInputArrayToProcess(
    2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "SurfaceTypeBreak");
  svtkLagrangianParticle* interactionParticle5 = odeWavelet->ComputeSurfaceInteraction(
    &part, particles, interactedSurfaceFlatIndex, passThroughParticles);
  ...
  nextPos[2] = 0;
  odeWavelet->SetInputArrayToProcess(
    2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "SurfaceTypePass");
  svtkLagrangianParticle* interactionParticle6 = odeWavelet->ComputeSurfaceInteraction(
    &part, particles, interactedSurfaceFlatIndex, passThroughParticles);
  ...
  odeWavelet->SetInputArrayToProcess(
    2, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "SurfaceTypeModel");
  svtkLagrangianParticle* interactionParticle7 = odeWavelet->ComputeSurfaceInteraction(
    &part, particles, interactedSurfaceFlatIndex, passThroughParticles);
