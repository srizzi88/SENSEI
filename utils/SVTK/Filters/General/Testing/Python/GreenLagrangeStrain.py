...
for F in F_lst:
    ...
    # Compute displacement gradient using svtkCellDerivatives
    cell_derivatives = svtk.svtkCellDerivatives()
    ...
    # Compute small strain tensor using svtkCellDerivatives
    cell_derivatives = svtk.svtkCellDerivatives()
    cell_derivatives.SetVectorModeToPassVectors()
    ...
    # Compute Green-Lagrange strain tensor using svtkCellDerivatives
    cell_derivatives = svtk.svtkCellDerivatives()
    cell_derivatives.SetVectorModeToPassVectors()
