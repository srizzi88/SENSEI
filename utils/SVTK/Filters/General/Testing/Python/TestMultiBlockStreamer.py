...
Plot3D0 = svtk.svtkMultiBlockPLOT3DReader()
Plot3D0.SetFileName(SVTK_DATA_ROOT + "/Data/combxyz.bin")
Plot3D0.SetQFileName(SVTK_DATA_ROOT + "/Data/combq.bin")
...
Geometry5 = svtk.svtkStructuredGridOutlineFilter()
...
ExtractGrid0 = svtk.svtkExtractGrid()
...
ExtractGrid1 = svtk.svtkExtractGrid()
...
ExtractGrid2 = svtk.svtkExtractGrid()
...
LineSourceWidget0 = svtk.svtkLineSource()
...
LookupTable1 = svtk.svtkLookupTable()
...
Mapper10 = svtk.svtkPolyDataMapper()
