/*=========================================================================
  ...
  Module:    svtkAreaContourSpectrumFilter.cxx
...
=========================================================================*/
#include "svtkAreaContourSpectrumFilter.h"
...
svtkStandardNewMacro(svtkAreaContourSpectrumFilter);

//----------------------------------------------------------------------------
svtkAreaContourSpectrumFilter::svtkAreaContourSpectrumFilter()
{
...
//----------------------------------------------------------------------------
svtkAreaContourSpectrumFilter::~svtkAreaContourSpectrumFilter() = default;

//----------------------------------------------------------------------------
int svtkAreaContourSpectrumFilter::FillInputPortInformation(int portNumber, svtkInformation* info)
{
  switch (portNumber)
  {
    case 0:
...
//----------------------------------------------------------------------------
int svtkAreaContourSpectrumFilter::FillOutputPortInformation(
...
//----------------------------------------------------------------------------
void svtkAreaContourSpectrumFilter::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
svtkTable* svtkAreaContourSpectrumFilter::GetOutput()
{
  return svtkTable::SafeDownCast(this->GetOutputDataObject(0));
}

//----------------------------------------------------------------------------
int svtkAreaContourSpectrumFilter::RequestData(svtkInformation* svtkNotUsed(request),
