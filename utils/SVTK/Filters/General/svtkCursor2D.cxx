...
//---------------------------------------------------------------------------
int svtkCursor2D::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  int numPts = 0;
  svtkPoints* newPts;
  svtkCellArray *newLines = nullptr, *newVerts = nullptr;
  double x[3];
  svtkIdType ptIds[5];
...
void svtkCursor2D::SetModelBounds(
...
//---------------------------------------------------------------------------
void svtkCursor2D::SetFocalPoint(double x[3])
{
...
//---------------------------------------------------------------------------
void svtkCursor2D::SetModelBounds(const double bounds[6])
{
...
//---------------------------------------------------------------------------
void svtkCursor2D::PrintSelf(ostream& os, svtkIndent indent)
{
