/*=========================================================================
  ...
  Module:    svtkDiscreteMarchingCubes.h
...
=========================================================================*/
/**
 * @class   svtkDiscreteMarchingCubes
 ...
 * of the corresponding cube. Note that this differs from svtkMarchingCubes,
 ...
 * scalar value using svtkThreshold, or 2) process the data with
 * filters that can handle non-manifold polydata
 * (e.g. svtkWindowedSincPolyDataFilter).
 ...
 * This allows to remove regions of the resulting svtkPolyData that are
 ...
 * details and images see the SVTK Journal paper
 * "Providing values of adjacent voxel with svtkDiscreteMarchingCubes"
 * by Roman Grothausmann:
 * http://hdl.handle.net/10380/3559
 * http://www.svtkjournal.org/browse/publication/975
 * @warning
 ...
 * @sa
 * svtkContourFilter svtkSliceCubes svtkMarchingSquares svtkDividingCubes
 */

#ifndef svtkDiscreteMarchingCubes_h
#define svtkDiscreteMarchingCubes_h

#include "svtkFiltersGeneralModule.h" // For export macro
#include "svtkMarchingCubes.h"

class SVTKFILTERSGENERAL_EXPORT svtkDiscreteMarchingCubes : public svtkMarchingCubes
{
public:
  static svtkDiscreteMarchingCubes* New();
  svtkTypeMacro(svtkDiscreteMarchingCubes, svtkMarchingCubes);

  //@{
  /**
   * Set/Get the computation of neighbouring voxel values.
   */
  svtkSetMacro(ComputeAdjacentScalars, svtkTypeBool);
  svtkGetMacro(ComputeAdjacentScalars, svtkTypeBool);
  svtkBooleanMacro(ComputeAdjacentScalars, svtkTypeBool);
  //@}

protected:
  svtkDiscreteMarchingCubes();
  ~svtkDiscreteMarchingCubes() override;

  int RequestData(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;
  svtkTypeBool ComputeAdjacentScalars;

private:
  svtkDiscreteMarchingCubes(const svtkDiscreteMarchingCubes&) = delete;
  void operator=(const svtkDiscreteMarchingCubes&) = delete;
};
