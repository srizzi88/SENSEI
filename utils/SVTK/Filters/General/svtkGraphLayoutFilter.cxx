/*=========================================================================
  ...
  Module:    svtkGraphLayoutFilter.cxx
...
=========================================================================*/
#include "svtkGraphLayoutFilter.h"
...
svtkStandardNewMacro(svtkGraphLayoutFilter);

svtkGraphLayoutFilter::svtkGraphLayoutFilter()
{
...
typedef struct _svtkLayoutVertex
{
  double x[3];
  double d[3];
} svtkLayoutVertex;
...
typedef struct _svtkLayoutEdge
{
  int t;
  int u;
} svtkLayoutEdge;
...
int svtkGraphLayoutFilter::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  svtkLayoutVertex* v = new svtkLayoutVertex[numPts];
  svtkLayoutEdge* e = new svtkLayoutEdge[numLines];
...
void svtkGraphLayoutFilter::PrintSelf(ostream& os, svtkIndent indent)
{
