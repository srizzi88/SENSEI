 ...
 * dataset type. For example, a polyhedral mesh (svtkPolyData) can be probed
 * with a volume (three-dimensional svtkImageData), and then volume rendering
 ...
 * you can always use svtkPointDataToCellData and/or svtkCellDataToPointData in
 ...
 *
 * @sa
 * svtkProbeFilter svtkMeanValueCoordinatesInterpolator svtkPolyhedron
 */

#ifndef svtkProbePolyhedron_h
#define svtkProbePolyhedron_h
...
class SVTKFILTERSGENERAL_EXPORT svtkProbePolyhedron : public svtkDataSetAlgorithm
{
public:
  //@{
  /**
   ...
   */
  static svtkProbePolyhedron* New();
  svtkTypeMacro(svtkProbePolyhedron, svtkDataSetAlgorithm);
   ...
   */
  svtkSetMacro(ProbePointData, svtkTypeBool);
  svtkGetMacro(ProbePointData, svtkTypeBool);
  svtkBooleanMacro(ProbePointData, svtkTypeBool);
  //@}
   ...
   * the probe position.
   */
  svtkSetMacro(ProbeCellData, svtkTypeBool);
  svtkGetMacro(ProbeCellData, svtkTypeBool);
  svtkBooleanMacro(ProbeCellData, svtkTypeBool);
  //@}

protected:
  svtkProbePolyhedron();
  ~svtkProbePolyhedron() override;

  svtkTypeBool ProbePointData;
  svtkTypeBool ProbeCellData;
...
private:
  svtkProbePolyhedron(const svtkProbePolyhedron&) = delete;
  void operator=(const svtkProbePolyhedron&) = delete;
};
