/*=========================================================================
  ...
  Module:    svtkStructuredGridClip.cxx
...
=========================================================================*/
#include "svtkStructuredGridClip.h"
...
svtkStandardNewMacro(svtkStructuredGridClip);

//----------------------------------------------------------------------------
svtkStructuredGridClip::svtkStructuredGridClip()
{
  this->ClipData = 0;
  this->Initialized = 0;
...
//----------------------------------------------------------------------------
void svtkStructuredGridClip::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkStructuredGridClip::SetOutputWholeExtent(int extent[6], svtkInformation* outInfo)
{
  int idx;
  int modified = 0;
...
//----------------------------------------------------------------------------
void svtkStructuredGridClip::SetOutputWholeExtent(
...
//----------------------------------------------------------------------------
void svtkStructuredGridClip::GetOutputWholeExtent(int extent[6])
{
  int idx;
...
int svtkStructuredGridClip::RequestInformation(svtkInformation* svtkNotUsed(request),
...
void svtkStructuredGridClip::ResetOutputWholeExtent()
{
  if (!this->GetInput())
  {
...
int svtkStructuredGridClip::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  int* inExt;
  svtkInformation* inInfo = inputVector[0]->GetInformationObject(0);
