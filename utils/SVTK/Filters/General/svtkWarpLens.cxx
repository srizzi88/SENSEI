...
//
void svtkWarpLens::SetCenter(double centerX, double centerY)
{
  this->SetPrincipalPoint(centerX, centerY);
}

double* svtkWarpLens::GetCenter()
{
  return this->GetPrincipalPoint();
}

svtkWarpLens::svtkWarpLens()
{
...
int svtkWarpLens::FillInputPortInformation(int svtkNotUsed(port), svtkInformation* info)
{
...
int svtkWarpLens::RequestDataObject(
...
int svtkWarpLens::RequestData(svtkInformation* svtkNotUsed(request),
...
void svtkWarpLens::PrintSelf(ostream& os, svtkIndent indent)
{
