...
=========================================================================*/
/**
 * @class   svtkGenericCutter
 * @brief   cut a svtkGenericDataSet with an implicit function or scalar data
 *
 * svtkGenericCutter is a filter to cut through data using any subclass of
 ...
 *
 * svtkGenericCutter is generally used to "slice-through" a dataset, generating
 * a surface that can be visualized. It is also possible to use
 * svtkGenericCutter to do a form of volume rendering. svtkGenericCutter does
 ...
 *
 * @sa
 * svtkCutter svtkImplicitFunction svtkClipPolyData svtkGenericDataSet
 */

#ifndef svtkGenericCutter_h
#define svtkGenericCutter_h
...
class SVTKFILTERSGENERIC_EXPORT svtkGenericCutter : public svtkPolyDataAlgorithm
{
public:
  svtkTypeMacro(svtkGenericCutter, svtkPolyDataAlgorithm);
...
protected:
  svtkGenericCutter(svtkImplicitFunction* cf = nullptr);
  ~svtkGenericCutter() override;
...
private:
  svtkGenericCutter(const svtkGenericCutter&) = delete;
  void operator=(const svtkGenericCutter&) = delete;
};
