...
=========================================================================*/
// This test covers the svtkUnstructuredGridGeometryFilter class on all
// types of cells.
...
// If FAST_GEOMETRY is defined, a svtkDataSetSurfaceFilter is used instead
// of a svtkGeometryFilter at the end of the pipeline
...
int TestUnstructuredGridGeometryFilter(int argc, char* argv[])
{
  ...
  svtkIdTypeArray* cellIds = svtkIdTypeArray::New();
  ...
  svtkVertex* vertex = svtkVertex::New();
  ...
  svtkPolyVertex* polyVertex = svtkPolyVertex::New();
  ...
  svtkQuadraticEdge* quadEdge = svtkQuadraticEdge::New();
  ...
  svtkCubicLine* cubLine = svtkCubicLine::New();
  ...
  svtkTriangleStrip* triangleStrip = svtkTriangleStrip::New();
  ...
  svtkQuadraticTriangle* quadraticTriangle = svtkQuadraticTriangle::New();
  i = 0;
  while (i < 6)
  {
  ...
  svtkBiQuadraticTriangle* BiQuadraticTriangle = svtkBiQuadraticTriangle::New();
  i = 0;
  while (i < 7)
  {
  ...
  svtkQuadraticQuad* quadraticQuad = svtkQuadraticQuad::New();
  i = 0;
  while (i < 8)
  {
  ...
  // 2D: biquadratic quad: add a center point  svtkBiQuadraticQuad.h
  ...
  svtkBiQuadraticQuad* biquadraticQuad = svtkBiQuadraticQuad::New();
  i = 0;
  while (i < 9)
  {
  ...
  svtkQuadraticLinearQuad* quadraticLinearQuad = svtkQuadraticLinearQuad::New();
  i = 0;
  while (i < 6)
  {
  ...
  svtkHexahedron* hexahedron = svtkHexahedron::New();
  ...
  svtkPyramid* pyramid = svtkPyramid::New();
  ...
  svtkPentagonalPrism* pentagonalPrism = svtkPentagonalPrism::New();
  ...
  pentagonalPrism = svtkPentagonalPrism::New();
  ...
  svtkHexagonalPrism* hexagonalPrism = svtkHexagonalPrism::New();
  ...
  hexagonalPrism = svtkHexagonalPrism::New();
  ...
  svtkQuadraticTetra* quadraticTetra = svtkQuadraticTetra::New();
  ...
  quadraticTetra = svtkQuadraticTetra::New();
  quadraticTetra->GetPointIds()->SetId(0, pointId);
  ...
  svtkQuadraticHexahedron* quadraticHexahedron = svtkQuadraticHexahedron::New();
  ...
  quadraticHexahedron = svtkQuadraticHexahedron::New();
  ...
  svtkQuadraticWedge* quadraticWedge = svtkQuadraticWedge::New();
  ...
  quadraticWedge = svtkQuadraticWedge::New();
  ...
  svtkQuadraticPyramid* quadraticPyramid = svtkQuadraticPyramid::New();
  ...
  quadraticPyramid = svtkQuadraticPyramid::New();
  ...
  triQuadraticHexahedron = svtkTriQuadraticHexahedron::New();
  ...
  svtkQuadraticLinearWedge* quadraticLinearWedge = svtkQuadraticLinearWedge::New();
  ...
  // this wedge shares a triangle face
  quadraticLinearWedge = svtkQuadraticLinearWedge::New();
  ...
  biQuadraticQuadraticWedge = svtkBiQuadraticQuadraticWedge::New();
  ...
  biQuadraticQuadraticHexahedron = svtkBiQuadraticQuadraticHexahedron::New();
  ...
  svtkPolyhedron* polyhedron = svtkPolyhedron::New();
  svtkIdType faces[6][4] = {
    { 0, 4, 7, 3 },
    { 1, 2, 6, 5 },
    { 0, 1, 5, 4 },
    { 3, 7, 6, 2 },
  ...
  svtkNew<svtkCellTypes> uniqueCells;
  grid->GetCellTypes(uniqueCells);
  for (svtkIdType j = 0; j < uniqueCells->GetNumberOfTypes(); ++j)
  {
    unsigned char cellType = uniqueCells->GetCellType(j);
    std::cout << svtkCellTypes::GetClassNameFromTypeId(cellType) << ": "
  ...
  // Create the filter
  svtkUnstructuredGridGeometryFilter* geom;
  geom = svtkUnstructuredGridGeometryFilter::New();
#ifdef READ_FILE
  ...
  // TODO
#ifdef USE_SHRINK
  svtkShrinkFilter* shrink = svtkShrinkFilter::New();
  shrink->SetShrinkFactor(0.5);
  shrink->SetInputConnection(0, geom->GetOutputPort(0));
#endif
#ifdef FAST_GEOMETRY
  svtkDataSetSurfaceFilter* linearGeom = svtkDataSetSurfaceFilter::New();
#else
  svtkGeometryFilter* linearGeom = svtkGeometryFilter::New();
#endif
#ifdef USE_SHRINK
...
//  cout<<"prop="<<actor->GetProperty()->GetBackfaceCulling()<<endl;
  ...
  svtkXMLUnstructuredGridWriter* writer3d = svtkXMLUnstructuredGridWriter::New();
