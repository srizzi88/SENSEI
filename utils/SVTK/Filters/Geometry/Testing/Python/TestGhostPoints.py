...
class TestGhostPoints(Testing.svtkTest):
    ...
    def testLinearDuplicate(self):
        duplicate = svtk.svtkDataSetAttributes.DUPLICATEPOINT
        ghosts = svtk.svtkUnsignedCharArray()
        ghosts.SetName(svtk.svtkDataSetAttributes.GhostArrayName())
    ...
    def testLinearHidden(self):
        hidden = svtk.svtkDataSetAttributes.HIDDENPOINT
        ghosts = svtk.svtkUnsignedCharArray()
        ghosts.SetName(svtk.svtkDataSetAttributes.GhostArrayName())
        ghosts.SetNumberOfTuples(4)
    ...
    def doNonLinear(self, ghosts, ncells):
        ...
        ugg = svtk.svtkUnstructuredGridGeometryFilter()
