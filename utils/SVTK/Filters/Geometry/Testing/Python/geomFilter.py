...
ug.Allocate(4)
lpts = [0, 1]
ug.InsertNextCell(svtk.SVTK_LINE, 2, lpts)
vpts = [1]
ug.InsertNextCell(svtk.SVTK_VERTEX, 1, vpts)
lpts = [2, 3]
ug.InsertNextCell(svtk.SVTK_LINE, 2, lpts)
vpts = [3]
ug.InsertNextCell(svtk.SVTK_VERTEX, 1, vpts)
aa = svtk.svtkIntArray()
