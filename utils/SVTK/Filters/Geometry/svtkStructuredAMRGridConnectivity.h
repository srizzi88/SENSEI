/*=========================================================================
 ...
 Module:    svtkStructuredAMRGridConnectivity.h
 ...
 =========================================================================*/
/**
 * @class   svtkStructuredAMRGridConnectivity
 *  grid connectivity.
 *
 *
 *  A concrete instance of svtkAbstractGridConnectivity that implements
 ...
 *  implementation see svtkPStructuredAMRGridConnectivity.
 *
 * @sa
 *  svtkPStructuredAMRGridConnectivity svtkAbstractGridConnectivity
 */

#ifndef svtkStructuredAMRGridConnectivity_h
#define svtkStructuredAMRGridConnectivity_h

#include "svtkAbstractGridConnectivity.h"
#include "svtkFiltersGeometryModule.h" // For export macro

#include "svtkStructuredAMRNeighbor.h" // For svtkStructuredAMRNeighbor def.
...
class SVTKFILTERSGEOMETRY_EXPORT svtkStructuredAMRGridConnectivity
  : public svtkAbstractGridConnectivity
{
public:
  static svtkStructuredAMRGridConnectivity* New();
  svtkTypeMacro(svtkStructuredAMRGridConnectivity, svtkAbstractGridConnectivity);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Initializes this instance of svtkStructuredAMRGridConnectivity where N
   ...
   */
  svtkSetMacro(BalancedRefinement, bool);
  svtkGetMacro(BalancedRefinement, bool);
  //@}
   ...
   */
  svtkSetMacro(NodeCentered, bool);
  svtkGetMacro(NodeCentered, bool);
  //@}
   ...
   */
  svtkSetMacro(CellCentered, bool);
  svtkGetMacro(CellCentered, bool);
  //@}
   ...
   */
  svtkStructuredAMRNeighbor GetNeighbor(const int gridID, const int nei);

protected:
  svtkStructuredAMRGridConnectivity();
  ~svtkStructuredAMRGridConnectivity() override;
   ...
   */
  virtual void FillNodesGhostArray(const int gridId, svtkUnsignedCharArray* nodesArray);

  /**
   * Fills the cell ghost arrays for the given grid
   */
  virtual void FillCellsGhostArray(const int gridId, svtkUnsignedCharArray* cellArray);

  /**
   * Fills ghost arrays.
   */
  void FillGhostArrays(
    const int gridId, svtkUnsignedCharArray* nodesArray, svtkUnsignedCharArray* cellsArray) override;
   ...
   */
  svtkStructuredAMRNeighbor GetAMRNeighbor(const int i, const int iLevel, int next1[6], const int j,
    const int jLevel, int next2[6], const int normalizedLevel, const int levelDiff,
    svtkStructuredNeighbor& nei);
  ...
  void ComputeAMRNeighborOverlapExtents(const int iLevel, const int jLevel,
    const int normalizedLevel, const svtkStructuredNeighbor& nei, int orient[3], int ndim,
   ...
   */
  void TransferLocalNodeCenteredNeighborData(const int gridID, svtkStructuredAMRNeighbor& nei);
   ...
   */
  void GetLocalCellCentersFromCoarserLevel(const int gridID, svtkStructuredAMRNeighbor& nei);

  /**
   * Copy cell center values from a finer level by cell averaging.
   */
  void GetLocalCellCentersFromFinerLevel(const int gridID, svtkStructuredAMRNeighbor& nei);
   ...
   */
  void GetLocalCellCentersAtSameLevel(const int gridID, svtkStructuredAMRNeighbor& nei);

  /**
   * Transfers local cell-centered neighbor data
   */
  void TransferLocalCellCenteredNeighborData(const int gridID, svtkStructuredAMRNeighbor& nei);

  /**
   * Transfers local neighbor data
   */
  void TransferLocalNeighborData(const int gridID, svtkStructuredAMRNeighbor& nei);
   ...
   */
  void AverageFieldData(svtkFieldData* source, svtkIdType* sourceIds, const int N,
    svtkFieldData* target, svtkIdType targetIdx);
  ...
  int DataDescription;         // The data description, i.e., SVTK_XY_PLANE, etc.
  ...
  std::vector<std::vector<svtkStructuredAMRNeighbor> > Neighbors;
...
private:
  svtkStructuredAMRGridConnectivity(const svtkStructuredAMRGridConnectivity&) = delete;
  void operator=(const svtkStructuredAMRGridConnectivity&) = delete;
};
...
//------------------------------------------------------------------------------
inline int svtkStructuredAMRGridConnectivity::GetNumberOfNeighbors(const int gridID)
{
...
//------------------------------------------------------------------------------
inline svtkStructuredAMRNeighbor svtkStructuredAMRGridConnectivity::GetNeighbor(
...
//------------------------------------------------------------------------------
inline int svtkStructuredAMRGridConnectivity::Get1DOrientation(const int idx, const int ExtentLo,
...
//------------------------------------------------------------------------------
inline int svtkStructuredAMRGridConnectivity::GetNumberOfConnectingBlockFaces(const int gridID)
{
  // Sanity check
  assert("pre: gridID is out-of-bounds" && (gridID >= 0) &&
    (gridID < static_cast<int>(this->NumberOfGrids)));
...
//------------------------------------------------------------------------------
inline void svtkStructuredAMRGridConnectivity::RemoveBlockConnection(
...
//------------------------------------------------------------------------------
inline void svtkStructuredAMRGridConnectivity::AddBlockConnection(
  const int gridID, const int blockDirection)
{
  // Sanity check
  assert("pre: gridID is out-of-bounds" && (gridID >= 0) &&
...
//------------------------------------------------------------------------------
inline void svtkStructuredAMRGridConnectivity::ClearBlockConnections(const int gridID)
{
  // Sanity check
  assert("pre: gridID is out-of-bounds" && (gridID >= 0) &&
    (gridID < static_cast<int>(this->NumberOfGrids)));
...
//------------------------------------------------------------------------------
inline bool svtkStructuredAMRGridConnectivity::AreExtentsEqual(int ext1[6], int ext2[6])
{
  for (int i = 0; i < 6; ++i)
  {
    if (ext1[i] != ext2[i])
...
//------------------------------------------------------------------------------
inline void svtkStructuredAMRGridConnectivity::PrintExtent(std::ostream& os, int ext[6])
{
  for (int i = 0; i < 6; i += 2)
  {
    os << "[";
...
//------------------------------------------------------------------------------
inline int svtkStructuredAMRGridConnectivity::GetGridLevel(const int gridIdx)
{
...
//------------------------------------------------------------------------------
inline void svtkStructuredAMRGridConnectivity::SetRefinementRatioAtLevel(
...
//------------------------------------------------------------------------------
inline int svtkStructuredAMRGridConnectivity::GetRefinementRatioAtLevel(const int level)
{
  assert("pre: RefinementRatios vector is not properly allocated" &&
    this->RefinementRatios.size() == this->NumberOfLevels);
  assert("pre: leve is out-of-bounds!" && (level >= 0) &&
...
//------------------------------------------------------------------------------
inline bool svtkStructuredAMRGridConnectivity::HasConstantRefinementRatio()
{
...
//------------------------------------------------------------------------------
inline void svtkStructuredAMRGridConnectivity::GetGridExtent(const int gridIdx, int ext[6])
{
...
//------------------------------------------------------------------------------
inline bool svtkStructuredAMRGridConnectivity::LevelExists(const int level)
{
...
//------------------------------------------------------------------------------
inline void svtkStructuredAMRGridConnectivity::InsertGridAtLevel(const int level, const int gridID)
{
...
#endif /* SVTKSTRUCTUREDAMRGRIDCONNECTIVITY_H_ */
