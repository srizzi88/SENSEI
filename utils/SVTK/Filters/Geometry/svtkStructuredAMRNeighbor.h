/*=========================================================================
 ...
 Module:    svtkStructuredAMRNeighbor.h
 ...
 =========================================================================*/
/**
 * @class   svtkStructuredAMRNeighbor
 *
 *
 ...
 *
 * @sa
 *  svtkStructuredNeighbor svtkStructuredAMRGridConnectivity
 */

#ifndef svtkStructuredAMRNeighbor_h
#define svtkStructuredAMRNeighbor_h

#include "svtkFiltersGeometryModule.h" // For export macro
#include "svtkStructuredNeighbor.h"

class SVTKFILTERSGEOMETRY_EXPORT svtkStructuredAMRNeighbor : public svtkStructuredNeighbor
{
public:
   ...
   */
  svtkStructuredAMRNeighbor(const int gridLevel, const int neiID, const int neighborLevel,
    int gridOverlap[6], int neiOverlap[6], int orient[3], const int relationShip);

  /**
   * Copy constructor.
   */
  svtkStructuredAMRNeighbor(const svtkStructuredAMRNeighbor& N)
    : svtkStructuredNeighbor(N)
  {
    *this = N;
  }
   ...
   * Destructor.
   */
  ~svtkStructuredAMRNeighbor() override {}

  /**
   * Overload assignment operator.
   */
  svtkStructuredAMRNeighbor& operator=(const svtkStructuredAMRNeighbor& N);
...
#endif /* svtkStructuredAMRNeighbor_h */
// SVTK-HeaderTest-Exclude: svtkStructuredAMRNeighbor.h
