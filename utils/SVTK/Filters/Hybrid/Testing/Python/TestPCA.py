...
# using svtkProcrustesAlignmentFilter, and then pass the output to svtkPCAAnalysisFilter. We visualise
...
#svtkWindowToImageFilter to_image
#to_image SetInput renWin
#svtkPNGWriter to_png
