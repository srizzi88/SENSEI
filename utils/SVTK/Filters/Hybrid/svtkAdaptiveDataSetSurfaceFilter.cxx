/*=========================================================================
  ...
  Module:    svtkAdaptiveDataSetSurfaceFilter.cxx
...
svtkStandardNewMacro(svtkAdaptiveDataSetSurfaceFilter);

//-----------------------------------------------------------------------------
svtkAdaptiveDataSetSurfaceFilter::svtkAdaptiveDataSetSurfaceFilter()
{
  this->InData = nullptr;
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
int svtkAdaptiveDataSetSurfaceFilter::RequestData(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  if (MeshType != SVTK_HYPER_TREE_GRID)
  {
...
//----------------------------------------------------------------------------
int svtkAdaptiveDataSetSurfaceFilter::DataSetExecute(svtkDataObject* inputDS, svtkPolyData* output)
{
  // Retrieve input grid
  svtkHyperTreeGrid* input = svtkHyperTreeGrid::SafeDownCast(inputDS);
  if (!input)
  {
    ...
    // return svtkDataSetSurfaceFilter::DataSetExecute( inputDS, output );
    svtkErrorMacro("pre: input_not_HyperTreeGrid: " << inputDS->GetClassName());
    return 0;
  }
  ...
  this->InData = static_cast<svtkDataSetAttributes*>(input->GetPointData());
  this->OutData = static_cast<svtkDataSetAttributes*>(output->GetCellData());
...
//----------------------------------------------------------------------------
int svtkAdaptiveDataSetSurfaceFilter::FillInputPortInformation(int, svtkInformation* info)
{
...
//-----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::ProcessTrees(svtkHyperTreeGrid* input, svtkPolyData* output)
{
  if (this->Points)
  {
    this->Points->Delete();
  ...
  //
  svtkUnsignedCharArray* ghost = nullptr; // DDM input->GetPointGhostArray();
  if (ghost)
  {
    this->OutData->CopyFieldOff(svtkDataSetAttributes::GhostArrayName());
  }
  ...
  if (this->Dimension == 3)
  {
    ...
    svtkNew<svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight> cursor;
...
#ifndef NDEBUG
  std::cerr << "svtkAdaptiveDataSetSurfaceFilter #Points            "
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::RecursivelyProcessTreeNot3D(
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::ProcessLeaf1D(
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::ProcessLeaf2D(
  svtkHyperTreeGridNonOrientedGeometryCursor* cursor)
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::RecursivelyProcessTree3D(
  svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight* cursor, int level)
{
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::ProcessLeaf3D(
  svtkHyperTreeGridNonOrientedVonNeumannSuperCursorLight* superCursor)
{
  // Cell at super cursor center is a leaf, retrieve its global index, level, and mask
  svtkIdType idcenter = superCursor->GetGlobalNodeIndex();
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::AddFace(
  svtkIdType inId, const double* origin, const double* size, int offset, unsigned int orientation)
{
...
//----------------------------------------------------------------------------
void svtkAdaptiveDataSetSurfaceFilter::SetRenderer(svtkRenderer* ren)
{
...
//----------------------------------------------------------------------------
svtkMTimeType svtkAdaptiveDataSetSurfaceFilter::GetMTime()
{
