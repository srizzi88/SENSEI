/*=========================================================================
  ...
  Module:    svtkWeightedTransformFilter.h
...
=========================================================================*/
/**
 * @class   svtkWeightedTransformFilter
 * @brief   transform based on per-point or per-cell weighting functions.
 *
 *
 * svtkWeightedTransformFilter is a filter that can be used to "skin"
 ...
 *
 * svtkWeightedTransformFilter is also useful for creating "strange and
 ...
 *
 * @sa
 * svtkAbstractTransform svtkLinearTransform svtkTransformPolyDataFilter svtkActor
 */

#ifndef svtkWeightedTransformFilter_h
#define svtkWeightedTransformFilter_h
...
class SVTKFILTERSHYBRID_EXPORT svtkWeightedTransformFilter : public svtkPointSetAlgorithm
{
public:
  static svtkWeightedTransformFilter* New();
  svtkTypeMacro(svtkWeightedTransformFilter, svtkPointSetAlgorithm);
   ...
   */
  svtkSetStringMacro(WeightArray);
  svtkGetStringMacro(WeightArray);
  //@}
   ...
   * This array transforms points, normals, and vectors.
   */
  svtkSetStringMacro(TransformIndexArray);
  svtkGetStringMacro(TransformIndexArray);
  //@}
   ...
   * and vectors.
   */
  svtkSetStringMacro(CellDataWeightArray);
  svtkGetStringMacro(CellDataWeightArray);
  //@}
   ...
   */
  svtkSetStringMacro(CellDataTransformIndexArray);
  svtkGetStringMacro(CellDataTransformIndexArray);
  //@}
   ...
   */
  virtual void SetTransform(svtkAbstractTransform* transform, int num);
  virtual svtkAbstractTransform* GetTransform(int num);
  //@}
  ...
  svtkGetMacro(NumberOfTransforms, int);
  //@}
   ...
   */
  svtkBooleanMacro(AddInputValues, svtkTypeBool);
  svtkSetMacro(AddInputValues, svtkTypeBool);
  svtkGetMacro(AddInputValues, svtkTypeBool);
  //@}

protected:
  svtkAbstractTransform** Transforms;
  int NumberOfTransforms;
  svtkTypeBool AddInputValues;
  ...
  svtkWeightedTransformFilter();
  ~svtkWeightedTransformFilter() override;

  int RequestData(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;

private:
  svtkWeightedTransformFilter(const svtkWeightedTransformFilter&) = delete;
  void operator=(const svtkWeightedTransformFilter&) = delete;
};
