...
int TestHyperTreeGridTernarySphereMaterialReflections(int argc, char* argv[])
{
  ...
  svtkIdType nV = H->GetNumberOfVertices();
  svtkIdType nL = H->GetNumberOfLeaves();
