/*=========================================================================
  ...
  Module:    svtkHyperTreeGridEvaluateCoarse.h
...
=========================================================================*/
/**
 * @class   svtkHyperTreeGridEvaluateCoarse
 * @brief   The value of the parent cell is determined from an operation
 * defined on the values of the child cells.
 *
 *
 * svtkHyperTreeGridEvaluateCoarse is a filter that takes as input an hypertree
 * grid.
...
#ifndef svtkHyperTreeGridEvaluateCoarse_h
#define svtkHyperTreeGridEvaluateCoarse_h
...
class SVTKFILTERSHYPERTREE_EXPORT svtkHyperTreeGridEvaluateCoarse : public svtkHyperTreeGridAlgorithm
{
public:
  enum
  {
  ...
  static svtkHyperTreeGridEvaluateCoarse* New();
  svtkTypeMacro(svtkHyperTreeGridEvaluateCoarse, svtkHyperTreeGridAlgorithm);
   ...
   * Set/Get operator
   */
  svtkSetMacro(Operator, unsigned int);
  svtkGetMacro(Operator, unsigned int);
  //@}
   ...
   * Set/Get operator
   */
  svtkSetMacro(Default, double);
  //@}

protected:
  svtkHyperTreeGridEvaluateCoarse();
  ~svtkHyperTreeGridEvaluateCoarse() override;
   ...
   */
  virtual void ProcessNode(svtkHyperTreeGridNonOrientedCursor*);

private:
  svtkHyperTreeGridEvaluateCoarse(const svtkHyperTreeGridEvaluateCoarse&) = delete;
  void operator=(const svtkHyperTreeGridEvaluateCoarse&) = delete;
...
#endif // svtkHyperTreeGridEvaluateCoarse_h
