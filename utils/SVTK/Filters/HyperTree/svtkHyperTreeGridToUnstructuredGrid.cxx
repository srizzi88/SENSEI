/*=========================================================================
  ...
  Module:    svtkHyperTreeGridToUnstructuredGrid.cxx
...
svtkStandardNewMacro(svtkHyperTreeGridToUnstructuredGrid);

//-----------------------------------------------------------------------------
svtkHyperTreeGridToUnstructuredGrid::svtkHyperTreeGridToUnstructuredGrid()
  : Points(nullptr)
  , Cells(nullptr)
  , Dimension(0)
  , Orientation(0)
...
//----------------------------------------------------------------------------
void svtkHyperTreeGridToUnstructuredGrid::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
int svtkHyperTreeGridToUnstructuredGrid::FillOutputPortInformation(int, svtkInformation* info)
{
...
//-----------------------------------------------------------------------------
int svtkHyperTreeGridToUnstructuredGrid::ProcessTrees(
  svtkHyperTreeGrid* input, svtkDataObject* outputDO)
{
  ...
  switch (this->Dimension)
  {
    case 1:
      // 1D cells are lines
      output->SetCells(SVTK_LINE, this->Cells);
      break;
    case 2:
      // 2D cells are quadrilaterals
      output->SetCells(SVTK_PIXEL, this->Cells);
      break;
    case 3:
      // 3D cells are voxels (i.e. hexahedra with indexing order equal to that of cursors)
      output->SetCells(SVTK_VOXEL, this->Cells);
      break;
    default:
      break;
  } // switch ( this->Dimension )
...
//----------------------------------------------------------------------------
void svtkHyperTreeGridToUnstructuredGrid::RecursivelyProcessTree(
...
//----------------------------------------------------------------------------
void svtkHyperTreeGridToUnstructuredGrid::AddCell(svtkIdType inId, double* origin, double* size)
{
