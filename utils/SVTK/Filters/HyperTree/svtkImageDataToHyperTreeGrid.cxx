/*=========================================================================
  ...
  Module:    svtkImageDataToHyperTreeGrid.cxx
...
=========================================================================*/
#include "svtkImageDataToHyperTreeGrid.h"
...
svtkStandardNewMacro(svtkImageDataToHyperTreeGrid);

//-----------------------------------------------------------------------------
svtkImageDataToHyperTreeGrid::svtkImageDataToHyperTreeGrid()
{
  this->NbColors = 256;
  this->DepthMax = 0;
}
...
//----------------------------------------------------------------------------
void svtkImageDataToHyperTreeGrid::PrintSelf(ostream& os, svtkIndent indent)
{
...
int svtkImageDataToHyperTreeGrid::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  // Update progress
  this->UpdateProgress(0.);

  svtkHyperTreeGrid* output = svtkHyperTreeGrid::GetData(outputVector, 0);
  if (!output)
  {
    return 0;
  }
  ...
  if (!this->InScalars)
  {
    svtkWarningMacro(<< "No scalar data to process");
    return 1;
  }
  ...
  svtkNew<svtkDoubleArray> coordX;
  ...
  svtkNew<svtkDoubleArray> coordY;
  ...
  svtkNew<svtkDoubleArray> coordZ;
  ...
  svtkIdType nbTrees = output->GetMaxNumberOfTrees();
...
void svtkImageDataToHyperTreeGrid::ProcessPixels(
  svtkIntArray* grps, svtkHyperTreeGridNonOrientedCursor* cursor)
{
...
int svtkImageDataToHyperTreeGrid::ProcessTrees(
  svtkHyperTreeGrid* svtkNotUsed(output), svtkDataObject* svtkNotUsed(input))
{
  return 1;
}

//-----------------------------------------------------------------------------
int svtkImageDataToHyperTreeGrid::FillOutputPortInformation(
...
//-----------------------------------------------------------------------------
int svtkImageDataToHyperTreeGrid::FillInputPortInformation(
  int svtkNotUsed(port), svtkInformation* info)
{
