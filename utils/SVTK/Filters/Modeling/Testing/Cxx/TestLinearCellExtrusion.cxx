...
=========================================================================*/
// This tests svtkLinearCellExtrusionFilter
...
//----------------------------------------------------------------------------
int TestLinearCellExtrusion(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  ...
  svtkIdType pentagon[] = { 0, 1, 2, 3, 4 };
  polys->InsertNextCell(5, pentagon);

  svtkIdType quad[] = { 3, 2, 5, 6 };
  polys->InsertNextCell(4, quad);

  svtkIdType triangle[] = { 5, 6, 7 };
  ...
  svtkNew<svtkLinearCellExtrusionFilter> extrusion;
  extrusion->SetInputData(polyData);
  extrusion->SetInputArrayToProcess(0, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "Values");
  extrusion->SetScaleFactor(1.0);

  svtkNew<svtkLinearCellExtrusionFilter> extrusionUser;
  extrusionUser->SetInputData(polyData);
  extrusionUser->SetInputArrayToProcess(0, 0, 0, svtkDataObject::FIELD_ASSOCIATION_CELLS, "Values");
  extrusionUser->SetScaleFactor(0.8);
  extrusionUser->UseUserVectorOn();
  extrusionUser->SetUserVector(0.707107, 0.707107, 0.0);

  svtkNew<svtkDataSetSurfaceFilter> surf2;
  surf2->SetInputConnection(extrusion->GetOutputPort());

  svtkNew<svtkDataSetSurfaceFilter> surf3;
  ...
  svtkNew<svtkPolyDataMapper> mapperUser;
