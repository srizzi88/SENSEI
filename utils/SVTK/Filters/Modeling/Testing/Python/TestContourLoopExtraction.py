...
# Custom glyph
glyphData = svtk.svtkPolyData()
glyphPts = svtk.svtkPoints()
glyphVerts = svtk.svtkCellArray()
glyphLines = svtk.svtkCellArray()
glyphPolys = svtk.svtkCellArray()
