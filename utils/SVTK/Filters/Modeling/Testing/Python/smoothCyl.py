...
smooth = svtk.svtkSmoothPolyDataFilter()
...
cylMapper = svtk.svtkPolyDataMapper()
cylMapper.SetInputConnection(normals.GetOutputPort())

cylActor = svtk.svtkActor()
...
originalMapper = svtk.svtkPolyDataMapper()
originalMapper.SetInputConnection(bump.GetOutputPort())

originalActor = svtk.svtkActor()
