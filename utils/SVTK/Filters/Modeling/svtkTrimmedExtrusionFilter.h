/*=========================================================================
  ...
  Module:    svtkTrimmedExtrusionFilter.h
...
=========================================================================*/
/**
 * @class   svtkTrimmedExtrusionFilter
 * @brief   extrude polygonal data trimmed by a second input surface
 *
 * svtkTrimmedExtrusionFilter is a modeling filter. It takes polygonal data as
...
#ifndef svtkTrimmedExtrusionFilter_h
#define svtkTrimmedExtrusionFilter_h
...
class SVTKFILTERSMODELING_EXPORT svtkTrimmedExtrusionFilter : public svtkPolyDataAlgorithm
{
public:
  svtkTypeMacro(svtkTrimmedExtrusionFilter, svtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Create object with extrusion direction (0,0,1) and capping on.
   */
  static svtkTrimmedExtrusionFilter* New();

  //@{
  /**
   * Set/Get the extrusion direction.
   */
  svtkSetVector3Macro(ExtrusionDirection, double);
  svtkGetVectorMacro(ExtrusionDirection, double, 3);
  //@}
   ...
   */
  void SetTrimSurfaceData(svtkPolyData* pd);
  void SetTrimSurfaceConnection(svtkAlgorithmOutput* algOutput);
  //@}
   ...
   */
  svtkPolyData* GetTrimSurface();
  svtkPolyData* GetTrimSurface(svtkInformationVector* sourceInfo);
  //@}
   ...
   */
  svtkSetMacro(Capping, int);
  svtkGetMacro(Capping, int);
  svtkBooleanMacro(Capping, int);
  //@}
   ...
   */
  svtkSetMacro(ExtrusionStrategy, int);
  svtkGetMacro(ExtrusionStrategy, int);
   ...
   */
  svtkSetMacro(CappingStrategy, int);
  svtkGetMacro(CappingStrategy, int);
  ...
  //@{
  /**
   * Specify a cell locator. By default a svtkStaticCellLocator is
   * used. The locator performs efficient searches to intersect cells.
   */
  void SetLocator(svtkAbstractCellLocator* locator);
  svtkGetObjectMacro(Locator, svtkAbstractCellLocator);
  //@}

protected:
  svtkTrimmedExtrusionFilter();
  ~svtkTrimmedExtrusionFilter() override;
  ...
  void AdjustPoints(svtkPolyData* mesh, svtkIdType numPts, svtkIdType numCells, unsigned char* hots,
    svtkPoints* newPts);

  void ExtrudeEdges(svtkPolyData* input, svtkPolyData* output, svtkIdType numPts, svtkIdType numCells);

  svtkIdType GetNeighborCount(
    svtkPolyData* mesh, svtkIdType inCellId, svtkIdType p1, svtkIdType p2, svtkIdList* cellIds);

  int RequestData(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;
  int FillInputPortInformation(int, svtkInformation*) override;

private:
  svtkTrimmedExtrusionFilter(const svtkTrimmedExtrusionFilter&) = delete;
  void operator=(const svtkTrimmedExtrusionFilter&) = delete;
};
