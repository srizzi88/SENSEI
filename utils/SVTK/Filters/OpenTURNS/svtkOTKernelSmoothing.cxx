/*=========================================================================
  ...
  Module:    svtkOTKernelSmoothing.cxx
...
svtkStandardNewMacro(svtkOTKernelSmoothing);

using namespace OT;

//-----------------------------------------------------------------------------
svtkOTKernelSmoothing::svtkOTKernelSmoothing()
{
...
//-----------------------------------------------------------------------------
void svtkOTKernelSmoothing::PrintSelf(ostream& os, svtkIndent indent)
{
...
//-----------------------------------------------------------------------------
int svtkOTKernelSmoothing::Process(Sample* input)
{
...
//-----------------------------------------------------------------------------
void svtkOTKernelSmoothing::ComputePDF(
