...
void MyProcess::Execute()
{
  ...
  svtkStructuredPointsReader* spr = nullptr;
  svtkStructuredPoints* sp = nullptr;

  if (me == 0)
  {
    spr = svtkStructuredPointsReader::New();
  ...
  svtkTransmitImageDataPiece* pass = svtkTransmitImageDataPiece::New();
