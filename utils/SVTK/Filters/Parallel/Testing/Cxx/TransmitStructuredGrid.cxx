...
// Tests svtkTransmitStructuredGrid.
...
#include "svtkTransmitStructuredGridPiece.h"
...
void MyProcess::Execute()
{
  ...
  svtkStructuredGridReader* sgr = nullptr;
  svtkStructuredGrid* sg = nullptr;

  if (me == 0)
  {
    sgr = svtkStructuredGridReader::New();
    char* fname =
      svtkTestUtilities::ExpandDataFileName(this->Argc, this->Argv, "Data/SampleStructGrid.svtk");
  ...
  svtkTransmitStructuredGridPiece* pass = svtkTransmitStructuredGridPiece::New();
