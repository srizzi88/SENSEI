...
pvTemp59 = svtk.svtkXMLRectilinearGridReader()
pvTemp59.SetFileName("" + str(SVTK_DATA_ROOT) + "/Data/cth.vtr")
...
pvTemp79 = svtk.svtkExtractCTHPart()
...
pvTemp104 = svtk.svtkLookupTable()
...
while not dataList.IsDoneWithTraversal():
  ...
  # construct mapper
  pvTemp87 = svtk.svtkDataSetMapper()
