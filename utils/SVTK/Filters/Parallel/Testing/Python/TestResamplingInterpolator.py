from svtkmodules.util.svtkAlgorithm import SVTKPythonAlgorithmBase
from svtkmodules.svtkIOExodus import svtkExodusIIReader
from svtkmodules.svtkCommonDataModel import svtkMultiBlockDataSet
from svtkmodules.svtkCommonExecutionModel import svtkAlgorithm, svtkCompositeDataPipeline
from svtkmodules.svtkFiltersParallel import svtkAdaptiveTemporalInterpolator
from svtkmodules.svtkFiltersGeometry import svtkCompositeDataGeometryFilter
from svtkmodules.svtkRenderingCore import svtkCompositePolyDataMapper, svtkActor, svtkRenderer, svtkRenderWindow, svtkRenderWindowInteractor, svtkWindowToImageFilter
from svtkmodules.svtkRenderingOpenGL2 import svtkCompositePolyDataMapper2


class SimpleTimeReader(SVTKPythonAlgorithmBase):
    """A reader that exposes two exodus files as a time series"""
    def __init__(self):
        SVTKPythonAlgorithmBase.__init__(self, nInputPorts=0, nOutputPorts=1, outputType='svtkMultiBlockDataSet')

        r1 = svtkExodusIIReader()
        r1.SetFileName("" + str(SVTK_DATA_ROOT) + "/Data/simpleamrgrid.e-s000")
        ...
        r2 = svtkExodusIIReader()
        r2.SetFileName("" + str(SVTK_DATA_ROOT) + "/Data/simpleamrgrid.e-s001")
    ...
    def RequestData(self, request, inInfoVec, outInfoVec):
        ...
        output = svtkMultiBlockDataSet.GetData(outInfoVec, 0)
