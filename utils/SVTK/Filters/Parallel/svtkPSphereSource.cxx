...
svtkStandardNewMacro(svtkPSphereSource);

//----------------------------------------------------------------------------
int svtkPSphereSource::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  svtkInformation* outInfo = outputVector->GetInformationObject(0);

  svtkIdType i, j, numOffset;
  int jStart, jEnd;
  svtkIdType numPts, numPolys;
  ...
  svtkIdType base, thetaResolution, phiResolution;
  int numPoles = 0;
  svtkIdType pts[3];
  ...
  svtkDebugMacro("PSphereSource Executing");
  ...
  {
    theta = localStartTheta * svtkMath::Pi() / 180.0 + i * deltaTheta;
...
//----------------------------------------------------------------------------
unsigned long svtkPSphereSource::GetEstimatedMemorySize()
{
  svtkLargeInteger sz;
  svtkLargeInteger sz2;
...
void svtkPSphereSource::PrintSelf(ostream& os, svtkIndent indent)
{
