/*=========================================================================
  ...
  Module:    svtkMemoryLimitImageDataStreamer.cxx
...
=========================================================================*/
#include "svtkMemoryLimitImageDataStreamer.h"
...
svtkStandardNewMacro(svtkMemoryLimitImageDataStreamer);

//----------------------------------------------------------------------------
svtkMemoryLimitImageDataStreamer::svtkMemoryLimitImageDataStreamer()
{
...
//----------------------------------------------------------------------------
void svtkMemoryLimitImageDataStreamer::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
svtkTypeBool svtkMemoryLimitImageDataStreamer ::ProcessRequest(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  if (request->Has(svtkStreamingDemandDrivenPipeline::REQUEST_UPDATE_EXTENT()))
  {
    if (this->CurrentDivision == 0)
    {
      ...
      svtkPipelineSize* sizer = svtkPipelineSize::New();
      ...
      do
      {
        ...
        // then propagate it
        svtkExecutive* exec = svtkExecutive::PRODUCER()->GetExecutive(inInfo);
        int index = svtkExecutive::PRODUCER()->GetPort(inInfo);
        svtkStreamingDemandDrivenPipeline* sddp =
          svtkStreamingDemandDrivenPipeline::SafeDownCast(exec);
