/*=========================================================================
  ...
  Module:    svtkPCorrelativeStatistics.cxx
...
svtkStandardNewMacro(svtkPCorrelativeStatistics);
svtkCxxSetObjectMacro(svtkPCorrelativeStatistics, Controller, svtkMultiProcessController);
//-----------------------------------------------------------------------------
svtkPCorrelativeStatistics::svtkPCorrelativeStatistics()
{
  this->Controller = 0;
...
//-----------------------------------------------------------------------------
void svtkPCorrelativeStatistics::PrintSelf(ostream& os, svtkIndent indent)
{
...
// ----------------------------------------------------------------------
void svtkPCorrelativeStatistics::Learn(
...
// ----------------------------------------------------------------------
void svtkPCorrelativeStatistics::Test(
