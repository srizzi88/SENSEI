/*=========================================================================
  ...
  Module:    svtkPDescriptiveStatistics.cxx
...
svtkStandardNewMacro(svtkPDescriptiveStatistics);
svtkCxxSetObjectMacro(svtkPDescriptiveStatistics, Controller, svtkMultiProcessController);
//-----------------------------------------------------------------------------
svtkPDescriptiveStatistics::svtkPDescriptiveStatistics()
{
  this->Controller = 0;
...
//-----------------------------------------------------------------------------
void svtkPDescriptiveStatistics::PrintSelf(ostream& os, svtkIndent indent)
{
...
// ----------------------------------------------------------------------
void svtkPDescriptiveStatistics::Learn(
  svtkTable* inData, svtkTable* inParameters, svtkMultiBlockDataSet* outMeta)
{
  ...
  for (int r = 0; r < nRow; ++r)
  {
    ...
    double extrema_g[2];
    com->AllReduce(extrema_l, extrema_g, 2, svtkCommunicator::MIN_OP);
