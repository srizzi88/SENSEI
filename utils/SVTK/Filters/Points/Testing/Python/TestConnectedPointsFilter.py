...
cpf = svtk.svtkConnectedPointsFilter()
...
segMapper = svtk.svtkPointGaussianMapper()
...
cpf1 = svtk.svtkConnectedPointsFilter()
...
segMapper1 = svtk.svtkPointGaussianMapper()
...
# Test largest region------------------------------------------------
cpf2 = svtk.svtkConnectedPointsFilter()
...
segMapper2 = svtk.svtkPointGaussianMapper()
...
cpf3 = svtk.svtkConnectedPointsFilter()
...
segMapper3 = svtk.svtkPointGaussianMapper()
...
segActor3 = svtk.svtkActor()
segActor3.SetMapper(segMapper3)

# Create an outline
outline3 = svtk.svtkOutlineFilter()
...
cpf4 = svtk.svtkConnectedPointsFilter()
...
segMapper4 = svtk.svtkPointGaussianMapper()
...
segActor4 = svtk.svtkActor()
segActor4.SetMapper(segMapper4)

# Create an outline
outline4 = svtk.svtkOutlineFilter()
outline4.SetInputData(polydata)

outlineMapper4 = svtk.svtkPolyDataMapper()
outlineMapper4.SetInputConnection(outline4.GetOutputPort())

outlineActor4 = svtk.svtkActor()
outlineActor4.SetMapper(outlineMapper4)

# Now execute and extract point seeded regions-----------------------
cpf5 = svtk.svtkConnectedPointsFilter()
...
segMapper5 = svtk.svtkPointGaussianMapper()
...
segActor5 = svtk.svtkActor()
segActor5.SetMapper(segMapper5)

# Create an outline
outline5 = svtk.svtkOutlineFilter()
outline5.SetInputData(polydata)

outlineMapper5 = svtk.svtkPolyDataMapper()
outlineMapper5.SetInputConnection(outline5.GetOutputPort())

outlineActor5 = svtk.svtkActor()
