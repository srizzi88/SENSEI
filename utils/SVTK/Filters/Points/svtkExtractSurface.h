 ...
 * 1. This is a lightly modified version of svtkFlyingEdges3D. Some design goals
 ...
 *
 * @sa
 * svtkSignedDistance svtkFlyingEdges3D
 */

#ifndef svtkExtractSurface_h
#define svtkExtractSurface_h
...
class SVTKFILTERSPOINTS_EXPORT svtkExtractSurface : public svtkPolyDataAlgorithm
{
public:
  //@{
  /**
   ...
   * and printing.
   */
  static svtkExtractSurface* New();
  svtkTypeMacro(svtkExtractSurface, svtkPolyDataAlgorithm);
   ...
   */
  svtkSetMacro(HoleFilling, bool);
  svtkGetMacro(HoleFilling, bool);
  svtkBooleanMacro(HoleFilling, bool);
  //@}
...
private:
  svtkExtractSurface(const svtkExtractSurface&) = delete;
  void operator=(const svtkExtractSurface&) = delete;
};
