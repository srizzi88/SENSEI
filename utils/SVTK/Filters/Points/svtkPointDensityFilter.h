/*=========================================================================
  ...
  Module:    svtkPointDensityFilter.h
...
=========================================================================*/
/**
 * @class   svtkPointDensityFilter
 * @brief   produce density field from input point cloud
 *
 * svtkPointDensityFilter is a filter that generates a density field on a
 ...
 * of 1.0.
 *
 * To use this filter, specify an input of type svtkPointSet (i.e., has an
 ...
 * svtkStaticPointLocator is used; however the user may specify an alternative
 ...
 *
 * @warning
 * While this class is very similar to many other of SVTK's the point
 ...
 * svtkPointInterpolation class with a svtkLinearKernel, a (scalar) weighting
 ...
 *
 * @sa
 * svtkCheckerboardSplatter svtkShepardMethod svtkGaussianSplatter
 * svtkPointInterpolator svtkSPHInterpolator
*/

#ifndef svtkPointDensityFilter_h
#define svtkPointDensityFilter_h

#include "svtkFiltersPointsModule.h" // For export macro
#include "svtkImageAlgorithm.h"

#define SVTK_DENSITY_ESTIMATE_FIXED_RADIUS 0
#define SVTK_DENSITY_ESTIMATE_RELATIVE_RADIUS 1

#define SVTK_DENSITY_FORM_VOLUME_NORM 0
#define SVTK_DENSITY_FORM_NPTS 1

class svtkAbstractPointLocator;

class SVTKFILTERSPOINTS_EXPORT svtkPointDensityFilter : public svtkImageAlgorithm
{
public:
  //@{
  /**
   ...
   */
  static svtkPointDensityFilter* New();
  svtkTypeMacro(svtkPointDensityFilter, svtkImageAlgorithm);
   ...
   */
  svtkSetClampMacro(
    DensityEstimate, int, SVTK_DENSITY_ESTIMATE_FIXED_RADIUS, SVTK_DENSITY_ESTIMATE_RELATIVE_RADIUS);
  svtkGetMacro(DensityEstimate, int);
  void SetDensityEstimateToFixedRadius()
  {
    this->SetDensityEstimate(SVTK_DENSITY_ESTIMATE_FIXED_RADIUS);
  }
  void SetDensityEstimateToRelativeRadius()
  {
    this->SetDensityEstimate(SVTK_DENSITY_ESTIMATE_RELATIVE_RADIUS);
  }
   ...
   */
  svtkSetClampMacro(DensityForm, int, SVTK_DENSITY_FORM_VOLUME_NORM, SVTK_DENSITY_FORM_NPTS);
  svtkGetMacro(DensityForm, int);
  void SetDensityFormToVolumeNormalized() { this->SetDensityForm(SVTK_DENSITY_FORM_VOLUME_NORM); }
  void SetDensityFormToNumberOfPoints() { this->SetDensityForm(SVTK_DENSITY_FORM_NPTS); }
   ...
   * relative to voxel size).
   */
  svtkSetClampMacro(RelativeRadius, double, 0.0, SVTK_DOUBLE_MAX);
  svtkGetMacro(RelativeRadius, double);
  //@}
   ...
   */
  svtkSetMacro(ScalarWeighting, bool);
  svtkGetMacro(ScalarWeighting, bool);
  svtkBooleanMacro(ScalarWeighting, bool);
  //@}
   ...
   * and "Classification".)
   */
  svtkSetMacro(ComputeGradient, bool);
  svtkGetMacro(ComputeGradient, bool);
  svtkBooleanMacro(ComputeGradient, bool);
  //@}
...
protected:
  svtkPointDensityFilter();
  ~svtkPointDensityFilter() override;
  ...
  svtkAbstractPointLocator* Locator; // accelerate point searches
...
private:
  svtkPointDensityFilter(const svtkPointDensityFilter&) = delete;
  void operator=(const svtkPointDensityFilter&) = delete;
};
