/*=========================================================================
  ...
  Module:    svtkPointOccupancyFilter.h
...
=========================================================================*/
/**
 * @class   svtkPointOccupancyFilter
 * @brief   produce occupancy bit mask from input point cloud
 *
 * svtkPointOccupancyFilter is a filter that generates an occupancy mask on a
 ...
 *
 * @sa
 * svtkPointDensityFilter svtkPointMaskFilter
 */

#ifndef svtkPointOccupancyFilter_h
#define svtkPointOccupancyFilter_h

#include "svtkFiltersPointsModule.h" // For export macro
#include "svtkImageAlgorithm.h"

class SVTKFILTERSPOINTS_EXPORT svtkPointOccupancyFilter : public svtkImageAlgorithm
{
public:
  //@{
  /**
   ...
   */
  static svtkPointOccupancyFilter* New();
  svtkTypeMacro(svtkPointOccupancyFilter, svtkImageAlgorithm);
  ...
  svtkSetMacro(OccupiedValue, unsigned char);
  svtkGetMacro(OccupiedValue, unsigned char);
  //@}

protected:
  svtkPointOccupancyFilter();
  ~svtkPointOccupancyFilter() override;
...
private:
  svtkPointOccupancyFilter(const svtkPointOccupancyFilter&) = delete;
  void operator=(const svtkPointOccupancyFilter&) = delete;
};
