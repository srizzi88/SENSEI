 ...
 *
 *
 * svtkSPHKernel is an abstract superclass for smoothed-particle hydrodynamics
 ...
 *
 * @sa
 * svtkSPHKernel svtkSPHQuinticKernel svtkInterpolationKernel svtkGaussianKernel
 * svtkShepardKernel svtkLinearKernel
 */

#ifndef svtkSPHKernel_h
#define svtkSPHKernel_h
...
class SVTKFILTERSPOINTS_EXPORT svtkSPHKernel : public svtkInterpolationKernel
{
public:
  //@{
  /**
   ...
   */
  svtkTypeMacro(svtkSPHKernel, svtkInterpolationKernel);
   ...
   */
  svtkSetClampMacro(SpatialStep, double, 0.0, SVTK_FLOAT_MAX);
  svtkGetMacro(SpatialStep, double);
  //@}
   ...
   */
  svtkSetClampMacro(Dimension, int, 1, 3);
   ...
   * svtkSPHQuinticKernel has a cutoff factor = 3.0).
   */
  svtkGetMacro(CutoffFactor, double);
  //@}
   ...
   */
  virtual void SetCutoffArray(svtkDataArray*);
  svtkGetObjectMacro(CutoffArray, svtkDataArray);
  //@}
   ...
   */
  virtual void SetDensityArray(svtkDataArray*);
  svtkGetObjectMacro(DensityArray, svtkDataArray);
  //@}
   ...
   * compute local particle volumes.
   */
  virtual void SetMassArray(svtkDataArray*);
  svtkGetObjectMacro(MassArray, svtkDataArray);
  //@}
   ...
   */
  virtual svtkIdType ComputeDerivWeights(
   ...
   */
  svtkGetMacro(NormFactor, double);
  //@}

protected:
  svtkSPHKernel();
  ~svtkSPHKernel() override;
  ...
  svtkDataArray* CutoffArray;
  svtkDataArray* DensityArray;
  svtkDataArray* MassArray;
...
private:
  svtkSPHKernel(const svtkSPHKernel&) = delete;
  void operator=(const svtkSPHKernel&) = delete;
};
