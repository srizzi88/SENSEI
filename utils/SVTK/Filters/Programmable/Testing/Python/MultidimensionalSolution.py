...
#
# The dataset read by this exercise ("combVectors.svtk") has field data
...
#
# You will most likely use svtkFieldDataToAttributeDataFilter, svtkHedgeHog,
# and svtkProgrammableAttributeDataFilter.
#
...
pl3d_gradient = svtk.svtkMultiBlockPLOT3DReader()
pl3d_gradient.SetXYZFileName("" + str(SVTK_DATA_ROOT) + "/Data/combxyz.bin")
pl3d_gradient.SetQFileName("" + str(SVTK_DATA_ROOT) + "/Data/combq.bin")
...
pl3d_velocity = svtk.svtkMultiBlockPLOT3DReader()
pl3d_velocity.SetXYZFileName("" + str(SVTK_DATA_ROOT) + "/Data/combxyz.bin")
pl3d_velocity.SetQFileName("" + str(SVTK_DATA_ROOT) + "/Data/combq.bin")
...
#
#
dotProduct = svtk.svtkProgrammableAttributeDataFilter()
