/*=========================================================================
  ...
  Module:    svtkProgrammableAttributeDataFilter.cxx
...
svtkStandardNewMacro(svtkProgrammableAttributeDataFilter);

svtkProgrammableAttributeDataFilter::svtkProgrammableAttributeDataFilter()
{
...
void svtkProgrammableAttributeDataFilter::AddInput(svtkDataSet* ds)
{
...
void svtkProgrammableAttributeDataFilter::RemoveInput(svtkDataSet* ds)
{
  if (this->InputList->IsItemPresent(ds))
  {
    this->Modified();
...
void svtkProgrammableAttributeDataFilter::SetExecuteMethod(void (*f)(void*), void* arg)
{
...
void svtkProgrammableAttributeDataFilter::SetExecuteMethodArgDelete(void (*f)(void*))
{
...
int svtkProgrammableAttributeDataFilter::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  svtkDebugMacro(<< "Executing programmable point data filter");
...
void svtkProgrammableAttributeDataFilter::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkProgrammableAttributeDataFilter ::ReportReferences(svtkGarbageCollector* collector)
{
