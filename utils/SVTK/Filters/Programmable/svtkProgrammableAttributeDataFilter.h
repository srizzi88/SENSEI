/*=========================================================================
  ...
  Module:    svtkProgrammableAttributeDataFilter.h
...
=========================================================================*/
/**
 * @class   svtkProgrammableAttributeDataFilter
 * @brief   manipulate attribute (cell and point) data via a user-specified function
 *
 * svtkProgrammableAttributeDataFilter is a filter that allows you to write a
 ...
 *
 * @warning
 * The output of this filter is the abstract type svtkDataSet, even if your
 * input is a concrete type like svtkPolyData. Thus you may need to use
 * svtkCastToConcrete to obtain the output as a particular concrete type, or
 * one of the special methods of the superclass (e.g.,
 * svtkDataSetAlgorithm::GetPolyDataOutput) to retrieve output of the
 * correct type.
 *
 * @warning
...
#ifndef svtkProgrammableAttributeDataFilter_h
#define svtkProgrammableAttributeDataFilter_h
...
class SVTKFILTERSPROGRAMMABLE_EXPORT svtkProgrammableAttributeDataFilter : public svtkDataSetAlgorithm
{
public:
  static svtkProgrammableAttributeDataFilter* New();
  svtkTypeMacro(svtkProgrammableAttributeDataFilter, svtkDataSetAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Add a dataset to the list of data to process.
   */
  void AddInput(svtkDataSet* in);

  /**
   * Remove a dataset from the list of data to process.
   */
  void RemoveInput(svtkDataSet* in);

  /**
   * Return the list of inputs.
   */
  svtkDataSetCollection* GetInputList() { return this->InputList; }
...
protected:
  svtkProgrammableAttributeDataFilter();
  ~svtkProgrammableAttributeDataFilter() override;

  int RequestData(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;
  svtkDataSetCollection* InputList;              // list of datasets to process
...
private:
  svtkProgrammableAttributeDataFilter(const svtkProgrammableAttributeDataFilter&) = delete;
  void operator=(const svtkProgrammableAttributeDataFilter&) = delete;
};
