...
// Reference values
const svtkIdType cardSelection[] = {
  54,
  54,
  108,
  45,
  ...
  svtkExtractSelection* extract, const char* tag, int testIdx, bool writeGrid)
{
  ...
  {
    svtkGenericWarningMacro("Incorrect cardinality: " << nCells << " != " << cardSelection[testIdx]);
    testStatus = 1;
  }
  ...
  if (writeGrid)
  {
    ...
    fileNameSS << "./LinearExtraction3D-" << testIdx << ".svtk";
...
int TestLinearSelector3D(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkLinearSelector> ls0 = svtkSmartPointer<svtkLinearSelector>::New();
  ...
  // Create selection along one line segment
  svtkSmartPointer<svtkLinearSelector> ls1 = svtkSmartPointer<svtkLinearSelector>::New();
  ...
  svtkSmartPointer<svtkLinearSelector> ls2 = svtkSmartPointer<svtkLinearSelector>::New();
  ...
  // Create selection along this broken line
  svtkSmartPointer<svtkLinearSelector> ls3 = svtkSmartPointer<svtkLinearSelector>::New();
