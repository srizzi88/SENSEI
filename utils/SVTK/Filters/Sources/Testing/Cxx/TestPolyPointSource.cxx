...
int TestPolyPointSource(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  svtkSmartPointer<svtkPolyPointSource> source = svtkSmartPointer<svtkPolyPointSource>::New();
