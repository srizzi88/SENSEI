...
class SuperQuadricViewer(Testing.svtkTest):
    '''
    ...
    def SetUp(self):
        ...
        self.tkrw = svtkTkRenderWidget(self.root, width=550, height=450)
        ...
        pnmReader.SetFileName(SVTK_DATA_ROOT + "/Data/earth.ppm")
        atext = svtk.svtkTexture()
        atext.SetInputConnection(pnmReader.GetOutputPort())
        atext.InterpolateOn()

        appendSquads = svtk.svtkAppendPolyData()
