...
svtkStandardNewMacro(svtkCylinderSource);

svtkCylinderSource::svtkCylinderSource(int res)
{
  this->Resolution = res;
  this->Height = 1.0;
  this->Radius = 0.5;
...
int svtkCylinderSource::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  double angle = 2.0 * svtkMath::Pi() / this->Resolution;
  int numPolys, numPts;
...
void svtkCylinderSource::PrintSelf(ostream& os, svtkIndent indent)
{
