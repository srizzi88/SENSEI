/*=========================================================================
  ...
  Module:    svtkEllipticalButtonSource.cxx
...
svtkStandardNewMacro(svtkEllipticalButtonSource);

//----------------------------------------------------------------------------
// Construct
svtkEllipticalButtonSource::svtkEllipticalButtonSource()
{
  this->Width = 0.5;
  this->Height = 0.5;
  this->Depth = 0.05;
...
//----------------------------------------------------------------------------
int svtkEllipticalButtonSource::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  svtkDebugMacro(<< "Generating elliptical button");
  ...
  if (this->TwoSided > 0.0)
  {
    ...
    // do the polygons
    const svtkIdType* ipts = nullptr;
    svtkIdType opts[4];

    svtkIdType npts = 0;
    svtkIdType numPolys = newPolys->GetNumberOfCells();
...
//----------------------------------------------------------------------------
void svtkEllipticalButtonSource::InterpolateCurve(int inTextureRegion, svtkPoints* newPts, int numPts,
  svtkFloatArray* normals, svtkFloatArray* tcoords, int res, int c1StartPt, int c1Incr, int c2StartPt,
...
//----------------------------------------------------------------------------
void svtkEllipticalButtonSource::CreatePolygons(
  svtkCellArray* newPolys, int num, int res, int startIdx)
{
  int i, j;
  svtkIdType idx, pts[4];
...
//----------------------------------------------------------------------------
void svtkEllipticalButtonSource::IntersectEllipseWithLine(
...
//----------------------------------------------------------------------------
double svtkEllipticalButtonSource::ComputeDepth(
  int svtkNotUsed(inTextureRegion), double x, double y, double n[3])
{
  double z;
...
//----------------------------------------------------------------------------
void svtkEllipticalButtonSource::PrintSelf(ostream& os, svtkIndent indent)
{
