...
svtkStandardNewMacro(svtkOutlineSource);

//----------------------------------------------------------------------------
svtkOutlineSource::svtkOutlineSource()
{
  this->BoxType = SVTK_BOX_TYPE_AXIS_ALIGNED;
...
//----------------------------------------------------------------------------
int svtkOutlineSource::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  if (this->BoxType == SVTK_BOX_TYPE_AXIS_ALIGNED)
  {
    x[0] = bounds[0];
    x[1] = bounds[2];
    x[2] = bounds[4];
...
//----------------------------------------------------------------------------
void svtkOutlineSource::PrintSelf(ostream& os, svtkIndent indent)
{
