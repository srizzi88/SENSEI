/*=========================================================================
  ...
  Module:    svtkTessellatedBoxSource.cxx
...
svtkStandardNewMacro(svtkTessellatedBoxSource);

// ----------------------------------------------------------------------------
svtkTessellatedBoxSource::svtkTessellatedBoxSource()
{
  this->Bounds[0] = -0.5;
  this->Bounds[1] = 0.5;
  this->Bounds[2] = -0.5;
...
// ----------------------------------------------------------------------------
svtkTessellatedBoxSource::~svtkTessellatedBoxSource() = default;
...
// happens here.
int svtkTessellatedBoxSource::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  // Always create a new svtkCellArray, otherwise it uses the this->Dummy of
  // svtkPolyData...
...
void svtkTessellatedBoxSource::DuplicateSharedPointsMethod(
  double* bounds, svtkPoints* points, svtkCellArray* polys)
{
...
// ----------------------------------------------------------------------------
void svtkTessellatedBoxSource::MinimalPointsMethod(
  double* bounds, svtkPoints* points, svtkCellArray* polys)
{
  ...
  // Faces
  svtkIdType poly[4]; // fit a triangle or a quad depending on the Quads flag.
  int f = 0;
  while (f < 6)
  {
...
svtkIdType svtkTessellatedBoxSource::LocalFacePointCoordinatesToPointId(int f, int i, int j)
{
...
void svtkTessellatedBoxSource::BuildFace(svtkPoints* points, svtkCellArray* polys,
  svtkIdType firstPointId, double facePoints[3][3], int changed)
{
...
// ----------------------------------------------------------------------------
void svtkTessellatedBoxSource::PrintSelf(ostream& os, svtkIndent indent)
{
