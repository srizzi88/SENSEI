/*=========================================================================
  ...
  Module:    svtkTessellatedBoxSource.h
...
/**
 * @class   svtkTessellatedBoxSource
 * @brief   Create a polygonal representation of a box
 * with a given level of subdivision.
 *
 * svtkTessellatedBoxSource creates a axis-aligned box defined by its bounds
...
#ifndef svtkTessellatedBoxSource_h
#define svtkTessellatedBoxSource_h

#include "svtkFiltersSourcesModule.h" // For export macro
#include "svtkPolyDataAlgorithm.h"

class SVTKFILTERSSOURCES_EXPORT svtkTessellatedBoxSource : public svtkPolyDataAlgorithm
{
public:
  static svtkTessellatedBoxSource* New();
  svtkTypeMacro(svtkTessellatedBoxSource, svtkPolyDataAlgorithm);
   ...
   */
  svtkSetMacro(DuplicateSharedPoints, svtkTypeBool);
  svtkGetMacro(DuplicateSharedPoints, svtkTypeBool);
  svtkBooleanMacro(DuplicateSharedPoints, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(Quads, svtkTypeBool);
  svtkGetMacro(Quads, svtkTypeBool);
  svtkBooleanMacro(Quads, svtkTypeBool);
  //@}
...
protected:
  svtkTessellatedBoxSource();
  ~svtkTessellatedBoxSource() override;
  ...
  int RequestData(svtkInformation* request, svtkInformationVector** inputVector,
    svtkInformationVector* outpuVector) override;

  void DuplicateSharedPointsMethod(double* bounds, svtkPoints* points, svtkCellArray* polys);

  void MinimalPointsMethod(double* bounds, svtkPoints* points, svtkCellArray* polys);
   ...
   */
  svtkIdType LocalFacePointCoordinatesToPointId(int f, int i, int j);
   ...
   */
  void BuildFace(svtkPoints* points, svtkCellArray* polys, svtkIdType firstPointId,
    double facePoints[3][3], int changed);

  double Bounds[6];
  int Level;
  svtkTypeBool DuplicateSharedPoints;
  svtkTypeBool Quads;
  int OutputPointsPrecision;

private:
  svtkTessellatedBoxSource(const svtkTessellatedBoxSource&) = delete;
  void operator=(const svtkTessellatedBoxSource&) = delete;
};
