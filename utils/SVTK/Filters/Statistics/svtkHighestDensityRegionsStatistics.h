...
Module:    svtkHighestDensityRegionsStatistics.h
...
/**
 * @class   svtkHighestDensityRegionsStatistics
 ...
 *   dataset containing at one svtkTable holding three columns which are for the
 ...
 *   svtkTable holding some pairs of columns which are for the second one the
...
#ifndef svtkHighestDensityRegionsStatistics_h
#define svtkHighestDensityRegionsStatistics_h
...
class SVTKFILTERSSTATISTICS_EXPORT svtkHighestDensityRegionsStatistics : public svtkStatisticsAlgorithm
{
public:
  svtkTypeMacro(svtkHighestDensityRegionsStatistics, svtkStatisticsAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkHighestDensityRegionsStatistics* New();
   ...
   */
  double ComputeHDR(svtkDataArray* inObservations, svtkDataArray* outDensity);
   ...
   * Look ComputeSmoothGaussianKernel for KH kernel definition.
   */
  double ComputeHDR(svtkDataArray* inObs, svtkDataArray* inPOI, svtkDataArray* outDensity);

protected:
  svtkHighestDensityRegionsStatistics();
  ~svtkHighestDensityRegionsStatistics() override;
   ...
   */
  void SelectAssessFunctor(svtkTable*, svtkDataObject*, svtkStringArray*, AssessFunctor*&) override
  {
    return;
  }
   ...
   */
  svtkIdType NumberOfRequestedColumnsPair;
...
private:
  svtkHighestDensityRegionsStatistics(const svtkHighestDensityRegionsStatistics&) = delete;
  void operator=(const svtkHighestDensityRegionsStatistics&) = delete;
};
