#ifndef svtkKMeansDistanceFunctorCalculator_h
#define svtkKMeansDistanceFunctorCalculator_h

/**
 * @class   svtkKMeansDistanceFunctorCalculator
 ...
 * svtkObject pointers are not allowed.)
...
class SVTKFILTERSSTATISTICS_EXPORT svtkKMeansDistanceFunctorCalculator
  : public svtkKMeansDistanceFunctor
{
public:
  static svtkKMeansDistanceFunctorCalculator* New();
  svtkTypeMacro(svtkKMeansDistanceFunctorCalculator, svtkKMeansDistanceFunctor);
   ...
   */
  void operator()(double&, svtkVariantArray*, svtkVariantArray*) override;

  //@{
  /**
   * Set/get the distance function expression.
   */
  svtkSetStringMacro(DistanceExpression);
  svtkGetStringMacro(DistanceExpression);
  //@}
   ...
   */
  virtual void SetFunctionParser(svtkFunctionParser*);
  svtkGetObjectMacro(FunctionParser, svtkFunctionParser);
  //@}

protected:
  svtkKMeansDistanceFunctorCalculator();
  ~svtkKMeansDistanceFunctorCalculator() override;
...
private:
  svtkKMeansDistanceFunctorCalculator(const svtkKMeansDistanceFunctorCalculator&) = delete;
  void operator=(const svtkKMeansDistanceFunctorCalculator&) = delete;
};

#endif // svtkKMeansDistanceFunctorCalculator_h
