...
Module:    svtkMultiCorrelativeStatistics.h
...
/*-------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------*/
/**
 * @class   svtkMultiCorrelativeStatistics
 ...
 *   one svtkTable holding the raw sums in a sparse matrix style. If \a finalize is
 *   true, then one additional svtkTable will be present for each requested set of
...
#ifndef svtkMultiCorrelativeStatistics_h
#define svtkMultiCorrelativeStatistics_h
...
class SVTKFILTERSSTATISTICS_EXPORT svtkMultiCorrelativeStatistics : public svtkStatisticsAlgorithm
{
public:
  svtkTypeMacro(svtkMultiCorrelativeStatistics, svtkStatisticsAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkMultiCorrelativeStatistics* New();
   ...
   * Default is false.
   */
  svtkSetMacro(MedianAbsoluteDeviation, bool);
  svtkGetMacro(MedianAbsoluteDeviation, bool);
  svtkBooleanMacro(MedianAbsoluteDeviation, bool);
  //@}

protected:
  svtkMultiCorrelativeStatistics();
  ~svtkMultiCorrelativeStatistics() override;
  ...
  /**
   * Computes the median of inData with svtkOrderStatistics.
   */
  virtual void ComputeMedian(svtkTable* inData, svtkTable* outData);

  /**
   * Return a new svtkOrderStatistics instance.
   * Used by derived class to return a derivate class instead.
   */
  virtual svtkOrderStatistics* CreateOrderStatisticsInstance();

  bool MedianAbsoluteDeviation;

private:
  svtkMultiCorrelativeStatistics(const svtkMultiCorrelativeStatistics&) = delete;
  void operator=(const svtkMultiCorrelativeStatistics&) = delete;
};
