/*=========================================================================
  ...
  Module:    svtkTransformTextureCoords.cxx
...
svtkStandardNewMacro(svtkTransformTextureCoords);
...
svtkTransformTextureCoords::svtkTransformTextureCoords()
{
...
void svtkTransformTextureCoords::AddPosition(double dPX, double dPY, double dPZ)
{
  double position[3];
...
void svtkTransformTextureCoords::AddPosition(double deltaPosition[3])
{
  this->AddPosition(deltaPosition[0], deltaPosition[1], deltaPosition[2]);
}

int svtkTransformTextureCoords::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  svtkDataArray* inTCoords = input->GetPointData()->GetTCoords();
  svtkDataArray* newTCoords;
  svtkIdType numPts = input->GetNumberOfPoints(), ptId;
  int i, j, texDim;
  svtkTransform* transform;
  svtkMatrix4x4* matrix;
  double TC[3], newTC[3];

  svtkDebugMacro(<< "Transforming texture coordinates...");
  ...
  {
    svtkErrorMacro(<< "No texture coordinates to transform");
    return 1;
  }
...
void svtkTransformTextureCoords::PrintSelf(ostream& os, svtkIndent indent)
{
