...
// PURPOSE: FiberSurface test cases output generator (new svtkFiberSurface filter)
...
int TestFiberSurface(int argc, char* argv[])
{
  ...
  /************** Input File paths using svtkTestUtilities ****************/
  const char* inputDataFiles[3] = { svtkTestUtilities::ExpandDataFileName(
                                      argc, argv, "Data/FiberSurface/one_cube.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/one_cube_both_forking.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/one_cube_closed.svtk") };

  /************** FSCP File paths using svtkTestUtilities ****************/
  const char* inputFSCPFiles[15] = { svtkTestUtilities::ExpandDataFileName(
                                       argc, argv, "Data/FiberSurface/line_01.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_02.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_03.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_04.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_05.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_11.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_12.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_13.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_14.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_15.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_21.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_22.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_23.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_24.svtk"),
    svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/FiberSurface/line_25.svtk") };
  /**********************************************/
  ...
  for (int i = 0; i < 3; i++) // loop for three input files
  {
    ...
    {
      // read and load .svtk input data file
      svtkSmartPointer<svtkUnstructuredGridReader> mesh_reader =
      ...
      svtkSmartPointer<svtkPolyDataReader> polyline_reader =
        svtkSmartPointer<svtkPolyDataReader>::New();
      polyline_reader->SetFileName(inputFSCPFiles[cmpIndex]);
      polyline_reader->Update();

      // extract polydata surface
      svtkSmartPointer<svtkFiberSurface> fs = svtkSmartPointer<svtkFiberSurface>::New();
      ...
      svtkPolyData* polyData = fs->GetOutput();
