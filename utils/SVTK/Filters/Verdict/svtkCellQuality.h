...
=========================================================================*/
/**
 * @class   svtkCellQuality
 * @brief   Calculate functions of quality of the elements
 *  of a mesh
 *
 *
 * svtkCellQuality computes one or more functions of (geometric) quality for each
...
#ifndef svtkCellQuality_h
#define svtkCellQuality_h
...
class SVTKFILTERSVERDICT_EXPORT svtkCellQuality : public svtkDataSetAlgorithm
{
...
public:
  ...
  svtkTypeMacro(svtkCellQuality, svtkDataSetAlgorithm);
  static svtkCellQuality* New();
   ...
   */
  svtkSetMacro(QualityMeasure, int);
  svtkGetMacro(QualityMeasure, int);
  //@}
   ...
   */
  svtkSetMacro(UnsupportedGeometry, double);
  svtkGetMacro(UnsupportedGeometry, double);
  //@}
   ...
   */
  svtkSetMacro(UndefinedQuality, double);
  svtkGetMacro(UndefinedQuality, double);
  //@}

  double TriangleStripArea(svtkCell*);
  double PixelArea(svtkCell*);
  double PolygonArea(svtkCell*);

protected:
  ~svtkCellQuality() override;
  svtkCellQuality();
   ...
   * SHAPE_AND_SIZE
   */
  double ComputeTriangleQuality(svtkCell*);
   ...
   */
  double ComputeQuadQuality(svtkCell*);
   ...
   * VOLUME
   */
  double ComputeTetQuality(svtkCell*);
   ...
   * VOLUME
   */
  double ComputeHexQuality(svtkCell*);
   ...
   * AREA
   */
  double ComputeTriangleStripQuality(svtkCell*);
   ...
   * AREA
   */
  double ComputePixelQuality(svtkCell*);
...
private:
  ...
  svtkCellQuality(const svtkCellQuality&) = delete;
  void operator=(const svtkCellQuality&) = delete;
};

#endif // svtkCellQuality_h
