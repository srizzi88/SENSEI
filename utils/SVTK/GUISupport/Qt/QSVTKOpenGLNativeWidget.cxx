/*=========================================================================
  ...
  Module:    QSVTKOpenGLNativeWidget.cxx
...
//-----------------------------------------------------------------------------
QSVTKOpenGLNativeWidget::QSVTKOpenGLNativeWidget(QWidget* parentWdg, Qt::WindowFlags f)
  : QSVTKOpenGLNativeWidget(
      svtkSmartPointer<svtkGenericOpenGLRenderWindow>::New().GetPointer(), parentWdg, f)
{
}

//-----------------------------------------------------------------------------
QSVTKOpenGLNativeWidget::QSVTKOpenGLNativeWidget(
  svtkGenericOpenGLRenderWindow* renderWin, QWidget* parentWdg, Qt::WindowFlags f)
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::setRenderWindow(svtkRenderWindow* win)
{
  auto gwin = svtkGenericOpenGLRenderWindow::SafeDownCast(win);
  if (win != nullptr && gwin == nullptr)
  {
    qDebug() << "QSVTKOpenGLNativeWidget requires a `svtkGenericOpenGLRenderWindow`. `"
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::setRenderWindow(svtkGenericOpenGLRenderWindow* win)
{
  ...
  if (this->RenderWindow)
  {
    ...
    if (this->isValid())
    {
      ...
      // QSVTKOpenGLNativeWidget has initialized itself in a previous update
...
//-----------------------------------------------------------------------------
svtkRenderWindow* QSVTKOpenGLNativeWidget::renderWindow() const
{
  return this->RenderWindow;
}

//-----------------------------------------------------------------------------
QSVTKInteractor* QSVTKOpenGLNativeWidget::interactor() const
{
...
//-----------------------------------------------------------------------------
QSurfaceFormat QSVTKOpenGLNativeWidget::defaultFormat(bool stereo_capable)
{
  return QSVTKRenderWindowAdapter::defaultFormat(stereo_capable);
}

//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::setEnableHiDPI(bool enable)
{
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::setUnscaledDPI(int dpi)
{
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::setDefaultCursor(const QCursor& cursor)
{
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::initializeGL()
{
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::updateSize()
{
  if (this->RenderWindowAdapter)
  {
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::paintGL()
{
...
//-----------------------------------------------------------------------------
void QSVTKOpenGLNativeWidget::cleanupContext()
{
  this->RenderWindowAdapter.reset(nullptr);
}

//-----------------------------------------------------------------------------
bool QSVTKOpenGLNativeWidget::event(QEvent* evt)
{
  if (this->RenderWindowAdapter)
  {
...
void QSVTKOpenGLNativeWidget::SetRenderWindow(svtkRenderWindow* win)
{
  SVTK_LEGACY_REPLACED_BODY(
    QSVTKOpenGLNativeWidget::SetRenderWindow, "SVTK 9.0", QSVTKOpenGLNativeWidget::setRenderWindow);
...
//-----------------------------------------------------------------------------
#if !defined(SVTK_LEGACY_REMOVE)
svtkRenderWindow* QSVTKOpenGLNativeWidget::GetRenderWindow()
{
  SVTK_LEGACY_REPLACED_BODY(
    QSVTKOpenGLNativeWidget::GetRenderWindow, "SVTK 9.0", QSVTKOpenGLNativeWidget::renderWindow);
  return this->renderWindow();
}
#endif
...
//-----------------------------------------------------------------------------
#if !defined(SVTK_LEGACY_REMOVE)
QSVTKInteractorAdapter* QSVTKOpenGLNativeWidget::GetInteractorAdapter()
{
  SVTK_LEGACY_BODY(QSVTKOpenGLNativeWidget::GetInteractorAdapter, "SVTK 9.0");
  return nullptr;
}
#endif
...
//-----------------------------------------------------------------------------
#if !defined(SVTK_LEGACY_REMOVE)
QSVTKInteractor* QSVTKOpenGLNativeWidget::GetInteractor()
{
  SVTK_LEGACY_REPLACED_BODY(
    QSVTKOpenGLNativeWidget::GetInteractor, "SVTK 9.0", QSVTKOpenGLNativeWidget::interactor);
...
//-----------------------------------------------------------------------------
#if !defined(SVTK_LEGACY_REMOVE)
void QSVTKOpenGLNativeWidget::setQSVTKCursor(const QCursor& cursor)
{
  SVTK_LEGACY_REPLACED_BODY(
    QSVTKOpenGLNativeWidget::setQSVTKCursor, "SVTK 9.0", QSVTKOpenGLNativeWidget::setCursor);
...
//-----------------------------------------------------------------------------
#if !defined(SVTK_LEGACY_REMOVE)
void QSVTKOpenGLNativeWidget::setDefaultQSVTKCursor(const QCursor& cursor)
{
  SVTK_LEGACY_REPLACED_BODY(QSVTKOpenGLNativeWidget::setDefaultQSVTKCursor, "SVTK 9.0",
    QSVTKOpenGLNativeWidget::setDefaultCursor);
