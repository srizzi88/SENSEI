...
int TestQtSQLDatabase(int argc, char* argv[])
{
  ...
  svtkQtSQLDatabase* db = svtkQtSQLDatabase::New();
  ...
  if (interactive)
  {
    svtkQtTableModelAdapter* model = new svtkQtTableModelAdapter(table);
