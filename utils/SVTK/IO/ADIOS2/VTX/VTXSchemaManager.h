...
#ifndef SVTK_IO_ADIOS2_VTX_VTXSchemaManager_H_
#define SVTK_IO_ADIOS2_VTX_VTXSchemaManager_H_
...
public:
  ...
  void Update(const std::string& streamName, const size_t step = 0,
    const std::string& schemaName = "svtk.xml");
...
private:
  ...
  bool InitReaderXMLSVTK();
};

} // end namespace adios2svtk

#endif /* SVTK_IO_ADIOS2_VTX_VTXSchemaManager_h */
