...
/*
 * VTXDataArray.h : wrapper around svtkDataArray adding adios2 relevant
 * information
 *
...
#ifndef SVTK_IO_ADIOS2_VTX_COMMON_VTXDataArray_h
#define SVTK_IO_ADIOS2_VTX_COMMON_VTXDataArray_h
...
public:
  ...
  /** true : uses the special svtkIdType for indexing
   *  false : uses other SVTK supported type */
  bool IsIdType = false;
  ...
  /**
   * Convert internal svtkDataArray to a 3D SVTK conforming array
   ...
   */
  void ConvertTo3DSVTK(const std::vector<double>& fillValues = std::vector<double>());
};

} // end namespace types
} // end namespace vtx

#endif /* SVTK_IO_ADIOS2_VTX_COMMON_VTXDataArray_h */
