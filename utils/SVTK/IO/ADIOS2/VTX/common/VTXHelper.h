...
/*
 * VTXHelper.h : collection of helper function needed by SVTK::IOADIOS2 module
 *
 *  Created on: May 3, 2019
 *      Author: William F Godoy godoywf@ornl.gov
 */

#ifndef SVTK_IO_ADIOS2_VTX_COMMON_VTXHelper_h
#define SVTK_IO_ADIOS2_VTX_COMMON_VTXHelper_h
...
/** Get current MPI global communicator from SVTK */
MPI_Comm MPIGetComm();
...
/**
 * Return a derived class of svtkDataArray specialized for supported types
 * @return specialized svtkDataArray
 */
template <class T>
svtkSmartPointer<svtkDataArray> NewDataArray();

/**
 * Special type for svtkIdTypeArray
 * @return smart pointer of type svtkIdTypeArray
 */
...
#endif /* SVTK_IO_ADIOS2_VTX_COMMON_VTXHelper_h */
