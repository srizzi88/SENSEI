...
#ifndef SVTK_IO_ADIOS2_VTX_SCHEMA_VTXSchema_h
#define SVTK_IO_ADIOS2_VTX_SCHEMA_VTXSchema_h
...
public:
   ...
   */
  void Fill(svtkMultiBlockDataSet* multiBlock, const size_t step = 0);
...
#endif /* SVTK_IO_ADIOS2_VTX_SCHEMA_VTXSchema_h */
