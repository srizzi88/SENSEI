...
/*
 * VTXsvtkBase.h : abstract class for schemas of type
 *                  [SVTK XML file formats schemas]
 *                  (https://svtk.org/wp-content/uploads/2015/04/file-formats.pdf)
...
#ifndef SVTK_IO_ADIOS2_VTX_SCHEMA_SVTK_VTXsvtkBase_h
#define SVTK_IO_ADIOS2_VTX_SCHEMA_SVTK_VTXsvtkBase_h
...
class VTXsvtkBase : public VTXSchema
{
public:
  VTXsvtkBase(
...
protected:
  ...
  virtual void DoFill(svtkMultiBlockDataSet* multiBlock, const size_t step) = 0;
...
#endif /* SVTK_IO_ADIOS2_VTX_SCHEMA_SVTK_VTXsvtkBase_h */
