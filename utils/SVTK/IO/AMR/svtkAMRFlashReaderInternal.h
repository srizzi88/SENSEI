/*=========================================================================
  ...
  Module:    svtkAMRFlashReaderInternal.hpp
...
=========================================================================*/
/**
 * @class   svtkAMRFlashReaderInternal
 *
 *
 *  Consists of the low-level Flash Reader used by the svtkAMRFlashReader.
 *
 * @sa
 *  svtkAMRFlashReader
 */

#ifndef svtkAMRFlashReaderInternal_h
#define svtkAMRFlashReaderInternal_h
...
// ----------------------------------------------------------------------------
//                     Class  svtkFlashReaderInternal (begin)
// ----------------------------------------------------------------------------

class svtkFlashReaderInternal
{
public:
  svtkFlashReaderInternal() { this->Init(); }
  ~svtkFlashReaderInternal() { this->Init(); }
...
// ----------------------------------------------------------------------------
//                     Class  svtkFlashReaderInternal ( end )
// ----------------------------------------------------------------------------
#endif /* svtkAMRFlashReaderInternal_h */
// SVTK-HeaderTest-Exclude: svtkAMRFlashReaderInternal.h
