...
del cdp
reader.SetCaseFileName("" + str(SVTK_DATA_ROOT) + "/Data/EnSight/office6_bin.case")
reader.Update()

outline = svtk.svtkStructuredGridOutlineFilter()
outline.SetInputConnection(reader.GetOutputPort())
mapOutline = svtk.svtkHierarchicalPolyDataMapper()
...
mapCones = svtk.svtkHierarchicalPolyDataMapper()
