/*=========================================================================
  ...
  Module:    svtkEnSightGoldBinaryReader.h
...
=========================================================================*/
/**
 * @class   svtkEnSightGoldBinaryReader
 * @brief   class to read binary EnSight Gold files
 *
 * svtkEnSightGoldBinaryReader is a class to read EnSight Gold files into svtk.
...
#ifndef svtkEnSightGoldBinaryReader_h
#define svtkEnSightGoldBinaryReader_h
...
class SVTKIOENSIGHT_EXPORT svtkEnSightGoldBinaryReader : public svtkEnSightReader
{
public:
  static svtkEnSightGoldBinaryReader* New();
  svtkTypeMacro(svtkEnSightGoldBinaryReader, svtkEnSightReader);
  void PrintSelf(ostream& os, svtkIndent indent) override;

protected:
  svtkEnSightGoldBinaryReader();
  ~svtkEnSightGoldBinaryReader() override;
  ...
  int CreateUnstructuredGridOutput(
    int partId, char line[80], const char* name, svtkMultiBlockDataSet* output) override;
  ...
  int CreateImageDataOutput(
    int partId, char line[80], const char* name, svtkMultiBlockDataSet* output);
   ...
   * Returns zero if there was an error.
   */
  int ReadLong(svtkTypeInt64* result);
   ...
   */
  void AddTimeStepToCache(const char* fileName, int realTimeStep, svtkTypeInt64 address);
...
private:
  int SizeOfInt;
  svtkEnSightGoldBinaryReader(const svtkEnSightGoldBinaryReader&) = delete;
  void operator=(const svtkEnSightGoldBinaryReader&) = delete;
};
