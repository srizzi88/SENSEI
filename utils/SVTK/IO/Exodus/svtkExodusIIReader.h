...
/**
 * @class   svtkExodusIIReader
 * @brief   Read exodus 2 files .ex2
 *
 * svtkExodusIIReader is a unstructured grid source object that reads ExodusII
...
#ifndef svtkExodusIIReader_h
#define svtkExodusIIReader_h
...
class svtkExodusIIReaderPrivate;
...
class SVTKIOEXODUS_EXPORT svtkExodusIIReader : public svtkMultiBlockDataSetAlgorithm
{
public:
  static svtkExodusIIReader* New();
  svtkTypeMacro(svtkExodusIIReader, svtkMultiBlockDataSetAlgorithm);
   ...
   * This is really only intended for use by svtkPExodusIIReader in order
   * to determine if the filename is newer than the metadata.
   */
  virtual svtkMTimeType GetMetadataMTime();
  ...
  svtkGetStringMacro(XMLFileName);
  //@}
   ...
   */
  svtkGetVector2Macro(ModeShapesRange, int);
  //@}
   ...
   */
  virtual void SetGenerateObjectIdCellArray(svtkTypeBool g);
  svtkTypeBool GetGenerateObjectIdCellArray();
  svtkBooleanMacro(GenerateObjectIdCellArray, svtkTypeBool);
  static const char* GetObjectIdArrayName() { return "ObjectId"; }
  //@}

  virtual void SetGenerateGlobalElementIdArray(svtkTypeBool g);
  svtkTypeBool GetGenerateGlobalElementIdArray();
  svtkBooleanMacro(GenerateGlobalElementIdArray, svtkTypeBool);

  virtual void SetGenerateGlobalNodeIdArray(svtkTypeBool g);
  svtkTypeBool GetGenerateGlobalNodeIdArray();
  svtkBooleanMacro(GenerateGlobalNodeIdArray, svtkTypeBool);

  virtual void SetGenerateImplicitElementIdArray(svtkTypeBool g);
  svtkTypeBool GetGenerateImplicitElementIdArray();
  svtkBooleanMacro(GenerateImplicitElementIdArray, svtkTypeBool);

  virtual void SetGenerateImplicitNodeIdArray(svtkTypeBool g);
  svtkTypeBool GetGenerateImplicitNodeIdArray();
  svtkBooleanMacro(GenerateImplicitNodeIdArray, svtkTypeBool);

  virtual void SetGenerateFileIdArray(svtkTypeBool f);
  svtkTypeBool GetGenerateFileIdArray();
  svtkBooleanMacro(GenerateFileIdArray, svtkTypeBool);
  ...
  static int GetGlobalElementID(svtkDataSet* data, int localID);
  static int GetGlobalElementID(svtkDataSet* data, int localID, int searchType);
  ...
  static int GetGlobalFaceID(svtkDataSet* data, int localID);
  static int GetGlobalFaceID(svtkDataSet* data, int localID, int searchType);
  ...
  static int GetGlobalEdgeID(svtkDataSet* data, int localID);
  static int GetGlobalEdgeID(svtkDataSet* data, int localID, int searchType);
  ...
  static int GetGlobalNodeID(svtkDataSet* data, int localID);
  static int GetGlobalNodeID(svtkDataSet* data, int localID, int searchType);
  ...
  svtkTypeBool GetApplyDisplacements();
  svtkBooleanMacro(ApplyDisplacements, svtkTypeBool);
   ...
   */
  virtual void SetHasModeShapes(svtkTypeBool ms);
  svtkTypeBool GetHasModeShapes();
  svtkBooleanMacro(HasModeShapes, svtkTypeBool);
  //@}
   ...
   */
  virtual void SetAnimateModeShapes(svtkTypeBool flag);
  svtkTypeBool GetAnimateModeShapes();
  svtkBooleanMacro(AnimateModeShapes, svtkTypeBool);
  //@}
  ...
  svtkBooleanMacro(IgnoreFileTime, bool);
  //@}
   ...
   * (Developer Note) This meta data is all accessed through svtkExodusMetadata
   */
  ...
  virtual svtkIdType GetTotalNumberOfNodes();
  virtual svtkIdType GetTotalNumberOfEdges();
  virtual svtkIdType GetTotalNumberOfFaces();
  virtual svtkIdType GetTotalNumberOfElements();
  ...
  int GetTimeSeriesData(int ID, const char* vName, const char* vType, svtkFloatArray* result);
   ...
   * GLOBAL_TEMPORAL.
   *
   * @sa svtkExtractExodusGlobalTemporalVariables.
   */
  static svtkInformationIntegerKey* GLOBAL_VARIABLE();
  static svtkInformationIntegerKey* GLOBAL_TEMPORAL_VARIABLE();
  //@}
   ...
   */
  svtkSetMacro(UseLegacyBlockNames, bool);
  svtkGetMacro(UseLegacyBlockNames, bool);
  svtkBooleanMacro(UseLegacyBlockNames, bool);
  //@}
protected:
  svtkExodusIIReader();
  ~svtkExodusIIReader() override;

  // helper for finding IDs
  static int GetIDHelper(const char* arrayName, svtkDataSet* data, int localID, int searchType);
  static int GetGlobalID(const char* arrayName, svtkDataSet* data, int localID, int searchType);

  virtual void SetMetadata(svtkExodusIIReaderPrivate*);
  svtkGetObjectMacro(Metadata, svtkExodusIIReaderPrivate);
  ...
  void GetAllTimes(svtkInformationVector*);

  /**
   * Populates the TIME_STEPS and TIME_RANGE keys based on file metadata.
   */
  void AdvertiseTimeSteps(svtkInformation* outputInfo);
  ...
  // int RequestDataOverTime( svtkInformation *, svtkInformationVector **, svtkInformationVector *);
  ...
  svtkTimeStamp XMLFileNameMTime;
  ...
  svtkExodusIIReaderPrivate* Metadata;
...
private:
  svtkExodusIIReader(const svtkExodusIIReader&) = delete;
  void operator=(const svtkExodusIIReader&) = delete;

  void AddDisplacements(svtkUnstructuredGrid* output);
