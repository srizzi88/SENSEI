...
svtkStandardNewMacro(svtkModelMetadata);

#include <algorithm>
#include <map>
#include <set>

class svtkModelMetadataSTLCloak
{
public:
  std::set<int> IntSet;
...
void svtkModelMetadata::InitializeAllMetadata()
{
  this->Title = nullptr;
...
void svtkModelMetadata::InitializeAllIvars()
{
...
void svtkModelMetadata::FreeAllGlobalData()
{
...
void svtkModelMetadata::FreeAllLocalData()
{
...
void svtkModelMetadata::FreeBlockDependentData()
{
  // All the fields that depend on exactly which blocks
  // are in the svtkUnstructuredGrid
...
void svtkModelMetadata::FreeAllMetadata()
{
  this->FreeAllLocalData();
  this->FreeAllGlobalData();
}
void svtkModelMetadata::FreeAllIvars()
{
...
//
svtkModelMetadata::svtkModelMetadata()
{
...
void svtkModelMetadata::SetInformationLines(int nlines, char** lines)
{
  int i;
...
int svtkModelMetadata::GetInformationLines(char*** lines) const
{
...
void svtkModelMetadata::SetTimeSteps(int num, float* steps)
{
...
void svtkModelMetadata::SetCoordinateNames(int dimension, char** n)
{
  int i;
...
void svtkModelMetadata::SetBlockIds(int* b)
{
  FREE(this->BlockIds);

  this->BlockIds = b;
}
void svtkModelMetadata::SetBlockElementType(char** t)
{
  int i;
...
void svtkModelMetadata::SetBlockNodesPerElement(int* e)
{
  FREE(this->BlockNodesPerElement);

  this->BlockNodesPerElement = e;
}
void svtkModelMetadata::SetBlockElementIdList(int* e)
{
  FREE(this->BlockElementIdList);

  this->BlockElementIdList = e;
}
void svtkModelMetadata::SetBlockAttributes(float* a)
{
  FREE(this->BlockAttributes);

  this->BlockAttributes = a;
}
int svtkModelMetadata::BuildBlockAttributesIndex()
{
...
int svtkModelMetadata::BuildBlockElementIdListIndex()
{
  int nblocks = this->NumberOfBlocks;
...
int svtkModelMetadata::SetBlockNumberOfElements(int* nelts)
{
...
int svtkModelMetadata::SetBlockNumberOfAttributesPerElement(int* natts)
{
...
void svtkModelMetadata::SetNodeSetIds(int* n)
{
  FREE(this->NodeSetIds);

  this->NodeSetIds = n;
}
void svtkModelMetadata::SetNodeSetSize(int* n)
{
  FREE(this->NodeSetSize);

  this->NodeSetSize = n;
}
void svtkModelMetadata::SetNodeSetNodeIdList(int* n)
{
  FREE(this->NodeSetNodeIdList);

  this->NodeSetNodeIdList = n;
}
void svtkModelMetadata::SetNodeSetNumberOfDistributionFactors(int* n)
{
  FREE(this->NodeSetNumberOfDistributionFactors);

  this->NodeSetNumberOfDistributionFactors = n;
}
void svtkModelMetadata::SetNodeSetDistributionFactors(float* d)
{
...
//-------------------------------------------------
void svtkModelMetadata::SetSideSetIds(int* s)
{
  FREE(this->SideSetIds);

  this->SideSetIds = s;
}
void svtkModelMetadata::SetSideSetElementList(int* s)
{
  FREE(this->SideSetElementList);

  this->SideSetElementList = s;
}
void svtkModelMetadata::SetSideSetSideList(int* s)
{
  FREE(this->SideSetSideList);

  this->SideSetSideList = s;
}
void svtkModelMetadata::SetSideSetNumDFPerSide(int* s)
{
  FREE(this->SideSetNumDFPerSide);

  this->SideSetNumDFPerSide = s;
}
int svtkModelMetadata::SetSideSetNumberOfDistributionFactors(int* df)
{
...
void svtkModelMetadata::SetSideSetDistributionFactors(float* d)
{
...
int svtkModelMetadata::SetSideSetSize(int* size)
{
...
int svtkModelMetadata::BuildSideSetDistributionFactorIndex()
{
...
void svtkModelMetadata::SetBlockPropertyNames(int nprop, char** nms)
{
  int i;
...
void svtkModelMetadata::SetBlockPropertyValue(int* v)
{
  FREE(this->BlockPropertyValue);

  this->BlockPropertyValue = v;
}
void svtkModelMetadata::SetNodeSetPropertyNames(int nprops, char** nms)
{
  int i;
...
void svtkModelMetadata::SetNodeSetPropertyValue(int* v)
{
  FREE(this->NodeSetPropertyValue);

  this->NodeSetPropertyValue = v;
}
void svtkModelMetadata::SetSideSetPropertyNames(int nprops, char** nms)
{
  int i;
...
void svtkModelMetadata::SetSideSetPropertyValue(int* v)
{
...
void svtkModelMetadata::SetGlobalVariableNames(int num, char** n)
{
  int i;
...
void svtkModelMetadata::SetGlobalVariableValue(float* f)
{
...
int svtkModelMetadata::FindNameOnList(char* name, char** list, int listLen)
{
  int found = -1;
...
void svtkModelMetadata::SetOriginalElementVariableNames(int nvars, char** names)
{
  this->FreeOriginalElementVariableNames();
...
void svtkModelMetadata::SetElementVariableNames(int nvars, char** names)
{
  this->FreeUsedElementVariableNames();
...
void svtkModelMetadata::SetElementVariableNumberOfComponents(int* comp)
{
  FREE(this->ElementVariableNumberOfComponents);
  this->ElementVariableNumberOfComponents = comp;
}
void svtkModelMetadata::SetMapToOriginalElementVariableNames(int* map)
{
  FREE(this->MapToOriginalElementVariableNames);
  this->MapToOriginalElementVariableNames = map;
}

void svtkModelMetadata::SetElementVariableInfo(
...
void svtkModelMetadata::SetElementVariableTruthTable(int* n)
{
...
void svtkModelMetadata::SetOriginalNodeVariableNames(int nvars, char** names)
{
  this->FreeOriginalNodeVariableNames();
...
void svtkModelMetadata::SetNodeVariableNames(int nvars, char** names)
{
  this->FreeUsedNodeVariableNames();
...
void svtkModelMetadata::SetNodeVariableNumberOfComponents(int* comp)
{
  FREE(this->NodeVariableNumberOfComponents);
  this->NodeVariableNumberOfComponents = comp;
}
void svtkModelMetadata::SetMapToOriginalNodeVariableNames(int* map)
{
  FREE(this->MapToOriginalNodeVariableNames);
  this->MapToOriginalNodeVariableNames = map;
}

void svtkModelMetadata::SetNodeVariableInfo(
  int numOrigNames, char** origNames, int numNames, char** names, int* numComp, int* map)
{
...
void svtkModelMetadata::ShowFloats(const char* what, int num, float* f)
{
  if (num < 1)
    return;
  if (!f)
...
void svtkModelMetadata::ShowLines(const char* what, int num, char** l)
{
  if (num < 1)
    return;
  if (!l)
...
void svtkModelMetadata::ShowIntArray(const char* what, int numx, int numy, int* id)
{
  if (numx < 1)
    return;
  if (numy < 1)
...
void svtkModelMetadata::ShowInts(const char* what, int num, int* id)
{
  if (num < 1)
    return;
  if (!id)
...
void svtkModelMetadata::ShowListsOfInts(
...
void svtkModelMetadata::ShowListsOfFloats(
...
void svtkModelMetadata::PrintLocalInformation()
{
  int verbose = 0;
...
void svtkModelMetadata::PrintGlobalInformation()
{
  int i, j;
...
int svtkModelMetadata::CalculateMaximumLengths(int& maxString, int& maxLine)
{
  int i;
  maxLine = 0;
  maxString = 0;
...
void svtkModelMetadata::PrintSelf(ostream& os, svtkIndent indent)
{
  int i;
