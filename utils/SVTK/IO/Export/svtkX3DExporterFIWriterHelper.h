/*=========================================================================
  ...
  Module:    svtkX3DExporterFIWriterHelper.h
...
=========================================================================*/
/**
 * @class   svtkX3DExporterFIWriterHelper
 *
 */

#ifndef svtkX3DExporterFIWriterHelper_h
#define svtkX3DExporterFIWriterHelper_h

//#include "svtkX3DExporterFIByteWriter.h"
...
public:
  ...
  template <typename T>
  static inline void EncodeFloatFI(svtkX3DExporterFIByteWriter* writer, T* value, size_t size)
  {
  ...
  template <typename T>
  static inline void EncodeIntegerFI(svtkX3DExporterFIByteWriter* writer, T* value, size_t size)
  {
    // We want to start at position 3
    assert(writer->CurrentBytePos == 2);
  ...
  static inline void EncodeCharacterString3(
    svtkX3DExporterFIByteWriter* writer, const std::string& value)
  {
    // We want to start at position 3
    assert(writer->CurrentBytePos == 2);
  ...
  static inline void EncodeInteger3(svtkX3DExporterFIByteWriter* writer, unsigned int value)
  {
    // We want to start at position 3
    assert(writer->CurrentBytePos == 2);
  ...
  static inline void EncodeInteger2(svtkX3DExporterFIByteWriter* writer, unsigned int value)
  {
  ...
  static inline void EncodeLineFeed(svtkX3DExporterFIByteWriter* writer)
  {
...
public:
  template <typename T>
  static inline void EncodeIntegerDeltaZ(svtkX3DExporterFIByteWriter* writer, T* value, size_t size,
    svtkZLibDataCompressor* compressor, bool image = false)
  {
    // We want to start at position 3
    assert(writer->CurrentBytePos == 2);
    ...
    if (image)
    {
      ...
      for (i = 0; i < size; i++)
      {
        ...
        f = svtkX3DExporterFIWriterHelper::ReverseBytes(vp);
    ...
    else
    {
      ...
      for (i = span; i < size; i++)
      {
        ...
        f = svtkX3DExporterFIWriterHelper::ReverseBytes(&v);
    ...
    int size32_reversed = svtkX3DExporterFIWriterHelper::ReverseBytes(&size32);
    ...
    svtkX3DExporterFIWriterHelper::EncodeNonEmptyByteString5(writer, bytes);
    if (image)
    {
  ...
  static inline void EncodeQuantizedzlibFloatArray(svtkX3DExporterFIByteWriter* writer,
    const double* value, size_t size, svtkZLibDataCompressor* compressor)
  {
    // We want to start at position 3
    assert(writer->CurrentBytePos == 2);
    ...
    for (i = 0; i < size; i++)
    {
      ...
      // svtkGenericWarningMacro(<< "value: " << v << " bytes: " << (int)s[0] << " " << (int)s[1] <<
      // " " << (int)s[2] << " " << (int)s[3]);
      *bytepos++ = v.ub[3];
      *bytepos++ = v.ub[2];
      *bytepos++ = v.ub[1];
    ...
    int length_reversed = svtkX3DExporterFIWriterHelper::ReverseBytes(&length);
    ...
    int numFloats_reversed = svtkX3DExporterFIWriterHelper::ReverseBytes(&numFloats);
    ...
    svtkX3DExporterFIWriterHelper::EncodeNonEmptyByteString5(writer, bytesCompressed);
    delete[] buffer;
    delete[] bytes;
  }
};
...
#endif
// SVTK-HeaderTest-Exclude: svtkX3DExporterFIWriterHelper.h
