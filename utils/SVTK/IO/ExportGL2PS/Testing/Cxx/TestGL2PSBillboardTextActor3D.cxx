...
namespace svtkTestGL2PSBillboardTextActor3D
{
...
} // end namespace svtkTestGL2PSBillboardTextActor3D

//----------------------------------------------------------------------------
int TestGL2PSBillboardTextActor3D(int, char*[])
{
  using namespace svtkTestGL2PSBillboardTextActor3D;
  ...
  std::string fileprefix =
    svtkTestingInteractor::TempDirectory + std::string("/TestGL2PSBillboardTextActor3D");
