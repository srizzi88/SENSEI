...
svtkAbstractObjectFactoryNewMacro(svtkGL2PSExporter);
svtkCxxSetObjectMacro(svtkGL2PSExporter, RasterExclusions, svtkPropCollection);

svtkGL2PSExporter::svtkGL2PSExporter()
{
...
int svtkGL2PSExporter::GetGL2PSOptions()
{
...
int svtkGL2PSExporter::GetGL2PSSort()
{
  switch (this->Sort)
  {
    default:
      svtkDebugMacro(<< "Invalid sort settings, using NO_SORT.");
      SVTK_FALLTHROUGH;
    case NO_SORT:
...
int svtkGL2PSExporter::GetGL2PSFormat()
{
  switch (this->FileFormat)
  {
    default:
      svtkDebugMacro(<< "Invalid output format. Using postscript.");
      SVTK_FALLTHROUGH;
    case PS_FILE:
      return GL2PS_PS;
    case EPS_FILE:
...
const char* svtkGL2PSExporter::GetFileExtension()
{
  switch (this->FileFormat)
  {
    default:
...
void svtkGL2PSExporter::PrintSelf(ostream& os, svtkIndent indent)
{
