...
=========================================================================*/
/**
 * @class   svtkGL2PSExporter
 * @brief   export a scene as a PostScript file using GL2PS.
 *
 * svtkGL2PSExporter is a concrete subclass of svtkExporter that writes
 ...
 *
 * By default svtkGL2PSExporter generates Encapsulated PostScript (EPS)
...
#ifndef svtkGL2PSExporter_h
#define svtkGL2PSExporter_h
...
class SVTKIOEXPORTGL2PS_EXPORT svtkGL2PSExporter : public svtkExporter
{
public:
  static svtkGL2PSExporter* New();
  svtkTypeMacro(svtkGL2PSExporter, svtkExporter);
   ...
   */
  svtkSetMacro(BufferSize, int);
  svtkGetMacro(BufferSize, int);
  //@}

  //@{
  /**
   * Set the title for the output, if supported. If nullptr, "SVTK GL2PS Export" is
   * used.
   */
   ...
   */
  svtkSetClampMacro(FileFormat, int, PS_FILE, SVG_FILE);
  svtkGetMacro(FileFormat, int);
   ...
   */
  svtkSetClampMacro(Sort, int, NO_SORT, BSP_SORT);
   ...
   */
  svtkSetMacro(Compress, svtkTypeBool);
  svtkGetMacro(Compress, svtkTypeBool);
  svtkBooleanMacro(Compress, svtkTypeBool);
  //@}
   ...
   * on.
   */
  svtkSetMacro(SimpleLineOffset, svtkTypeBool);
  svtkGetMacro(SimpleLineOffset, svtkTypeBool);
  svtkBooleanMacro(SimpleLineOffset, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(Silent, svtkTypeBool);
  svtkGetMacro(Silent, svtkTypeBool);
  svtkBooleanMacro(Silent, svtkTypeBool);
  //@}
   ...
   * on.
   */
  svtkSetMacro(BestRoot, svtkTypeBool);
  svtkGetMacro(BestRoot, svtkTypeBool);
  svtkBooleanMacro(BestRoot, svtkTypeBool);
  //@}
   ...
   * suppressed.
   */
  svtkSetMacro(Text, svtkTypeBool);
  svtkGetMacro(Text, svtkTypeBool);
  svtkBooleanMacro(Text, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(Landscape, svtkTypeBool);
  svtkGetMacro(Landscape, svtkTypeBool);
  svtkBooleanMacro(Landscape, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(PS3Shading, svtkTypeBool);
  svtkGetMacro(PS3Shading, svtkTypeBool);
  svtkBooleanMacro(PS3Shading, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(OcclusionCull, svtkTypeBool);
  svtkGetMacro(OcclusionCull, svtkTypeBool);
  svtkBooleanMacro(OcclusionCull, svtkTypeBool);
  //@}
   ...
   * 3D props (excluding svtkTextActor3D) are rasterized into the background.
   */
  svtkSetMacro(Write3DPropsAsRasterImage, svtkTypeBool);
  svtkGetMacro(Write3DPropsAsRasterImage, svtkTypeBool);
  svtkBooleanMacro(Write3DPropsAsRasterImage, svtkTypeBool);
  //@}
   ...
   */
  void SetRasterExclusions(svtkPropCollection*);
  svtkGetObjectMacro(RasterExclusions, svtkPropCollection);
  //@}
  ...
  svtkGetMacro(PointSizeFactor, float);
  //@}
  ...
  svtkGetMacro(LineWidthFactor, float);
  //@}

protected:
  svtkGL2PSExporter();
  ~svtkGL2PSExporter() override;
  ...
  svtkPropCollection* RasterExclusions;
  ...
  int BufferSize;
  int Sort;
  svtkTypeBool Compress;
  svtkTypeBool DrawBackground;
  svtkTypeBool SimpleLineOffset;
  svtkTypeBool Silent;
  svtkTypeBool BestRoot;
  svtkTypeBool Text;
  svtkTypeBool Landscape;
  svtkTypeBool PS3Shading;
  svtkTypeBool OcclusionCull;
  svtkTypeBool Write3DPropsAsRasterImage;
  bool TextAsPath;
  float PointSizeFactor;
  float LineWidthFactor;

private:
  svtkGL2PSExporter(const svtkGL2PSExporter&) = delete;
  void operator=(const svtkGL2PSExporter&) = delete;
};

inline const char* svtkGL2PSExporter::GetSortAsString(void)
{
...
inline const char* svtkGL2PSExporter::GetFileFormatAsString(void)
{
