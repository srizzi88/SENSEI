...
//----------------------------------------------------------------------------
class ContextPDFTest : public svtkContextItem
{
  void SetSpritePoint(int x, int y, svtkImageData* sprite);

public:
  static ContextPDFTest* New();
  svtkTypeMacro(ContextPDFTest, svtkContextItem);
...
int TestPDFContextExport(int, char*[])
{
  ...
  std::string filename =
    svtkTestingInteractor::TempDirectory + std::string("/TestPDFContextExport.pdf");
...
svtkStandardNewMacro(ContextPDFTest);
// This function aims to test the primitives provided by the 2D API.
bool ContextPDFTest::Paint(svtkContext2D* painter)
{
...
//------------------------------------------------------------------------------
void ContextPDFTest::SetSpritePoint(int x, int y, svtkImageData* sprite)
{
