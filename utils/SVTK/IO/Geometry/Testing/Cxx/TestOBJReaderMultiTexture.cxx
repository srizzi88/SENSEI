...
{
  // Create the reader.
  char* fname = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/obj_multitexture.obj");
  ...
  svtkDataArray* texture0 = data->GetPointData()->GetArray("texture_0");
  svtkDataArray* texture1 = data->GetPointData()->GetArray("texture_1");
