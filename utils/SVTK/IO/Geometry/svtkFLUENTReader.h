...
=========================================================================*/
/**
 * @class   svtkFLUENTReader
 * @brief   reads a dataset in Fluent file format
 *
 * svtkFLUENTReader creates an unstructured grid dataset. It reads .cas and
...
#ifndef svtkFLUENTReader_h
#define svtkFLUENTReader_h
...
class SVTKIOGEOMETRY_EXPORT svtkFLUENTReader : public svtkMultiBlockDataSetAlgorithm
{
public:
  static svtkFLUENTReader* New();
  svtkTypeMacro(svtkFLUENTReader, svtkMultiBlockDataSetAlgorithm);
   ...
   */
  svtkGetMacro(NumberOfCells, svtkIdType);
  //@}
...
protected:
  ...
  virtual bool ParallelCheckCell(int svtkNotUsed(i)) { return true; }
...
private:
  svtkFLUENTReader(const svtkFLUENTReader&) = delete;
  void operator=(const svtkFLUENTReader&) = delete;
};
#endif
