 ...
 *
 * svtkGLTFUtils is a helper namespace that contains various functions to help
...
#ifndef svtkGLTFUtils_h
#define svtkGLTFUtils_h
...
bool ExtractGLBFileInformation(const std::string& fileName, std::string& magic, uint32_t& version,
  uint32_t& fileLength, std::vector<svtkGLTFUtils::ChunkInfoType>& chunkInfo);
...
// SVTK-HeaderTest-Exclude: svtkGLTFUtils.h
