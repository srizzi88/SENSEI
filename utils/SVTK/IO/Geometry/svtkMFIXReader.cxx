...
svtkStandardNewMacro(svtkMFIXReader);

//----------------------------------------------------------------------------
svtkMFIXReader::svtkMFIXReader()
{
  ...
  this->MakeMeshFlag = 0;
  this->Minimum = svtkFloatArray::New();
  this->Maximum = svtkFloatArray::New();
  this->VectorLength = svtkIntArray::New();
  ...
  this->Mesh = svtkUnstructuredGrid::New();
  this->AHexahedron = svtkHexahedron::New();
  this->AQuad = svtkQuad::New();
  this->AWedge = svtkWedge::New();
  this->NMax = svtkIntArray::New();
  this->C = svtkDoubleArray::New();
  this->Dx = svtkDoubleArray::New();
  this->Dy = svtkDoubleArray::New();
  this->Dz = svtkDoubleArray::New();
  this->TempI = svtkIntArray::New();
  this->TempD = svtkDoubleArray::New();
  this->Flag = svtkIntArray::New();
  this->VariableNames = svtkStringArray::New();
  this->VariableComponents = svtkIntArray::New();
  this->VariableIndexToSPX = svtkIntArray::New();
  this->VariableTimesteps = svtkIntArray::New();
  this->VariableTimestepTable = svtkIntArray::New();
  this->SPXToNVarTable = svtkIntArray::New();
  this->VariableToSkipTable = svtkIntArray::New();
  this->SpxFileExists = svtkIntArray::New();
  this->SetNumberOfInputPorts(0);
  this->SPXTimestepIndexTable = svtkIntArray::New();
...
//----------------------------------------------------------------------------
int svtkMFIXReader::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  svtkDebugMacro(<< "Reading MFIX file");
...
//----------------------------------------------------------------------------
void svtkMFIXReader::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::MakeMesh(svtkUnstructuredGrid* output)
{
  output->Allocate();
  ...
  if (this->MakeMeshFlag == 0)
  {
    ...
    this->CellDataArray = new svtkFloatArray*[this->VariableNames->GetMaxId() + 2];
    for (int j = 0; j <= this->VariableNames->GetMaxId(); j++)
    {
      this->CellDataArray[j] = svtkFloatArray::New();
...
//----------------------------------------------------------------------------
int svtkMFIXReader::RequestInformation(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
...
//----------------------------------------------------------------------------
int svtkMFIXReader::GetNumberOfCellArrays()
{
  return this->CellDataArraySelection->GetNumberOfArrays();
}

//----------------------------------------------------------------------------
const char* svtkMFIXReader::GetCellArrayName(int index)
{
  return this->CellDataArraySelection->GetArrayName(index);
}

//----------------------------------------------------------------------------
int svtkMFIXReader::GetCellArrayStatus(const char* name)
{
  return this->CellDataArraySelection->ArrayIsEnabled(name);
}

//----------------------------------------------------------------------------
void svtkMFIXReader::SetCellArrayStatus(const char* name, int status)
{
  if (status)
  {
...
//----------------------------------------------------------------------------
void svtkMFIXReader::DisableAllCellArrays()
{
  this->CellDataArraySelection->DisableAllArrays();
}

//----------------------------------------------------------------------------
void svtkMFIXReader::EnableAllCellArrays()
{
  this->CellDataArraySelection->EnableAllArrays();
}

//----------------------------------------------------------------------------
void svtkMFIXReader::GetCellDataRange(int cellComp, float* min, float* max)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::SetProjectName(const char* infile)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::RestartVersionNumber(const char* buffer)
{
  char s1[512];
  char s2[512];
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetInt(istream& in, int& val)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::SwapInt(int& value)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::SwapDouble(double& value)
{
  union Swap {
    double valDouble;
...
//----------------------------------------------------------------------------
void svtkMFIXReader::SwapFloat(float& value)
{
  union Swap {
    float valFloat;
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetDouble(istream& in, double& val)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::SkipBytes(istream& in, int n)
{
  in.read(this->DataBuffer, n); // maybe seekg instead
}

//----------------------------------------------------------------------------
void svtkMFIXReader::GetBlockOfDoubles(istream& in, svtkDoubleArray* v, int n)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetBlockOfInts(istream& in, svtkIntArray* v, int n)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetBlockOfFloats(istream& in, svtkFloatArray* v, int n)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::ReadRestartFile()
{
  int dimensionUsr = 5;

#ifdef _WIN32
  svtksys::ifstream in(this->FileName, ios::binary);
#else
...
//----------------------------------------------------------------------------
void svtkMFIXReader::CreateVariableNames()
{
...
#ifdef _WIN32
    svtksys::ifstream in(fileName, ios::binary);
#else
    svtksys::ifstream in(fileName);
#endif
    if (in) // file exists
    {
      ...
      switch (i + 1)
      {
        ...
        case 11:
          ...
          break;
        default:
          svtkWarningMacro(<< "unknown SPx file : " << i << "\n");
          break;
      }
    }
    else
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetTimeSteps()
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::MakeTimeStepTable(int numberOfVariables)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetVariableAtTimestep(int vari, int tstep, svtkFloatArray* v)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::MakeSPXTimeStepIndexTable(int nvars)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::CalculateMaxTimeStep()
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetNumberOfVariablesInSPXFiles()
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::FillVectorVariable(int xindex, int yindex, int zindex, svtkFloatArray* v)
{
...
//----------------------------------------------------------------------------
void svtkMFIXReader::ConvertVectorFromCylindricalToCartesian(int xindex, int zindex)
{
  int count = 0;
  double radius = 0.0;
  double y = 0.0;
...
//----------------------------------------------------------------------------
void svtkMFIXReader::GetAllTimes(svtkInformationVector* outputVector)
{
  int max = 0;
  int maxVar = 0;
...
#ifdef _WIN32
  svtksys::ifstream tfile(fileName, ios::binary);
#else
  svtksys::ifstream tfile(fileName);
#endif
  ...
  svtkInformation* outInfo = outputVector->GetInformationObject(0);
  outInfo->Set(svtkStreamingDemandDrivenPipeline::TIME_STEPS(), steps, this->NumberOfTimeSteps);
  double timeRange[2];
  timeRange[0] = steps[0];
