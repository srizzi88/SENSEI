...
=========================================================================*/
/**
 * @class svtkH5PartReader
 * @brief Read H5Part particle files
 *
 * svtkH5PartReader reads compatible with H5Part : documented here
...
#ifndef svtkH5PartReader_h
#define svtkH5PartReader_h

#include "svtkIOH5partModule.h" // for export macro
...
struct H5PartFile;
class SVTKIOH5PART_EXPORT svtkH5PartReader : public svtkPolyDataAlgorithm
{
public:
  static svtkH5PartReader* New();
  svtkTypeMacro(svtkH5PartReader, svtkPolyDataAlgorithm);
   ...
   */
  svtkGetStringMacro(Xarray);
  svtkSetStringMacro(Xarray);
  //@}
   ...
   */
  svtkGetStringMacro(Yarray);
  svtkSetStringMacro(Yarray);
  //@}
   ...
   */
  svtkGetStringMacro(Zarray);
  svtkSetStringMacro(Zarray);
  //@}
   ...
   * svtkPointSpriteMapper does not require them.
   * When using ParaView, cell generation is recommended, without them
   * many filter operations are unavailable
   */
  svtkSetMacro(GenerateVertexCells, int);
  svtkGetMacro(GenerateVertexCells, int);
  svtkBooleanMacro(GenerateVertexCells, int);
  //@}
   ...
   */
  svtkSetMacro(CombineVectorComponents, int);
  svtkGetMacro(CombineVectorComponents, int);
  svtkBooleanMacro(CombineVectorComponents, int);
  //@}
   ...
   */
  svtkSetMacro(MaskOutOfTimeRangeOutput, int);
  svtkGetMacro(MaskOutOfTimeRangeOutput, int);
  svtkBooleanMacro(MaskOutOfTimeRangeOutput, int);
  //@}
...
protected:
  svtkH5PartReader();
  ~svtkH5PartReader() override;
  //
  int RequestInformation(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;
  int RequestData(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;
  int OpenFile();
  void CloseFile();
  //  void  CopyIntoCoords(int offset, svtkDataArray *source, svtkDataArray *dest);
  ...
  H5PartFile* H5FileId;
  svtkTimeStamp FileModifiedTime;
  svtkTimeStamp FileOpenedTime;
...
private:
  svtkH5PartReader(const svtkH5PartReader&) = delete;
  void operator=(const svtkH5PartReader&) = delete;
};
