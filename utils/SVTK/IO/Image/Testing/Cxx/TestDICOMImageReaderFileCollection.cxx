...
=========================================================================*/
// .NAME Test of svtkDICOMImageReader
// .SECTION Description
//
...
int TestDICOMImageReaderFileCollection(int argc, char* argv[])
{
  ...
  char* dirName = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/dicom/collection");
  std::string directoryName = dirName;
  delete[] dirName;

  svtkSmartPointer<svtkDICOMImageReader> DICOMReader = svtkSmartPointer<svtkDICOMImageReader>::New();
