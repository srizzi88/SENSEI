...
static void TestDisplay(svtkRenderWindow* renwin, const char* infile, const char* tempDir)
{
  std::string outpath = tempDir;
  outpath += "/";
  outpath += "avg152T1_RL_nifti2.nii.gz";

  svtkNew<svtkNIFTIImageReader> reader1;
  ...
  svtkNIFTIImageHeader* header = reader->GetNIFTIHeader();
