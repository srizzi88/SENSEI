...
writerObjects = list()
writerObjectTypes = ["svtk.svtkTIFFWriter()", "svtk.svtkBMPWriter()",
  "svtk.svtkPNMWriter()", "svtk.svtkPostScriptWriter()",
  "svtk.svtkPNGWriter()", "svtk.svtkJPEGWriter()" ]
idx = 0
for fn in filenames:
