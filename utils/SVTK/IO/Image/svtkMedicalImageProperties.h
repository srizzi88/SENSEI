/*=========================================================================
  ...
  Module:    svtkMedicalImageProperties.h
 ...
 *
 * svtkMedicalImageProperties is a helper class that can be used by medical
...
#ifndef svtkMedicalImageProperties_h
#define svtkMedicalImageProperties_h
...
class SVTKIOIMAGE_EXPORT svtkMedicalImageProperties : public svtkObject
{
public:
  static svtkMedicalImageProperties* New();
  svtkTypeMacro(svtkMedicalImageProperties, svtkObject);
   ...
   */
  svtkSetStringMacro(PatientName);
   ...
   */
  svtkSetStringMacro(PatientAge);
  svtkGetStringMacro(PatientAge);
  //@}
   ...
   */
  svtkSetStringMacro(PatientSex);
  svtkGetStringMacro(PatientSex);
  //@}
   ...
   */
  svtkSetStringMacro(PatientBirthDate);
  svtkGetStringMacro(PatientBirthDate);
  //@}
   ...
   */
  svtkSetStringMacro(StudyDate);
  svtkGetStringMacro(StudyDate);
  //@}
   ...
   */
  svtkSetStringMacro(AcquisitionDate);
  svtkGetStringMacro(AcquisitionDate);
  //@}
   ...
   */
  svtkSetStringMacro(StudyTime);
  svtkGetStringMacro(StudyTime);
  //@}
   ...
   */
  svtkSetStringMacro(AcquisitionTime);
  svtkGetStringMacro(AcquisitionTime);
  //@}
   ...
   */
  svtkSetStringMacro(ImageDate);
  svtkGetStringMacro(ImageDate);
  //@}
   ...
   */
  svtkSetStringMacro(ImageTime);
  svtkGetStringMacro(ImageTime);
  //@}
   ...
   */
  svtkSetStringMacro(ImageNumber);
   ...
   */
  svtkSetStringMacro(SeriesNumber);
  svtkGetStringMacro(SeriesNumber);
  //@}
   ...
   */
  svtkSetStringMacro(SeriesDescription);
  svtkGetStringMacro(SeriesDescription);
  //@}
   ...
   */
  svtkSetStringMacro(StudyDescription);
  svtkGetStringMacro(StudyDescription);
  //@}
   ...
   */
  svtkSetStringMacro(Manufacturer);
  svtkGetStringMacro(Manufacturer);
  //@}
   ...
   */
  svtkSetStringMacro(ManufacturerModelName);
  svtkGetStringMacro(ManufacturerModelName);
  //@}
   ...
   */
  svtkSetStringMacro(StationName);
  svtkGetStringMacro(StationName);
  //@}
   ...
   */
  svtkSetStringMacro(InstitutionName);
  svtkGetStringMacro(InstitutionName);
  //@}
   ...
   */
  svtkSetStringMacro(ConvolutionKernel);
  svtkGetStringMacro(ConvolutionKernel);
  //@}
   ...
   */
  svtkSetStringMacro(SliceThickness);
  svtkGetStringMacro(SliceThickness);
   ...
   */
  svtkSetStringMacro(KVP);
  svtkGetStringMacro(KVP);
  //@}
   ...
   */
  svtkSetStringMacro(GantryTilt);
  svtkGetStringMacro(GantryTilt);
   ...
   */
  svtkSetStringMacro(EchoTime);
  svtkGetStringMacro(EchoTime);
  //@}
   ...
   */
  svtkSetStringMacro(EchoTrainLength);
  svtkGetStringMacro(EchoTrainLength);
  //@}
   ...
   */
  svtkSetStringMacro(RepetitionTime);
  svtkGetStringMacro(RepetitionTime);
  //@}
   ...
   */
  svtkSetStringMacro(ExposureTime);
  svtkGetStringMacro(ExposureTime);
  //@}
   ...
   */
  svtkSetStringMacro(XRayTubeCurrent);
  svtkGetStringMacro(XRayTubeCurrent);
  //@}
   ...
   */
  svtkSetStringMacro(Exposure);
  svtkGetStringMacro(Exposure);
  //@}
   ...
   */
  svtkSetVector6Macro(DirectionCosine, double);
  svtkGetVector6Macro(DirectionCosine, double);
  //@}
  ...
  virtual double* GetNthWindowLevelPreset(int idx) SVTK_SIZEHINT(2);
   ...
   * a slice index in a svtkImageData volume we can backtrack and find out
   ...
   */
  virtual void DeepCopy(svtkMedicalImageProperties* p);

protected:
  svtkMedicalImageProperties();
  ~svtkMedicalImageProperties() override;
   ...
   */
  svtkMedicalImagePropertiesInternals* Internals;

private:
  svtkMedicalImageProperties(const svtkMedicalImageProperties&) = delete;
  void operator=(const svtkMedicalImageProperties&) = delete;
};
