 ...
 *
 * @sa
 * svtkImageWriter svtkMetaImageReader
 */

#ifndef svtkMetaImageWriter_h
#define svtkMetaImageWriter_h
...
class SVTKIOIMAGE_EXPORT svtkMetaImageWriter : public svtkImageWriter
{
public:
  svtkTypeMacro(svtkMetaImageWriter, svtkImageWriter);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Construct object with FlipNormals turned off and Normals set to true.
   */
  static svtkMetaImageWriter* New();
...
protected:
  svtkMetaImageWriter();
  ~svtkMetaImageWriter() override;

  svtkSetStringMacro(MHDFileName);
  char* MHDFileName;
  bool Compress;

private:
  svtkMetaImageWriter(const svtkMetaImageWriter&) = delete;
  void operator=(const svtkMetaImageWriter&) = delete;
