...
Module:    svtkNIFTIImageHeader.cxx
...
svtkStandardNewMacro(svtkNIFTIImageHeader);
...
double svtkNIFTINormalizeFloat(double d)
{
  return (fabs(d) < FLT_MIN ? 0.0 : d);
}

double svtkNIFTINormalizeDouble(double d)
{
...
//----------------------------------------------------------------------------
svtkNIFTIImageHeader::svtkNIFTIImageHeader()
{
  this->Initialize();
}

//----------------------------------------------------------------------------
svtkNIFTIImageHeader::~svtkNIFTIImageHeader() = default;

//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::Initialize()
{
...
//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::SetHeader(const nifti_1_header* hdr)
{
  ...
  this->VoxOffset = static_cast<svtkTypeInt64>(hdr->vox_offset);
...
//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::GetHeader(nifti_1_header* hdr)
{
  ...
  hdr->intent_p1 = svtkNIFTINormalizeFloat(this->IntentP1);
  hdr->intent_p2 = svtkNIFTINormalizeFloat(this->IntentP2);
  hdr->intent_p3 = svtkNIFTINormalizeFloat(this->IntentP3);
  ...
  for (int i = 0; i < 8; i++)
  {
    ...
    hdr->pixdim[i] = svtkNIFTINormalizeFloat(this->PixDim[i]);
  }
  ...
  hdr->scl_slope = svtkNIFTINormalizeFloat(this->SclSlope);
  hdr->scl_inter = svtkNIFTINormalizeFloat(this->SclInter);
  hdr->cal_min = svtkNIFTINormalizeFloat(this->CalMin);
  hdr->cal_max = svtkNIFTINormalizeFloat(this->CalMax);
  hdr->slice_duration = svtkNIFTINormalizeFloat(this->SliceDuration);
  hdr->toffset = svtkNIFTINormalizeFloat(this->TOffset);
  hdr->glmax = 0;
  hdr->glmin = 0;
  ...
  hdr->quatern_b = svtkNIFTINormalizeFloat(this->QuaternB);
  hdr->quatern_c = svtkNIFTINormalizeFloat(this->QuaternC);
  hdr->quatern_d = svtkNIFTINormalizeFloat(this->QuaternD);
  hdr->qoffset_x = svtkNIFTINormalizeFloat(this->QOffsetX);
  hdr->qoffset_y = svtkNIFTINormalizeFloat(this->QOffsetY);
  hdr->qoffset_z = svtkNIFTINormalizeFloat(this->QOffsetZ);
  for (int i = 0; i < 4; i++)
  {
    hdr->srow_x[i] = svtkNIFTINormalizeFloat(this->SRowX[i]);
    hdr->srow_y[i] = svtkNIFTINormalizeFloat(this->SRowY[i]);
    hdr->srow_z[i] = svtkNIFTINormalizeFloat(this->SRowZ[i]);
  }
}

//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::SetHeader(const nifti_2_header* hdr)
{
  memcpy(this->Magic, hdr->magic, sizeof(hdr->magic));
...
//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::GetHeader(nifti_2_header* hdr)
{
  ...
  {
    hdr->dim[i] = static_cast<short>(this->Dim[i]);
    hdr->pixdim[i] = svtkNIFTINormalizeDouble(this->PixDim[i]);
  }
  hdr->intent_p1 = svtkNIFTINormalizeDouble(this->IntentP1);
  hdr->intent_p2 = svtkNIFTINormalizeDouble(this->IntentP2);
  hdr->intent_p3 = svtkNIFTINormalizeDouble(this->IntentP3);
  hdr->vox_offset = this->VoxOffset;
  hdr->scl_slope = svtkNIFTINormalizeDouble(this->SclSlope);
  hdr->scl_inter = svtkNIFTINormalizeDouble(this->SclInter);
  hdr->cal_min = svtkNIFTINormalizeDouble(this->CalMin);
  hdr->cal_max = svtkNIFTINormalizeDouble(this->CalMax);
  hdr->slice_duration = svtkNIFTINormalizeDouble(this->SliceDuration);
  hdr->toffset = svtkNIFTINormalizeDouble(this->TOffset);
  hdr->slice_start = this->SliceStart;
  hdr->slice_end = this->SliceEnd;
  strncpy(hdr->descrip, this->Descrip, sizeof(hdr->descrip) - 1);
  hdr->descrip[sizeof(hdr->descrip) - 1] = '\0';
  ...
  hdr->qform_code = static_cast<short>(this->QFormCode);
  hdr->sform_code = static_cast<short>(this->SFormCode);
  hdr->quatern_b = svtkNIFTINormalizeDouble(this->QuaternB);
  hdr->quatern_c = svtkNIFTINormalizeDouble(this->QuaternC);
  hdr->quatern_d = svtkNIFTINormalizeDouble(this->QuaternD);
  hdr->qoffset_x = svtkNIFTINormalizeDouble(this->QOffsetX);
  hdr->qoffset_y = svtkNIFTINormalizeDouble(this->QOffsetY);
  hdr->qoffset_z = svtkNIFTINormalizeDouble(this->QOffsetZ);
  for (int i = 0; i < 4; i++)
  {
    hdr->srow_x[i] = svtkNIFTINormalizeDouble(this->SRowX[i]);
    hdr->srow_y[i] = svtkNIFTINormalizeDouble(this->SRowY[i]);
    hdr->srow_z[i] = svtkNIFTINormalizeDouble(this->SRowZ[i]);
  }
  hdr->slice_code = this->SliceCode;
  hdr->xyzt_units = this->XYZTUnits;
  hdr->intent_code = static_cast<short>(this->IntentCode);
...
//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::DeepCopy(svtkNIFTIImageHeader* o)
{
  if (o)
  {
    nifti_2_header hdr;
...
//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::SetStringValue(char* x, const char* y, size_t n)
{
  if (y == nullptr)
  {
    y = "";
...
//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::SetIntentName(const char* val)
{
  this->SetStringValue(this->IntentName, val, 16);
}

//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::SetDescrip(const char* val)
{
  this->SetStringValue(this->Descrip, val, 80);
}

//----------------------------------------------------------------------------
void svtkNIFTIImageHeader::SetAuxFile(const char* val)
{
