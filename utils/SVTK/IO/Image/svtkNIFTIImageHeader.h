 ...
 *
 * This class stores the header of a NIfTI file in a SVTK-friendly format.
 * By using this class, it is possible to specify the header information
 * that will be stored in a file written by the svtkNIFTIImageWriter.  Note
 ...
 * because this information must instead be taken from the svtkImageData
 * information.  Finally, note that the svtkNIFTIImageWriter will ignore the
 ...
 * @sa
 * svtkNIFTIImageReader, svtkNIFTIImageWriter
 */

#ifndef svtkNIFTIImageHeader_h
#define svtkNIFTIImageHeader_h
...
//----------------------------------------------------------------------------
class SVTKIOIMAGE_EXPORT svtkNIFTIImageHeader : public svtkObject
{
public:
  /**
   * NIFTI intent codes.
  ...
  /**
   * NIFTI data types.
   * Types RGB24 and RGB32 are represented in SVTK as a multi-component
   ...
   */
  static svtkNIFTIImageHeader* New();
  svtkTypeMacro(svtkNIFTIImageHeader, svtkObject);
  //@}
   ...
   */
  svtkTypeInt64 GetVoxOffset() { return this->VoxOffset; }
   ...
   */
  svtkTypeInt64 GetDim(int i) { return (i < 0 || i > 7 ? 0 : this->Dim[i]); }
   ...
   */
  svtkSetMacro(IntentP1, double);
  double GetIntentP1() { return this->IntentP1; }
  svtkSetMacro(IntentP2, double);
  double GetIntentP2() { return this->IntentP2; }
  svtkSetMacro(IntentP3, double);
   ...
   */
  svtkSetMacro(SclSlope, double);
  double GetSclSlope() { return this->SclSlope; }
  svtkSetMacro(SclInter, double);
   ...
   */
  svtkSetMacro(CalMin, double);
  double GetCalMin() { return this->CalMin; }
  svtkSetMacro(CalMax, double);
   ...
   */
  svtkSetMacro(SliceDuration, double);
  double GetSliceDuration() { return this->SliceDuration; }
  svtkSetMacro(TOffset, double);
   ...
   */
  svtkSetMacro(SliceStart, svtkTypeInt64);
  svtkTypeInt64 GetSliceStart() { return this->SliceStart; }
  svtkSetMacro(SliceEnd, svtkTypeInt64);
  svtkTypeInt64 GetSliceEnd() { return this->SliceEnd; }
  //@}
   ...
   */
  svtkSetMacro(QFormCode, int);
  int GetQFormCode() { return this->QFormCode; }
  svtkSetMacro(SFormCode, int);
   ...
   * the svtkNIFTIImageWriter ignores this part of the header if a quaternion
   * has been set via svtkNIFTIImageWriter::SetQFormMatrix().
   */
  svtkSetMacro(QuaternB, double);
  double GetQuaternB() { return this->QuaternB; }
  svtkSetMacro(QuaternC, double);
  double GetQuaternC() { return this->QuaternC; }
  svtkSetMacro(QuaternD, double);
  double GetQuaternD() { return this->QuaternD; }
  svtkSetMacro(QOffsetX, double);
  double GetQOffsetX() { return this->QOffsetX; }
  svtkSetMacro(QOffsetY, double);
  double GetQOffsetY() { return this->QOffsetY; }
  svtkSetMacro(QOffsetZ, double);
   ...
   * the svtkNIFTIImageWriter ignores this part of the header if a matrix
   * has been set via svtkNIFTIImageWriter::SetSFormMatrix().
   */
  svtkSetVector4Macro(SRowX, double);
  svtkGetVector4Macro(SRowX, double);
  svtkSetVector4Macro(SRowY, double);
  svtkGetVector4Macro(SRowY, double);
  svtkSetVector4Macro(SRowZ, double);
  svtkGetVector4Macro(SRowZ, double);
  //@}
   ...
   */
  void DeepCopy(svtkNIFTIImageHeader* o);
...
protected:
  svtkNIFTIImageHeader();
  ~svtkNIFTIImageHeader() override;

  char Magic[12];
  svtkTypeInt64 VoxOffset;
  int DataType;
  int BitPix;
  svtkTypeInt64 Dim[8];
  double PixDim[8];
  ...
  double TOffset;
  svtkTypeInt64 SliceStart;
  svtkTypeInt64 SliceEnd;
  int SliceCode;
  int XYZTUnits;
  int DimInfo;
  char Descrip[82];
...
private:
  svtkNIFTIImageHeader(const svtkNIFTIImageHeader&) = delete;
  void operator=(const svtkNIFTIImageHeader&) = delete;
};

#endif // svtkNIFTIImageHeader_h
