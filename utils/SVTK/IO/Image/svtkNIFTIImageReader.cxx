/*=========================================================================
  ...
  Module:    svtkNIFTIImageReader.cxx
...
#include "svtkNIFTIImagePrivate.h"
...
svtkStandardNewMacro(svtkNIFTIImageReader);

//----------------------------------------------------------------------------
svtkNIFTIImageReader::svtkNIFTIImageReader()
{
  for (int i = 0; i < 8; i++)
  {
    this->Dim[i] = 0;
...
void svtkNIFTIImageReaderSwapHeader(nifti_1_header* hdr)
{
  // Common to NIFTI and Analyze 7.5
  svtkByteSwap::SwapVoidRange(&hdr->sizeof_hdr, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->extents, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->session_error, 1, 2);
  svtkByteSwap::SwapVoidRange(hdr->dim, 8, 2);
  svtkByteSwap::SwapVoidRange(&hdr->intent_p1, 1, 4);   // unused in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->intent_p2, 1, 4);   // unused in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->intent_p3, 1, 4);   // unused in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->intent_code, 1, 2); // unused in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->datatype, 1, 2);
  svtkByteSwap::SwapVoidRange(&hdr->bitpix, 1, 2);
  svtkByteSwap::SwapVoidRange(&hdr->slice_start, 1, 2); // dim_un0 in 7.5
  svtkByteSwap::SwapVoidRange(hdr->pixdim, 8, 4);
  svtkByteSwap::SwapVoidRange(&hdr->vox_offset, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->scl_slope, 1, 4); // unused in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->scl_inter, 1, 4); // unused in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->slice_end, 1, 2); // unused in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->cal_max, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->cal_min, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->slice_duration, 1, 4); // compressed in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->toffset, 1, 4);        // verified in 7.5
  svtkByteSwap::SwapVoidRange(&hdr->glmax, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->glmin, 1, 4);

  // All NIFTI-specific (meaning is totally different in Analyze 7.5)
  if (strncmp(hdr->magic, "ni1", 4) == 0 || strncmp(hdr->magic, "n+1", 4) == 0)
  {
    svtkByteSwap::SwapVoidRange(&hdr->qform_code, 1, 2);
    svtkByteSwap::SwapVoidRange(&hdr->sform_code, 1, 2);
    svtkByteSwap::SwapVoidRange(&hdr->quatern_b, 1, 4);
    svtkByteSwap::SwapVoidRange(&hdr->quatern_c, 1, 4);
    svtkByteSwap::SwapVoidRange(&hdr->quatern_d, 1, 4);
    svtkByteSwap::SwapVoidRange(&hdr->qoffset_x, 1, 4);
    svtkByteSwap::SwapVoidRange(&hdr->qoffset_y, 1, 4);
    svtkByteSwap::SwapVoidRange(&hdr->qoffset_z, 1, 4);
    svtkByteSwap::SwapVoidRange(hdr->srow_x, 4, 4);
    svtkByteSwap::SwapVoidRange(hdr->srow_y, 4, 4);
    svtkByteSwap::SwapVoidRange(hdr->srow_z, 4, 4);
  }
}

void svtkNIFTIImageReaderSwapHeader(nifti_2_header* hdr)
{
  svtkByteSwap::SwapVoidRange(&hdr->sizeof_hdr, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->datatype, 1, 2);
  svtkByteSwap::SwapVoidRange(&hdr->bitpix, 1, 2);
  svtkByteSwap::SwapVoidRange(hdr->dim, 8, 8);
  svtkByteSwap::SwapVoidRange(&hdr->intent_p1, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->intent_p2, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->intent_p3, 1, 8);
  svtkByteSwap::SwapVoidRange(hdr->pixdim, 8, 8);
  svtkByteSwap::SwapVoidRange(&hdr->vox_offset, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->scl_slope, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->scl_inter, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->cal_max, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->cal_min, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->slice_duration, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->toffset, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->slice_start, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->slice_end, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->qform_code, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->sform_code, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->quatern_b, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->quatern_c, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->quatern_d, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->qoffset_x, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->qoffset_y, 1, 8);
  svtkByteSwap::SwapVoidRange(&hdr->qoffset_z, 1, 8);
  svtkByteSwap::SwapVoidRange(hdr->srow_x, 4, 8);
  svtkByteSwap::SwapVoidRange(hdr->srow_y, 4, 8);
  svtkByteSwap::SwapVoidRange(hdr->srow_z, 4, 8);
  svtkByteSwap::SwapVoidRange(&hdr->slice_code, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->xyzt_units, 1, 4);
  svtkByteSwap::SwapVoidRange(&hdr->intent_code, 1, 4);
}

} // end anonymous namespace

//----------------------------------------------------------------------------
svtkNIFTIImageHeader* svtkNIFTIImageReader::GetNIFTIHeader()
{
  if (!this->NIFTIHeader)
  {
    this->NIFTIHeader = svtkNIFTIImageHeader::New();
  }
  return this->NIFTIHeader;
}

//----------------------------------------------------------------------------
void svtkNIFTIImageReader::PrintSelf(ostream& os, svtkIndent indent)
{
  ...
  {
    double mat[16];
    svtkMatrix4x4::DeepCopy(mat, this->QFormMatrix);
    for (int i = 0; i < 16; i++)
    {
      os << " " << mat[i];
    }
  ...
  {
    double mat[16];
    svtkMatrix4x4::DeepCopy(mat, this->SFormMatrix);
    for (int i = 0; i < 16; i++)
    {
      os << " " << mat[i];
    }
...
//----------------------------------------------------------------------------
bool svtkNIFTIImageReader::CheckExtension(const char* filename, const char* ext)
{
...
//----------------------------------------------------------------------------
char* svtkNIFTIImageReader::ReplaceExtension(
  const char* filename, const char* ext1, const char* ext2)
{
  ...
  if (strlen(ext1) == 4 && ext1[0] == '.' && strlen(ext2) == 4 && ext2[0] == '.')
  {
    ...
    if (svtkNIFTIImageReader::CheckExtension(filename, ext1))
    {
    ...
    for (int i = 0; i < 2; i++)
    {
      if (svtksys::SystemTools::FileExists(newname))
      {
        return newname;
      }
      if (i == 0)
...
//----------------------------------------------------------------------------
int svtkNIFTIImageReader::CheckNIFTIVersion(const nifti_1_header* hdr)
{
  int version = 0;
...
//----------------------------------------------------------------------------
bool svtkNIFTIImageReader::CheckAnalyzeHeader(const nifti_1_header* hdr)
{
...
//----------------------------------------------------------------------------
int svtkNIFTIImageReader::CanReadFile(const char* filename)
{
  svtkDebugMacro("Opening NIFTI file " << filename);

  char* hdrname = svtkNIFTIImageReader::ReplaceExtension(filename, ".img", ".hdr");
  ...
  bool canRead = false;
  nifti_1_header hdr;
  int hsize = svtkNIFTIImageHeader::NIFTI1HeaderSize; // nifti_1 header size
  int rsize = gzread(file, &hdr, hsize);
  if (rsize == hsize)
  {
    int version = svtkNIFTIImageReader::CheckNIFTIVersion(&hdr);
    if (version > 0)
    {
      // NIFTI file
      canRead = true;
    ...
    {
      // Analyze 7.5 file
      canRead = svtkNIFTIImageReader::CheckAnalyzeHeader(&hdr);
    }
  }
...
//----------------------------------------------------------------------------
int svtkNIFTIImageReader::RequestInformation(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  if (this->FileNames)
  {
    ...
    if (n != 2 || headers != 1)
    {
      svtkErrorMacro("There must be two files and one must be a .hdr file.");
      delete[] hdrname;
      return 0;
    }
  }
  ...
  if (filename == nullptr)
  {
    svtkErrorMacro("A FileName must be provided");
  ...
  if (hdrname == nullptr)
  {
    hdrname = svtkNIFTIImageReader::ReplaceExtension(filename, ".img", ".hdr");
  }

  if (hdrname == nullptr)
  {
    svtkErrorMacro("Unable to locate header for file " << filename);
    this->SetErrorCode(svtkErrorCode::CannotOpenFileError);
    return 0;
  }

  svtkDebugMacro("Opening NIFTI file " << hdrname);
  ...
  if (!file)
  {
    svtkErrorMacro("Cannot open file " << hdrname);
    delete[] hdrname;
    this->SetErrorCode(svtkErrorCode::CannotOpenFileError);
    return 0;
  }
  ...
  const int hsize = svtkNIFTIImageHeader::NIFTI1HeaderSize;
  int rsize = gzread(file, hdr1, hsize);
  if (rsize == hsize)
  {
    niftiVersion = svtkNIFTIImageReader::CheckNIFTIVersion(hdr1);
    if (niftiVersion >= 2)
    {
      // the header was a NIFTIv2 header
      const int h2size = svtkNIFTIImageHeader::NIFTI2HeaderSize;
    ...
    {
      // Analyze 7.5 file
      canRead = svtkNIFTIImageReader::CheckAnalyzeHeader(hdr1);
    }
  }
  ...
  if (canRead)
  {
    if (niftiVersion >= 2)
    {
      ...
      {
        svtkNIFTIImageReaderSwapHeader(hdr2);
    ...
    else
    {
      ...
      {
        svtkNIFTIImageReaderSwapHeader(hdr1);
        isLittleEndian = !isLittleEndian;
      }
  ...
  if (!canRead)
  {
    ...
    svtkErrorMacro(<< message << hdrname);
  ...
  if (ndim < 0 || ndim > 7)
  {
    svtkErrorMacro("NIfTI image has illegal ndim of " << ndim);
  ...
  for (int i = 0; i < 8; i++)
  {
    ...
    {
      svtkErrorMacro("NIfTI image dimension " << i << " is negative");
      this->SetErrorCode(svtkErrorCode::FileFormatError);
      return 0;
    }
    else if ((hdr2->dim[i] & 0x7fffffff) != hdr2->dim[i])
    {
      ...
      svtkErrorMacro("NIfTI image dimension " << i << " is larger than int32");
      this->SetErrorCode(svtkErrorCode::FileFormatError);
      return 0;
    }
  }
  ...
  // map the NIFTI type to a SVTK type and number of components
  static const int typeMap[][3] = { { NIFTI_TYPE_INT8, SVTK_TYPE_INT8, 1 },
    { NIFTI_TYPE_UINT8, SVTK_TYPE_UINT8, 1 }, { NIFTI_TYPE_INT16, SVTK_TYPE_INT16, 1 },
    { NIFTI_TYPE_UINT16, SVTK_TYPE_UINT16, 1 }, { NIFTI_TYPE_INT32, SVTK_TYPE_INT32, 1 },
    { NIFTI_TYPE_UINT32, SVTK_TYPE_UINT32, 1 }, { NIFTI_TYPE_INT64, SVTK_TYPE_INT64, 1 },
    { NIFTI_TYPE_UINT64, SVTK_TYPE_UINT64, 1 }, { NIFTI_TYPE_FLOAT32, SVTK_TYPE_FLOAT32, 1 },
    { NIFTI_TYPE_FLOAT64, SVTK_TYPE_FLOAT64, 1 }, { NIFTI_TYPE_COMPLEX64, SVTK_TYPE_FLOAT32, 2 },
    { NIFTI_TYPE_COMPLEX128, SVTK_TYPE_FLOAT64, 2 }, { NIFTI_TYPE_RGB24, SVTK_TYPE_UINT8, 3 },
    { NIFTI_TYPE_RGBA32, SVTK_TYPE_UINT8, 4 }, { 0, 0, 0 } };
  ...
  if (numComponents == 0)
  {
    svtkErrorMacro("Unrecognized NIFTI data type: " << hdr2->datatype);
    this->SetErrorCode(svtkErrorCode::FileFormatError);
    return 0;
  }
  ...
  //
  // The svtkImageData class does not provide a way of storing image
  // orientation.  So when we read a NIFTI file, we should also provide
  // the user with a 4x4 matrix that can transform SVTK's data coordinates
  ...
  // are stacked in reverse: SVTK will have to reorder the slices in order
  // to maintain a right-handed coordinate transformation between indices
  // and coordinates.
  //
  // Let's call SVTK data coordinates X,Y,Z to distinguish them from
  ...
  //   [ 1 ]   [ 0   0   0   1   ] [ 1 ]
  //
  // where the SVTK data coordinates X,Y,Z are related to the
  // SVTK structured coordinates IJK (i.e. point indices) by:
  //
  ...
  //
  //    I,J,K = i,j,k (i.e. voxel order in SVTK same as in NIFTI)
  //
  //    Spacing[0] = pixdim[1]
  //    Spacing[1] = pixdim[2]
  //    Spacing[2] = pixdim[3]
  ...
  //       slice spacing, which might cause some SVTK algorithms to
  //       misbehave (the SVTK tests only use images with positive spacing).
  //    b) we can use M13 = -R13, M23 = -R23, M33 = -R33 i.e. introduce
  //       a flip into the matrix, which is very bad for SVTK rendering
  //       algorithms and should definitely be avoided.
  //    c) we can reverse the order of the slices in SVTK relative to
  ...
  //
  //       This will give us data that will be well-behaved in SVTK, at
  //       the expense of making SVTK slice numbers not match with
  //       the original NIFTI slice numbers.  NIFTI slice 0 will become
  //       SVTK slice N-1, and the order will be reversed.
  //
  ...
  // desired coordinate transformation from SVTK data coordinates X,Y,Z
  ...
  //
  //       The third choice will provide a SVTK image that has positive
  ...
  if (niftiVersion > 0 && hdr2->qform_code > 0)
  {
    ...
    svtkMath::QuaternionToMatrix3x3(quat, rmat);
    ...
    if (this->QFac < 0)
    {
      // We will be reversing the order of the slices, so the first SVTK
    ...
    this->QFormMatrix = svtkMatrix4x4::New();
  ...
  if (niftiVersion > 0 && hdr2->sform_code > 0)
  {
    ...
    if (svtkMatrix4x4::Determinant(mmat) < 0 && hdr2->qform_code == 0)
    {
      this->QFac = -1.0;
    }
    ...
    this->SFormMatrix = svtkMatrix4x4::New();
    this->SFormMatrix->DeepCopy(mmat);

    if (this->SFormMatrix->Determinant() < 0)
    {
      svtkWarningMacro("SFormMatrix is flipped compared to QFormMatrix");
    }
  }
...
//----------------------------------------------------------------------------
int svtkNIFTIImageReader::RequestData(svtkInformation* request,
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  svtkImageData* data = static_cast<svtkImageData*>(outInfo->Get(svtkDataObject::DATA_OBJECT()));
#if SVTK_MAJOR_VERSION >= 6
  ...
  if (imgname == nullptr)
  {
    imgname = svtkNIFTIImageReader::ReplaceExtension(filename, ".hdr", ".img");
  }

  if (imgname == nullptr)
  {
    svtkErrorMacro("Unable to locate image for file " << filename);
    return 0;
  }

  svtkDebugMacro("Opening NIFTI file " << imgname);
  ...
  svtkIdType planarOffset = 0;
  svtkIdType planarEndOffset = 0;
  if (planarRGB)
  {
  ...
  svtkIdType target =
    static_cast<svtkIdType>(0.02 * planarSize * outSizeY * outSizeZ * vectorDim) + 1;
  svtkIdType count = 0;
  ...
  while (!this->AbortExecute)
  {
    if (offset)
    {
      ...
      if (rval == -1)
      {
        errorCode = svtkErrorCode::FileFormatError;
        if (gzeof(file))
        {
          errorCode = svtkErrorCode::PrematureEndOfFileError;
        }
        break;
      }
    }
    ...
    {
      svtkByteSwap::SwapVoidRange(rowBuffer, rowSize, scalarSize);
    }
      ...
      if (++p == planarSize)
      {
        ...
        if (++k == outSizeZ)
        {
          ...
          if (this->TimeAsVector)
          {
            ...
            // SVTK scalar components) then we have to make sure that
  ...
  if (errorCode)
  {
    ...
    if (errorCode == svtkErrorCode::PrematureEndOfFileError)
    {
      errorText = "NIFTI file is truncated, some data is missing.";
    }
    this->SetErrorCode(errorCode);
    svtkErrorMacro(<< errorText);
    return 0;
  }
