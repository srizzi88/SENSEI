...
svtkStandardNewMacro(svtkPNMWriter);
...
void svtkPNMWriter::WriteFileHeader(ostream* file, svtkImageData* cache, int wExt[6])
{
...
void svtkPNMWriter::WriteFile(ostream* file, svtkImageData* data, int extent[6], int wExtent[6])
{
  int idx0, idx1, idx2;
  ...
  switch (data->GetScalarType())
  {
    case SVTK_UNSIGNED_CHAR:
      ...
      break;
    default:
      svtkErrorMacro("PNMWriter only accepts unsigned char scalars!");
      return;
  }
...
//----------------------------------------------------------------------------
void svtkPNMWriter::PrintSelf(ostream& os, svtkIndent indent)
{
