...
int TestDelimitedTextReader(int argc, char* argv[])
{
  ...
  {
    char* filename = svtkTestUtilities::ExpandDataFileName(argc, argv, testOneFNames[index]);

    svtkDelimitedTextReader* reader = svtkDelimitedTextReader::New();
    ...
    {
      reader->SetUnicodeFieldDelimiters(svtkUnicodeString::from_utf8(":"));
      reader->SetUnicodeStringDelimiters(svtkUnicodeString::from_utf8("\""));
    ...
    reader = svtkDelimitedTextReader::New();
    ...
    filename = svtkTestUtilities::ExpandDataFileName(argc, argv, testTwoFNames[index]);
