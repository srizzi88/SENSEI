 ...
 * @brief   reads an XML file into a svtkTree
 *
 *
 * svtkXMLTreeReader parses an XML file and uses the nesting structure of the
 ...
 * svtkStringArray.  There is an array for each attribute type in the XML file,
...
#ifndef svtkXMLTreeReader_h
#define svtkXMLTreeReader_h

#include "svtkIOInfovisModule.h" // For export macro
#include "svtkTreeAlgorithm.h"

class SVTKIOINFOVIS_EXPORT svtkXMLTreeReader : public svtkTreeAlgorithm
{
public:
  static svtkXMLTreeReader* New();
  svtkTypeMacro(svtkXMLTreeReader, svtkTreeAlgorithm);
   ...
   */
  svtkGetStringMacro(XMLString);
  svtkSetStringMacro(XMLString);
  //@}
  ...
  svtkSetMacro(GenerateVertexPedigreeIds, bool);
  svtkGetMacro(GenerateVertexPedigreeIds, bool);
  svtkBooleanMacro(GenerateVertexPedigreeIds, bool);
  //@}
   ...
   */
  svtkGetMacro(MaskArrays, bool);
  svtkSetMacro(MaskArrays, bool);
  svtkBooleanMacro(MaskArrays, bool);
  //@}
   ...
   * Default is off.
   */
  svtkGetMacro(ReadCharData, bool);
  svtkSetMacro(ReadCharData, bool);
  svtkBooleanMacro(ReadCharData, bool);
  //@}
   ...
   * Default is on.
   */
  svtkGetMacro(ReadTagName, bool);
  svtkSetMacro(ReadTagName, bool);
  svtkBooleanMacro(ReadTagName, bool);
  //@}
...
private:
  svtkXMLTreeReader(const svtkXMLTreeReader&) = delete;
  void operator=(const svtkXMLTreeReader&) = delete;
};
