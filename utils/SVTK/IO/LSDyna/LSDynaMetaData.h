...
public:
  ...
  svtkIdType GetTotalMaterialCount();
  ...
  svtkIdType MaxFileLength; // Maximum size of any file (data too big is split into multiple files)
  ...
  float CodeVersion;
  int Dimensionality;
  svtkIdType CurrentState; // time step
  svtkIdType NumberOfNodes;
  svtkIdType NumberOfCells[LSDynaMetaData::NUM_CELL_TYPES];
  ...
  std::map<std::string, svtkIdType> Dict;
