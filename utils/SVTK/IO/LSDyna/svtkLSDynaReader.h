 ...
 * Because each mesh has its own cell attributes, the svtkLSDynaReader has a
...
#ifndef svtkLSDynaReader_h
#define svtkLSDynaReader_h
...
class svtkLSDynaPartCollection;
class svtkPoints;
class svtkDataArray;
class svtkUnsignedCharArray;
class svtkUnstructuredGrid;

class SVTKIOLSDYNA_EXPORT svtkLSDynaReader : public svtkMultiBlockDataSetAlgorithm
{
public:
  svtkTypeMacro(svtkLSDynaReader, svtkMultiBlockDataSetAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkLSDynaReader* New();

  /**
   * Print out more complete information about the dataset
   * (and less complete information about the SVTK hierarchy) than PrintSelf.
   */
...
#ifdef SVTK_LEGACY_REMOVE
  std::string GetDatabaseDirectory();
#else
  SVTK_LEGACY(const char* GetDatabaseDirectory());
#endif
  int IsDatabaseValid();
  //@}
...
#else
  SVTK_LEGACY(const char* GetFileName());
#endif
  //@}
   ...
   */
  svtkIdType GetNumberOfContinuumCells();
   ...
   * UpdateInformation().
   */
  svtkIdType GetNumberOfSolidCells();
   ...
   * UpdateInformation().
   */
  svtkIdType GetNumberOfThickShellCells();
   ...
   * UpdateInformation().
   */
  svtkIdType GetNumberOfShellCells();
   ...
   * UpdateInformation().
   */
  svtkIdType GetNumberOfRigidBodyCells();
   ...
   * UpdateInformation().
   */
  svtkIdType GetNumberOfRoadSurfaceCells();
   ...
   * UpdateInformation().
   */
  svtkIdType GetNumberOfBeamCells();
   ...
   * UpdateInformation().
   */
  svtkIdType GetNumberOfParticleCells();
   ...
   */
  svtkIdType GetNumberOfTimeSteps();
  virtual void SetTimeStep(svtkIdType);
  svtkIdType GetTimeStep();
  double GetTimeValue(svtkIdType);
   ...
   */
  void SetDeformedMesh(svtkTypeBool);
  svtkGetMacro(DeformedMesh, svtkTypeBool);
  svtkBooleanMacro(DeformedMesh, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(RemoveDeletedCells, svtkTypeBool);
  svtkGetMacro(RemoveDeletedCells, svtkTypeBool);
  svtkBooleanMacro(RemoveDeletedCells, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(DeletedCellsAsGhostArray, svtkTypeBool);
  svtkGetMacro(DeletedCellsAsGhostArray, svtkTypeBool);
  svtkBooleanMacro(DeletedCellsAsGhostArray, svtkTypeBool);
  //@}
   ...
   */
  svtkSetStringMacro(InputDeck);
  svtkGetStringMacro(InputDeck);
  //@}
...
protected:
  ...
  svtkLSDynaPartCollection* Parts;

  /**
   * Should deflected coordinates be used, or should the mesh remain
   * undeflected?  By default, this is true.
   */
  svtkTypeBool DeformedMesh;
   ...
   */
  svtkTypeBool RemoveDeletedCells;
  svtkTypeBool DeletedCellsAsGhostArray;
  //@}
   ...
   * The functions that take a svtkIdType argument must be passed
  ...
  virtual int ReadState(svtkIdType);
  virtual int ReadNodeStateInfo(svtkIdType);
  virtual int ReadCellStateInfo(svtkIdType);
  virtual int ReadDeletion();
  virtual int ReadSPHState(svtkIdType);
  virtual int ComputeDeflectionAndUpdateGeometry(svtkUnstructuredGrid* grid);
  //@}
   ...
   * (as opposed to attach it to the proper place in the SVTK dataset)
   ...
   */
  virtual void ReadDeletionArray(svtkUnsignedCharArray* arr, const int& pos, const int& size);
...
private:
  ...
  template <typename T>
  void FillDeletionArray(T* buffer, svtkUnsignedCharArray* arr, const svtkIdType& start,
    const svtkIdType& numCells, const int& deathPos, const int& cellSize);
  ...
  svtkLSDynaReader(const svtkLSDynaReader&) = delete;
  void operator=(const svtkLSDynaReader&) = delete;
};

inline void svtkLSDynaReader::SetPointArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Point array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetPointArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfPointArrays(); ++a)
  {
    if (strcmp(arrName, this->GetPointArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInPointArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfPointArrays(); ++a)
  {
    if (strcmp(arrName, this->GetPointArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetCellArrayStatus(int cellType, const char* arrName, int status)
{
  ...
  svtkWarningMacro("Cell array \"" << arrName << "\" (type " << cellType << ") does not exist");
}

inline int svtkLSDynaReader::GetCellArrayStatus(int cellType, const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfCellArrays(cellType); ++a)
  {
    if (strcmp(arrName, this->GetCellArrayName(cellType, a)) == 0)
  ...
  // svtkWarningMacro( "Cell array \"" << arrName << "\" does not exist" );
  return 0;
}

inline int svtkLSDynaReader::GetNumberOfComponentsInCellArray(int cellType, const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfCellArrays(cellType); ++a)
  {
    if (strcmp(arrName, this->GetCellArrayName(cellType, a)) == 0)
...
inline void svtkLSDynaReader::SetSolidArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Solid array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetSolidArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfSolidArrays(); ++a)
  {
    if (strcmp(arrName, this->GetSolidArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInSolidArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfSolidArrays(); ++a)
  {
    if (strcmp(arrName, this->GetSolidArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetThickShellArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Thick shell array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetThickShellArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfThickShellArrays(); ++a)
  {
    if (strcmp(arrName, this->GetThickShellArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInThickShellArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfThickShellArrays(); ++a)
  {
    if (strcmp(arrName, this->GetThickShellArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetShellArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Shell array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetShellArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfShellArrays(); ++a)
  {
    if (strcmp(arrName, this->GetShellArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInShellArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfShellArrays(); ++a)
  {
    if (strcmp(arrName, this->GetShellArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetBeamArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Beam array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetBeamArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfBeamArrays(); ++a)
  {
    if (strcmp(arrName, this->GetBeamArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInBeamArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfBeamArrays(); ++a)
  {
    if (strcmp(arrName, this->GetBeamArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetParticleArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Particle array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetParticleArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfParticleArrays(); ++a)
  {
    if (strcmp(arrName, this->GetParticleArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInParticleArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfParticleArrays(); ++a)
  {
    if (strcmp(arrName, this->GetParticleArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetRigidBodyArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Rigid body array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetRigidBodyArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfRigidBodyArrays(); ++a)
  {
    if (strcmp(arrName, this->GetRigidBodyArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInRigidBodyArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfRigidBodyArrays(); ++a)
  {
    if (strcmp(arrName, this->GetRigidBodyArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetRoadSurfaceArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Road surface array \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetRoadSurfaceArrayStatus(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfRoadSurfaceArrays(); ++a)
  {
    if (strcmp(arrName, this->GetRoadSurfaceArrayName(a)) == 0)
...
inline int svtkLSDynaReader::GetNumberOfComponentsInRoadSurfaceArray(const char* arrName)
{
  for (int a = 0; a < this->GetNumberOfRoadSurfaceArrays(); ++a)
  {
    if (strcmp(arrName, this->GetRoadSurfaceArrayName(a)) == 0)
...
inline void svtkLSDynaReader::SetPartArrayStatus(const char* arrName, int status)
{
  ...
  svtkWarningMacro("Part \"" << arrName << "\" does not exist");
}

inline int svtkLSDynaReader::GetPartArrayStatus(const char* partName)
{
  for (int a = 0; a < this->GetNumberOfPartArrays(); ++a)
  {
  ...
  // svtkWarningMacro( "PartArray \"" << partName << "\" does not exist" );
  return 0;
}
