...
svtkStandardNewMacro(svtkLSDynaSummaryParser);
...
//-----------------------------------------------------------------------------
svtkLSDynaSummaryParser::svtkLSDynaSummaryParser()
  : MetaData(nullptr)
  , PartId(-1)
  , PartStatus(0)
  , PartMaterial(0)
...
//-----------------------------------------------------------------------------
void svtkLSDynaSummaryParser::StartElement(const char* name, const char** atts)
{
  int i;
  if (!strcmp(name, "part"))
  {
...
//-----------------------------------------------------------------------------
void svtkLSDynaSummaryParser::EndElement(const char* name)
{
  if (!strcmp(name, "part"))
  {
    ...
    {
      svtkLSTrimWhitespace(this->PartName);
...
//-----------------------------------------------------------------------------
void svtkLSDynaSummaryParser::CharacterDataHandler(const char* data, int length)
{
  if (!this->InName)
  {
    return;
...
//-----------------------------------------------------------------------------
void svtkLSDynaSummaryParser::PrintSelf(ostream& os, svtkIndent indent)
{
