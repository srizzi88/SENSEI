...
=========================================================================*/
// .NAME Test of svtkPWindBladeReader
// .SECTION Description
// Tests the svtkPWindBladeReader.
...
int TestPWindBladeReader(int argc, char* argv[])
{
  ...
  if (reader->IsA("svtkPWindBladeReader") == false)
  {
    svtkGenericWarningMacro(
      "Tried to make a svtkPWindBladeReader but got a svtkWindBladeReader instead.");
    return 1;
  }
