/*=========================================================================
  ...
  Module:    svtkMotionFXCFGGrammar.h
...
=========================================================================*/
#ifndef svtkMotionFXCFGGrammar_h
#define svtkMotionFXCFGGrammar_h

// Internal header used by svtkMotionFXCFGReader.
// We define the various grammars here rather than clobbering the
// svtkMotionFXCFGReader.cxx.

#include <svtk_pegtl.h>

// for debugging
// clang-format off
#include SVTK_PEGTL(pegtl/contrib/tracer.hpp)
// clang-format on
...
#endif
// SVTK-HeaderTest-Exclude: svtkMotionFXCFGGrammar.h
