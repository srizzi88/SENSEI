...
reader_cartesian.SetFileName("" + str(SVTK_DATA_ROOT) + "/Data/sampleGenGrid3.nc")
...
reader_spherical.SetFileName("" + str(SVTK_DATA_ROOT) + "/Data/sampleGenGrid3.nc")
# Set the arrays we want to load.
...
reader_structured = svtk.svtkNetCDFCFReader()
reader_structured.SetFileName("" + str(SVTK_DATA_ROOT) + "/Data/sampleGenGrid3.nc")
