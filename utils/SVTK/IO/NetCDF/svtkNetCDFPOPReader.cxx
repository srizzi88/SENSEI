...
Module:    svtkNetCDFPOPReader.cxx
...
svtkStandardNewMacro(svtkNetCDFPOPReader);
...
//----------------------------------------------------------------------------
// set default values
svtkNetCDFPOPReader::svtkNetCDFPOPReader()
{
  ...
  this->SelectionObserver->SetCallback(&svtkNetCDFPOPReader::SelectionModifiedCallback);
  this->SelectionObserver->SetClientData(this);
  this->Internals = new svtkNetCDFPOPReaderInternal;
...
//----------------------------------------------------------------------------
void svtkNetCDFPOPReader::PrintSelf(ostream& os, svtkIndent indent)
{
...
int svtkNetCDFPOPReader::RequestInformation(svtkInformation* svtkNotUsed(request),
...
int svtkNetCDFPOPReader::RequestData(svtkInformation* request,
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  /*
    svtkMultiThreaderIDType pid = svtkMultiThreader::GetCurrentThreadID();
    ...
    //necessary?
    if ((pid = svtkMultiThreader::GetCurrentThreadID()) == 0)
      {
...
void svtkNetCDFPOPReader::SelectionModifiedCallback(
  svtkObject*, unsigned long, void* clientdata, void*)
{
  static_cast<svtkNetCDFPOPReader*>(clientdata)->Modified();
}

//-----------------------------------------------------------------------------
int svtkNetCDFPOPReader::GetNumberOfVariableArrays()
{
  return this->Internals->VariableArraySelection->GetNumberOfArrays();
}

//-----------------------------------------------------------------------------
const char* svtkNetCDFPOPReader::GetVariableArrayName(int index)
{
...
//-----------------------------------------------------------------------------
int svtkNetCDFPOPReader::GetVariableArrayStatus(const char* name)
{
  return this->Internals->VariableArraySelection->ArrayIsEnabled(name);
}

//-----------------------------------------------------------------------------
void svtkNetCDFPOPReader::SetVariableArrayStatus(const char* name, int status)
{
