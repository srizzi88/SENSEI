...
/* memory allocation */
#define myalloc(mem_size) svtkPLY::my_alloc((mem_size), __LINE__, __FILE__)

// wjs: added to manage memory leak
static svtkHeap* plyHeap = nullptr;
static void plyInitialize()
{
  if (plyHeap == nullptr)
  {
    plyHeap = svtkHeap::New();
  }
}
...
PlyFile* svtkPLY::ply_write(std::ostream* os, int nelems, const char** elem_names, int file_type)
{
  int i;
  PlyFile* plyfile;
  PlyElement* elem;
  ...
  const char* filename, int nelems, const char** elem_names, int file_type)
{
  ...
  plyfile = svtkPLY::ply_write(ofs, nelems, elem_names, file_type);
  if (plyfile == nullptr)
  {
    ofs->close();
    delete ofs;
...
PlyFile* svtkPLY::ply_open_for_writing_to_string(
  std::string& output, int nelems, const char** elem_names, int file_type)
{
  ...
  /* create the actual PlyFile structure */
  plyfile = svtkPLY::ply_write(oss, nelems, elem_names, file_type);
  if (plyfile == nullptr)
  {
    delete oss;
    return (nullptr);
...
void svtkPLY::ply_describe_element(
  PlyFile* plyfile, const char* elem_name, int nelems, int nprops, PlyProperty* prop_list)
{
  ...
  if (elem == nullptr)
  {
    svtkGenericWarningMacro("ply_describe_element: can't find element " << elem_name);
    return;
  }
...
void svtkPLY::ply_describe_property(PlyFile* plyfile, const char* elem_name, PlyProperty* prop)
{
  PlyElement* elem;
  ...
  if (elem == nullptr)
  {
    svtkGenericWarningMacro("ply_describe_property: can't find element " << elem_name);
    return;
  }
...
void svtkPLY::ply_describe_other_properties(PlyFile* plyfile, PlyOtherProp* other, int offset)
{
  int i;
  PlyElement* elem;
  PlyProperty* prop;
  ...
  if (elem == nullptr)
  {
    svtkGenericWarningMacro("ply_describe_other_properties: can't find element " << other->name);
    return;
  }
...
void svtkPLY::ply_element_count(PlyFile* plyfile, const char* elem_name, int nelems)
{
  PlyElement* elem;
  ...
  if (elem == nullptr)
  {
    svtkGenericWarningMacro("ply_element_count: can't find element " << elem_name);
    return;
  }
...
void svtkPLY::ply_header_complete(PlyFile* plyfile)
{
  int i, j;
...
void svtkPLY::ply_put_element_setup(PlyFile* plyfile, const char* elem_name)
{
  PlyElement* elem;
  ...
  if (elem == nullptr)
  {
    svtkGenericWarningMacro("ply_put_element_setup: can't find element " << elem_name);
    return;
  }
...
void svtkPLY::ply_put_element(PlyFile* plyfile, void* elem_ptr)
{
  int j, k;
  std::ostream* os = plyfile->os;
  PlyElement* elem;
...
void svtkPLY::ply_put_comment(PlyFile* plyfile, const char* comment)
{
...
void svtkPLY::ply_put_obj_info(PlyFile* plyfile, const char* obj_info)
{
...
PlyFile* svtkPLY::ply_read(std::istream* is, int* nelems, char*** elem_names)
{
  int i, j;
  PlyFile* plyfile;
  int nwords;
...
PlyFile* svtkPLY::ply_open_for_reading(const char* filename, int* nelems, char*** elem_names)
{
  ...
  plyfile = svtkPLY::ply_read(ifs, nelems, elem_names);
  if (plyfile == nullptr)
  {
    ifs->close();
    delete ifs;
...
PlyFile* svtkPLY::ply_open_for_reading_from_string(
  const std::string& input, int* nelems, char*** elem_names)
{
  ...
  plyfile = svtkPLY::ply_read(iss, nelems, elem_names);
  if (plyfile == nullptr)
  {
    delete iss;
    return (nullptr);
...
PlyElement* svtkPLY::ply_get_element_description(
...
void svtkPLY::ply_get_element_setup(
...
void svtkPLY::ply_get_property(PlyFile* plyfile, const char* elem_name, PlyProperty* prop)
{
  PlyElement* elem;
...
void svtkPLY::ply_get_element(PlyFile* plyfile, void* elem_ptr)
{
  if (plyfile->file_type == PLY_ASCII)
...
char** svtkPLY::ply_get_comments(PlyFile* plyfile, int* num_comments)
{
...
char** svtkPLY::ply_get_obj_info(PlyFile* plyfile, int* num_obj_info)
{
...
PlyOtherProp* svtkPLY::ply_get_other_properties(PlyFile* plyfile, const char* elem_name, int offset)
{
  int i;
  PlyElement* elem;
  PlyOtherProp* other;
  ...
  if (elem == nullptr)
  {
    svtkGenericWarningMacro("ply_get_other_properties: can't find element " << elem_name);
    return (nullptr);
  }
...
PlyOtherElems* svtkPLY::ply_get_other_element(
  PlyFile* plyfile, const char* elem_name, int elem_count)
{
  ...
  if (elem == nullptr)
  {
    svtkGenericWarningMacro("ply_get_other_element: can't find element " << elem_name);
    return (nullptr);
  }
  ...
  other->other_props = svtkPLY::ply_get_other_properties(
  ...
  for (i = 0; i < other->elem_count; i++)
  {
    ...
    svtkPLY::ply_get_element(plyfile, (void*)other->other_data[i]);
  }
...
void svtkPLY::ply_describe_other_elements(PlyFile* plyfile, PlyOtherElems* other_elems)
{
  int i;
  OtherElem* other;
  ...
  for (i = 0; i < other_elems->num_elems; i++)
  {
    ...
    svtkPLY::ply_element_count(plyfile, other->elem_name, other->elem_count);
    svtkPLY::ply_describe_other_properties(
...
void svtkPLY::ply_put_other_elements(PlyFile* plyfile)
{
  int i, j;
  OtherElem* other;
  ...
  for (i = 0; i < plyfile->other_elems->num_elems; i++)
  {
    ...
    svtkPLY::ply_put_element_setup(plyfile, other->elem_name);

    /* write out each instance of the current element */
    for (j = 0; j < other->elem_count; j++)
      svtkPLY::ply_put_element(plyfile, (void*)other->other_data[j]);
  }
}
...
void svtkPLY::ply_free_other_elements(PlyOtherElems*) {}
...
void svtkPLY::ply_close(PlyFile* plyfile)
{
  ...
  if (plyfile->is)
  {
    svtksys::ifstream* ifs = dynamic_cast<svtksys::ifstream*>(plyfile->is);
    if (ifs)
    {
      ifs->close();
    }
  ...
  if (plyfile->os)
  {
    svtksys::ofstream* ofs = dynamic_cast<svtksys::ofstream*>(plyfile->os);
    if (ofs)
    {
      ofs->close();
    }
...
void svtkPLY::ply_get_info(PlyFile* ply, float* version, int* file_type)
{
  if (ply == nullptr)
    return;
...
bool svtkPLY::equal_strings(const char* s1, const char* s2)
{
  while (*s1 && *s2)
    if (*s1++ != *s2++)
      return false;
...
PlyElement* svtkPLY::find_element(PlyFile* plyfile, const char* element)
{
  int i;
...
PlyProperty* svtkPLY::find_property(PlyElement* elem, const char* prop_name, int* index)
{
  int i;
...
bool svtkPLY::ascii_get_element(PlyFile* plyfile, char* elem_ptr)
{
  int j, k;
  PlyElement* elem;
  PlyProperty* prop;
...
bool svtkPLY::binary_get_element(PlyFile* plyfile, char* elem_ptr)
{
  int j, k;
  PlyElement* elem;
  PlyProperty* prop;
...
void svtkPLY::write_scalar_type(std::ostream* os, int code)
{
...
char** svtkPLY::get_words(std::istream* is, int* nwords, char** orig_line)
{
...
double svtkPLY::get_item_value(const char* item, int type)
{
  switch (type)
  {
    case PLY_CHAR:
...
void svtkPLY::write_binary_item(
  PlyFile* plyfile, int int_val, unsigned int uint_val, double double_val, int type)
{
  std::ostream* os = plyfile->os;
  svtkTypeUInt8 uchar_val;
  svtkTypeInt8 char_val;
  svtkTypeUInt16 ushort_val;
  svtkTypeInt16 short_val;
  svtkTypeFloat32 float_val;
  ...
  switch (type)
  {
    ...
    case PLY_INT16:
      short_val = int_val;
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap2BE(&short_val)
                                          : svtkByteSwap::Swap2LE(&short_val);
      os->write(reinterpret_cast<char*>(&short_val), sizeof(short_val));
      break;
    case PLY_INT:
    case PLY_INT32:
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap4BE(&int_val)
                                          : svtkByteSwap::Swap4LE(&int_val);
    ...
    case PLY_UINT16:
      ushort_val = uint_val;
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap2BE(&ushort_val)
                                          : svtkByteSwap::Swap2LE(&ushort_val);
      os->write(reinterpret_cast<char*>(&ushort_val), sizeof(ushort_val));
      break;
    case PLY_UINT:
    case PLY_UINT32:
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap4BE(&uint_val)
                                          : svtkByteSwap::Swap4LE(&uint_val);
      os->write(reinterpret_cast<char*>(&uint_val), sizeof(uint_val));
      break;
    case PLY_FLOAT:
    case PLY_FLOAT32:
      float_val = double_val;
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap4BE(&float_val)
                                          : svtkByteSwap::Swap4LE(&float_val);
      os->write(reinterpret_cast<char*>(&float_val), sizeof(float_val));
      break;
    case PLY_DOUBLE:
    case PLY_FLOAT64:
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap8BE(&double_val)
                                          : svtkByteSwap::Swap8LE(&double_val);
...
double svtkPLY::old_write_ascii_item(std::ostream* os, char* item, int type)
{
  switch (type)
  {
    case PLY_CHAR:
  ...
  PlyFile* plyfile, int type, int* int_val, unsigned int* uint_val, double* double_val)
{
  switch (type)
  {
    ...
    case PLY_INT8:
    {
      svtkTypeInt8 value = 0;
      plyfile->is->read(reinterpret_cast<char*>(&value), sizeof(value));
      if (!plyfile->is->good())
      {
        svtkGenericWarningMacro("PLY error reading file."
    ...
    case PLY_INT16:
    {
      ...
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap2BE(&value)
                                          : svtkByteSwap::Swap2LE(&value);
    ...
    case PLY_INT32:
    {
      ...
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap4BE(&value)
                                          : svtkByteSwap::Swap4LE(&value);
    ...
    case PLY_FLOAT32:
    {
      ...
      // is 2^32 - 256.
      *int_val = static_cast<int>(svtkMath::ClampValue(value, (float)SVTK_INT_MIN, 2147483520.0f));
      *uint_val = static_cast<unsigned int>(svtkMath::ClampValue(value, 0.0f, 4294967040.0f));
      *double_val = static_cast<double>(value);
    }
    break;
    case PLY_DOUBLE:
    case PLY_FLOAT64:
    {
      ...
      plyfile->file_type == PLY_BINARY_BE ? svtkByteSwap::Swap8BE(&value)
                                          : svtkByteSwap::Swap8LE(&value);

      // Here we can just clamp and cast, all int32s can be exactly represented as doubles.
      *int_val =
        static_cast<int>(svtkMath::ClampValue(value, (double)SVTK_INT_MIN, (double)SVTK_INT_MAX));
      *uint_val =
        static_cast<unsigned int>(svtkMath::ClampValue(value, 0.0, (double)SVTK_UNSIGNED_INT_MAX));
      *double_val = value;
    }
    break;
    default:
...
void svtkPLY::store_item(char* item, int type, int int_val, unsigned int uint_val, double double_val)
{
  switch (type)
  {
    case PLY_CHAR:
    case PLY_INT8:
    {
      svtkTypeInt8 value = static_cast<svtkTypeInt8>(int_val);
    ...
    case PLY_UINT8:
    {
      svtkTypeUInt8 value = static_cast<svtkTypeUInt8>(uint_val);
      memcpy(item, &value, sizeof(value));
      break;
    }
    case PLY_SHORT:
    case PLY_INT16:
    {
      svtkTypeInt16 value = static_cast<svtkTypeInt16>(int_val);
      memcpy(item, &value, sizeof(value));
      break;
    }
    case PLY_USHORT:
    case PLY_UINT16:
    {
      svtkTypeUInt16 value = static_cast<svtkTypeUInt16>(uint_val);
      memcpy(item, &value, sizeof(value));
      break;
    }
    case PLY_INT:
    case PLY_INT32:
    {
      svtkTypeInt32 value = static_cast<svtkTypeInt32>(int_val);
      memcpy(item, &value, sizeof(value));
      break;
    }
    case PLY_UINT:
    case PLY_UINT32:
    {
      svtkTypeUInt32 value = static_cast<svtkTypeUInt32>(uint_val);
      memcpy(item, &value, sizeof(value));
      break;
    }
    case PLY_FLOAT:
    case PLY_FLOAT32:
    {
      svtkTypeFloat32 value = static_cast<svtkTypeFloat32>(double_val);
      memcpy(item, &value, sizeof(value));
      break;
    }
    case PLY_DOUBLE:
    case PLY_FLOAT64:
    {
      svtkTypeFloat64 value = static_cast<svtkTypeFloat64>(double_val);
      memcpy(item, &value, sizeof(value));
      break;
    }
    default:
...
void svtkPLY::add_element(PlyFile* plyfile, char** words, int)
{
  PlyElement* elem;
...
int svtkPLY::get_prop_type(const char* type_name)
{
  int i;
...
void svtkPLY::add_property(PlyFile* plyfile, char** words, int)
{
  PlyProperty* prop;
  PlyElement* elem;
...
void svtkPLY::add_comment(PlyFile* plyfile, char* line)
{
  int i;
  ...
  svtkPLY::ply_put_comment(plyfile, &line[i]);
}
...
void svtkPLY::add_obj_info(PlyFile* plyfile, char* line)
{
  int i;
  ...
  svtkPLY::ply_put_obj_info(plyfile, &line[i]);
}
...
void svtkPLY::copy_property(PlyProperty* dest, const PlyProperty* src)
{
...
void* svtkPLY::my_alloc(size_t size, int lnum, const char* fname)
{
