 ...
 *
 * svtkPLY is a modified version of the PLY 1.1 library. The library
...
class SVTKIOPLY_EXPORT svtkPLY
{
public:
...
// SVTK-HeaderTest-Exclude: svtkPLY.h
