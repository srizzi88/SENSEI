 ...
 * \endverbatim
 *
 * This reader leverages svtkMultiBlockPLOT3DReader to do the actual
 * reading so you may want to refer to the documentation of
 * svtkMultiBlockPLOT3DReader about the details of some of these
...
#ifndef svtkPlot3DMetaReader_h
#define svtkPlot3DMetaReader_h

#include "svtkIOParallelModule.h" // For export macro
#include "svtkMultiBlockDataSetAlgorithm.h"

#include "svtk_jsoncpp_fwd.h" // For forward declarations

struct svtkPlot3DMetaReaderInternals;

class svtkMultiBlockPLOT3DReader;

class SVTKIOPARALLEL_EXPORT svtkPlot3DMetaReader : public svtkMultiBlockDataSetAlgorithm
{
public:
  static svtkPlot3DMetaReader* New();
  svtkTypeMacro(svtkPlot3DMetaReader, svtkMultiBlockDataSetAlgorithm);
...
protected:
  svtkPlot3DMetaReader();
  ~svtkPlot3DMetaReader() override;
...
private:
  svtkPlot3DMetaReader(const svtkPlot3DMetaReader&) = delete;
  void operator=(const svtkPlot3DMetaReader&) = delete;

  svtkMultiBlockPLOT3DReader* Reader;
  svtkPlot3DMetaReaderInternals* Internal;
};
