...
#ifndef svtkPLSDynaReader_h
#define svtkPLSDynaReader_h

#include "svtkIOParallelLSDynaModule.h" // For export macro
#include "svtkLSDynaReader.h"

class svtkMultiProcessController;
class SVTKIOPARALLELLSDYNA_EXPORT svtkPLSDynaReader : public svtkLSDynaReader
{
public:
  svtkTypeMacro(svtkPLSDynaReader, svtkLSDynaReader);
  void PrintSelf(ostream& os, svtkIndent indent) override;
  static svtkPLSDynaReader* New();
...
private:
  svtkPLSDynaReader(const svtkPLSDynaReader&) = delete;
  void operator=(const svtkPLSDynaReader&) = delete;

  void GetPartRanges(svtkIdType* mins, svtkIdType* maxs);

  svtkMultiProcessController* Controller;

  struct svtkPLSDynaReaderInternal;
  svtkPLSDynaReaderInternal* Internal;
};

#endif // svtkPLSDynaReader_h
