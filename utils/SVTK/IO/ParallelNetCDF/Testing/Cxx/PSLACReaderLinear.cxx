...
//=============================================================================
void PSLACReaderLinearMethod(svtkMultiProcessController* controller, void* _args)
{
  ...
  *(args->retval) = 1;
  ...
  geometry->SetInputConnection(reader->GetOutputPort(svtkSLACReader::VOLUME_OUTPUT));
