...
def createMB(piece, num_pieces):
    output = svtk.svtkMultiBlockDataSet()
...
writer = svtk.svtkXMLPMultiBlockDataWriter()
prefix =SVTK_TEMP_DIR + "/testParallelXMLWriters"
fname = prefix + ".vtm"
...
if rank == 0:
    reader = svtk.svtkXMLMultiBlockDataReader()
