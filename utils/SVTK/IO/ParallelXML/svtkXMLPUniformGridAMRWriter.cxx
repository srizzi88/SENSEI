/*=========================================================================
  ...
  Module:    svtkXMLPUniformGridAMRWriter.cxx
...
//----------------------------------------------------------------------------
svtkStandardNewMacro(svtkXMLPUniformGridAMRWriter);

svtkCxxSetObjectMacro(svtkXMLPUniformGridAMRWriter, Controller, svtkMultiProcessController);

//----------------------------------------------------------------------------
svtkXMLPUniformGridAMRWriter::svtkXMLPUniformGridAMRWriter()
{
...
//----------------------------------------------------------------------------
void svtkXMLPUniformGridAMRWriter::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkXMLPUniformGridAMRWriter::SetWriteMetaFile(int flag)
{
  this->Modified();
...
//----------------------------------------------------------------------------
void svtkXMLPUniformGridAMRWriter::FillDataTypes(svtkCompositeDataSet* cdInput)
{
