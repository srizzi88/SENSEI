...
//----------------------------------------------------------------------------
svtkStandardNewMacro(svtkPostgreSQLToTableReader);

//----------------------------------------------------------------------------
svtkPostgreSQLToTableReader::svtkPostgreSQLToTableReader() {}

//----------------------------------------------------------------------------
svtkPostgreSQLToTableReader::~svtkPostgreSQLToTableReader() {}

//----------------------------------------------------------------------------
int svtkPostgreSQLToTableReader::RequestData(
...
//----------------------------------------------------------------------------
void svtkPostgreSQLToTableReader::PrintSelf(ostream& os, svtkIndent indent)
{
