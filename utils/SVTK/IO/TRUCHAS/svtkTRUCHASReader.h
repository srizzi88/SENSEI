...
=========================================================================*/
/**
 * @class   svtkTRUCHASReader
 * @brief   read GE TRUCHAS format HDF5 files
 *
 * svtkTRUCHASReader is a source object that reads TRUCHAS simulation
 * data from HDF5 files.
 */

#ifndef svtkTRUCHASReader_h
#define svtkTRUCHASReader_h

#include "svtkIOTRUCHASModule.h" // For export macro
#include "svtkMultiBlockDataSetAlgorithm.h"

class svtkDataArraySelection;

class SVTKIOTRUCHAS_EXPORT svtkTRUCHASReader : public svtkMultiBlockDataSetAlgorithm
{
public:
  static svtkTRUCHASReader* New();
  svtkTypeMacro(svtkTRUCHASReader, svtkMultiBlockDataSetAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  //@{
  /**
   * Specify file name of svtk data file to read.
   */
...
protected:
  ...
  svtkDataArraySelection* BlockChoices;
  svtkDataArraySelection* PointArrayChoices;
  svtkDataArraySelection* CellArrayChoices;

private:
  svtkTRUCHASReader(const svtkTRUCHASReader&) = delete;
  void operator=(const svtkTRUCHASReader&) = delete;
};
