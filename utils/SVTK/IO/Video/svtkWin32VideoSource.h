...
=========================================================================*/
/**
 * @class   svtkWin32VideoSource
 * @brief   Video-for-Windows video digitizer
 *
 * svtkWin32VideoSource grabs frames or streaming video from a
 ...
 *
 * @sa
 * svtkVideoSource svtkMILVideoSource
 */

#ifndef svtkWin32VideoSource_h
#define svtkWin32VideoSource_h
...
class SVTKIOVIDEO_EXPORT svtkWin32VideoSource : public svtkVideoSource
{
public:
  static svtkWin32VideoSource* New();
  svtkTypeMacro(svtkWin32VideoSource, svtkVideoSource);
  ...
  svtkBooleanMacro(Preview, int);
  svtkGetMacro(Preview, int);
  //@}
...
protected:
  svtkWin32VideoSource();
  ~svtkWin32VideoSource() override;

  char WndClassName[16];
  int BitMapSize;
  int Preview;

  svtkWin32VideoSourceInternal* Internal;
...
private:
  svtkWin32VideoSource(const svtkWin32VideoSource&) = delete;
  void operator=(const svtkWin32VideoSource&) = delete;
};
