...
int TestXMLUnstructuredGridReader(int argc, char* argv[])
{
  ...
  std::string testXML =
    "<?xml version=\"1.0\"?>\n"
    "<SVTKFile type=\"UnstructuredGrid\"  version=\"0.1\" >\n"
    "  <UnstructuredGrid>\n"
  ...
  svtkNew<svtkXMLUnstructuredGridReader> reader0;
  ...
  svtkNew<svtkXMLUnstructuredGridReader> reader1;
  ...
  cout << "Loading " << filename.c_str() << endl;
  svtkNew<svtkXMLUnstructuredGridReader> reader2;
  reader2->SetFileName(filename.c_str());

  svtkNew<svtkDataSetSurfaceFilter> surfaces;
  ...
  int rtResult = svtkRegressionTestImage(renwin);
  if (rtResult == svtkRegressionTester::DO_INTERACTOR)
  {
    iren->Start();
  }
