...
file0 = SVTK_TEMP_DIR + '/idFile0.vtt'
file1 = SVTK_TEMP_DIR + '/idFile1.vtt'
file2 = SVTK_TEMP_DIR + '/idFile2.vtt'

# read in some poly data
csvReader = svtk.svtkDelimitedTextReader()
csvReader.SetFileName(SVTK_DATA_ROOT + "/Data/vehicle_data.csv")
csvReader.DetectNumericColumnsOn();
csvReader.SetHaveHeaders(True);
csvReader.Update()

# write various versions
xmlTableWriter = svtk.svtkXMLTableWriter()
...
modifiedTable = svtk.svtkTable()
modifiedTable.DeepCopy(csvReader.GetOutput())

array0 = svtk.svtkIntArray()
...
reader = svtk.svtkXMLTableReader()
reader.SetFileName(file0)
reader.Update()

reference = svtk.svtkTable()
