/*=========================================================================
  ...
  Module:    svtkXMLPolyDataReader.cxx
...
svtkStandardNewMacro(svtkXMLPolyDataReader);

//----------------------------------------------------------------------------
svtkXMLPolyDataReader::svtkXMLPolyDataReader()
{
...
//----------------------------------------------------------------------------
void svtkXMLPolyDataReader::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
svtkPolyData* svtkXMLPolyDataReader::GetOutput()
{
  return this->GetOutput(0);
}

//----------------------------------------------------------------------------
svtkPolyData* svtkXMLPolyDataReader::GetOutput(int idx)
{
  return svtkPolyData::SafeDownCast(this->GetOutputDataObject(idx));
}

//----------------------------------------------------------------------------
svtkIdType svtkXMLPolyDataReader::GetNumberOfVerts()
{
  return this->TotalNumberOfVerts;
}

//----------------------------------------------------------------------------
svtkIdType svtkXMLPolyDataReader::GetNumberOfLines()
{
  return this->TotalNumberOfLines;
}

//----------------------------------------------------------------------------
svtkIdType svtkXMLPolyDataReader::GetNumberOfStrips()
{
  return this->TotalNumberOfStrips;
}

//----------------------------------------------------------------------------
svtkIdType svtkXMLPolyDataReader::GetNumberOfPolys()
{
  return this->TotalNumberOfPolys;
}

//----------------------------------------------------------------------------
const char* svtkXMLPolyDataReader::GetDataSetName()
{
  return "PolyData";
}

//----------------------------------------------------------------------------
void svtkXMLPolyDataReader::GetOutputUpdateExtent(int& piece, int& numberOfPieces, int& ghostLevel)
{
...
//----------------------------------------------------------------------------
void svtkXMLPolyDataReader::SetupOutputTotals()
{
...
//----------------------------------------------------------------------------
void svtkXMLPolyDataReader::SetupPieces(int numPieces)
{
  this->Superclass::SetupPieces(numPieces);
  this->NumberOfVerts = new svtkIdType[numPieces];
  this->NumberOfLines = new svtkIdType[numPieces];
  this->NumberOfStrips = new svtkIdType[numPieces];
  this->NumberOfPolys = new svtkIdType[numPieces];
  this->VertElements = new svtkXMLDataElement*[numPieces];
  this->LineElements = new svtkXMLDataElement*[numPieces];
  this->StripElements = new svtkXMLDataElement*[numPieces];
  this->PolyElements = new svtkXMLDataElement*[numPieces];
...
//----------------------------------------------------------------------------
void svtkXMLPolyDataReader::DestroyPieces()
{
...
//----------------------------------------------------------------------------
svtkIdType svtkXMLPolyDataReader::GetNumberOfCellsInPiece(int piece)
{
...
//----------------------------------------------------------------------------
void svtkXMLPolyDataReader::SetupOutputData()
{
...
//----------------------------------------------------------------------------
int svtkXMLPolyDataReader::ReadPiece(svtkXMLDataElement* ePiece)
{
...
//----------------------------------------------------------------------------
void svtkXMLPolyDataReader::SetupNextPiece()
{
...
//----------------------------------------------------------------------------
int svtkXMLPolyDataReader::ReadPieceData()
{
  ...
  // specifications for svtkPolyData take two data arrays split across
  // cell types).
  svtkIdType totalPieceSize = superclassPieceSize + 2 * this->GetNumberOfCellsInPiece(this->Piece);
  if (totalPieceSize == 0)
  {
    totalPieceSize = 1;
  }
  ...
  // Read the Verts.
  svtkXMLDataElement* eVerts = this->VertElements[this->Piece];
  if (eVerts)
  {
  ...
  // Read the Lines.
  svtkXMLDataElement* eLines = this->LineElements[this->Piece];
  if (eLines)
  {
    //    int needToRead = this->CellsNeedToReadTimeStep(eNested,
  ...
  // Read the Strips.
  svtkXMLDataElement* eStrips = this->StripElements[this->Piece];
  if (eStrips)
  {
    //    int needToRead = this->CellsNeedToReadTimeStep(eNested,
  ...
  // Read the Polys.
  svtkXMLDataElement* ePolys = this->PolyElements[this->Piece];
  if (ePolys)
  {
    //    int needToRead = this->CellsNeedToReadTimeStep(eNested,
...
//----------------------------------------------------------------------------
int svtkXMLPolyDataReader::ReadArrayForCells(svtkXMLDataElement* da, svtkAbstractArray* outArray)
{
  ...
  svtkIdType numCells = this->NumberOfVerts[this->Piece];
...
//----------------------------------------------------------------------------
int svtkXMLPolyDataReader::FillOutputPortInformation(int, svtkInformation* info)
{
