...
#ifndef svtkXdmf3ArraySelection_h
#define svtkXdmf3ArraySelection_h
...
#endif
class SVTKIOXDMF3_EXPORT svtkXdmf3ArraySelection : public std::map<std::string, bool>
{
public:
  /**
   * used in parallel to send of combine sets
   */
  void Merge(const svtkXdmf3ArraySelection& other);
...
#endif //# svtkXdmf3ArraySelection_h
// SVTK-HeaderTest-Exclude: svtkXdmf3ArraySelection.h
