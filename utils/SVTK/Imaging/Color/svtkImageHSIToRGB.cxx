...
svtkStandardNewMacro(svtkImageHSIToRGB);

//----------------------------------------------------------------------------
svtkImageHSIToRGB::svtkImageHSIToRGB()
{
  this->Maximum = 255.0;
...
template <class T>
void svtkImageHSIToRGBExecute(
  svtkImageHSIToRGB* self, svtkImageData* inData, svtkImageData* outData, int outExt[6], int id, T*)
{
  ...
  while (!outIt.IsAtEnd())
  {
    ...
    {
      // Pixel operation
      H = static_cast<double>(*inSI);
      ++inSI;
      S = static_cast<double>(*inSI);
      ++inSI;
      I = static_cast<double>(*inSI);
      ++inSI;
...
//----------------------------------------------------------------------------
void svtkImageHSIToRGB::ThreadedExecute(
  svtkImageData* inData, svtkImageData* outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(
      svtkImageHSIToRGBExecute(this, inData, outData, outExt, id, static_cast<SVTK_TT*>(nullptr)));
    default:
...
void svtkImageHSIToRGB::PrintSelf(ostream& os, svtkIndent indent)
{
