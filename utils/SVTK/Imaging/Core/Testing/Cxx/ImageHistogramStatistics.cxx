...
=========================================================================*/
// Test the svtkImageHistogramStatistics class
//
...
int ImageHistogramStatistics(int argc, char* argv[])
{
  ...
  svtkImageCast* imageCast = svtkImageCast::New();
  ...
  svtkImageHistogramStatistics* statistics = svtkImageHistogramStatistics::New();
  ...
  // uncomment to test svtkImageAccumulate instead
  /*
    svtkImageAccumulate *accumulate = svtkImageAccumulate::New();
