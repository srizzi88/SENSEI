...
int ImageWeightedSum(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkImageWeightedSum> sum = svtkSmartPointer<svtkImageWeightedSum>::New();
  sum->SetWeight(0, 0.);
  ...
  svtkSmartPointer<svtkImageMathematics> math = svtkSmartPointer<svtkImageMathematics>::New();
  ...
  svtkSmartPointer<svtkImageShiftScale> shift = svtkSmartPointer<svtkImageShiftScale>::New();
