...
class TestAllMathematics(svtk.test.Testing.svtkTest):
    ...
    def testAllMathematics(self):
        ...
        sphere1 = svtk.svtkImageEllipsoidSource()
        ...
        for idx, operator in enumerate(mathematics):
            mathematic.append(svtk.svtkImageMathematics())
...
if __name__ == "__main__":
     svtk.test.Testing.main([(TestAllMathematics, 'test')])
