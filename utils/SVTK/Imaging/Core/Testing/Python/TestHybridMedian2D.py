...
imageCanvas = svtk.svtkImageCanvasSource2D()
...
shotNoiseSource = svtk.svtkImageNoiseSource()
...
shotNoiseThresh1 = svtk.svtkImageThreshold()
...
shotNoiseThresh2 = svtk.svtkImageThreshold()
...
shotNoise = svtk.svtkImageMathematics()
...
hybrid1 = svtk.svtkImageHybridMedian2D()
hybrid1.SetInputConnection(add.GetOutputPort())
hybrid2 = svtk.svtkImageHybridMedian2D()
