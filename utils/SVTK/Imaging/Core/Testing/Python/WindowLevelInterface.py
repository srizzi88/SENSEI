...
if (info.commands(globals(), locals(),  rtExMath) != "rtExMath"):
    ...
    def InitializeWindowLevelInterface (__svtk__temp0=0,__svtk__temp1=0):
    ...
    def SetSlice (slice,__svtk__temp0=0,__svtk__temp1=0):
        global sliceNumber, viewer
        viewer.SetZSlice(slice)
        viewer.Render()

    def SetWindow (window,__svtk__temp0=0,__svtk__temp1=0):
        global viewer, video
        if (video):
    ...
    def SetLevel (level,__svtk__temp0=0,__svtk__temp1=0):
        global viewer
        viewer.SetColorLevel(level)
        viewer.Render()

    def SetInverseVideo (__svtk__temp0=0,__svtk__temp1=0):
