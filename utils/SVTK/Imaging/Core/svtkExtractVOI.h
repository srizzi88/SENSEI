...
=========================================================================*/
/**
 * @class   svtkExtractVOI
 * @brief   select piece (e.g., volume of interest) and/or subsample structured points dataset
 *
 *
 * svtkExtractVOI is a filter that selects a portion of an input structured
 ...
 *
 * @sa
 * svtkGeometryFilter svtkExtractGeometry svtkExtractGrid
 */

#ifndef svtkExtractVOI_h
#define svtkExtractVOI_h
...
class SVTKIMAGINGCORE_EXPORT svtkExtractVOI : public svtkImageAlgorithm
{
public:
  svtkTypeMacro(svtkExtractVOI, svtkImageAlgorithm);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Construct object to extract all of the input data.
   */
  static svtkExtractVOI* New();
...
private:
  svtkExtractVOI(const svtkExtractVOI&) = delete;
  void operator=(const svtkExtractVOI&) = delete;
};
