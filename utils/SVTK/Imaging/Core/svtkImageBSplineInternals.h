/*=========================================================================
  ...
  Module:    svtkImageBSplineInternals.h
...
=========================================================================*/
/**
 * @class   svtkImageBSplineInternals
 * @brief   BSpline code from P. Thevenaz
 *
 * svtkImageBSplineInternals provides code for image interpolation with
...
#ifndef svtkImageBSplineInternals_h
#define svtkImageBSplineInternals_h

#include "svtkImagingCoreModule.h" // For export macro
#include "svtkSystemIncludes.h"

class SVTKIMAGINGCORE_EXPORT svtkImageBSplineInternals
{
public:
  /**
  ...
  static void ConvertToInterpolationCoefficients(double data[], long size, long border,
    double poles[4], long numPoles, double tol) SVTK_SIZEHINT(data, size);
...
private:
  svtkImageBSplineInternals(const svtkImageBSplineInternals&) = delete;
  void operator=(const svtkImageBSplineInternals&) = delete;
};

#endif
// SVTK-HeaderTest-Exclude: svtkImageBSplineInternals.h
