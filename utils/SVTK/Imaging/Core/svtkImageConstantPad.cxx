/*=========================================================================
  ...
  Module:    svtkImageConstantPad.cxx
...
svtkStandardNewMacro(svtkImageConstantPad);

//----------------------------------------------------------------------------
// Constructor sets default values
svtkImageConstantPad::svtkImageConstantPad()
{
  this->Constant = 0.0;
}
...
template <class T>
void svtkImageConstantPadExecute(svtkImageConstantPad* self, svtkImageData* inData, T* inPtr,
  svtkImageData* outData, T* outPtr, int outExt[6], int inExt[6], int id)
{
...
void svtkImageConstantPad::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageConstantPadExecute(this, inData[0][0], static_cast<SVTK_TT*>(inPtr),
      outData[0], static_cast<SVTK_TT*>(outPtr), outExt, inExt, id));
    default:
...
void svtkImageConstantPad::PrintSelf(ostream& os, svtkIndent indent)
{
