...
svtkStandardNewMacro(svtkImageMirrorPad);

//----------------------------------------------------------------------------
// Just clip the request.
void svtkImageMirrorPad::ComputeInputUpdateExtent(int inExt[6], int outExt[6], int wExtent[6])
{
  int idx;
...
//----------------------------------------------------------------------------
template <class T>
void svtkImageMirrorPadExecute(svtkImageMirrorPad* self, svtkImageData* inData, int* wExtent,
...
void svtkImageMirrorPad::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageMirrorPadExecute(
      this, inData[0][0], wExt, outData[0], static_cast<SVTK_TT*>(outPtr), outExt, id));
    default:
