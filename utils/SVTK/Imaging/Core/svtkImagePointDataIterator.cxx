/*=========================================================================
  ...
  Module:    svtkImagePointDataIterator.cxx
...
//----------------------------------------------------------------------------
class svtkImageStencilIteratorFriendship
{
public:
  static int* GetExtentListLengths(svtkImageStencilData* stencil)
  {
    return stencil->ExtentListLengths;
  }

  static int** GetExtentLists(svtkImageStencilData* stencil) { return stencil->ExtentLists; }
};

//----------------------------------------------------------------------------
svtkImagePointDataIterator::svtkImagePointDataIterator()
{
  this->Id = 0;
  this->SpanEnd = 0;
  this->RowEnd = 0;
...
//----------------------------------------------------------------------------
void svtkImagePointDataIterator::Initialize(svtkImageData* image, const int extent[6],
  ...
  if (stencil)
  {
    ...
    if (this->Extent[2] <= this->Extent[3] && this->Extent[4] <= this->Extent[5])
    {
      this->SpanCountPointer =
        svtkImageStencilIteratorFriendship::GetExtentListLengths(stencil) + startOffset;

      this->SpanListPointer =
        svtkImageStencilIteratorFriendship::GetExtentLists(stencil) + startOffset;
...
//----------------------------------------------------------------------------
void svtkImagePointDataIterator::SetSpanState(int idX)
{
  ...
  svtkIdType rowStart = this->RowEnd - (this->RowIncrement - this->RowEndIncrement);
...
//----------------------------------------------------------------------------
void svtkImagePointDataIterator::NextSpan()
{
...
//----------------------------------------------------------------------------
void* svtkImagePointDataIterator::GetVoidPointer(
  svtkDataArray* array, svtkIdType i, int* pixelIncrement)
{
...
//----------------------------------------------------------------------------
void* svtkImagePointDataIterator::GetVoidPointer(
  svtkImageData* image, svtkIdType i, int* pixelIncrement)
{
  return svtkImagePointDataIterator::GetVoidPointer(
    image->GetPointData()->GetScalars(), i, pixelIncrement);
}

//----------------------------------------------------------------------------
void svtkImagePointDataIterator::ReportProgress()
{
