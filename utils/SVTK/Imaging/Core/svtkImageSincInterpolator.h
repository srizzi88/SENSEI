/*=========================================================================
  ...
  Module:    svtkImageSincInterpolator.h
...
=========================================================================*/
/**
 * @class   svtkImageSincInterpolator
 * @brief   perform sinc interpolation on images
 *
 * svtkImageSincInterpolator provides various windowed sinc interpolation
...
#ifndef svtkImageSincInterpolator_h
#define svtkImageSincInterpolator_h

#include "svtkAbstractImageInterpolator.h"
#include "svtkImagingCoreModule.h" // For export macro

#define SVTK_LANCZOS_WINDOW 0
#define SVTK_KAISER_WINDOW 1
#define SVTK_COSINE_WINDOW 2
#define SVTK_HANN_WINDOW 3
#define SVTK_HAMMING_WINDOW 4
#define SVTK_BLACKMAN_WINDOW 5
#define SVTK_BLACKMAN_HARRIS3 6
#define SVTK_BLACKMAN_HARRIS4 7
#define SVTK_NUTTALL_WINDOW 8
#define SVTK_BLACKMAN_NUTTALL3 9
#define SVTK_BLACKMAN_NUTTALL4 10
#define SVTK_SINC_KERNEL_SIZE_MAX 32

class svtkImageData;
struct svtkInterpolationInfo;

class SVTKIMAGINGCORE_EXPORT svtkImageSincInterpolator : public svtkAbstractImageInterpolator
{
public:
  static svtkImageSincInterpolator* New();
  svtkTypeMacro(svtkImageSincInterpolator, svtkAbstractImageInterpolator);
  ...
  void SetWindowFunctionToLanczos() { this->SetWindowFunction(SVTK_LANCZOS_WINDOW); }
  void SetWindowFunctionToKaiser() { this->SetWindowFunction(SVTK_KAISER_WINDOW); }
  void SetWindowFunctionToCosine() { this->SetWindowFunction(SVTK_COSINE_WINDOW); }
  void SetWindowFunctionToHann() { this->SetWindowFunction(SVTK_HANN_WINDOW); }
  void SetWindowFunctionToHamming() { this->SetWindowFunction(SVTK_HAMMING_WINDOW); }
  void SetWindowFunctionToBlackman() { this->SetWindowFunction(SVTK_BLACKMAN_WINDOW); }
  void SetWindowFunctionToBlackmanHarris3() { this->SetWindowFunction(SVTK_BLACKMAN_HARRIS3); }
  void SetWindowFunctionToBlackmanHarris4() { this->SetWindowFunction(SVTK_BLACKMAN_HARRIS4); }
  void SetWindowFunctionToNuttall() { this->SetWindowFunction(SVTK_NUTTALL_WINDOW); }
  void SetWindowFunctionToBlackmanNuttall3() { this->SetWindowFunction(SVTK_BLACKMAN_NUTTALL3); }
  void SetWindowFunctionToBlackmanNuttall4() { this->SetWindowFunction(SVTK_BLACKMAN_NUTTALL4); }
  ...
  double* GetBlurFactors() SVTK_SIZEHINT(3) { return this->BlurFactors; }
  //@}
   ...
   * filter like svtkImageReslice.  Such a filter will indicate the output
   ...
   * By default, the svtkImageSincInterpolator will renormalize these kernels.
...
protected:
  svtkImageSincInterpolator();
  ~svtkImageSincInterpolator() override;
...
private:
  svtkImageSincInterpolator(const svtkImageSincInterpolator&) = delete;
  void operator=(const svtkImageSincInterpolator&) = delete;
};
