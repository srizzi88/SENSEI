/*=========================================================================
  ...
  Module:    svtkRTAnalyticSource.cxx
...
svtkStandardNewMacro(svtkRTAnalyticSource);

// ----------------------------------------------------------------------------
svtkRTAnalyticSource::svtkRTAnalyticSource()
{
  this->Maximum = 255.0;
  this->Center[0] = 0.0;
  this->Center[1] = 0.0;
...
// ----------------------------------------------------------------------------
void svtkRTAnalyticSource::SetWholeExtent(int xMin, int xMax, int yMin, int yMax, int zMin, int zMax)
{
  int modified = 0;
...
// ----------------------------------------------------------------------------
int svtkRTAnalyticSource::RequestInformation(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  ...
  {
    svtkErrorMacro("Invalid SubsampleRate: value must be > 0");
    return 0;
  }
  ...
  {
    svtkErrorMacro("Invalid WholeExtent: " << this->WholeExtent[0] << ", " << this->WholeExtent[1]
                                          << ", " << this->WholeExtent[2] << ", "
  ...
  outInfo->Set(svtkStreamingDemandDrivenPipeline::WHOLE_EXTENT(), tmpExt, 6);

  outInfo->Set(svtkDataObject::ORIGIN(), 0.0, 0.0, 0.0);
  outInfo->Set(
    svtkDataObject::SPACING(), this->SubsampleRate, this->SubsampleRate, this->SubsampleRate);
...
void svtkRTAnalyticSource::ExecuteDataWithInformation(
  svtkDataObject* svtkNotUsed(output), svtkInformation* outInfo)
{
  ...
  */
  ...
  if (data->GetScalarType() != SVTK_FLOAT)
  {
...
void svtkRTAnalyticSource::PrintSelf(ostream& os, svtkIndent indent)
{
...
int svtkRTAnalyticSource::FillOutputPortInformation(int port, svtkInformation* info)
{
