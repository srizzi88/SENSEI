/*=========================================================================
  ...
  Module:    svtkImageButterworthHighPass.cxx
...
=========================================================================*/
#include "svtkImageButterworthHighPass.h"
...
svtkStandardNewMacro(svtkImageButterworthHighPass);

//----------------------------------------------------------------------------
svtkImageButterworthHighPass::svtkImageButterworthHighPass()
{
  this->CutOff[0] = this->CutOff[1] = this->CutOff[2] = SVTK_DOUBLE_MAX;
  this->Order = 1;
}

//----------------------------------------------------------------------------
void svtkImageButterworthHighPass::SetXCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageButterworthHighPass::SetYCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageButterworthHighPass::SetZCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageButterworthHighPass::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* svtkNotUsed(outputVector),
  svtkImageData*** inData, svtkImageData** outData, int ext[6], int id)
{
  int idx0, idx1, idx2;
  int min0, max0;
  double* inPtr;
  ...
  {
    svtkErrorMacro("Expecting 2 components not " << inData[0][0]->GetNumberOfScalarComponents());
    return;
  }
  if (inData[0][0]->GetScalarType() != SVTK_DOUBLE || outData[0]->GetScalarType() != SVTK_DOUBLE)
  {
    svtkErrorMacro("Expecting input and output to be of type double");
    return;
  }
...
void svtkImageButterworthHighPass::PrintSelf(ostream& os, svtkIndent indent)
{
