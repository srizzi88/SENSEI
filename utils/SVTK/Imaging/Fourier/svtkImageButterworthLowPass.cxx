/*=========================================================================
  ...
  Module:    svtkImageButterworthLowPass.cxx
...
=========================================================================*/
#include "svtkImageButterworthLowPass.h"
...
svtkStandardNewMacro(svtkImageButterworthLowPass);

//----------------------------------------------------------------------------
svtkImageButterworthLowPass::svtkImageButterworthLowPass()
{
...
//----------------------------------------------------------------------------
void svtkImageButterworthLowPass::SetXCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageButterworthLowPass::SetYCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageButterworthLowPass::SetZCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageButterworthLowPass::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
...
void svtkImageButterworthLowPass::PrintSelf(ostream& os, svtkIndent indent)
{
