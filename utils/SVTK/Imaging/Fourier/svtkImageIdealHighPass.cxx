/*=========================================================================
  ...
  Module:    svtkImageIdealHighPass.cxx
...
=========================================================================*/
#include "svtkImageIdealHighPass.h"
...
svtkStandardNewMacro(svtkImageIdealHighPass);

//----------------------------------------------------------------------------
svtkImageIdealHighPass::svtkImageIdealHighPass()
{
  this->CutOff[0] = this->CutOff[1] = this->CutOff[2] = SVTK_DOUBLE_MAX;
}

//----------------------------------------------------------------------------
void svtkImageIdealHighPass::SetXCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageIdealHighPass::SetYCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageIdealHighPass::SetZCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageIdealHighPass::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
...
void svtkImageIdealHighPass::PrintSelf(ostream& os, svtkIndent indent)
{
