/*=========================================================================
  ...
  Module:    svtkImageIdealLowPass.cxx
...
=========================================================================*/
#include "svtkImageIdealLowPass.h"
...
svtkStandardNewMacro(svtkImageIdealLowPass);

//----------------------------------------------------------------------------
svtkImageIdealLowPass::svtkImageIdealLowPass()
{
  this->CutOff[0] = this->CutOff[1] = this->CutOff[2] = SVTK_DOUBLE_MAX;
}

//----------------------------------------------------------------------------
void svtkImageIdealLowPass::SetXCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageIdealLowPass::SetYCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageIdealLowPass::SetZCutOff(double cutOff)
{
...
//----------------------------------------------------------------------------
void svtkImageIdealLowPass::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
...
void svtkImageIdealLowPass::PrintSelf(ostream& os, svtkIndent indent)
{
