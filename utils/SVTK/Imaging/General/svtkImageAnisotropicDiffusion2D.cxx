/*=========================================================================
  ...
  Module:    svtkImageAnisotropicDiffusion2D.cxx
...
svtkStandardNewMacro(svtkImageAnisotropicDiffusion2D);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageAnisotropicDiffusion2D filter.
svtkImageAnisotropicDiffusion2D::svtkImageAnisotropicDiffusion2D()
{
...
//----------------------------------------------------------------------------
void svtkImageAnisotropicDiffusion2D::PrintSelf(ostream& os, svtkIndent indent)
{
...
void svtkImageAnisotropicDiffusion2D::SetNumberOfIterations(int num)
{
  int temp;
...
void svtkImageAnisotropicDiffusion2D::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
...
void svtkImageAnisotropicDiffusion2D::Iterate(
  svtkImageData* inData, svtkImageData* outData, double ar0, double ar1, int* coreExtent, int count)
{
  int idx0, idx1, idx2;
