/*=========================================================================
  ...
  Module:    svtkImageAnisotropicDiffusion3D.h
...
=========================================================================*/
/**
 * @class   svtkImageAnisotropicDiffusion3D
 * @brief   edge preserving smoothing.
 *
 *
 * svtkImageAnisotropicDiffusion3D diffuses an volume iteratively.
...
#ifndef svtkImageAnisotropicDiffusion3D_h
#define svtkImageAnisotropicDiffusion3D_h

#include "svtkImageSpatialAlgorithm.h"
#include "svtkImagingGeneralModule.h" // For export macro

class SVTKIMAGINGGENERAL_EXPORT svtkImageAnisotropicDiffusion3D : public svtkImageSpatialAlgorithm
{
public:
  static svtkImageAnisotropicDiffusion3D* New();
  svtkTypeMacro(svtkImageAnisotropicDiffusion3D, svtkImageSpatialAlgorithm);
...
protected:
  ...
  ~svtkImageAnisotropicDiffusion3D() override {}
  ...
  void Iterate(svtkImageData* in, svtkImageData* out, double ar0, double ar1, double ar3,
    int* coreExtent, int count);

private:
  svtkImageAnisotropicDiffusion3D(const svtkImageAnisotropicDiffusion3D&) = delete;
  void operator=(const svtkImageAnisotropicDiffusion3D&) = delete;
};
