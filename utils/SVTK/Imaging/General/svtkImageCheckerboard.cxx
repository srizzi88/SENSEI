/*=========================================================================
  ...
  Module:    svtkImageCheckerboard.cxx
...
svtkStandardNewMacro(svtkImageCheckerboard);

//----------------------------------------------------------------------------
svtkImageCheckerboard::svtkImageCheckerboard()
{
...
template <class T>
void svtkImageCheckerboardExecute2(svtkImageCheckerboard* self, svtkImageData* in1Data, T* in1Ptr,
...
void svtkImageCheckerboard::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  if (!in1Ptr)
  {
    svtkErrorMacro(<< "Input " << 0 << " cannot be empty.");
    return;
  }
  ...
  if (!in2Ptr)
  {
    svtkErrorMacro(<< "Input " << 1 << " cannot be empty.");
    return;
  }
  ...
  {
    svtkTemplateMacro(svtkImageCheckerboardExecute2(this, inData[0][0], static_cast<SVTK_TT*>(in1Ptr),
      inData[1][0], static_cast<SVTK_TT*>(in2Ptr), outData[0], static_cast<SVTK_TT*>(outPtr), outExt,
      id, wholeExtent));
    default:
...
void svtkImageCheckerboard::PrintSelf(ostream& os, svtkIndent indent)
{
