/*=========================================================================
  ...
  Module:    svtkImageCityBlockDistance.cxx
...
=========================================================================*/
#include "svtkImageCityBlockDistance.h"
...
svtkStandardNewMacro(svtkImageCityBlockDistance);

//----------------------------------------------------------------------------
svtkImageCityBlockDistance::svtkImageCityBlockDistance() = default;

//----------------------------------------------------------------------------
void svtkImageCityBlockDistance::AllocateOutputScalars(
  svtkImageData* outData, int* uExt, int* wholeExtent, svtkInformation* outInfo)
{
...
int svtkImageCityBlockDistance::IterativeRequestUpdateExtent(
...
int svtkImageCityBlockDistance::IterativeRequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  int* wExt = outInfo->Get(svtkStreamingDemandDrivenPipeline::WHOLE_EXTENT());
  ...
  if (inData->GetScalarType() != SVTK_SHORT || outData->GetScalarType() != SVTK_SHORT)
  {
    svtkErrorMacro(<< "Execute: input ScalarType, " << inData->GetScalarType()
                  << ", and out ScalarType " << outData->GetScalarType() << " must be short.");
    return 1;
  }
