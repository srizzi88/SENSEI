...
//----------------------------------------------------------------------------
// Destructor
svtkImageConvolve::~svtkImageConvolve() = default;

//----------------------------------------------------------------------------
void svtkImageConvolve::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
// Set a 3x3 kernel
void svtkImageConvolve::SetKernel3x3(const double kernel[9])
{
  // Fill the kernel
...
//----------------------------------------------------------------------------
// Set a 5x5 kernel
void svtkImageConvolve::SetKernel5x5(const double kernel[25])
{
  // Fill the kernel
...
//----------------------------------------------------------------------------
// Set a 7x7 kernel
void svtkImageConvolve::SetKernel7x7(const double kernel[49])
{
  // Fill the kernel
...
//----------------------------------------------------------------------------
// Set a 3x3x3 kernel
void svtkImageConvolve::SetKernel3x3x3(const double kernel[27])
{
  // Fill the kernel
...
//----------------------------------------------------------------------------
// Set a 5x5x5 kernel
void svtkImageConvolve::SetKernel5x5x5(const double kernel[125])
{
  // Fill the kernel
...
//----------------------------------------------------------------------------
// Set a 7x7x7 kernel
void svtkImageConvolve::SetKernel7x7x7(const double kernel[343])
{
  // Fill the kernel
...
void svtkImageConvolve::SetKernel(const double* kernel, int sizeX, int sizeY, int sizeZ)
{
  int modified = 0;
...
//----------------------------------------------------------------------------
// Get the 3x3 kernel
double* svtkImageConvolve::GetKernel3x3()
{
...
//----------------------------------------------------------------------------
// Get the 5x5 kernel
double* svtkImageConvolve::GetKernel5x5()
{
  return this->GetKernel();
}
...
//----------------------------------------------------------------------------
// Get the 7x7 kernel
double* svtkImageConvolve::GetKernel7x7()
{
  return this->GetKernel();
}
...
double* svtkImageConvolve::GetKernel3x3x3()
{
  return this->GetKernel();
}
...
double* svtkImageConvolve::GetKernel5x5x5()
{
  return this->GetKernel();
}
...
double* svtkImageConvolve::GetKernel7x7x7()
{
  return this->GetKernel();
}
...
double* svtkImageConvolve::GetKernel()
{
  return this->Kernel;
}
...
//----------------------------------------------------------------------------
// Get the kernel
void svtkImageConvolve::GetKernel3x3(double kernel[9])
{
...
//----------------------------------------------------------------------------
// Get the kernel
void svtkImageConvolve::GetKernel5x5(double kernel[25])
{
  this->GetKernel(kernel);
}
...
//----------------------------------------------------------------------------
// Get the kernel
void svtkImageConvolve::GetKernel7x7(double kernel[49])
{
  this->GetKernel(kernel);
}
...
//----------------------------------------------------------------------------
// Get the kernel
void svtkImageConvolve::GetKernel3x3x3(double kernel[27])
{
  this->GetKernel(kernel);
}
...
//----------------------------------------------------------------------------
// Get the kernel
void svtkImageConvolve::GetKernel5x5x5(double kernel[125])
{
  this->GetKernel(kernel);
}
...
//----------------------------------------------------------------------------
// Get the kernel
void svtkImageConvolve::GetKernel7x7x7(double kernel[343])
{
  this->GetKernel(kernel);
}
...
//----------------------------------------------------------------------------
// Get the kernel, this is an internal method
void svtkImageConvolve::GetKernel(double* kernel)
{
...
template <class T>
void svtkImageConvolveExecute(svtkImageConvolve* self, svtkImageData* inData, T* inPtr,
  svtkImageData* outData, T* outPtr, int outExt[6], int id, svtkInformation* inInfo)
{
  ...
  inInfo->Get(svtkStreamingDemandDrivenPipeline::WHOLE_EXTENT(), inImageExt);
...
void svtkImageConvolve::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageConvolveExecute(this, inData[0][0], static_cast<SVTK_TT*>(inPtr),
