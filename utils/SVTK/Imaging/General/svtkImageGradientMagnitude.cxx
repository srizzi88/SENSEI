/*=========================================================================
  ...
  Module:    svtkImageGradientMagnitude.cxx
...
svtkStandardNewMacro(svtkImageGradientMagnitude);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageGradientMagnitude filter.
svtkImageGradientMagnitude::svtkImageGradientMagnitude()
{
...
//----------------------------------------------------------------------------
void svtkImageGradientMagnitude::PrintSelf(ostream& os, svtkIndent indent)
{
...
// output.
int svtkImageGradientMagnitude::RequestInformation(svtkInformation* svtkNotUsed(request),
...
int svtkImageGradientMagnitude::RequestUpdateExtent(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  int wholeExtent[6];
  int idx;
...
// out of extent.
template <class T>
void svtkImageGradientMagnitudeExecute(svtkImageGradientMagnitude* self, svtkImageData* inData,
...
void svtkImageGradientMagnitude::ThreadedExecute(
  svtkImageData* inData, svtkImageData* outData, int outExt[6], int id)
{
  ...
  {
    svtkErrorMacro(<< "Execute: input data type, " << inData->GetScalarType()
  ...
  {
    svtkTemplateMacro(svtkImageGradientMagnitudeExecute(this, inData, static_cast<SVTK_TT*>(inPtr),
