/*=========================================================================
  ...
  Module:    svtkImageHybridMedian2D.cxx
...
=========================================================================*/
#include "svtkImageHybridMedian2D.h"
...
svtkStandardNewMacro(svtkImageHybridMedian2D);

//----------------------------------------------------------------------------
svtkImageHybridMedian2D::svtkImageHybridMedian2D()
{
  this->KernelSize[0] = 5;
  this->KernelSize[1] = 5;
  this->KernelSize[2] = 1;
...
template <class T>
void svtkImageHybridMedian2DExecute(svtkImageHybridMedian2D* self, svtkImageData* inData, T* inPtr2,
  svtkImageData* outData, T* outPtr2, int outExt[6], int id, svtkInformation* inInfo)
{
    ...
    for (idx1 = min1; !self->AbortExecute && idx1 <= max1; ++idx1)
    {
      ...
      for (idx0 = min0; idx0 <= max0; ++idx0)
      {
        ...
        for (idxC = 0; idxC < numComps; ++idxC)
        {
          ...
          // note that y axis direction is up in svtk images, not down
...
void svtkImageHybridMedian2D::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageHybridMedian2DExecute(this, inData[0][0], static_cast<SVTK_TT*>(inPtr),
