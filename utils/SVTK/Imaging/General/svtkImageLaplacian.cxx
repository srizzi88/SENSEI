...
svtkStandardNewMacro(svtkImageLaplacian);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageLaplacian filter.
svtkImageLaplacian::svtkImageLaplacian()
{
  this->Dimensionality = 2;
}

//----------------------------------------------------------------------------
void svtkImageLaplacian::PrintSelf(ostream& os, svtkIndent indent)
{
...
int svtkImageLaplacian::RequestUpdateExtent(svtkInformation* svtkNotUsed(request),
...
// out of extent.
template <class T>
void svtkImageLaplacianExecute(svtkImageLaplacian* self, svtkImageData* inData, T* inPtr,
...
void svtkImageLaplacian::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageLaplacianExecute(this, inData[0][0], static_cast<SVTK_TT*>(inPtr),
