...
svtkStandardNewMacro(svtkImageRange3D);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageRange3D filter.
// By default zero values are dilated.
svtkImageRange3D::svtkImageRange3D()
{
...
//----------------------------------------------------------------------------
void svtkImageRange3D::PrintSelf(ostream& os, svtkIndent indent)
{
...
void svtkImageRange3D::SetKernelSize(int size0, int size1, int size2)
{
  int modified = 0;
...
int svtkImageRange3D::RequestInformation(
...
template <class T>
void svtkImageRange3DExecute(svtkImageRange3D* self, svtkImageData* mask, svtkImageData* inData,
...
void svtkImageRange3D::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageRange3DExecute(this, mask, inData[0][0], static_cast<SVTK_TT*>(inPtr),
...
//----------------------------------------------------------------------------
int svtkImageRange3D::RequestData(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  this->Ellipse->Update();
