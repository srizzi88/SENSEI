...
svtkStandardNewMacro(svtkImageSobel2D);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageSobel2D filter.
svtkImageSobel2D::svtkImageSobel2D()
{
  this->KernelSize[0] = 3;
  this->KernelSize[1] = 3;
  this->KernelSize[2] = 1;
...
//----------------------------------------------------------------------------
void svtkImageSobel2D::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
int svtkImageSobel2D::RequestInformation(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  int retval = this->Superclass::RequestInformation(request, inputVector, outputVector);
  svtkInformation* outInfo = outputVector->GetInformationObject(0);
  svtkDataObject::SetPointDataActiveScalarInfo(outInfo, SVTK_DOUBLE, 2);
  return retval;
}
...
// out of extent.
template <class T>
void svtkImageSobel2DExecute(svtkImageSobel2D* self, svtkImageData* inData, T* inPtr,
  svtkImageData* outData, int* outExt, double* outPtr, int id, svtkInformation* inInfo)
{
  ...
  svtkIdType inInc0L, inInc0R, inInc1L, inInc1R;
  T *inPtrL, *inPtrR;
  double sum;
...
void svtkImageSobel2D::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageSobel2DExecute(this, inData[0][0], static_cast<SVTK_TT*>(inPtr),
