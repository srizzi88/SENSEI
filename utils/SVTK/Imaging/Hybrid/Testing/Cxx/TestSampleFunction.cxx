...
int TestSampleFunction(int, char*[])
{
  ...
  svtkSmartPointer<svtkSampleFunction> sf1 = svtkSmartPointer<svtkSampleFunction>::New();
  sf1->AddObserver(svtkCommand::ErrorEvent, errorObserver);
  ...
  bounds[4] = zmin;
  bounds[5] = zmax;
  svtkSmartPointer<svtkSampleFunction> sf2 = svtkSmartPointer<svtkSampleFunction>::New();
  ...
  svtkSmartPointer<svtkSampleFunction> sf3 = svtkSmartPointer<svtkSampleFunction>::New();
  ...
  svtkSmartPointer<svtkSampleFunction> sf4 = svtkSmartPointer<svtkSampleFunction>::New();
  ...
  svtkDataArray* sa = sf4->GetOutput()->GetPointData()->GetScalars();
  double* s4 = static_cast<double*>(sa->GetVoidPointer(0));

  svtkSmartPointer<svtkSampleFunction> sf5 = svtkSmartPointer<svtkSampleFunction>::New();
  ...
  std::cout << "ModelBounds: " << bounds[0] << ", " << bounds[1] << ", " << bounds[2] << ", "
  ...
  std::cout << "After SetOutputScalarTypeToDouble, OutputScalarType: " << sf3->GetOutputScalarType()
            << std::endl;
  sf3->SetOutputScalarTypeToFloat();
  std::cout << "After SetOutputScalarTypeToFloat, OutputScalarType: " << sf3->GetOutputScalarType()
            << std::endl;
  sf3->SetOutputScalarTypeToLong();
  std::cout << "After SetOutputScalarTypeToLong, OutputScalarType: " << sf3->GetOutputScalarType()
            << std::endl;
  sf3->SetOutputScalarTypeToUnsignedLong();
  std::cout << "After SetOutputScalarTypeToUnsignedLong, OutputScalarType: "
            << sf3->GetOutputScalarType() << std::endl;
  sf3->SetOutputScalarTypeToInt();
  std::cout << "After SetOutputScalarTypeToInt, OutputScalarType: " << sf3->GetOutputScalarType()
            << std::endl;
  sf3->SetOutputScalarTypeToUnsignedInt();
  std::cout << "After SetOutputScalarTypeToUnsignedInt, OutputScalarType: "
            << sf3->GetOutputScalarType() << std::endl;
  sf3->SetOutputScalarTypeToShort();
  std::cout << "After SetOutputScalarTypeToShort, OutputScalarType: " << sf3->GetOutputScalarType()
            << std::endl;
  sf3->SetOutputScalarTypeToUnsignedShort();
  std::cout << "After SetOutputScalarTypeToUnsignedShort, OutputScalarType: "
            << sf3->GetOutputScalarType() << std::endl;
  sf3->SetOutputScalarTypeToChar();
  std::cout << "After SetOutputScalarTypeToChar, OutputScalarType: " << sf3->GetOutputScalarType()
            << std::endl;
  sf3->SetOutputScalarTypeToUnsignedChar();
  std::cout << "After SetOutputScalarTypeToUnsignedChar, OutputScalarType: "
            << sf3->GetOutputScalarType() << std::endl;
  return EXIT_SUCCESS;
}
