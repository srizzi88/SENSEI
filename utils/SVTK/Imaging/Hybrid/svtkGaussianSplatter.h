...
=========================================================================*/
/**
 * @class   svtkGaussianSplatter
 * @brief   splat points into a volume with an elliptical, Gaussian distribution
 *
 * svtkGaussianSplatter is a filter that injects input points into a
 ...
 *
 * @sa
 * svtkShepardMethod svtkCheckerboardSplatter
 */

#ifndef svtkGaussianSplatter_h
#define svtkGaussianSplatter_h
...
class SVTKIMAGINGHYBRID_EXPORT svtkGaussianSplatter : public svtkImageAlgorithm
{
public:
  svtkTypeMacro(svtkGaussianSplatter, svtkImageAlgorithm);
   ...
   */
  static svtkGaussianSplatter* New();
   ...
   */
  svtkSetClampMacro(Radius, double, 0.0, 1.0);
   ...
   * properly.
   */
  friend class svtkGaussianSplatterAlgorithm;
  double SamplePoint(double x[3]) // for compilers who can't handle this
  {
    return (this->*Sample)(x);
  }
  void SetScalar(svtkIdType idx, double dist2, double* sPtr)
  {
...
protected:
  svtkGaussianSplatter();
  ~svtkGaussianSplatter() override {}

  int FillInputPortInformation(int port, svtkInformation* info) override;
  int RequestInformation(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;
  int RequestData(svtkInformation*, svtkInformationVector**, svtkInformationVector*) override;
  void Cap(svtkDoubleArray* s);
...
private:
  double Radius2;
  double (svtkGaussianSplatter::*Sample)(double x[3]);
  double (svtkGaussianSplatter::*SampleFactor)(double s);
  char* Visited;
...
private:
  svtkGaussianSplatter(const svtkGaussianSplatter&) = delete;
  void operator=(const svtkGaussianSplatter&) = delete;
};
