...
svtkStandardNewMacro(svtkImageCursor3D);

//----------------------------------------------------------------------------
void svtkImageCursor3D::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
svtkImageCursor3D::svtkImageCursor3D()
{
...
template <class T>
void svtkImageCursor3DExecute(svtkImageCursor3D* self, svtkImageData* outData, T* ptr)
{
...
int svtkImageCursor3D::RequestData(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  {
    svtkTemplateMacro(svtkImageCursor3DExecute(this, outData, static_cast<SVTK_TT*>(ptr)));
    default:
