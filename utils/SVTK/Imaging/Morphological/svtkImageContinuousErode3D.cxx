/*=========================================================================
  ...
  Module:    svtkImageContinuousErode3D.cxx
...
=========================================================================*/
#include "svtkImageContinuousErode3D.h"
...
svtkStandardNewMacro(svtkImageContinuousErode3D);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageContinuousErode3D filter.
// By default zero values are eroded.
svtkImageContinuousErode3D::svtkImageContinuousErode3D()
{
...
//----------------------------------------------------------------------------
void svtkImageContinuousErode3D::PrintSelf(ostream& os, svtkIndent indent)
{
...
void svtkImageContinuousErode3D::SetKernelSize(int size0, int size1, int size2)
{
  int modified = 0;
...
template <class T>
void svtkImageContinuousErode3DExecute(svtkImageContinuousErode3D* self, svtkImageData* mask,
...
void svtkImageContinuousErode3D::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(
      svtkImageContinuousErode3DExecute(this, mask, inData[0][0], static_cast<SVTK_TT*>(inPtr),
...
//----------------------------------------------------------------------------
int svtkImageContinuousErode3D::RequestData(
