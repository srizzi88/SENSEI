/*=========================================================================
  ...
  Module:    svtkImageDilateErode3D.cxx
...
svtkStandardNewMacro(svtkImageDilateErode3D);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageDilateErode3D filter.
// By default zero values are dilated.
svtkImageDilateErode3D::svtkImageDilateErode3D()
{
...
//----------------------------------------------------------------------------
void svtkImageDilateErode3D::PrintSelf(ostream& os, svtkIndent indent)
{
...
void svtkImageDilateErode3D::SetKernelSize(int size0, int size1, int size2)
{
  int modified = 0;
...
template <class T>
void svtkImageDilateErode3DExecute(svtkImageDilateErode3D* self, svtkImageData* mask,
...
void svtkImageDilateErode3D::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageDilateErode3DExecute(this, mask, inData[0][0],
      static_cast<SVTK_TT*>(inPtr), outData[0], outExt, static_cast<SVTK_TT*>(outPtr), id, inInfo));
    default:
...
//----------------------------------------------------------------------------
int svtkImageDilateErode3D::RequestData(
