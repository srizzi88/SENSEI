/*=========================================================================
  ...
  Module:    svtkImageNonMaximumSuppression.cxx
...
=========================================================================*/
#include "svtkImageNonMaximumSuppression.h"
...
svtkStandardNewMacro(svtkImageNonMaximumSuppression);

//----------------------------------------------------------------------------
// Construct an instance of svtkImageNonMaximumSuppression filter.
svtkImageNonMaximumSuppression::svtkImageNonMaximumSuppression()
{
...
// output.
int svtkImageNonMaximumSuppression::RequestInformation(svtkInformation* svtkNotUsed(request),
...
int svtkImageNonMaximumSuppression::RequestUpdateExtent(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  // get the info objects
  svtkInformation* outInfo = outputVector->GetInformationObject(0);
  ...
  inInfo2->Set(svtkStreamingDemandDrivenPipeline::UPDATE_EXTENT(), inExt, 6);
...
template <class T>
void svtkImageNonMaximumSuppressionExecute(svtkImageNonMaximumSuppression* self,
  svtkImageData* in1Data, T* in1Ptr, svtkImageData* in2Data, T* in2Ptr, svtkImageData* outData,
...
void svtkImageNonMaximumSuppression::ThreadedRequestData(svtkInformation* svtkNotUsed(request),
  ...
  svtkImageData*** inData, svtkImageData** outData, int outExt[6], int id)
{
  ...
  {
    svtkTemplateMacro(svtkImageNonMaximumSuppressionExecute(this, inData[0][0],
      static_cast<SVTK_TT*>(in1Ptr), inData[1][0], static_cast<SVTK_TT*>(in2Ptr), outData[0],
...
void svtkImageNonMaximumSuppression::PrintSelf(ostream& os, svtkIndent indent)
{
