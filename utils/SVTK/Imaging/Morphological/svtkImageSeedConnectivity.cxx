/*=========================================================================
  ...
  Module:    svtkImageSeedConnectivity.cxx
...
=========================================================================*/
#include "svtkImageSeedConnectivity.h"
...
svtkStandardNewMacro(svtkImageSeedConnectivity);

//----------------------------------------------------------------------------
svtkImageSeedConnectivity::svtkImageSeedConnectivity()
{
  this->InputConnectValue = 255;
  this->OutputConnectedValue = 255;
  this->OutputUnconnectedValue = 0;
  this->Seeds = nullptr;
  this->Connector = svtkImageConnector::New();
...
//----------------------------------------------------------------------------
void svtkImageSeedConnectivity::RemoveAllSeeds()
{
...
//----------------------------------------------------------------------------
void svtkImageSeedConnectivity::AddSeed(int num, int* index)
{
  int idx, newIndex[3];
...
//----------------------------------------------------------------------------
void svtkImageSeedConnectivity::AddSeed(int i0, int i1, int i2)
{
  int index[3];
...
//----------------------------------------------------------------------------
void svtkImageSeedConnectivity::AddSeed(int i0, int i1)
{
  int index[2];
...
//----------------------------------------------------------------------------
int svtkImageSeedConnectivity::RequestUpdateExtent(svtkInformation* svtkNotUsed(request),
...
//----------------------------------------------------------------------------
int svtkImageSeedConnectivity::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  if (inData->GetScalarType() != SVTK_UNSIGNED_CHAR || outData->GetScalarType() != SVTK_UNSIGNED_CHAR)
  {
    svtkErrorMacro("Execute: Both input and output must have scalar type UnsignedChar");
    return 1;
  }
...
void svtkImageSeedConnectivity::PrintSelf(ostream& os, svtkIndent indent)
{
