/*=========================================================================
  ...
  Module:    svtkImageSinusoidSource.cxx
...
svtkStandardNewMacro(svtkImageSinusoidSource);

//----------------------------------------------------------------------------
svtkImageSinusoidSource::svtkImageSinusoidSource()
{
...
void svtkImageSinusoidSource::SetDirection(double v[3])
{
  this->SetDirection(v[0], v[1], v[2]);
}

void svtkImageSinusoidSource::SetDirection(double v0, double v1, double v2)
{
  double sum;
  ...
  if (sum == 0.0)
  {
    svtkErrorMacro("Zero direction vector");
    return;
  }
  ...
  if (this->Direction[0] == v0 && this->Direction[1] == v1 && this->Direction[2] == v2)
  {
    return;
  }
...
//----------------------------------------------------------------------------
void svtkImageSinusoidSource::SetWholeExtent(
...
//----------------------------------------------------------------------------
int svtkImageSinusoidSource::RequestInformation(svtkInformation* svtkNotUsed(request),
...
//----------------------------------------------------------------------------
void svtkImageSinusoidSource::ExecuteDataWithInformation(
  ...
  for (idxZ = 0; idxZ <= maxZ; idxZ++)
  {
    ...
    for (idxY = 0; !this->AbortExecute && idxY <= maxY; idxY++)
    {
      ...
      for (idxX = 0; idxX <= maxX; idxX++)
      {
        ...
        *outPtr = this->Amplitude * cos((2.0 * svtkMath::Pi() * sum / this->Period) - this->Phase);
        outPtr++;
      }
      outPtr += outIncY;
    }
...
//----------------------------------------------------------------------------
void svtkImageSinusoidSource::PrintSelf(ostream& os, svtkIndent indent)
{
