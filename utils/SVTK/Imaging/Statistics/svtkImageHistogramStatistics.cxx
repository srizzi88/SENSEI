/*=========================================================================
  ...
  Module:    svtkImageHistogramStatistics.cxx
...
svtkStandardNewMacro(svtkImageHistogramStatistics);

//----------------------------------------------------------------------------
// Constructor sets default values
svtkImageHistogramStatistics::svtkImageHistogramStatistics()
{
...
//----------------------------------------------------------------------------
svtkImageHistogramStatistics::~svtkImageHistogramStatistics() = default;

//----------------------------------------------------------------------------
void svtkImageHistogramStatistics::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
int svtkImageHistogramStatistics::RequestData(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  svtkIdType total = this->Total;
  svtkIdType sum = 0;
  svtkIdType lowSum = static_cast<svtkIdType>(total * lowPercentile);
  svtkIdType highSum = static_cast<svtkIdType>(total * highPercentile);
  svtkIdType midSum = total / 2;
  svtkIdType lowVal = 0;
  svtkIdType highVal = 0;
  svtkIdType midVal = 0;
  svtkIdType minVal = -1;
  svtkIdType maxVal = 0;
  double mom1 = 0;
  double mom2 = 0;
  svtkIdType nx = this->Histogram->GetNumberOfTuples();
