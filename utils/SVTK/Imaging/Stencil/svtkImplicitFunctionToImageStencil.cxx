/*=========================================================================
  ...
  Module:    svtkImplicitFunctionToImageStencil.cxx
...
=========================================================================*/
#include "svtkImplicitFunctionToImageStencil.h"
...
svtkStandardNewMacro(svtkImplicitFunctionToImageStencil);
svtkCxxSetObjectMacro(svtkImplicitFunctionToImageStencil, Input, svtkImplicitFunction);

//----------------------------------------------------------------------------
svtkImplicitFunctionToImageStencil::svtkImplicitFunctionToImageStencil()
{
...
//----------------------------------------------------------------------------
void svtkImplicitFunctionToImageStencil::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
svtkMTimeType svtkImplicitFunctionToImageStencil::GetMTime()
{
  svtkMTimeType mTime = this->Superclass::GetMTime();

  if (this->Input != nullptr)
  {
    svtkMTimeType nTime = this->Input->GetMTime();
...
int svtkImplicitFunctionToImageStencil::RequestData(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  ...
  svtkImplicitFunction* function = this->Input;
