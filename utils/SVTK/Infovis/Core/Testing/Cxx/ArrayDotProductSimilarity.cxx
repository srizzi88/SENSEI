...
int ArrayDotProductSimilarity(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  ...
  try
  {
    ...
    svtkSmartPointer<svtkDenseArray<double> > matrix_a =
      svtkSmartPointer<svtkDenseArray<double> >::New();
    matrix_a->Resize(svtkArrayExtents(2, 2));
    matrix_a->SetValue(svtkArrayCoordinates(0, 0), 1);
    matrix_a->SetValue(svtkArrayCoordinates(1, 0), 2);
    matrix_a->SetValue(svtkArrayCoordinates(0, 1), 3);
    matrix_a->SetValue(svtkArrayCoordinates(1, 1), 4);

    svtkSmartPointer<svtkArrayData> matrix_data_a = svtkSmartPointer<svtkArrayData>::New();
    matrix_data_a->AddArray(matrix_a);

    svtkSmartPointer<svtkDotProductSimilarity> similarity =
      svtkSmartPointer<svtkDotProductSimilarity>::New();
    ...
    svtkSmartPointer<svtkDenseArray<double> > matrix_b =
      svtkSmartPointer<svtkDenseArray<double> >::New();
    matrix_b->Resize(svtkArrayExtents(2, 2));
    matrix_b->SetValue(svtkArrayCoordinates(0, 0), 5);
    matrix_b->SetValue(svtkArrayCoordinates(1, 0), 6);
    matrix_b->SetValue(svtkArrayCoordinates(0, 1), 7);
    matrix_b->SetValue(svtkArrayCoordinates(1, 1), 8);

    svtkSmartPointer<svtkArrayData> matrix_data_b = svtkSmartPointer<svtkArrayData>::New();
