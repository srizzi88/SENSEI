...
int TestWordCloud(int argc, char* argv[])
{
  ...
  svtkWordCloud::OffsetDistributionContainer offset;
  offset[0] = 0;
  offset[1] = 0;
  ...
  auto interactor = svtkSmartPointer<svtkRenderWindowInteractor>::New();

  auto imageViewer = svtkSmartPointer<svtkImageViewer2>::New();
  ...
  // Zoom in a bit
  svtkCamera* camera = imageViewer->GetRenderer()->GetActiveCamera();
