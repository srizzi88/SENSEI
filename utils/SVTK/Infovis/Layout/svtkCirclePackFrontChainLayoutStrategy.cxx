/*=========================================================================
  ...
  Module:    svtkCirclePackFrontChainLayoutStrategy.cxx
...
svtkStandardNewMacro(svtkCirclePackFrontChainLayoutStrategy);

class svtkCirclePackFrontChainLayoutStrategyImplementation
{

public:
  svtkCirclePackFrontChainLayoutStrategyImplementation();
  ~svtkCirclePackFrontChainLayoutStrategyImplementation();

  void createCirclePacking(
    svtkTree* tree, svtkDataArray* sizeArray, svtkDataArray* circlesArray, int height, int width);

  void packTreeNodes(svtkIdType treeNode, double originX, double originY,
    double enclosingCircleRadius, svtkDataArray* circlesArray, svtkDataArray* sizeArray,
    svtkTree* tree);

  void packBrotherNodes(std::vector<svtkIdType>& packedNodes, double originX, double originY,
    double enclosingCircleRadius, svtkDataArray* circlesArray, svtkDataArray* sizeArray,
    svtkTree* tree);

  void findCircleCenter(svtkIdType Ci, svtkIdType Cm, svtkIdType Cn, svtkDataArray* circlesArray);

  void findIntersectingCircle(svtkIdType Ci, bool& CjAfterCn, std::list<svtkIdType>::iterator& Cj,
    std::list<svtkIdType>::iterator Cm, std::list<svtkIdType>::iterator Cn,
    svtkDataArray* circlesArray, std::list<svtkIdType>& frontChain);

  bool validCjAfterCn(svtkIdType Ci, std::list<svtkIdType>::iterator Cm,
    std::list<svtkIdType>::iterator Cn, svtkDataArray* circlesArray, std::list<svtkIdType>& frontChain,
    int searchPathLength);

  bool validCjBeforeCm(svtkIdType Ci, std::list<svtkIdType>::iterator Cm,
    std::list<svtkIdType>::iterator Cn, svtkDataArray* circlesArray, std::list<svtkIdType>& frontChain,
    int searchPathLength);

  void findCm(double originX, double originY, svtkDataArray* circlesArray,
    std::list<svtkIdType>::iterator& Cm, std::list<svtkIdType>& frontChain);

  void findCn(std::list<svtkIdType>::iterator Cm, std::list<svtkIdType>::iterator& Cn,
    std::list<svtkIdType>& frontChain);

  bool circlesIntersect(svtkIdType circleOne, svtkIdType circleTwo, svtkDataArray* circlesArray);

  void deleteSection(std::list<svtkIdType>::iterator circleToStartAt,
    std::list<svtkIdType>::iterator circleToEndAt, std::list<svtkIdType>& frontChain);

  void incrListIteratorWrapAround(
    std::list<svtkIdType>::iterator& i, std::list<svtkIdType>& frontChain);
...
svtkCirclePackFrontChainLayoutStrategyImplementation::
  svtkCirclePackFrontChainLayoutStrategyImplementation() = default;

svtkCirclePackFrontChainLayoutStrategyImplementation::
  ~svtkCirclePackFrontChainLayoutStrategyImplementation() = default;

void svtkCirclePackFrontChainLayoutStrategyImplementation::incrListIteratorWrapAround(
  std::list<svtkIdType>::iterator& i, std::list<svtkIdType>& frontChain)
{
  if (i != frontChain.end())
    ++i;
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::decrListIteratorWrapAround(
  std::list<svtkIdType>::iterator& i, std::list<svtkIdType>& frontChain)
{
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::createCirclePacking(
  svtkTree* tree, svtkDataArray* sizeArray, svtkDataArray* circlesArray, int height, int width)
{
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::packTreeNodes(svtkIdType treeNode,
  double originX, double originY, double enclosingCircleRadius, svtkDataArray* circlesArray,
  svtkDataArray* sizeArray, svtkTree* tree)
{
  ...
  else
  {
    ...
    std::vector<svtkIdType> childNodesPackList;
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::packBrotherNodes(
  std::vector<svtkIdType>& packedNodes, double originX, double originY, double enclosingCircleRadius,
  svtkDataArray* circlesArray, svtkDataArray* sizeArray, svtkTree* tree)
{
  ...
  else
  {
    ...
    std::list<svtkIdType>::iterator Cm;
    std::list<svtkIdType>::iterator Cn;
    ...
    for (int i = 3; i < (int)packedNodes.size(); i++)
    {
      ...
      std::list<svtkIdType>::iterator Cj;
      bool CjAfterCn;
      ...
      std::list<svtkIdType>::iterator ti = Cm;
  ...
  double Xfc = 0.0;
  double Yfc = 0.0;
  std::list<svtkIdType>::iterator it;
...
bool svtkCirclePackFrontChainLayoutStrategyImplementation::validCjAfterCn(svtkIdType Ci,
  std::list<svtkIdType>::iterator Cm, std::list<svtkIdType>::iterator Cn, svtkDataArray* circlesArray,
  std::list<svtkIdType>& frontChain, int searchPathLength)
{
...
bool svtkCirclePackFrontChainLayoutStrategyImplementation::validCjBeforeCm(svtkIdType Ci,
  std::list<svtkIdType>::iterator Cm, std::list<svtkIdType>::iterator Cn, svtkDataArray* circlesArray,
  std::list<svtkIdType>& frontChain, int searchPathLength)
{
  this->findCircleCenter(Ci, *Cm, *Cn, circlesArray);
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::findIntersectingCircle(svtkIdType Ci,
  bool& CjAfterCn, std::list<svtkIdType>::iterator& Cj, std::list<svtkIdType>::iterator Cm,
  std::list<svtkIdType>::iterator Cn, svtkDataArray* circlesArray, std::list<svtkIdType>& frontChain)
{
  ...
  std::list<svtkIdType>::iterator CjfromCn = frontChain.end();
  std::list<svtkIdType>::iterator CjfromCm = frontChain.end();
  std::list<svtkIdType>::iterator lCm = Cm;
  std::list<svtkIdType>::iterator lCn = Cn;
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::findCircleCenter(
  svtkIdType Ci, svtkIdType Cm, svtkIdType Cn, svtkDataArray* circlesArray)
{
  ...
  if (xAxisAngle < 0)
  {
    xAxisAngle = svtkMath::Pi() + (svtkMath::Pi() + xAxisAngle);
  }
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::findCm(double originX, double originY,
  svtkDataArray* circlesArray, std::list<svtkIdType>::iterator& Cm, std::list<svtkIdType>& frontChain)
{
  std::list<svtkIdType>::iterator it = frontChain.begin();
  Cm = it;
  double circle[3];
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::findCn(std::list<svtkIdType>::iterator Cm,
  std::list<svtkIdType>::iterator& Cn, std::list<svtkIdType>& frontChain)
{
  incrListIteratorWrapAround(Cm, frontChain);
  if (Cm == frontChain.end())
  {
...
bool svtkCirclePackFrontChainLayoutStrategyImplementation::circlesIntersect(
  svtkIdType circleOne, svtkIdType circleTwo, svtkDataArray* circlesArray)
{
  double c1[3];
  double c2[3];
...
void svtkCirclePackFrontChainLayoutStrategyImplementation::deleteSection(
  std::list<svtkIdType>::iterator circleToStartAt, std::list<svtkIdType>::iterator circleToEndAt,
  std::list<svtkIdType>& frontChain)
{
...
svtkCirclePackFrontChainLayoutStrategy::svtkCirclePackFrontChainLayoutStrategy()
{
  this->Width = 1;
  this->Height = 1;
  this->pimpl = new svtkCirclePackFrontChainLayoutStrategyImplementation;
}
...
void svtkCirclePackFrontChainLayoutStrategy::Layout(
  svtkTree* inputTree, svtkDataArray* areaArray, svtkDataArray* sizeArray)
{

  this->pimpl->createCirclePacking(inputTree, sizeArray, areaArray, this->Height, this->Width);
}

void svtkCirclePackFrontChainLayoutStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
