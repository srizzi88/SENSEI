/*=========================================================================
  ...
  Module:    svtkClustering2DLayoutStrategy.cxx
...
svtkStandardNewMacro(svtkClustering2DLayoutStrategy);
...
svtkClustering2DLayoutStrategy::svtkClustering2DLayoutStrategy()
{
...
// Helper functions
void svtkClustering2DLayoutStrategy::GenerateCircularSplat(svtkImageData* splat, int x, int y)
{
...
void svtkClustering2DLayoutStrategy::GenerateGaussianSplat(svtkImageData* splat, int x, int y)
{
  splat->SetDimensions(x, y, 1);
  splat->AllocateScalars(SVTK_FLOAT, 1);
...
void svtkClustering2DLayoutStrategy::Initialize()
{
...
void svtkClustering2DLayoutStrategy::Layout()
{
...
void svtkClustering2DLayoutStrategy::ResolveCoincidentVertices()
{
...
void svtkClustering2DLayoutStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
