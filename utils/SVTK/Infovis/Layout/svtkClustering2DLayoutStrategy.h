/*=========================================================================
  ...
  Module:    svtkClustering2DLayoutStrategy.h
...
-------------------------------------------------------------------------*/
/**
 * @class   svtkClustering2DLayoutStrategy
...
#ifndef svtkClustering2DLayoutStrategy_h
#define svtkClustering2DLayoutStrategy_h
...
class SVTKINFOVISLAYOUT_EXPORT svtkClustering2DLayoutStrategy : public svtkGraphLayoutStrategy
{
public:
  static svtkClustering2DLayoutStrategy* New();

  svtkTypeMacro(svtkClustering2DLayoutStrategy, svtkGraphLayoutStrategy);
...
protected:
  svtkClustering2DLayoutStrategy();
  ~svtkClustering2DLayoutStrategy() override;
...
private:
  ...
  svtkClustering2DLayoutStrategy(const svtkClustering2DLayoutStrategy&) = delete;
  void operator=(const svtkClustering2DLayoutStrategy&) = delete;
};
