/*=========================================================================
  ...
  Module:    svtkCommunity2DLayoutStrategy.cxx
...
svtkStandardNewMacro(svtkCommunity2DLayoutStrategy);
...
svtkCommunity2DLayoutStrategy::svtkCommunity2DLayoutStrategy()
{
...
// Helper functions
void svtkCommunity2DLayoutStrategy::GenerateCircularSplat(svtkImageData* splat, int x, int y)
{
...
void svtkCommunity2DLayoutStrategy::GenerateGaussianSplat(svtkImageData* splat, int x, int y)
{
  splat->SetDimensions(x, y, 1);
  splat->AllocateScalars(SVTK_FLOAT, 1);
...
void svtkCommunity2DLayoutStrategy::Initialize()
{
...
void svtkCommunity2DLayoutStrategy::Layout()
{
  ...
  svtkDataArray* community = this->Graph->GetVertexData()->GetArray(this->CommunityArrayName);
  if (community == nullptr)
  {
    svtkWarningMacro("svtkCommunity2DLayoutStrategy did not find a \"community\" array."
...
void svtkCommunity2DLayoutStrategy::ResolveCoincidentVertices()
{
...
void svtkCommunity2DLayoutStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
