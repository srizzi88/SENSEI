/*=========================================================================
  ...
  Module:    svtkFast2DLayoutStrategy.cxx
...
svtkStandardNewMacro(svtkFast2DLayoutStrategy);
...
svtkFast2DLayoutStrategy::svtkFast2DLayoutStrategy()
{
...
// Helper functions
void svtkFast2DLayoutStrategy::GenerateCircularSplat(svtkImageData* splat, int x, int y)
{
...
void svtkFast2DLayoutStrategy::GenerateGaussianSplat(svtkImageData* splat, int x, int y)
{
  splat->SetDimensions(x, y, 1);
  splat->AllocateScalars(SVTK_FLOAT, 1);
...
void svtkFast2DLayoutStrategy::Initialize()
{
...
void svtkFast2DLayoutStrategy::Layout()
{
...
void svtkFast2DLayoutStrategy::ResolveCoincidentVertices()
{
...
void svtkFast2DLayoutStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
