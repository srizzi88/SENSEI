/*=========================================================================
  ...
  Module:    svtkForceDirectedLayoutStrategy.cxx
...
svtkStandardNewMacro(svtkForceDirectedLayoutStrategy);

svtkForceDirectedLayoutStrategy::svtkForceDirectedLayoutStrategy()
{
  this->RandomSeed = 123;
...
void svtkForceDirectedLayoutStrategy::Initialize()
{
  ...
  delete[] this->v;
  delete[] this->e;
  this->v = new svtkLayoutVertex[numVertices];
  this->e = new svtkLayoutEdge[numEdges];
  ...
  // cerr << endl << endl;
  // svtkSmartPointer<svtkOutEdgeIterator> it =
...
void svtkForceDirectedLayoutStrategy::Layout()
{
  ...
  for (int i = 0; i < this->IterationsPerLayout; i++)
  {
    ...
    for (svtkIdType j = 0; j < numVertices; j++)
    {
      ...
      v[j].d[1] = 0.0;
      v[j].d[2] = 0.0;
      for (svtkIdType l = 0; l < numVertices; l++)
      {
        if (j != l)
        {
...
void svtkForceDirectedLayoutStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
