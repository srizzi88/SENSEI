/*=========================================================================
  ...
  Module:    svtkGraphLayoutStrategy.h
 ...
 *
 *
 * All graph layouts should subclass from this class.  svtkGraphLayoutStrategy
 * works as a plug-in to the svtkGraphLayout algorithm.  The Layout()
...
#ifndef svtkGraphLayoutStrategy_h
#define svtkGraphLayoutStrategy_h
...
class SVTKINFOVISLAYOUT_EXPORT svtkGraphLayoutStrategy : public svtkObject
{
public:
  svtkTypeMacro(svtkGraphLayoutStrategy, svtkObject);
  ...
  svtkGetStringMacro(EdgeWeightField);
  //@}

protected:
  svtkGraphLayoutStrategy();
  ~svtkGraphLayoutStrategy() override;
...
private:
  svtkGraphLayoutStrategy(const svtkGraphLayoutStrategy&) = delete;
  void operator=(const svtkGraphLayoutStrategy&) = delete;
};
