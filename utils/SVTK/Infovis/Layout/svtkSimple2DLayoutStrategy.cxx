/*=========================================================================
  ...
  Module:    svtkSimple2DLayoutStrategy.cxx
...
svtkStandardNewMacro(svtkSimple2DLayoutStrategy);
...
svtkSimple2DLayoutStrategy::svtkSimple2DLayoutStrategy()
{

  // Create internal svtk classes
  this->RepulsionArray = svtkFloatArray::New();
  this->AttractionArray = svtkFloatArray::New();
...
void svtkSimple2DLayoutStrategy::Initialize()
{
...
void svtkSimple2DLayoutStrategy::Layout()
{
  ...
  float attractValue;
  float epsilon = 1e-5;
  svtkIdType pointIndex1 = 0;
  svtkIdType pointIndex2 = 0;
  for (int i = 0; i < this->IterationsPerLayout; ++i)
  {
    ...
    for (svtkIdType j = 0; j < numVertices; ++j)
    {
      ...
      for (svtkIdType k = 0; k < numVertices; ++k)
      {
...
void svtkSimple2DLayoutStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
