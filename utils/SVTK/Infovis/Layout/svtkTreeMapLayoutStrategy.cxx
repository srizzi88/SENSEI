/*=========================================================================
  ...
  Module:    svtkTreeMapLayoutStrategy.cxx
...
svtkTreeMapLayoutStrategy::svtkTreeMapLayoutStrategy() = default;

svtkTreeMapLayoutStrategy::~svtkTreeMapLayoutStrategy() = default;

void svtkTreeMapLayoutStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

void svtkTreeMapLayoutStrategy::AddBorder(float* boxInfo)
{
  float dx, dy;
...
svtkIdType svtkTreeMapLayoutStrategy::FindVertex(svtkTree* otree, svtkDataArray* array, float pnt[2])
{
