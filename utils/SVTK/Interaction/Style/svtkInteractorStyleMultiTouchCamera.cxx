/*=========================================================================
  ...
  Module:    svtkInteractorStyleMultiTouchCamera.cxx
...
svtkStandardNewMacro(svtkInteractorStyleMultiTouchCamera);

//----------------------------------------------------------------------------
svtkInteractorStyleMultiTouchCamera::svtkInteractorStyleMultiTouchCamera() = default;

//----------------------------------------------------------------------------
svtkInteractorStyleMultiTouchCamera::~svtkInteractorStyleMultiTouchCamera() = default;

//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnStartRotate()
{
  this->StartGesture();
}

//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnRotate()
{
  ...
  svtkInteractorObserver::ComputeDisplayToWorld(this->CurrentRenderer, pinchPositionDisplay[0],
  ...
  svtkMath::Subtract(oldPickPoint, newPickPoint, motionVector);

  svtkNew<svtkTransform> cameraTransform;
...
//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnEndRotate()
{
  this->EndGesture();
}

//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnStartPinch()
{
  this->StartGesture();
}

//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnPinch()
{
  if (this->State != SVTKIS_GESTURE)
  {
    return;
...
//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnEndPinch()
{
  this->EndGesture();
}

//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnStartPan()
{
  this->StartGesture();
}

//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnPan()
{
  if (this->State != SVTKIS_GESTURE)
  {
    return;
...
//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::OnEndPan()
{
  this->EndGesture();
}

//----------------------------------------------------------------------------
void svtkInteractorStyleMultiTouchCamera::PrintSelf(ostream& os, svtkIndent indent)
{
