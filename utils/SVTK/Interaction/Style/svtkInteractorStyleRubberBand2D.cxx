/*=========================================================================
  ...
  Module:    svtkInteractorStyleRubberBand2D.cxx
...
svtkStandardNewMacro(svtkInteractorStyleRubberBand2D);

//--------------------------------------------------------------------------
svtkInteractorStyleRubberBand2D::svtkInteractorStyleRubberBand2D()
{
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnLeftButtonDown()
{
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnLeftButtonUp()
{
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnMiddleButtonDown()
{
  if (this->Interaction == NONE)
  {
    this->Interaction = PANNING;
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnMiddleButtonUp()
{
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnRightButtonDown()
{
  if (this->Interaction == NONE)
  {
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnRightButtonUp()
{
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnMouseMove()
{
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnMouseWheelForward()
{
  this->FindPokedRenderer(
    this->Interactor->GetEventPosition()[0], this->Interactor->GetEventPosition()[1]);
  svtkCamera* camera = this->CurrentRenderer->GetActiveCamera();
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::OnMouseWheelBackward()
{
  this->FindPokedRenderer(
    this->Interactor->GetEventPosition()[0], this->Interactor->GetEventPosition()[1]);
  svtkCamera* camera = this->CurrentRenderer->GetActiveCamera();
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::RedrawRubberBand()
{
...
//--------------------------------------------------------------------------
void svtkInteractorStyleRubberBand2D::PrintSelf(ostream& os, svtkIndent indent)
{
