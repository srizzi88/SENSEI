/*=========================================================================
  ...
  Module:    svtkInteractorStyleUnicam.h
...
/*
 * This work (svtkInteractorStyleUnicam.h) was produced under a grant from
...
/**
 * @class   svtkInteractorStyleUnicam
...
#ifndef svtkInteractorStyleUnicam_h
#define svtkInteractorStyleUnicam_h
...
// but svtkWrapTcl signaled a "syntax error" when it parsed the 'enum' line.
// So, am making them defines which is what the other classes that want
// to have constants appear to do.
//
// buttons pressed
#define SVTK_UNICAM_NONE 0
#define SVTK_UNICAM_BUTTON_LEFT 1
#define SVTK_UNICAM_BUTTON_MIDDLE 2
#define SVTK_UNICAM_BUTTON_RIGHT 3
//
// camera modes
#define SVTK_UNICAM_CAM_INT_ROT 0
#define SVTK_UNICAM_CAM_INT_CHOOSE 1
#define SVTK_UNICAM_CAM_INT_PAN 2
#define SVTK_UNICAM_CAM_INT_DOLLY 3

class SVTKINTERACTIONSTYLE_EXPORT svtkInteractorStyleUnicam : public svtkInteractorStyle
{
public:
  static svtkInteractorStyleUnicam* New();
  svtkTypeMacro(svtkInteractorStyleUnicam, svtkInteractorStyle);
  ...
  svtkGetVectorMacro(WorldUpVector, double, 3);
...
protected:
  svtkInteractorStyleUnicam();
  ~svtkInteractorStyleUnicam() override;

  svtkWorldPointPicker* InteractionPicker;
  ...
  svtkActor* FocusSphere;            // geometry for indicating center of rotation
  int IsDot;                        // flag-- is the FocusSphere being displayed?
  svtkRenderer* FocusSphereRenderer; // renderer for 'FocusSphere'
  ...
  // projection plane.
  void GetRightVandUpV(double* p, svtkCamera* cam, double* rightV, double* upV);
...
private:
  svtkInteractorStyleUnicam(const svtkInteractorStyleUnicam&) = delete;
  void operator=(const svtkInteractorStyleUnicam&) = delete;
};

#endif // svtkInteractorStyleUnicam_h
