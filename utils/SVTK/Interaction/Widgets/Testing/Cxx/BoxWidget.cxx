...
class svtkBWCallback : public svtkCommand
{
public:
  static svtkBWCallback* New() { return new svtkBWCallback; }
  void Execute(svtkObject* caller, unsigned long, void*) override
  {
    svtkBoxWidget* boxWidget = reinterpret_cast<svtkBoxWidget*>(caller);
...
int BoxWidget(int, char*[])
{
  ...
  svtkSmartPointer<svtkBoxWidget> boxWidget = svtkSmartPointer<svtkBoxWidget>::New();
  ...
  svtkSmartPointer<svtkBWCallback> myCallback = svtkSmartPointer<svtkBWCallback>::New();
