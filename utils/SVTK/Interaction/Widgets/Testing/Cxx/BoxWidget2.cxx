...
class svtkBWCallback2 : public svtkCommand
{
public:
  static svtkBWCallback2* New() { return new svtkBWCallback2; }
...
const char BoxWidgetEventLog2[] = "# StreamVersion 1\n"
...
int BoxWidget2(int, char*[])
{
  ...
  svtkSmartPointer<svtkBWCallback2> myCallback = svtkSmartPointer<svtkBWCallback2>::New();
