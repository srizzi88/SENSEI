...
static char IPWeventLog[] = "# StreamVersion 1\n"
...
//----------------------------------------------------------------------------
class svtkWidgetWindowLevelCallback : public svtkCommand
{
public:
  static svtkWidgetWindowLevelCallback* New() { return new svtkWidgetWindowLevelCallback; }
...
int ImagePlaneWidget(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkWidgetWindowLevelCallback> cbk =
    svtkSmartPointer<svtkWidgetWindowLevelCallback>::New();
