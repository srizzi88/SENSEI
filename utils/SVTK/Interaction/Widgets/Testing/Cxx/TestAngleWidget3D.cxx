...
int TestAngleWidget3D(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkPointHandleRepresentation3D> handle =
    svtkSmartPointer<svtkPointHandleRepresentation3D>::New();
  handle->GetProperty()->SetColor(1, 0, 0);
  svtkSmartPointer<svtkAngleRepresentation3D> rep = svtkSmartPointer<svtkAngleRepresentation3D>::New();
  ...
  return svtkTesting::InteractorEventLoop(argc, argv, iren, TestAngleWidget3DEventLog);
}
