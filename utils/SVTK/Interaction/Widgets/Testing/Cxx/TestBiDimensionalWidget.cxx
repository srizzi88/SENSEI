...
=========================================================================*/
//
// This example tests the svtkBiDimensionalWidget.
...
class svtkBiDimensionalCallback : public svtkCommand
{
public:
  static svtkBiDimensionalCallback* New() { return new svtkBiDimensionalCallback; }
  void Execute(svtkObject*, unsigned long, void*) override
  {
    std::cout << "End interaction event\n" << std::flush;
  }
  svtkBiDimensionalCallback() = default;
};
...
int TestBiDimensionalWidget(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkBiDimensionalRepresentation2D> rep =
    svtkSmartPointer<svtkBiDimensionalRepresentation2D>::New();

  svtkSmartPointer<svtkBiDimensionalWidget> widget = svtkSmartPointer<svtkBiDimensionalWidget>::New();
  widget->SetInteractor(iren);
  widget->SetRepresentation(rep);

  svtkSmartPointer<svtkBiDimensionalCallback> callback =
    svtkSmartPointer<svtkBiDimensionalCallback>::New();
  widget->AddObserver(svtkCommand::EndInteractionEvent, callback);
