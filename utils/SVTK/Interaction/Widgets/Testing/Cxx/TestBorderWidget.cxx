...
=========================================================================*/
//
// This example tests the svtkBorderWidget.
...
const char BorderWidgetEventLog[] = "# StreamVersion 1\n"
...
int TestBorderWidget(int, char*[])
{
  ...
  svtkSmartPointer<svtkBorderRepresentation> rep = svtkSmartPointer<svtkBorderRepresentation>::New();
  rep->ProportionalResizeOn();
  rep->SetShowBorderToOn();

  svtkSmartPointer<svtkBorderWidget> widget = svtkSmartPointer<svtkBorderWidget>::New();
