...
class svtkButtonWidgetMultipleViewportsCallback : public svtkCommand
{
public:
  static svtkButtonWidgetMultipleViewportsCallback* New()
  {
    return new svtkButtonWidgetMultipleViewportsCallback;
  }
  ...
  svtkButtonWidgetMultipleViewportsCallback()
    : Glyph(nullptr)
  {
  }
  svtkGlyph3D* Glyph;
...
int TestButtonWidgetMultipleViewports(int argc, char* argv[])
{
  ...
  svtkNew<svtkAppendPolyData> apd;
  ...
  svtkNew<svtkButtonWidgetMultipleViewportsCallback> myCallback;
  myCallback->Glyph = glyph;

  svtkNew<svtkEllipticalButtonSource> button;
  button->TwoSidedOn();
  button->SetCircumferentialResolution(24);
  button->SetShoulderResolution(24);
  button->SetTextureResolution(24);

  svtkNew<svtkTexturedButtonRepresentation> rep;
  ...
  svtkNew<svtkButtonWidget> buttonWidget;
  ...
  svtkNew<svtkEllipticalButtonSource> button2;
  button2->TwoSidedOn();
  ...
  svtkNew<svtkTexturedButtonRepresentation> rep2;
  ...
  svtkNew<svtkTexturedButtonRepresentation2D> rep3;
  ...
  svtkNew<svtkTexturedButtonRepresentation2D> rep4;
  ...
  svtkNew<svtkPlatonicSolidSource> tet;
  ...
  svtkNew<svtkPlatonicSolidSource> cube;
  ...
  svtkNew<svtkButtonWidget> buttonWidget5;
  ...
  return svtkTesting::InteractorEventLoop(argc, argv, iren, ButtonWidgetMultipleViewportsEventLog);
}
