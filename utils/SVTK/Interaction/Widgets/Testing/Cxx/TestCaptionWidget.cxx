...
int TestCaptionWidget(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  ...
  // Create the widget
  svtkSmartPointer<svtkCaptionRepresentation> rep = svtkSmartPointer<svtkCaptionRepresentation>::New();
  ...
  svtkSmartPointer<svtkCaptionWidget> widget = svtkSmartPointer<svtkCaptionWidget>::New();
