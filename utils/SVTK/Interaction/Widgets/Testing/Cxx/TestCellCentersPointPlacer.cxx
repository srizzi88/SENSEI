...
=========================================================================*/
// This test demonstrates the svtkCellCentersPointPlacer. The placer may
...
void CreateHexahedronActor(svtkActor* actor);
void CreatePentagonalPrismActor(svtkActor* actor);
void CreatePyramidActor(svtkActor* actor);
void CreateTetraActor(svtkActor* actor);
void CreateVoxelActor(svtkActor* actor);
void CreateWedgeActor(svtkActor* actor);
...
int TestCellCentersPointPlacer(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkActor> hexahedronActor = svtkSmartPointer<svtkActor>::New();
  CreateHexahedronActor(hexahedronActor);
  actors.push_back(hexahedronActor);

  svtkSmartPointer<svtkActor> pentagonalPrismActor = svtkSmartPointer<svtkActor>::New();
  CreatePentagonalPrismActor(pentagonalPrismActor);
  actors.push_back(pentagonalPrismActor);

  svtkSmartPointer<svtkActor> pyramidActor = svtkSmartPointer<svtkActor>::New();
  CreatePyramidActor(pyramidActor);
  actors.push_back(pyramidActor);

  svtkSmartPointer<svtkActor> tetraActor = svtkSmartPointer<svtkActor>::New();
  CreateTetraActor(tetraActor);
  actors.push_back(tetraActor);

  svtkSmartPointer<svtkActor> voxelActor = svtkSmartPointer<svtkActor>::New();
  CreateVoxelActor(voxelActor);
  actors.push_back(voxelActor);

  svtkSmartPointer<svtkActor> wedgeActor = svtkSmartPointer<svtkActor>::New();
  ...
  // its constraints.
  svtkSmartPointer<svtkCellCentersPointPlacer> pointPlacer =
    svtkSmartPointer<svtkCellCentersPointPlacer>::New();
  ...
  for (int row = 0; row < gridDimensions; row++)
  {
    for (int col = 0; col < gridDimensions; col++)
    {
      ...
      svtkSmartPointer<svtkTransformFilter> transformFilter =
        svtkSmartPointer<svtkTransformFilter>::New();
      ...
      svtkSmartPointer<svtkMatrixToLinearTransform> mlt =
      ...
      svtkSmartPointer<svtkDataSetMapper> mapper2 = svtkSmartPointer<svtkDataSetMapper>::New();
  ...
  svtkSmartPointer<svtkDistanceWidget> widget = svtkSmartPointer<svtkDistanceWidget>::New();
  widget->CreateDefaultRepresentation();
  svtkSmartPointer<svtkDistanceRepresentation2D> rep =
  ...
  // widget
  svtkSmartPointer<svtkPointHandleRepresentation3D> handleRep3D =
  ...
  // turn it off.
  static_cast<svtkPointHandleRepresentation3D*>(rep->GetPoint1Representation())->SmoothMotionOff();
  static_cast<svtkPointHandleRepresentation3D*>(rep->GetPoint2Representation())->SmoothMotionOff();
...
void CreateHexahedronActor(svtkActor* actor)
{
  ...
  svtkSmartPointer<svtkHexahedron> hex = svtkSmartPointer<svtkHexahedron>::New();
  ...
  svtkSmartPointer<svtkCellArray> hexs = svtkSmartPointer<svtkCellArray>::New();
...
void CreatePentagonalPrismActor(svtkActor* actor)
{
  ...
  // Pentagonal Prism
  svtkSmartPointer<svtkPentagonalPrism> pentagonalPrism = svtkSmartPointer<svtkPentagonalPrism>::New();
...
void CreatePyramidActor(svtkActor* actor)
{
  ...
  svtkSmartPointer<svtkPyramid> pyramid = svtkSmartPointer<svtkPyramid>::New();
...
void CreateVoxelActor(svtkActor* actor)
{
  ...
  svtkSmartPointer<svtkVoxel> voxel = svtkSmartPointer<svtkVoxel>::New();
...
void CreateWedgeActor(svtkActor* actor)
{
  ...
  svtkSmartPointer<svtkWedge> wedge = svtkSmartPointer<svtkWedge>::New();
