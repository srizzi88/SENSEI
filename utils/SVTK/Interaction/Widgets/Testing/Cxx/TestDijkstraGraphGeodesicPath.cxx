...
int TestDijkstraGraphGeodesicPath(int argc, char* argv[])
{
  if (argc < 2)
  {
    std::cerr << "Demonstrates editing capabilities of a contour widget on polygonal \n"
              ...
              << "Usage args: [height_offset]." << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (distanceOffsetSpecified)
  {
    ...
    // svtkPolygonalSurfaceContourLineInterpolator needs vertex normals
  ...
  svtkSmartPointer<svtkPolygonalSurfaceContourLineInterpolator> interpolator =
    svtkSmartPointer<svtkPolygonalSurfaceContourLineInterpolator>::New();
  ...
  return svtkTesting::InteractorEventLoop(argc, argv, iren, TestDijkstraGraphGeodesicPathLog);
}
