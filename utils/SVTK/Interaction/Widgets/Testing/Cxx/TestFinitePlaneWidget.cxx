...
=========================================================================*/
//
// This example tests the svtkFinitePlaneWidget
...
int TestFinitePlaneWidget(int, char*[])
{
  ...
  svtkNew<svtkFinitePlaneRepresentation> fpr;
  fpr->SetTubing(true);
  ...
  svtkNew<svtkFinitePlaneWidget> finitePlaneWidget2;
