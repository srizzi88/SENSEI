...
=========================================================================*/
//
// This example tests the svtkFixedSizeHandleRepresentation3D class. This
...
class svtkHandleCallback : public svtkCommand
{
public:
  static svtkHandleCallback* New() { return new svtkHandleCallback; }
  void Execute(svtkObject*, unsigned long eid, void*) override
  {
    if (eid == svtkCommand::InteractionEvent)
    {
      double point1[3];
  ...
  svtkFixedSizeHandleRepresentation3D* Rep;
  svtkHandleCallback()
    : Rep(nullptr)
  {
  }
...
int TestFixedSizeHandleRepresentation3D(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkFixedSizeHandleRepresentation3D> rep =
    svtkSmartPointer<svtkFixedSizeHandleRepresentation3D>::New();
  ...
  svtkSmartPointer<svtkHandleCallback> mcbk = svtkSmartPointer<svtkHandleCallback>::New();
  mcbk->Rep = rep;
  ...
  return svtkTesting::InteractorEventLoop(argc, argv, iren, TestFixedSizeHandleRepresentation3DLog);
}
