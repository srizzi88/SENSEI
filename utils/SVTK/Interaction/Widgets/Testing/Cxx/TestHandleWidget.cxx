...
=========================================================================*/
//
// This example tests the svtkHandleWidget.
//
// The handle that you see is always constrained to lie on a plane (
// defined by a svtkImplicitPlaneWidget2). It goes to show that you can place
// constraints on the movement of the handle. You can move the plane around
// interactively. It exercises the class svtkBoundedPlanePointPlacer.
...
class svtkTIPW3Callback : public svtkCommand
{
public:
  static svtkTIPW3Callback* New() { return new svtkTIPW3Callback; }
  ...
  ~svtkTIPW3Callback() override { this->Plane->Delete(); }
...
int TestHandleWidget(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkTIPW3Callback> myCallback = svtkSmartPointer<svtkTIPW3Callback>::New();
  ...
  if (constrainHandlesToObliquePlane)
  {
    ...
    plane = svtkSmartPointer<svtkPlane>::New();
