...
=========================================================================*/
// Tests the class svtkImageActorPointPlacer.
//
...
// we define this mapping ? SVTK provides a few standard ways to define this
...
//
//   * svtkTerrainContourPointPlacer - On a terrain..
//
//
...
class svtkSliderCallback2 : public svtkCommand
{
public:
  static svtkSliderCallback2* New() { return new svtkSliderCallback2; }
  void SetImageViewer(svtkImageViewer2* viewer) { this->Viewer = viewer; }
  void Execute(svtkObject* caller, unsigned long, void*) override
  {
    svtkSliderWidget* slider = static_cast<svtkSliderWidget*>(caller);
    svtkSliderRepresentation* sliderRepres =
      static_cast<svtkSliderRepresentation*>(slider->GetRepresentation());
...
int TestImageActorContourWidget(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkSliderRepresentation2D> SliderRepres =
  ...
  svtkSmartPointer<svtkSliderCallback2> SliderCb = svtkSmartPointer<svtkSliderCallback2>::New();
  SliderCb->SetImageViewer(imageViewer);
  SliderWidget->AddObserver(svtkCommand::InteractionEvent, SliderCb);
  ...
  svtkSmartPointer<svtkImageActorPointPlacer> imageActorPointPlacer =
