...
class svtkTIPWCallback : public svtkCommand
{
public:
  static svtkTIPWCallback* New() { return new svtkTIPWCallback; }
  void Execute(svtkObject* caller, unsigned long, void*) override
  {
    svtkImplicitPlaneWidget* planeWidget = reinterpret_cast<svtkImplicitPlaneWidget*>(caller);
...
int TestImplicitPlaneWidget(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  ...
  svtkSmartPointer<svtkTIPWCallback> myCallback = svtkSmartPointer<svtkTIPWCallback>::New();
  myCallback->Plane = plane;
  myCallback->Actor = selectActor;

  svtkSmartPointer<svtkImplicitPlaneWidget> planeWidget =
    svtkSmartPointer<svtkImplicitPlaneWidget>::New();
