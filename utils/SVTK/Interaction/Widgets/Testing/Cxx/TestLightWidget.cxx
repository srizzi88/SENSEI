...
=========================================================================*/
//
// This example tests the svtkLightWidget
...
int TestLightWidget(int, char*[])
{
  ...
  svtkNew<svtkLightRepresentation> lightRep;
  lightRep->SetPositional(true);

  svtkNew<svtkLightWidget> lightWidget;
  lightWidget->SetInteractor(iren);
  lightWidget->SetRepresentation(lightRep);
  lightWidget->On();

  svtkNew<svtkLightRepresentation> lightRep2;
  double color[3] = { 1.0, 1.0, 0.0 };
  lightRep2->SetLightColor(color);

  svtkNew<svtkLightWidget> lightWidget2;
