...
int TestOrientationMarkerWidget2(int argc, char* argv[])
{
  ...
  svtkNew<svtkTextSource> textSource;
  ...
  svtkNew<svtkActor> textActor;
  textActor->SetMapper(mapper);

  svtkNew<svtkRenderer> smallViewRenderer;
  smallViewRenderer->SetViewport(0.5, 0.5, 0.75, 0.75);

  svtkNew<svtkRenderWindow> renWin;
  svtkNew<svtkRenderer> backgroundRenderer;
  ...
  // Create the widget
  svtkNew<svtkOrientationMarkerWidget> orientationWidget;
  ...
  int ret = svtkRegressionTestImage(renWin);
  return ret == svtkTesting::PASSED ? EXIT_SUCCESS : EXIT_FAILURE;
}
