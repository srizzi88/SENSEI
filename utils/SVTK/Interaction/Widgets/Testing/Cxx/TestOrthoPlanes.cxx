...
static char IOPeventLog[] = "# StreamVersion 1\n"
...
//----------------------------------------------------------------------------
class svtkOrthoPlanesCallback : public svtkCommand
{
public:
  static svtkOrthoPlanesCallback* New() { return new svtkOrthoPlanesCallback; }

  void Execute(svtkObject* caller, unsigned long svtkNotUsed(event), void* callData) override
  {
    svtkImagePlaneWidget* self = reinterpret_cast<svtkImagePlaneWidget*>(caller);
    if (!self)
      return;
  ...
  svtkImagePlaneWidget* WidgetX;
  svtkImagePlaneWidget* WidgetY;
  svtkImagePlaneWidget* WidgetZ;
};
...
int TestOrthoPlanes(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkImagePlaneWidget> planeWidgetX = svtkSmartPointer<svtkImagePlaneWidget>::New();
  ...
  svtkSmartPointer<svtkImagePlaneWidget> planeWidgetY = svtkSmartPointer<svtkImagePlaneWidget>::New();
  ...
  svtkSmartPointer<svtkImagePlaneWidget> planeWidgetZ = svtkSmartPointer<svtkImagePlaneWidget>::New();
  ...
  svtkSmartPointer<svtkImageOrthoPlanes> orthoPlanes = svtkSmartPointer<svtkImageOrthoPlanes>::New();
  ...
  svtkSmartPointer<svtkOrthoPlanesCallback> cbk = svtkSmartPointer<svtkOrthoPlanesCallback>::New();
  cbk->WidgetX = planeWidgetX;
  cbk->WidgetY = planeWidgetY;
  cbk->WidgetZ = planeWidgetZ;
  planeWidgetX->AddObserver(svtkCommand::EndWindowLevelEvent, cbk);
  planeWidgetY->AddObserver(svtkCommand::EndWindowLevelEvent, cbk);
  planeWidgetZ->AddObserver(svtkCommand::EndWindowLevelEvent, cbk);
  ...
  //
  svtkSmartPointer<svtkImageMapToColors> colorMap = svtkSmartPointer<svtkImageMapToColors>::New();
