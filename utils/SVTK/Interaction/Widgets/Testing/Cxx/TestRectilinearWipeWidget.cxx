...
=========================================================================*/
//
// This example tests the svtkRectilinearWipeWidget.
...
int TestRectilinearWipeWidget(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkImageRectilinearWipe> wipe = svtkSmartPointer<svtkImageRectilinearWipe>::New();
  ...
  svtkSmartPointer<svtkImageActor> wipeActor = svtkSmartPointer<svtkImageActor>::New();
  wipeActor->GetMapper()->SetInputConnection(wipe->GetOutputPort());

  // SVTK widgets consist of two parts: the widget part that handles
  // event processing; and the widget representation that defines how
  // the widget appears in the scene
  // (i.e., matters pertaining to geometry).
  svtkSmartPointer<svtkRectilinearWipeWidget> wipeWidget =
    svtkSmartPointer<svtkRectilinearWipeWidget>::New();
  wipeWidget->SetInteractor(iren);

  svtkRectilinearWipeRepresentation* wipeWidgetRep =
    static_cast<svtkRectilinearWipeRepresentation*>(wipeWidget->GetRepresentation());
  ...
  return svtkTesting::InteractorEventLoop(argc, argv, iren, eventLog);
}
