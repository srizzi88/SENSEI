...
//----------------------------------------------------------------------------
class svtkResliceCursorCallback3 : public svtkCommand
{
public:
  static svtkResliceCursorCallback3* New() { return new svtkResliceCursorCallback3; }
  ...
  svtkResliceCursorCallback3() = default;
...
int TestResliceCursorWidget3(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkResliceCursorCallback3> cbk =
    svtkSmartPointer<svtkResliceCursorCallback3>::New();
  ...
  svtkSmartPointer<svtkResliceCursorThickLineRepresentation> resliceCursorRep[3];
  ...
  for (int i = 0; i < 3; i++)
  {
    ...
    resliceCursorRep[i] = svtkSmartPointer<svtkResliceCursorThickLineRepresentation>::New();
