...
const char TestSeedWidget2Log[] = "# StreamVersion 1\n"
...
class svtkSeedCallback2 : public svtkCommand
{
public:
  static svtkSeedCallback2* New() { return new svtkSeedCallback2; }
  void Execute(svtkObject*, unsigned long eid, void*) override
  {
    if (eid == svtkCommand::CursorChangedEvent)
    {
...
int TestSeedWidget2(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkSeedCallback2> mcbk = svtkSmartPointer<svtkSeedCallback2>::New();
  widget->AddObserver(svtkCommand::PlacePointEvent, mcbk);
  widget->AddObserver(svtkCommand::CursorChangedEvent, mcbk);
  ...
  return svtkTesting::InteractorEventLoop(argc, argv, iren, TestSeedWidget2Log);
}
