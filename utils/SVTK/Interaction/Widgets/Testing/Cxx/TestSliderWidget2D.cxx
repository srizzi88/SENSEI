...
const char TestSliderWidget2DEventLog[] = "# StreamVersion 1\n"
...
class svtkSlider2DCallback : public svtkCommand
{
public:
  static svtkSlider2DCallback* New() { return new svtkSlider2DCallback; }
...
int TestSliderWidget2D(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  ...
  svtkSmartPointer<svtkSlider2DCallback> callback = svtkSmartPointer<svtkSlider2DCallback>::New();
