...
int svtkAngleRepresentation3DTest1(int, char*[])
{
  svtkSmartPointer<svtkAngleRepresentation3D> node1 =
    svtkSmartPointer<svtkAngleRepresentation3D>::New();

  EXERCISE_BASIC_ANGLE_REPRESENTATION_METHODS(svtkAngleRepresentation3D, node1);

  svtkActor* actor = node1->GetRay1();
  if (actor == nullptr)
  {
  ...
  svtkFollower* follower = node1->GetTextActor();
  if (follower == nullptr)
  {
