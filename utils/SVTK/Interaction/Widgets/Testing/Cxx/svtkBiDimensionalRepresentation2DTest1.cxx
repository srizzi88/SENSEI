...
int svtkBiDimensionalRepresentation2DTest1(int, char*[])
{
  svtkSmartPointer<svtkBiDimensionalRepresentation2D> node1 =
    svtkSmartPointer<svtkBiDimensionalRepresentation2D>::New();

  EXERCISE_BASIC_REPRESENTATION_METHODS(svtkBiDimensionalRepresentation2D, node1);
  ...
  {
    std::cerr << "Failure in Get/Set Point1WorldPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p[0] != pos[0] || p[1] != pos[1] || p[2] != pos[2])
  {
    std::cerr << "Failure in Get/Set Point2WorldPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p[0] != pos[0] || p[1] != pos[1] || p[2] != pos[2])
  {
    std::cerr << "Failure in Get/Set Point3WorldPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p[0] != pos[0] || p[1] != pos[1] || p[2] != pos[2])
  {
    std::cerr << "Failure in Get/Set Point4WorldPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p[0] != pos[0] || p[1] != pos[1] || p[2] != 0.0)
  {
    std::cerr << "Failure in Get/Set Point1DisplayPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p[0] != pos[0] || p[1] != pos[1] || p[2] != 0.0)
  {
    std::cerr << "Failure in Get/Set Point2DisplayPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p[0] != pos[0] || p[1] != pos[1] || p[2] != 0.0)
  {
    std::cerr << "Failure in Get/Set Point3DisplayPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p[0] != pos[0] || p[1] != pos[1] || p[2] != 0.0)
  {
    std::cerr << "Failure in Get/Set Point4DisplayPosition, expected " << pos[0] << ", " << pos[1]
              << ", " << pos[2] << ", instead got " << p[0] << ", " << p[1] << ", " << p[2]
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  std::cout << "LabelText = "
            << (node1->GetLabelText() == nullptr ? "nullptr" : node1->GetLabelText()) << std::endl;
  double* labelPos = node1->GetLabelPosition();
  if (labelPos)
  {
    std::cout << "LabelPosition: " << labelPos[0] << ", " << labelPos[1] << ", " << labelPos[2]
              << std::endl;
  }
  else
  {
  ...
  std::cout << "LabelPosition [3]: " << labelPosition[0] << ", " << labelPosition[1] << ", "
            << labelPosition[2] << std::endl;
  //  node1->GetWorldLabelPosition(labelPosition);
  //  std::cout << "WorldLabelPosition: " << labelPosition[0] << ", " << labelPosition[1] << ", " <<
  //  labelPosition[2] << std::endl;
  return EXIT_SUCCESS;
}
