...
int svtkLineRepresentationTest1(int, char*[])
{
  svtkSmartPointer<svtkLineRepresentation> node1 = svtkSmartPointer<svtkLineRepresentation>::New();
  ...
  EXERCISE_BASIC_REPRESENTATION_METHODS(svtkLineRepresentation, node1);
  ...
  */
  ...
  svtkSmartPointer<svtkPointHandleRepresentation3D> subHandleRep;
  ...
  svtkSmartPointer<svtkProperty> prop = node1->GetEndPointProperty();
  if (prop == nullptr)
  {
    std::cout << "End Point Property is nullptr." << std::endl;
  }
  prop = node1->GetSelectedEndPointProperty();
  if (prop == nullptr)
  {
    std::cout << "Selected End Point Property is nullptr." << std::endl;
  }

  prop = node1->GetEndPoint2Property();
  if (prop == nullptr)
  {
    std::cout << "End Point2 Property is nullptr." << std::endl;
  }
  prop = node1->GetSelectedEndPoint2Property();
  if (prop == nullptr)
  {
    std::cout << "Selected End Point2 Property is nullptr." << std::endl;
  }
  ...
  svtkSmartPointer<svtkFollower> follower = node1->GetTextActor();
