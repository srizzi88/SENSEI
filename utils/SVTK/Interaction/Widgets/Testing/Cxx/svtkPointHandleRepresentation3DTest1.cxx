...
int svtkPointHandleRepresentation3DTest1(int, char*[])
{
  svtkSmartPointer<svtkPointHandleRepresentation3D> node1 =
    svtkSmartPointer<svtkPointHandleRepresentation3D>::New();

  EXERCISE_BASIC_HANDLE_REPRESENTATION_METHODS(svtkPointHandleRepresentation3D, node1);
