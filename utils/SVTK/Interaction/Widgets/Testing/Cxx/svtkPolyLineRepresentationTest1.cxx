...
int svtkPolyLineRepresentationTest1(int, char*[])
{
  svtkSmartPointer<svtkPolyLineRepresentation> node1 =
    svtkSmartPointer<svtkPolyLineRepresentation>::New();

  EXERCISE_BASIC_REPRESENTATION_METHODS(svtkPolyLineRepresentation, node1);
