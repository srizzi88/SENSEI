...
int svtkSphereHandleRepresentationTest1(int, char*[])
{
  svtkSmartPointer<svtkSphereHandleRepresentation> node1 =
    svtkSmartPointer<svtkSphereHandleRepresentation>::New();

  EXERCISE_BASIC_HANDLE_REPRESENTATION_METHODS(svtkSphereHandleRepresentation, node1);
