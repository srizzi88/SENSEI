...
class TestSphereWidget(svtk.test.Testing.svtkTest):

    def testSphereWidget(self):

        # This example demonstrates how to use the svtkSphereWidget to control the
        # position of a light.
        ...
        rep = svtk.svtkSphereRepresentation()
        ...
        #  rep HandleTextOff
        sphereWidget = svtk.svtkSphereWidget2()
...
if __name__ == "__main__":
     svtk.test.Testing.main([(TestSphereWidget, 'test')])