...
svtkCxxSetObjectMacro(svtk3DWidget, Prop3D, svtkProp3D);

class svtk3DWidgetConnection : public svtkAlgorithm
{
public:
  static svtk3DWidgetConnection* New();
  svtkTypeMacro(svtk3DWidgetConnection, svtkAlgorithm);

  svtk3DWidgetConnection() { this->SetNumberOfInputPorts(1); }
};

svtkStandardNewMacro(svtk3DWidgetConnection);

//----------------------------------------------------------------------------
svtk3DWidget::svtk3DWidget()
{
  this->Placed = 0;
  this->Prop3D = nullptr;
  this->ConnectionHolder = svtk3DWidgetConnection::New();
...
//----------------------------------------------------------------------------
void svtk3DWidget::UpdateInput()
{
  svtkAlgorithm* inpAlg = this->ConnectionHolder->GetInputAlgorithm();
  if (inpAlg)
  {
    inpAlg->Update();
  }
...
void svtk3DWidget::PlaceWidget()
{
  ...
  {
    svtkErrorMacro(<< "No input or prop defined for widget placement");
    bounds[0] = -1.0;
    bounds[1] = 1.0;
    bounds[2] = -1.0;
    bounds[3] = 1.0;
  ...
  double xmin, double xmax, double ymin, double ymax, double zmin, double zmax)
{
  ...
  this->InvokeEvent(svtkCommand::PlaceWidgetEvent, nullptr);
  this->Placed = 1;
}

//----------------------------------------------------------------------------
void svtk3DWidget::AdjustBounds(double bounds[6], double newBounds[6], double center[3])
{
...
//----------------------------------------------------------------------------
double svtk3DWidget::SizeHandles(double factor)
{
  int i;
...
//----------------------------------------------------------------------------
void svtk3DWidget::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtk3DWidget::SetInputConnection(svtkAlgorithmOutput* ao)
{
  this->ConnectionHolder->SetInputConnection(ao);
}

//----------------------------------------------------------------------------
void svtk3DWidget::SetInputData(svtkDataSet* ds)
{
...
//----------------------------------------------------------------------------
svtkDataSet* svtk3DWidget::GetInput()
{
