/*=========================================================================
  ...
  Module:    svtkAffineRepresentation.h
 ...
 * representations. These representations interact with svtkAffineWidget. The
 ...
 * the svtkAffineWidget interacts with to render itself in the scene.
 *
 * @warning
 ...
 *
 * @sa
 * svtkAffineWidget svtkWidgetRepresentation svtkAbstractWidget
 */

#ifndef svtkAffineRepresentation_h
#define svtkAffineRepresentation_h
...
class SVTKINTERACTIONWIDGETS_EXPORT svtkAffineRepresentation : public svtkWidgetRepresentation
{
public:
  //@{
  /**
   ...
   */
  svtkTypeMacro(svtkAffineRepresentation, svtkWidgetRepresentation);
   ...
   */
  virtual void GetTransform(svtkTransform* t) = 0;
...
protected:
  svtkAffineRepresentation();
  ~svtkAffineRepresentation() override;
...
private:
  svtkAffineRepresentation(const svtkAffineRepresentation&) = delete;
  void operator=(const svtkAffineRepresentation&) = delete;
};
