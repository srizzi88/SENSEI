/*=========================================================================
  ...
  Module:    svtkAngleRepresentation2D.cxx
...
svtkStandardNewMacro(svtkAngleRepresentation2D);

//----------------------------------------------------------------------
svtkAngleRepresentation2D::svtkAngleRepresentation2D()
{
  // By default, use one of these handles
  this->HandleRepresentation = svtkPointHandleRepresentation2D::New();

  this->Ray1 = svtkLeaderActor2D::New();
  ...
  this->Ray2 = svtkLeaderActor2D::New();
  ...
  this->Arc = svtkLeaderActor2D::New();
...
//----------------------------------------------------------------------
double svtkAngleRepresentation2D::GetAngle()
{
  return this->Arc->GetAngle();
}

//----------------------------------------------------------------------
void svtkAngleRepresentation2D::GetPoint1WorldPosition(double pos[3])
{
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::GetCenterWorldPosition(double pos[3])
{
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::GetPoint2WorldPosition(double pos[3])
{
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::SetPoint1DisplayPosition(double x[3])
{
  if (!this->Point1Representation)
  {
    svtkErrorMacro("SetPoint1DisplayPosition: no point1 representation");
    return;
  }
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::SetCenterDisplayPosition(double x[3])
{
  if (!this->CenterRepresentation)
  {
    svtkErrorMacro("SetCenterDisplayPosition: no center representation");
    return;
  }
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::SetPoint2DisplayPosition(double x[3])
{
  if (!this->Point2Representation)
  {
    svtkErrorMacro("SetPoint2DisplayPosition: no point2 representation");
    return;
  }
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::GetPoint1DisplayPosition(double pos[3])
{
  if (this->Point1Representation)
  {
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::GetCenterDisplayPosition(double pos[3])
{
  if (this->CenterRepresentation)
  {
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::GetPoint2DisplayPosition(double pos[3])
{
  if (this->Point2Representation)
  {
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::BuildRepresentation()
{
      ...
      this->Renderer->GetSVTKWindow()->GetMTime() > this->BuildTime))
  {
    ...
    svtkMath::Normalize(vector1);
    svtkMath::Normalize(vector2);
    double angle = acos(svtkMath::Dot(vector1, vector2));
    char string[512];
    snprintf(string, sizeof(string), this->LabelFormat, svtkMath::DegreesFromRadians(angle));
    this->Arc->SetLabel(string);

    // Place the label and place the arc
    double l1 = sqrt(svtkMath::Distance2BetweenPoints(cd, p1d));
    double l2 = sqrt(svtkMath::Distance2BetweenPoints(cd, p2d));
    ...
    double l = sqrt(svtkMath::Distance2BetweenPoints(a1, a2));
    svtkInteractorObserver::ComputeDisplayToWorld(this->Renderer, a1[0], a1[1], a1[2], w1);
    svtkInteractorObserver::ComputeDisplayToWorld(this->Renderer, a2[0], a2[1], a2[2], w2);
    ...
    {
      svtkMath::Cross(ray1, ray2, v);
      z[0] = z[1] = 0.0;
      z[2] = 1.0;
      if (svtkMath::Dot(v, z) > 0.0)
      {
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::ReleaseGraphicsResources(svtkWindow* w)
{
  if (this->Ray1)
  {
...
//----------------------------------------------------------------------
int svtkAngleRepresentation2D::RenderOverlay(svtkViewport* v)
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
void svtkAngleRepresentation2D::PrintSelf(ostream& os, svtkIndent indent)
{
