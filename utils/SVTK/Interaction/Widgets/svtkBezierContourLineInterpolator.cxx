/*=========================================================================
  ...
  Module:    svtkBezierContourLineInterpolator.cxx
...
svtkStandardNewMacro(svtkBezierContourLineInterpolator);

//----------------------------------------------------------------------
svtkBezierContourLineInterpolator::svtkBezierContourLineInterpolator()
{
...
//----------------------------------------------------------------------
svtkBezierContourLineInterpolator::~svtkBezierContourLineInterpolator() = default;

//----------------------------------------------------------------------
int svtkBezierContourLineInterpolator::InterpolateLine(
  svtkRenderer* svtkNotUsed(ren), svtkContourRepresentation* rep, int idx1, int idx2)
{
  ...
  double distance = sqrt(svtkMath::Distance2BetweenPoints(p1, p4));
  ...
  while (stackCount)
  {
    ...
    totalDist += sqrt(svtkMath::Distance2BetweenPoints(p2, p3));
    totalDist += sqrt(svtkMath::Distance2BetweenPoints(p3, p4));

    distance = sqrt(svtkMath::Distance2BetweenPoints(p1, p4));
...
//----------------------------------------------------------------------
void svtkBezierContourLineInterpolator::GetSpan(
...
//----------------------------------------------------------------------
void svtkBezierContourLineInterpolator::PrintSelf(ostream& os, svtkIndent indent)
{
