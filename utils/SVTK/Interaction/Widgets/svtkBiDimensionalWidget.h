/*=========================================================================
  ...
  Module:    svtkBiDimensionalWidget.h,v
 ...
 *
 * The svtkBiDimensionalWidget is used to measure the bi-dimensional length of
 ...
 * the first line (similar to svtkDistanceWidget). The placement of the third
 ...
 * mode.
 *
 * To use this widget, specify an instance of svtkBiDimensionalWidget and a
 * representation (e.g., svtkBiDimensionalRepresentation2D). The widget is
 * implemented using four instances of svtkHandleWidget which are used to
 * position the end points of the two intersecting lines. The representations
 * for these handle widgets are provided by the svtkBiDimensionalRepresentation
 * class.
 *
 * @par Event Bindings:
 ...
 * into the svtkBiDimensionalWidget's widget events:
 * <pre>
 *   svtkWidgetEvent::AddPoint -- (In Define mode:) Add one point; depending on the
 ...
 *   svtkWidgetEvent::Move -- (In Define mode:) Position the second, third or fourth
 *                           point. (In Manipulate mode:) Move the handle, line or widget.
 *   svtkWidgetEvent::EndSelect -- the manipulation process has completed.
 * </pre>
 *
 * @par Event Bindings:
 ...
 *   svtkCommand::InteractionEvent (moving a handle, line or performing rotation)
...
#ifndef svtkBiDimensionalWidget_h
#define svtkBiDimensionalWidget_h
...
class svtkBiDimensionalWidgetCallback;

class SVTKINTERACTIONWIDGETS_EXPORT svtkBiDimensionalWidget : public svtkAbstractWidget
{
public:
  /**
   * Instantiate this class.
   */
  static svtkBiDimensionalWidget* New();

  //@{
  /**
   * Standard methods for a SVTK class.
   */
  svtkTypeMacro(svtkBiDimensionalWidget, svtkAbstractWidget);
   ...
   */
  void SetRepresentation(svtkBiDimensionalRepresentation* r)
  {
    this->Superclass::SetWidgetRepresentation(reinterpret_cast<svtkWidgetRepresentation*>(r));
  }

  /**
   * Return the representation as a svtkBiDimensionalRepresentation.
   */
  svtkBiDimensionalRepresentation* GetBiDimensionalRepresentation()
  {
    return reinterpret_cast<svtkBiDimensionalRepresentation*>(this->WidgetRep);
  }
...
protected:
  ...
  ~svtkBiDimensionalWidget() override;
  ...
  svtkHandleWidget* Point3Widget;
  svtkHandleWidget* Point4Widget;
  svtkBiDimensionalWidgetCallback* BiDimensionalWidgetCallback1;
  svtkBiDimensionalWidgetCallback* BiDimensionalWidgetCallback2;
  svtkBiDimensionalWidgetCallback* BiDimensionalWidgetCallback3;
  svtkBiDimensionalWidgetCallback* BiDimensionalWidgetCallback4;
  ...
  friend class svtkBiDimensionalWidgetCallback;

private:
  svtkBiDimensionalWidget(const svtkBiDimensionalWidget&) = delete;
  void operator=(const svtkBiDimensionalWidget&) = delete;
};
