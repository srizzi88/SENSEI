/*=========================================================================
  ...
  Module:    svtkBorderRepresentation.h
 ...
 * @brief   represent a svtkBorderWidget
 *
 ...
 * the svtkBorderRepresentation interacts with to render itself in the scene.
 *
 * @warning
 * The separation of the widget event handling (e.g., svtkBorderWidget) from
 * the representation (svtkBorderRepresentation) enables users and developers
...
#ifndef svtkBorderRepresentation_h
#define svtkBorderRepresentation_h

#include "svtkCoordinate.h"               //Because of the viewport coordinate macro
...
class SVTKINTERACTIONWIDGETS_EXPORT svtkBorderRepresentation : public svtkWidgetRepresentation
{
public:
  /**
   * Instantiate this class.
   */
  static svtkBorderRepresentation* New();

  //@{
  /**
   * Define standard methods.
   */
  svtkTypeMacro(svtkBorderRepresentation, svtkWidgetRepresentation);
   ...
   */
  svtkSetClampMacro(ShowVerticalBorder, int, BORDER_OFF, BORDER_ACTIVE);
  svtkGetMacro(ShowVerticalBorder, int);
  //@}
   ...
   */
  svtkSetClampMacro(ShowHorizontalBorder, int, BORDER_OFF, BORDER_ACTIVE);
  svtkGetMacro(ShowHorizontalBorder, int);
  //@}
   ...
   */
  svtkGetObjectMacro(BorderProperty, svtkProperty2D);
  //@}
   ...
   */
  svtkSetMacro(ProportionalResize, svtkTypeBool);
  svtkGetMacro(ProportionalResize, svtkTypeBool);
  svtkBooleanMacro(ProportionalResize, svtkTypeBool);
  //@}
  ...
  svtkSetVector2Macro(MaximumSize, int);
  svtkGetVector2Macro(MaximumSize, int);
  //@}
   ...
   */
  svtkGetVectorMacro(SelectionPoint, double, 2);
  //@}
   ...
   * motion.
   */
  svtkSetMacro(Moving, svtkTypeBool);
  svtkGetMacro(Moving, svtkTypeBool);
  svtkBooleanMacro(Moving, svtkTypeBool);
  //@}
...
protected:
  ...
  ~svtkBorderRepresentation() override;

  // Ivars
  int ShowVerticalBorder;
  int ShowHorizontalBorder;
  svtkProperty2D* BorderProperty;
  svtkTypeBool ProportionalResize;
  int Tolerance;
  svtkTypeBool Moving;
  ...
  svtkPoints* BWPoints;
  svtkPolyData* BWPolyData;
  svtkTransform* BWTransform;
  svtkTransformPolyDataFilter* BWTransformFilter;
  svtkPolyDataMapper2D* BWMapper;
  svtkActor2D* BWActor;
...
private:
  svtkBorderRepresentation(const svtkBorderRepresentation&) = delete;
  void operator=(const svtkBorderRepresentation&) = delete;
};
