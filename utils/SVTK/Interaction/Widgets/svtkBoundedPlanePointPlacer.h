/*=========================================================================
  ...
  Module:    svtkBoundedPlanePointPlacer.h
 ...
 *
 * svtkBoundedPlanePointPlacer is a type of point placer that constrains its
 * points to a finite (i.e., bounded) plance.
 *
 * @sa
 * svtkPointPlacer svtkHandleWidget svtkHandleRepresentation
 */

#ifndef svtkBoundedPlanePointPlacer_h
#define svtkBoundedPlanePointPlacer_h
...
class SVTKINTERACTIONWIDGETS_EXPORT svtkBoundedPlanePointPlacer : public svtkPointPlacer
{
public:
  /**
   * Instantiate this class.
   */
  static svtkBoundedPlanePointPlacer* New();

  //@{
  /**
   * Standard methods for instances of this class.
   */
  svtkTypeMacro(svtkBoundedPlanePointPlacer, svtkPointPlacer);
   ...
   */
  svtkSetClampMacro(
    ProjectionNormal, int, svtkBoundedPlanePointPlacer::XAxis, svtkBoundedPlanePointPlacer::Oblique);
  svtkGetMacro(ProjectionNormal, int);
  void SetProjectionNormalToXAxis()
  {
    this->SetProjectionNormal(svtkBoundedPlanePointPlacer::XAxis);
  }
  void SetProjectionNormalToYAxis()
  {
    this->SetProjectionNormal(svtkBoundedPlanePointPlacer::YAxis);
  }
  void SetProjectionNormalToZAxis()
  {
    this->SetProjectionNormal(svtkBoundedPlanePointPlacer::ZAxis);
  }
  void SetProjectionNormalToOblique()
  {
    this->SetProjectionNormal(svtkBoundedPlanePointPlacer::Oblique);
  }
  //@}
...
protected:
  svtkBoundedPlanePointPlacer();
  ~svtkBoundedPlanePointPlacer() override;
...
private:
  svtkBoundedPlanePointPlacer(const svtkBoundedPlanePointPlacer&) = delete;
  void operator=(const svtkBoundedPlanePointPlacer&) = delete;
};
