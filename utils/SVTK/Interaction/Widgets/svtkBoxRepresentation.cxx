/*=========================================================================
  ...
  Module:    svtkBoxRepresentation.cxx
...
svtkStandardNewMacro(svtkBoxRepresentation);

//----------------------------------------------------------------------------
svtkBoxRepresentation::svtkBoxRepresentation()
{
  // The initial state
  this->InteractionState = svtkBoxRepresentation::Outside;
  ...
  for (i = 0; i < 7; i++)
  {
    ...
    this->HandleGeometry[i]->SetOutputPointsPrecision(svtkAlgorithm::DOUBLE_PRECISION);
  ...
  this->PlanePoints = svtkPoints::New(SVTK_DOUBLE);
  this->PlanePoints->SetNumberOfPoints(6);
  this->PlaneNormals = svtkDoubleArray::New();
...
//----------------------------------------------------------------------
void svtkBoxRepresentation::GetPolyData(svtkPolyData* pd)
{
...
//----------------------------------------------------------------------
void svtkBoxRepresentation::StartWidgetInteraction(double e[2])
{
...
void svtkBoxRepresentation::StartComplexInteraction(
...
void svtkBoxRepresentation::SetTwoPlaneMode(bool val)
{
...
//----------------------------------------------------------------------
void svtkBoxRepresentation::WidgetInteraction(double e[2])
{
  ...
  // Process the motion
  if (this->InteractionState == svtkBoxRepresentation::MoveF0)
  {
    this->MoveMinusXFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == svtkBoxRepresentation::MoveF1)
  {
    this->MovePlusXFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == svtkBoxRepresentation::MoveF2)
  {
    this->MoveMinusYFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == svtkBoxRepresentation::MoveF3)
  {
    this->MovePlusYFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == svtkBoxRepresentation::MoveF4)
  {
    this->MoveMinusZFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == svtkBoxRepresentation::MoveF5)
  {
    this->MovePlusZFace(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == svtkBoxRepresentation::Translating)
  {
    this->Translate(prevPickPoint, pickPoint);
  }

  else if (this->InteractionState == svtkBoxRepresentation::Scaling)
  {
    this->Scale(prevPickPoint, pickPoint, static_cast<int>(e[0]), static_cast<int>(e[1]));
  }

  else if (this->InteractionState == svtkBoxRepresentation::Rotating)
  {
...
void svtkBoxRepresentation::ComplexInteraction(
  svtkRenderWindowInteractor*, svtkAbstractWidget*, unsigned long, void* calldata)
{
  svtkEventData* edata = static_cast<svtkEventData*>(calldata);
  svtkEventDataDevice3D* edd = edata->GetAsEventDataDevice3D();
...
void svtkBoxRepresentation::StepForward()
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  this->Translate(pts, pts + 3);
}

void svtkBoxRepresentation::StepBackward()
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  this->Translate(pts + 3, pts);
}

void svtkBoxRepresentation::EndComplexInteraction(
  svtkRenderWindowInteractor*, svtkAbstractWidget*, unsigned long, void*)
{
}

//----------------------------------------------------------------------------
void svtkBoxRepresentation::MoveFace(const double* p1, const double* p2, const double* dir,
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::GetDirection(
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::MovePlusXFace(const double* p1, const double* p2)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::MoveMinusXFace(const double* p1, const double* p2)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::MovePlusYFace(const double* p1, const double* p2)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::MoveMinusYFace(const double* p1, const double* p2)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::MovePlusZFace(const double* p1, const double* p2)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::MoveMinusZFace(const double* p1, const double* p2)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
void svtkBoxRepresentation::Translate(const double* p1, const double* p2)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double v[3] = { 0, 0, 0 };
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::Scale(
  const double* svtkNotUsed(p1), const double* svtkNotUsed(p2), int svtkNotUsed(X), int Y)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::ComputeNormals()
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double* p0 = pts;
  double* px = pts + 3 * 1;
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::GetPlanes(svtkPlanes* planes)
{
  if (!planes)
  {
    return;
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::Rotate(
  ...
  const double* pos1, const double* orient1, const double* pos2, const double* orient2)
{
  ...
  for (int i = 0; i < 3; ++i)
  {
    ...
    if (this->SnappedOrientation[i])
    {
      q1.SetRotationAngleAndAxis(svtkMath::RadiansFromDegrees(this->SnappedEventOrientations[i][0]),
    ...
    q1.Conjugate();
    svtkQuaternion<double> q3 = q2 * q1;
    double axis[4];
    axis[0] = svtkMath::DegreesFromRadians(q3.GetRotationAngleAndAxis(axis + 1));
    ...
    svtkVector3d p0(newPts->GetPoint(0));
    svtkVector3d p1(newPts->GetPoint((i > 0 ? i + 2 : 1)));
    basis[i] = p1 - p0;
  ...
  for (int i = 0; i < 3; ++i)
  {
    if (newSnap[i] || this->SnappedOrientation[i])
    {
      ...
      svtkVector3d& b0 = basis[i];
      svtkVector3d& b1 = basis[(i + 1) % 3];
      svtkVector3d& b2 = basis[(i + 2) % 3];
  ...
  svtkVector3d center(static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(3 * 14));
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::CreateDefaultProperties()
{
  // Handle properties
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::PlaceWidget(double bds[6])
{
  int i;
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::GetTransform(svtkTransform* t)
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double* p0 = pts;
  double* p1 = pts + 3 * 1;
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::SetTransform(svtkTransform* t)
{
  if (!t)
  {
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::SetOutlineFaceWires(int newValue)
{
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::SetOutlineCursorWires(int newValue)
{
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::GenerateOutline()
{
...
//----------------------------------------------------------------------------
int svtkBoxRepresentation::ComputeInteractionState(int X, int Y, int modify)
{
  ...
  if (path != nullptr)
  {
    ...
    this->CurrentHandle = reinterpret_cast<svtkActor*>(path->GetFirstNode()->GetViewProp());
    if (this->CurrentHandle == this->Handle[0])
    {
      this->InteractionState = svtkBoxRepresentation::MoveF0;
    }
    else if (this->CurrentHandle == this->Handle[1])
    {
      this->InteractionState = svtkBoxRepresentation::MoveF1;
    }
    else if (this->CurrentHandle == this->Handle[2])
    {
      this->InteractionState = svtkBoxRepresentation::MoveF2;
    }
    else if (this->CurrentHandle == this->Handle[3])
    {
      this->InteractionState = svtkBoxRepresentation::MoveF3;
    }
    else if (this->CurrentHandle == this->Handle[4])
    {
      this->InteractionState = svtkBoxRepresentation::MoveF4;
    }
    else if (this->CurrentHandle == this->Handle[5])
    {
      this->InteractionState = svtkBoxRepresentation::MoveF5;
    }
    else if (this->CurrentHandle == this->Handle[6])
    {
      this->InteractionState = svtkBoxRepresentation::Translating;
    }
  }
  else // see if the hex is picked
  {
    ...
    if (path != nullptr)
    {
      ...
      if (!modify)
      {
        this->InteractionState = svtkBoxRepresentation::Rotating;
      }
      else
      {
...
int svtkBoxRepresentation::ComputeComplexInteractionState(
  svtkRenderWindowInteractor*, svtkAbstractWidget*, unsigned long, void* calldata, int)
{
  ...
  if (edd)
  {
    ...
    svtkAssemblyPath* path = this->GetAssemblyPath3DPoint(pos, this->HandlePicker);
...
//----------------------------------------------------------------------
void svtkBoxRepresentation::SetInteractionState(int state)
{
  // Clamp to allowable values
  state = (state < svtkBoxRepresentation::Outside
      ? svtkBoxRepresentation::Outside
      : (state > svtkBoxRepresentation::Scaling ? svtkBoxRepresentation::Scaling : state));
  ...
  switch (state)
  {
    case svtkBoxRepresentation::MoveF0:
    case svtkBoxRepresentation::MoveF1:
    case svtkBoxRepresentation::MoveF2:
    case svtkBoxRepresentation::MoveF3:
    case svtkBoxRepresentation::MoveF4:
    case svtkBoxRepresentation::MoveF5:
      this->HighlightOutline(0);
      handle = this->HighlightHandle(this->CurrentHandle);
      this->HighlightFace(handle);
      break;
    case svtkBoxRepresentation::Rotating:
      this->HighlightOutline(0);
      this->HighlightHandle(nullptr);
      this->HighlightFace(this->HexPicker->GetCellId());
      break;
    case svtkBoxRepresentation::Translating:
    case svtkBoxRepresentation::Scaling:
...
//----------------------------------------------------------------------
double* svtkBoxRepresentation::GetBounds()
{
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::BuildRepresentation()
{
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::ReleaseGraphicsResources(svtkWindow* w)
{
...
//----------------------------------------------------------------------------
int svtkBoxRepresentation::RenderOpaqueGeometry(svtkViewport* v)
{
  int count = 0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
int svtkBoxRepresentation::RenderTranslucentPolygonalGeometry(svtkViewport* v)
{
  int count = 0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
svtkTypeBool svtkBoxRepresentation::HasTranslucentPolygonalGeometry()
{
  int result = 0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::PositionHandles()
{
  double* pts = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
  double* p0 = pts;
  double* p1 = pts + 3 * 1;
  ...
  for (int i = 0; i < 6; ++i)
  {
    ...
    int mix = 2 * (i % 2);
    svtkVector3d pp1(this->Points->GetPoint(8 + i));
    svtkVector3d pp2(this->Points->GetPoint(9 + i - mix));
    pp2 = pp2 - pp1;
    pp2.Normalize();
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::HandlesOn()
{
  if (this->TwoPlaneMode)
  {
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::HandlesOff()
{
  for (int i = 0; i < 7; i++)
  {
    this->Handle[i]->VisibilityOff();
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::SizeHandles()
{
  double* center = static_cast<svtkDoubleArray*>(this->Points->GetData())->GetPointer(3 * 14);
  double radius = this->svtkWidgetRepresentation::SizeHandlesInPixels(1.5, center);
  for (int i = 0; i < 7; i++)
  {
...
//----------------------------------------------------------------------------
int svtkBoxRepresentation::HighlightHandle(svtkProp* prop)
{
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::HighlightFace(int cellId)
{
  if (cellId >= 0)
  {
    svtkIdType npts;
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::HighlightOutline(int highlight)
{
  if (highlight)
  {
...
//------------------------------------------------------------------------------
void svtkBoxRepresentation::RegisterPickers()
{
...
//----------------------------------------------------------------------------
void svtkBoxRepresentation::PrintSelf(ostream& os, svtkIndent indent)
{
