 ...
 * nice feature of the object is that the svtkBoxWidget, like any 3D widget,
 * will work with the current interactor style. That is, if svtkBoxWidget does
 ...
 * svtkBoxWidget will terminate the processing of the event that it handles.
 *
 ...
 * svtkBoxWidget will appear. (See superclass documentation for information
 ...
 * rotate svtkBoxWidget, pick a face (but not a face handle) and move the left
 ...
 *
 * The svtkBoxWidget is very flexible. It can be used to select, cut, clip, or
 ...
 *
 * @sa
 * svtk3DWidget svtkPointWidget svtkLineWidget svtkPlaneWidget
 * svtkImplicitPlaneWidget svtkImagePlaneWidget
 */

#ifndef svtkBoxWidget_h
#define svtkBoxWidget_h
...
class SVTKINTERACTIONWIDGETS_EXPORT svtkBoxWidget : public svtk3DWidget
{
public:
  /**
   * Instantiate the object.
   */
  static svtkBoxWidget* New();

  svtkTypeMacro(svtkBoxWidget, svtk3DWidget);
...
private:
  svtkBoxWidget(const svtkBoxWidget&) = delete;
  void operator=(const svtkBoxWidget&) = delete;
};
