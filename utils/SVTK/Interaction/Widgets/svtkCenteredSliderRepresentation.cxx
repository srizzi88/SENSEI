/*=========================================================================
  ...
  Module:    svtkCenteredSliderRepresentation.cxx
...
#include "svtkCenteredSliderRepresentation.h"
...
svtkStandardNewMacro(svtkCenteredSliderRepresentation);

//----------------------------------------------------------------------
svtkCenteredSliderRepresentation::svtkCenteredSliderRepresentation()
{
...
void svtkCenteredSliderRepresentation::BuildTube()
{
...
//----------------------------------------------------------------------
svtkCoordinate* svtkCenteredSliderRepresentation::GetPoint1Coordinate()
{
  return this->Point1Coordinate;
}

void svtkCenteredSliderRepresentation::StartWidgetInteraction(double eventPos[2])
{
  this->ComputeInteractionState(static_cast<int>(eventPos[0]), static_cast<int>(eventPos[1]));
}

//----------------------------------------------------------------------
int svtkCenteredSliderRepresentation::ComputeInteractionState(int x, int y, int /*modify*/)
{
  // where is the pick
...
//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::WidgetInteraction(double eventPos[2])
{
...
//----------------------------------------------------------------------
svtkCoordinate* svtkCenteredSliderRepresentation::GetPoint2Coordinate()
{
  return this->Point2Coordinate;
}

//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::PlaceWidget(double* svtkNotUsed(bds[6]))
{
...
//----------------------------------------------------------------------
double svtkCenteredSliderRepresentation ::ComputePickPosition(double /* x */, double y)
{
  // where is the pick
  int* p1 = this->Point1Coordinate->GetComputedViewportValue(this->Renderer);
  int* p2 = this->Point2Coordinate->GetComputedViewportValue(this->Renderer);
...
//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::Highlight(int highlight)
{
  if (highlight)
  {
...
//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::BuildRepresentation()
{
...
//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::GetActors(svtkPropCollection* pc)
{
...
//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::ReleaseGraphicsResources(svtkWindow* w)
{
...
//----------------------------------------------------------------------
int svtkCenteredSliderRepresentation::RenderOpaqueGeometry(svtkViewport* viewport)
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
int svtkCenteredSliderRepresentation::RenderOverlay(svtkViewport* viewport)
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------
void svtkCenteredSliderRepresentation::SetTitleText(const char* label)
{
...
//----------------------------------------------------------------------
const char* svtkCenteredSliderRepresentation::GetTitleText()
{
