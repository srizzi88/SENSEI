/*=========================================================================
  ...
  Module:    svtkDistanceRepresentation3D.cxx
...
svtkStandardNewMacro(svtkDistanceRepresentation3D);

//----------------------------------------------------------------------
svtkDistanceRepresentation3D::svtkDistanceRepresentation3D()
{
  ...
  this->Glyph3D->SetOutputPointsPrecision(svtkAlgorithm::DOUBLE_PRECISION);
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetLabelActor(svtkFollower* fol)
{
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::GetPoint1WorldPosition(double pos[3])
{
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::GetPoint2WorldPosition(double pos[3])
{
...
//----------------------------------------------------------------------
double* svtkDistanceRepresentation3D::GetPoint1WorldPosition()
{
  if (!this->Point1Representation)
  {
...
//----------------------------------------------------------------------
double* svtkDistanceRepresentation3D::GetPoint2WorldPosition()
{
  if (!this->Point2Representation)
  {
    static double temp[3] = { 0, 0, 0 };
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetPoint1DisplayPosition(double x[3])
{
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetPoint2DisplayPosition(double x[3])
{
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetPoint1WorldPosition(double x[3])
{
  if (this->Point1Representation)
  {
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetPoint2WorldPosition(double x[3])
{
  if (this->Point2Representation)
  {
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::GetPoint1DisplayPosition(double pos[3])
{
  if (this->Point1Representation)
  {
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::GetPoint2DisplayPosition(double pos[3])
{
  if (this->Point2Representation)
  {
...
//----------------------------------------------------------------------
double* svtkDistanceRepresentation3D::GetBounds()
{
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::BuildRepresentation()
{
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::ReleaseGraphicsResources(svtkWindow* w)
{
...
//----------------------------------------------------------------------
int svtkDistanceRepresentation3D::RenderOpaqueGeometry(svtkViewport* v)
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
int svtkDistanceRepresentation3D::RenderTranslucentPolygonalGeometry(svtkViewport* v)
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetLabelScale(double scale[3])
{
...
//----------------------------------------------------------------------
double* svtkDistanceRepresentation3D::GetLabelScale()
{
  return this->LabelActor->GetScale();
}

//----------------------------------------------------------------------------
svtkProperty* svtkDistanceRepresentation3D::GetLabelProperty()
{
  return this->LabelActor->GetProperty();
}

//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetGlyphScale(double scale)
{
...
//----------------------------------------------------------------------------
svtkProperty* svtkDistanceRepresentation3D::GetLineProperty()
{
  return this->LineActor->GetProperty();
}

//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::SetLabelPosition(double labelPosition)
{
  svtkDebugMacro(<< this->GetClassName() << " (" << this << "): setting LabelPosition to "
                << labelPosition);
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::UpdateLabelPosition()
{
  if (!this->Point1Representation || !this->Point2Representation)
  {
    return;
  ...
  double diff = sqrt(svtkMath::Distance2BetweenPoints(pos, actorPos));
  if (diff > 0.001)
  {
...
//----------------------------------------------------------------------
void svtkDistanceRepresentation3D::PrintSelf(ostream& os, svtkIndent indent)
{
