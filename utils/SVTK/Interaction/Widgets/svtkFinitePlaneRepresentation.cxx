/*=========================================================================
  ...
  Module:    svtkFinitePlaneRepresentation.cxx
...
svtkStandardNewMacro(svtkFinitePlaneRepresentation);

//----------------------------------------------------------------------------
svtkFinitePlaneRepresentation::svtkFinitePlaneRepresentation()
{
  // The initial state
  this->InteractionState = svtkFinitePlaneRepresentation::Outside;
  ...
  // The finite plane
  this->PlanePolyData = svtkPolyData::New();
  ...
  svtkNew<svtkCellArray> cell;
  cell->AllocateEstimate(1, 4);
  svtkIdType pts[4] = { 0, 1, 2, 3 };
  ...
  this->RepresentationState = svtkFinitePlaneRepresentation::Outside;
  ...
  this->TransformRotation = svtkTransform::New();
}
...
//----------------------------------------------------------------------
void svtkFinitePlaneRepresentation::GetPolyData(svtkPolyData* pd)
{
  pd->ShallowCopy(this->PlanePolyData);
}

//----------------------------------------------------------------------
void svtkFinitePlaneRepresentation::StartWidgetInteraction(double e[2])
{
...
//----------------------------------------------------------------------
void svtkFinitePlaneRepresentation::WidgetInteraction(double e[2])
{
  ...
  // Process the motion
  if (this->InteractionState == svtkFinitePlaneRepresentation::MoveOrigin)
  {
    this->TranslateOrigin(prevPickPoint, pickPoint);
  }
  else if (this->InteractionState == svtkFinitePlaneRepresentation::ModifyV1)
  {
    this->MovePoint1(prevPickPoint, pickPoint);
  }
  else if (this->InteractionState == svtkFinitePlaneRepresentation::ModifyV2)
  {
    this->MovePoint2(prevPickPoint, pickPoint);
  }
  else if (this->InteractionState == svtkFinitePlaneRepresentation::Rotating)
  {
    camera->GetViewPlaneNormal(vpn);
    this->Rotate(e[0], e[1], prevPickPoint, pickPoint, vpn);
  }
  else if (this->InteractionState == svtkFinitePlaneRepresentation::Pushing)
  {
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::Rotate(int X, int Y, double* p1, double* p2, double* vpn)
{
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::CreateDefaultProperties()
{
  // Normal properties
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::PlaceWidget(double bnds[6])
{
  this->Normal[0] = 0.0;
  this->Normal[1] = 0.0;
  this->Normal[2] = 1.0;
...
//----------------------------------------------------------------------------
int svtkFinitePlaneRepresentation::ComputeInteractionState(int X, int Y, int svtkNotUsed(modify))
{
  // Okay, we can process this. Try to pick handles first;
  // if no handles picked, then pick the bounding box.
  if (!this->Renderer || !this->Renderer->IsInViewport(X, Y))
  {
    this->SetRepresentationState(svtkFinitePlaneRepresentation::Outside);
    this->InteractionState = svtkFinitePlaneRepresentation::Outside;
  ...
  {
    this->SetRepresentationState(svtkFinitePlaneRepresentation::Pushing);
    this->InteractionState = svtkFinitePlaneRepresentation::Pushing;
    this->SetHighlightNormal(0);
  ...
  {
    this->SetRepresentationState(svtkFinitePlaneRepresentation::Rotating);
    this->InteractionState = svtkFinitePlaneRepresentation::Rotating;
  ...
  {
    this->SetRepresentationState(svtkFinitePlaneRepresentation::MoveOrigin);
    this->InteractionState = svtkFinitePlaneRepresentation::MoveOrigin;
  ...
  {
    this->SetRepresentationState(svtkFinitePlaneRepresentation::ModifyV1);
    this->InteractionState = svtkFinitePlaneRepresentation::ModifyV1;
  ...
  {
    this->SetRepresentationState(svtkFinitePlaneRepresentation::ModifyV2);
    this->InteractionState = svtkFinitePlaneRepresentation::ModifyV2;
...
//----------------------------------------------------------------------
double* svtkFinitePlaneRepresentation::GetBounds()
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::BuildRepresentation()
{
  this->SizeHandles();
  ...
  svtkPoints* points = this->PlanePolyData->GetPoints();
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::ReleaseGraphicsResources(svtkWindow* w)
{
...
//----------------------------------------------------------------------------
int svtkFinitePlaneRepresentation::RenderOpaqueGeometry(svtkViewport* v)
{
  int count = 0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
int svtkFinitePlaneRepresentation::RenderTranslucentPolygonalGeometry(svtkViewport* v)
{
  int count = 0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
svtkTypeBool svtkFinitePlaneRepresentation::HasTranslucentPolygonalGeometry()
{
  int result = 0;
  this->BuildRepresentation();
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetHandles(bool handles)
{
  int h = handles ? 1 : 0;
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::HandlesOn()
{
  this->SetHandles(true);
}

//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::HandlesOff()
{
  this->SetHandles(false);
}

//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SizeHandles()
{
  double radius = this->svtkWidgetRepresentation::SizeHandlesInPixels(1.5, this->GetOrigin());
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetHighlightHandle(svtkProp* prop)
{
  ...
  this->CurrentHandle = dynamic_cast<svtkActor*>(prop);
...
//------------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::RegisterPickers()
{
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetOrigin(double x, double y, double z)
{
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetOrigin(double x[3])
{
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetV1(double x, double y)
{
  double v1[2] = { x, y };
  this->SetV1(v1);
}
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetV1(double x[2])
{
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetV2(double x, double y)
{
  double v2[2] = { x, y };
  this->SetV2(v2);
}
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetV2(double x[2])
{
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetNormal(double x, double y, double z)
{
  double n[3] = { x, y, z };
  ...
  if (n[0] != this->Normal[0] || n[1] != this->Normal[1] || n[2] != this->Normal[2])
  {
    ...
    svtkMath::Cross(this->PreviousNormal, this->Normal, RotationAxis);
    svtkMath::Normalize(RotationAxis);
    double RotationAngle =
      svtkMath::DegreesFromRadians(acos(svtkMath::Dot(this->PreviousNormal, this->Normal)));
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetNormal(double n[3])
{
  this->SetNormal(n[0], n[1], n[2]);
}

//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetDrawPlane(bool drawPlane)
{
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetHighlightPlane(int highlight)
{
  this->PlaneActor->SetProperty(highlight ? this->SelectedPlaneProperty : this->PlaneProperty);
}

//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetHighlightNormal(int highlight)
{
  svtkProperty* p = highlight ? this->SelectedNormalProperty : this->NormalProperty;
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::SetRepresentationState(int state)
{
  ...
  // Clamp the state
  state = (state < svtkFinitePlaneRepresentation::Outside
      ? svtkFinitePlaneRepresentation::Outside
      : (state > svtkFinitePlaneRepresentation::Pushing ? svtkFinitePlaneRepresentation::Pushing
                                                       : state));
...
void svtkFinitePlaneRepresentation::TranslateOrigin(double* p1, double* p2)
{
...
//----------------------------------------------------------------------------
// Move Point 1
void svtkFinitePlaneRepresentation::MovePoint1(double* p1, double* p2)
{
  // Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
//----------------------------------------------------------------------------
// Modified Vector v2
void svtkFinitePlaneRepresentation::MovePoint2(double* p1, double* p2)
{
  // Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
//----------------------------------------------------------------------------
// Push Face
void svtkFinitePlaneRepresentation::Push(double* p1, double* p2)
{
  // Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
  ...
  double distance = svtkMath::Dot(v, this->Normal);
...
//----------------------------------------------------------------------------
void svtkFinitePlaneRepresentation::PrintSelf(ostream& os, svtkIndent indent)
{
