/*=========================================================================
  ...
  Module:    svtkFocalPlanePointPlacer.cxx
...
svtkStandardNewMacro(svtkFocalPlanePointPlacer);

//----------------------------------------------------------------------
svtkFocalPlanePointPlacer::svtkFocalPlanePointPlacer()
{
...
//----------------------------------------------------------------------
svtkFocalPlanePointPlacer::~svtkFocalPlanePointPlacer() = default;

//----------------------------------------------------------------------
int svtkFocalPlanePointPlacer::ComputeWorldPosition(
  svtkRenderer* ren, double displayPos[2], double worldPos[3], double worldOrient[9])
{
  ...
  else
  {
    ...
    svtkMath::Normalize(viewDirection);
    double costheta = svtkMath::Dot(viewDirection, focalPlaneNormal) /
      (svtkMath::Norm(viewDirection) * svtkMath::Norm(focalPlaneNormal));
  ...
  if (this->PointBounds[0] < this->PointBounds[1] &&
    !(svtkMath::PointIsWithinBounds(tmp, this->PointBounds, tolerance)))
  {
    return 0;
  }
...
//----------------------------------------------------------------------
int svtkFocalPlanePointPlacer::ComputeWorldPosition(svtkRenderer* ren, double displayPos[2],
...
//----------------------------------------------------------------------
int svtkFocalPlanePointPlacer::ValidateWorldPosition(double* worldPos)
{
  double tolerance[3] = { 1e-12, 1e-12, 1e-12 };
  if (this->PointBounds[0] < this->PointBounds[1] &&
    !(svtkMath::PointIsWithinBounds(worldPos, this->PointBounds, tolerance)))
  {
    return 0;
  }
...
//----------------------------------------------------------------------
int svtkFocalPlanePointPlacer::ValidateWorldPosition(
  double* worldPos, double* svtkNotUsed(worldOrient))
{
  double tolerance[3] = { 1e-12, 1e-12, 1e-12 };
  if (this->PointBounds[0] < this->PointBounds[1] &&
    !(svtkMath::PointIsWithinBounds(worldPos, this->PointBounds, tolerance)))
...
//----------------------------------------------------------------------
void svtkFocalPlanePointPlacer::GetCurrentOrientation(double worldOrient[9])
{
...
//----------------------------------------------------------------------
void svtkFocalPlanePointPlacer::PrintSelf(ostream& os, svtkIndent indent)
{
