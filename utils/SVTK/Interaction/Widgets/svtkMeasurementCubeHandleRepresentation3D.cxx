/*=========================================================================
  ...
  Module:    svtkMeasurementCubeHandleRepresentation3D.cxx
...
svtkStandardNewMacro(svtkMeasurementCubeHandleRepresentation3D);
svtkCxxSetObjectMacro(svtkMeasurementCubeHandleRepresentation3D, Property, svtkProperty);
svtkCxxSetObjectMacro(svtkMeasurementCubeHandleRepresentation3D, SelectedProperty, svtkProperty);

//----------------------------------------------------------------------
svtkMeasurementCubeHandleRepresentation3D::svtkMeasurementCubeHandleRepresentation3D()
{
  ...
  this->LabelText = svtkBillboardTextActor3D::New();
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::RegisterPickers()
{
...
//----------------------------------------------------------------------
svtkPolyData* svtkMeasurementCubeHandleRepresentation3D::GetHandle()
{
  return svtkPolyData::SafeDownCast(this->HandleTransformFilter->GetInput());
}

//-------------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::SetWorldPosition(double p[3])
{
...
//-------------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::SetDisplayPosition(double p[3])
{
...
//-------------------------------------------------------------------------
int svtkMeasurementCubeHandleRepresentation3D ::ComputeInteractionState(
...
void svtkMeasurementCubeHandleRepresentation3D::StartWidgetInteraction(double startEventPos[2])
{
...
// of the widget.
void svtkMeasurementCubeHandleRepresentation3D::WidgetInteraction(double eventPos[2])
{
    ...
    this->InteractionState == svtkHandleRepresentation::Translating)
  {
    ...
    if (this->InteractionState == svtkHandleRepresentation::Selecting)
    {
      ...
      svtkFocalPlanePointPlacer* fPlacer = svtkFocalPlanePointPlacer::SafeDownCast(this->PointPlacer);
      if (fPlacer)
      {
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D ::MoveFocusRequest(
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::MoveFocus(const double* p1, const double* p2)
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D ::Scale(
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D ::SetUniformScale(double handleSize)
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::Highlight(int highlight)
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::CreateDefaultProperties()
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::UpdateHandle()
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::ScaleIfNecessary(svtkViewport* viewport)
{
  // Scaling is performed relative to the viewport window, so if there is no
  // window then there is nothing to do
  if (!viewport->GetSVTKWindow())
  {
    return;
  }
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::BuildRepresentation()
{
  ...
  // pointer is set to a valid svtkRenderer, but in the latter case this may not
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::UpdateLabel()
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::ShallowCopy(svtkProp* prop)
{
  svtkMeasurementCubeHandleRepresentation3D* rep =
    svtkMeasurementCubeHandleRepresentation3D::SafeDownCast(prop);
  if (rep)
  {
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::DeepCopy(svtkProp* prop)
{
  svtkMeasurementCubeHandleRepresentation3D* rep =
    svtkMeasurementCubeHandleRepresentation3D::SafeDownCast(prop);
  if (rep)
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::GetActors(svtkPropCollection* pc)
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::ReleaseGraphicsResources(svtkWindow* win)
{
...
//----------------------------------------------------------------------
int svtkMeasurementCubeHandleRepresentation3D::RenderOpaqueGeometry(svtkViewport* viewport)
{
  int count = 0;
...
//-----------------------------------------------------------------------------
int svtkMeasurementCubeHandleRepresentation3D::RenderTranslucentPolygonalGeometry(
...
//-----------------------------------------------------------------------------
svtkTypeBool svtkMeasurementCubeHandleRepresentation3D::HasTranslucentPolygonalGeometry()
{
  int result = 0;
  this->BuildRepresentation();
  if (this->HandleVisibility)
...
//-----------------------------------------------------------------------------
double* svtkMeasurementCubeHandleRepresentation3D::GetBounds()
{
  this->BuildRepresentation();
...
//-----------------------------------------------------------------------------
svtkAbstractTransform* svtkMeasurementCubeHandleRepresentation3D::GetTransform()
{
  return this->HandleTransform;
}

//------------------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::SetLabelTextInput(const char* s)
{
  this->LabelText->SetInput(s);
}

//------------------------------------------------------------------------------
char* svtkMeasurementCubeHandleRepresentation3D::GetLabelTextInput()
{
  return this->LabelText->GetInput();
}

//------------------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::SetSideLength(double d)
{
...
//------------------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::SetMinRelativeCubeScreenArea(double d)
{
...
//------------------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::SetMaxRelativeCubeScreenArea(double d)
{
...
//----------------------------------------------------------------------
void svtkMeasurementCubeHandleRepresentation3D::PrintSelf(ostream& os, svtkIndent indent)
{
