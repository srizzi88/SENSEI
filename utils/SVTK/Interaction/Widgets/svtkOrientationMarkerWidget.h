/*=========================================================================
  ...
  Module:    svtkOrientationMarkerWidget.h
...
=========================================================================*/
/**
 * @class   svtkOrientationMarkerWidget
 ...
 * the argument of the method a svtkRenderWindowInteractor, and 2) invoke
 * SetOrientationMarker with an instance of svtkProp (see caveats below).
 * Specifically, svtkAxesActor and svtkAnnotatedCubeActor are two classes
 * designed to work with this class.  A composite orientation marker can be
 * generated by adding instances of svtkAxesActor and svtkAnnotatedCubeActor to a
 * svtkPropAssembly, which can then be set as the input orientation marker.
 ...
 *
 * @par Thanks:
 * This class was based originally on Paraview's svtkPVAxesWidget.
 *
 * @warning
 ...
 * associated with the interactor must be of the type svtkInteractorStyle*Camera.
 ...
 *
 * @sa
 * svtkInteractorObserver svtkXYPlotWidget svtkScalarBarWidget svtkAxesActor
 * svtkAnnotatedCubeActor
 */

#ifndef svtkOrientationMarkerWidget_h
#define svtkOrientationMarkerWidget_h
...
class svtkPolyData;
class svtkProp;
class svtkOrientationMarkerWidgetObserver;
class svtkRenderer;

class SVTKINTERACTIONWIDGETS_EXPORT svtkOrientationMarkerWidget : public svtkInteractorObserver
{
public:
  static svtkOrientationMarkerWidget* New();
  svtkTypeMacro(svtkOrientationMarkerWidget, svtkInteractorObserver);
   ...
   */
  virtual void SetOrientationMarker(svtkProp* prop);
  svtkGetObjectMacro(OrientationMarker, svtkProp);
  //@}
   ...
   */
  void ExecuteCameraUpdateEvent(svtkObject* o, unsigned long event, void* calldata);
   ...
   * Default is On.
   */
  void SetInteractive(svtkTypeBool state);
  ...
  double* GetOutlineColor() SVTK_SIZEHINT(3);
  //@}
   ...
   * svtkSetVector4Macro/svtkGetVector4Macro use
   */
  void Modified() override;
  //@}

protected:
  svtkOrientationMarkerWidget();
  ~svtkOrientationMarkerWidget() override;

  svtkRenderer* Renderer;
  svtkProp* OrientationMarker;
  svtkPolyData* Outline;
  svtkActor2D* OutlineActor;
  ...
  svtkOrientationMarkerWidgetObserver* Observer;
...
private:
  svtkOrientationMarkerWidget(const svtkOrientationMarkerWidget&) = delete;
  void operator=(const svtkOrientationMarkerWidget&) = delete;
