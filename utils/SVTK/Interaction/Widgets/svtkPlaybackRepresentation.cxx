/*=========================================================================
  ...
  Module:    svtkPlaybackRepresentation.cxx
...
svtkStandardNewMacro(svtkPlaybackRepresentation);

svtkPlaybackRepresentation::svtkPlaybackRepresentation()
{
  // Set up the geometry
  double size[2];
  this->GetSize(size);
...
//-------------------------------------------------------------------------
void svtkPlaybackRepresentation::BuildRepresentation()
{
...
//-------------------------------------------------------------------------
void svtkPlaybackRepresentation::GetActors2D(svtkPropCollection* pc)
{
...
//-------------------------------------------------------------------------
void svtkPlaybackRepresentation::ReleaseGraphicsResources(svtkWindow* w)
{
...
//-------------------------------------------------------------------------
int svtkPlaybackRepresentation::RenderOverlay(svtkViewport* w)
{
...
//-------------------------------------------------------------------------
int svtkPlaybackRepresentation::RenderOpaqueGeometry(svtkViewport* w)
{
...
//-----------------------------------------------------------------------------
int svtkPlaybackRepresentation::RenderTranslucentPolygonalGeometry(svtkViewport* w)
{
...
svtkTypeBool svtkPlaybackRepresentation::HasTranslucentPolygonalGeometry()
{
...
//-------------------------------------------------------------------------
void svtkPlaybackRepresentation::PrintSelf(ostream& os, svtkIndent indent)
{
