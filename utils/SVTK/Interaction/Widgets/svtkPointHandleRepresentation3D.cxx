/*=========================================================================
  ...
  Module:    svtkPointHandleRepresentation3D.cxx
...
svtkStandardNewMacro(svtkPointHandleRepresentation3D);

svtkCxxSetObjectMacro(svtkPointHandleRepresentation3D, Property, svtkProperty);
svtkCxxSetObjectMacro(svtkPointHandleRepresentation3D, SelectedProperty, svtkProperty);

//----------------------------------------------------------------------
svtkPointHandleRepresentation3D::svtkPointHandleRepresentation3D()
{
  // Initialize state
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::RegisterPickers()
{
...
//-------------------------------------------------------------------------
void svtkPointHandleRepresentation3D::PlaceWidget(double bds[6])
{
  int i;
...
//-------------------------------------------------------------------------
double* svtkPointHandleRepresentation3D::GetBounds()
{
  return this->Cursor3D->GetModelBounds();
}

//-------------------------------------------------------------------------
void svtkPointHandleRepresentation3D::SetWorldPosition(double p[3])
{
...
//-------------------------------------------------------------------------
void svtkPointHandleRepresentation3D::SetDisplayPosition(double p[3])
{
  if (this->Renderer && this->PointPlacer)
  {
...
//-------------------------------------------------------------------------
void svtkPointHandleRepresentation3D::SetHandleSize(double size)
{
...
//-------------------------------------------------------------------------
int svtkPointHandleRepresentation3D ::ComputeInteractionState(int X, int Y, int svtkNotUsed(modify))
{
...
//-------------------------------------------------------------------------
int svtkPointHandleRepresentation3D::ComputeComplexInteractionState(
  svtkRenderWindowInteractor*, svtkAbstractWidget*, unsigned long, void* calldata, int)
{
  ...
  if (edd)
  {
    ...
    svtkAssemblyPath* path = this->GetAssemblyPath3DPoint(pos, this->CursorPicker);
    double focus[3];
...
//-------------------------------------------------------------------------
int svtkPointHandleRepresentation3D::DetermineConstraintAxis(
...
void svtkPointHandleRepresentation3D::StartWidgetInteraction(double startEventPos[2])
{
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::StartComplexInteraction(
...
// of the widget.
void svtkPointHandleRepresentation3D::WidgetInteraction(double eventPos[2])
{
    ...
    this->InteractionState == svtkHandleRepresentation::Translating)
  {
    ...
    if (this->WaitCount > 3 || !this->Constrained)
    {
      ...
      {
        svtkDebugMacro(<< "Processing widget interaction for Select mode");
      ...
      {
        svtkDebugMacro(<< "Processing widget interaction for translate");
...
void svtkPointHandleRepresentation3D::ComplexInteraction(
  svtkRenderWindowInteractor*, svtkAbstractWidget*, unsigned long, void* calldata)
{
  svtkEventData* edata = static_cast<svtkEventData*>(calldata);
  svtkEventDataDevice3D* edd = edata->GetAsEventDataDevice3D();
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D ::MoveFocusRequest(
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::MoveFocus(const double* p1, const double* p2)
{
  this->Translate(p1, p2);
}

//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::SetTranslationMode(svtkTypeBool mode)
{
...
void svtkPointHandleRepresentation3D::Translate(const double* p1, const double* p2)
{
  double v[3] = { 0, 0, 0 };
  svtkHandleRepresentation::Translate(p1, p2);
  this->GetTranslationVector(p1, p2, v);
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::SizeBounds()
{
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::Scale(
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::Highlight(int highlight)
{
  if (highlight)
  {
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::CreateDefaultProperties()
{
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::SetVisibility(svtkTypeBool visible)
{
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::BuildRepresentation()
{
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::ShallowCopy(svtkProp* prop)
{
  svtkPointHandleRepresentation3D* rep = svtkPointHandleRepresentation3D::SafeDownCast(prop);
  if (rep)
  {
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::DeepCopy(svtkProp* prop)
{
  svtkPointHandleRepresentation3D* rep = svtkPointHandleRepresentation3D::SafeDownCast(prop);
  if (rep)
  {
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::GetActors(svtkPropCollection* pc)
{
  this->Actor->GetActors(pc);
}

//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::ReleaseGraphicsResources(svtkWindow* win)
{
  this->Actor->ReleaseGraphicsResources(win);
}

//----------------------------------------------------------------------
int svtkPointHandleRepresentation3D::RenderOpaqueGeometry(svtkViewport* viewport)
{
...
//-----------------------------------------------------------------------------
int svtkPointHandleRepresentation3D::RenderTranslucentPolygonalGeometry(svtkViewport* viewport)
{
  this->BuildRepresentation();
...
//-----------------------------------------------------------------------------
svtkTypeBool svtkPointHandleRepresentation3D::HasTranslucentPolygonalGeometry()
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
void svtkPointHandleRepresentation3D::PrintSelf(ostream& os, svtkIndent indent)
{
