/*=========================================================================
  ...
  Module:    svtkPointHandleRepresentation3D.h
 ...
 *
 * This class is used to represent a svtkHandleWidget. It represents a position
 * in 3D world coordinates using a x-y-z cursor. The cursor can be configured to
 * show a bounding box and/or shadows.
 *
 * @sa
 * svtkHandleRepresentation svtkHandleWidget svtkCursor3D
 */

#ifndef svtkPointHandleRepresentation3D_h
#define svtkPointHandleRepresentation3D_h

#include "svtkCursor3D.h" // Needed for delegation to cursor3D
...
class SVTKINTERACTIONWIDGETS_EXPORT svtkPointHandleRepresentation3D : public svtkHandleRepresentation
{
public:
  /**
   * Instantiate this class.
   */
  static svtkPointHandleRepresentation3D* New();

  //@{
  /**
   * Standard methods for instances of this class.
   */
  svtkTypeMacro(svtkPointHandleRepresentation3D, svtkHandleRepresentation);
   ...
   */
  void SetTranslationMode(svtkTypeBool mode);
...
protected:
  svtkPointHandleRepresentation3D();
  ~svtkPointHandleRepresentation3D() override;
...
private:
  svtkPointHandleRepresentation3D(const svtkPointHandleRepresentation3D&) = delete;
  void operator=(const svtkPointHandleRepresentation3D&) = delete;
};
