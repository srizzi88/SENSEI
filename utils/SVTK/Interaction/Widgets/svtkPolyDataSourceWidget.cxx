/*=========================================================================
  ...
  Module:    svtkPolyDataSourceWidget.cxx
...
svtkPolyDataSourceWidget::svtkPolyDataSourceWidget()
  : svtk3DWidget()
{
  // child classes should call this constructor so that the svtk3DWidget()
  // constructor can set up some pertinent variables (e.g. Input and Prop3D)
}

void svtkPolyDataSourceWidget::PlaceWidget()
{
  double bounds[6];
...
void svtkPolyDataSourceWidget::PrintSelf(ostream& os, svtkIndent indent)
{
