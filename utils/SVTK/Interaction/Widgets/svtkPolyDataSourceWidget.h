/*=========================================================================
  ...
  Module:    svtkPolyDataSourceWidget.h
...
=========================================================================*/
/**
 * @class   svtkPolyDataSourceWidget
 * @brief   abstract PolyDataSource-based 3D widget
 *
 * This abstract class serves as parent to 3D widgets that have simple
 * svtkPolyDataSource instances defining their geometry.
 *
 * In addition to what is offered by the svtk3DWidget parent, this class
 ...
 *
 * @sa
 * svtk3DWidget svtkLineWidget svtkPlaneWidget svtkSphereWidget
 */

#ifndef svtkPolyDataSourceWidget_h
#define svtkPolyDataSourceWidget_h
...
class SVTKINTERACTIONWIDGETS_EXPORT svtkPolyDataSourceWidget : public svtk3DWidget
{
public:
  svtkTypeMacro(svtkPolyDataSourceWidget, svtk3DWidget);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Overrides svtk3DWidget PlaceWidget() so that it doesn't complain if
  ...
  /**
   * Convenience method brought over from svtkPlaneWidget.
   */
  void PlaceWidget(
  ...
  /**
   * Returns underlying svtkPolyDataAlgorithm that determines geometry.  This
   ...
   */
  virtual svtkPolyDataAlgorithm* GetPolyDataAlgorithm() = 0;

  /**
   * If you've made changes to the underlying svtkPolyDataSource AFTER your
...
private:
  ...
  svtkPolyDataSourceWidget(const svtkPolyDataSourceWidget&) = delete;
  void operator=(const svtkPolyDataSourceWidget&) = delete;
};
