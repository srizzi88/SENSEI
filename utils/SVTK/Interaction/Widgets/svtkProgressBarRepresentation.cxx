/*=========================================================================
  ...
  Module:    svtkProgressBarRepresentation.cxx
...
svtkStandardNewMacro(svtkProgressBarRepresentation);

svtkProgressBarRepresentation::svtkProgressBarRepresentation()
{
  this->ProgressRate = 0;
  ...
  this->Points->SetPoint(2, PROGRESS_BAR_WIDTH, PROGRESS_BAR_HEIGHT, 0.0);
  this->Points->SetPoint(3, PROGRESS_BAR_WIDTH, 0.2, 0.0);
  double progressPoint = 0.2 + (this->ProgressRate * (PROGRESS_BAR_WIDTH - 0.2));
  ...
  svtkIdType linesIds[5] = { 0, 1, 2, 3, 0 };
  lines->InsertNextCell(5, linesIds);

  // Progress bar
  svtkNew<svtkCellArray> polys;
  svtkIdType polysIds[4] = { 4, 5, 6, 7 };
  ...
  this->ProgressBarData = svtkUnsignedCharArray::New();
  ...
  svtkNew<svtkTransformPolyDataFilter> transformFilter;
  ...
  // Background cell
  svtkNew<svtkCellArray> background;
  background->InsertNextCell(4, linesIds);

  // Background polydata
  svtkNew<svtkPolyData> backgroundPolydata;
...
//-------------------------------------------------------------------------
void svtkProgressBarRepresentation::BuildRepresentation()
{
...
//-------------------------------------------------------------------------
void svtkProgressBarRepresentation::GetSize(double size[2])
{
...
//-------------------------------------------------------------------------
void svtkProgressBarRepresentation::GetActors2D(svtkPropCollection* pc)
{
...
//-------------------------------------------------------------------------
void svtkProgressBarRepresentation::ReleaseGraphicsResources(svtkWindow* w)
{
  if (this->DrawBackground)
  {
...
//-------------------------------------------------------------------------
int svtkProgressBarRepresentation::RenderOverlay(svtkViewport* w)
{
...
//-------------------------------------------------------------------------
int svtkProgressBarRepresentation::RenderOpaqueGeometry(svtkViewport* w)
{
...
//-----------------------------------------------------------------------------
int svtkProgressBarRepresentation::RenderTranslucentPolygonalGeometry(svtkViewport* w)
{
...
//-----------------------------------------------------------------------------
svtkTypeBool svtkProgressBarRepresentation::HasTranslucentPolygonalGeometry()
{
...
//-------------------------------------------------------------------------
void svtkProgressBarRepresentation::PrintSelf(ostream& os, svtkIndent indent)
{
