/*=========================================================================
  ...
  Module:    svtkSeedRepresentation.h
 ...
 * @brief   represent the svtkSeedWidget
 *
 * The svtkSeedRepresentation is a superclass for classes representing the
 * svtkSeedWidget. This representation consists of one or more handles
 * (svtkHandleRepresentation) which are used to place and manipulate the
 * points defining the collection of seeds.
 *
 * @sa
 * svtkSeedWidget svtkHandleRepresentation svtkSeedRepresentation
 */

#ifndef svtkSeedRepresentation_h
#define svtkSeedRepresentation_h

#include "svtkInteractionWidgetsModule.h" // For export macro
#include "svtkWidgetRepresentation.h"

class svtkHandleList;
class svtkHandleRepresentation;

class SVTKINTERACTIONWIDGETS_EXPORT svtkSeedRepresentation : public svtkWidgetRepresentation
{
public:
  /**
   * Instantiate class.
   */
  static svtkSeedRepresentation* New();

  //@{
  /**
   * Standard SVTK methods.
   */
  svtkTypeMacro(svtkSeedRepresentation, svtkWidgetRepresentation);
   ...
   * for the internal svtkHandleWidgets within svtkSeedWidget.  To use this
   * method, create a dummy svtkHandleWidget (or subclass), and then invoke
   * this method with this dummy. Then the svtkSeedRepresentation uses this
   * dummy to clone svtkHandleWidgets of the same type. Make sure you set the
   ...
   */
  svtkHandleRepresentation* GetHandleRepresentation(unsigned int num);

  //@{
  /**
   * Returns the model HandleRepresentation.
   */
  svtkHandleRepresentation* GetHandleRepresentation() { return this->HandleRepresentation; };
  //@}
  ...
  //@{
  /**
   * These are methods specific to svtkSeedRepresentation and which are
   * invoked from svtkSeedWidget.
   */
...
private:
  svtkSeedRepresentation(const svtkSeedRepresentation&) = delete;
  void operator=(const svtkSeedRepresentation&) = delete;
};
