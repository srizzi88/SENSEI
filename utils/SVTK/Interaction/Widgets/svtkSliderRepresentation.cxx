/*=========================================================================
  ...
  Module:    svtkSliderRepresentation.cxx
...
//----------------------------------------------------------------------
svtkSliderRepresentation::svtkSliderRepresentation()
{
...
//----------------------------------------------------------------------
void svtkSliderRepresentation::SetMinimumValue(double minValue)
{
  ...
  this->InvokeEvent(svtkCommand::WidgetValueChangedEvent, nullptr);
  if (this->Renderer)
  {
...
//----------------------------------------------------------------------
void svtkSliderRepresentation::SetMaximumValue(double maxValue)
{
...
//----------------------------------------------------------------------
void svtkSliderRepresentation::SetValue(double value)
{
  if (value == this->Value)
  {
    return;
...
//----------------------------------------------------------------------
void svtkSliderRepresentation::PrintSelf(ostream& os, svtkIndent indent)
{
