/*=========================================================================
  ...
  Module:    svtkSliderRepresentation2D.cxx
...
svtkStandardNewMacro(svtkSliderRepresentation2D);

//----------------------------------------------------------------------
svtkSliderRepresentation2D::svtkSliderRepresentation2D()
{
  ...
  // The slider
  this->SliderCells = svtkCellArray::New();
  ...
  this->TubeCells = svtkCellArray::New();
  ...
  // The two caps
  this->CapCells = svtkCellArray::New();
  ...
  this->TitleProperty = svtkTextProperty::New();
...
//----------------------------------------------------------------------
void svtkSliderRepresentation2D::SetTitleText(const char* label)
{
...
//----------------------------------------------------------------------
const char* svtkSliderRepresentation2D::GetTitleText()
{
  return this->TitleMapper->GetInput();
}

//----------------------------------------------------------------------
svtkCoordinate* svtkSliderRepresentation2D::GetPoint1Coordinate()
{
  return this->Point1Coordinate;
}

//----------------------------------------------------------------------
void svtkSliderRepresentation2D::StartWidgetInteraction(double eventPos[2])
{
  ...
  svtkCell* sliderCell = this->SliderXForm->GetOutput()->GetCell(0);
  ...
  svtkCell* tubeCell = this->TubeXForm->GetOutput()->GetCell(0);
  ...
  svtkCell* leftCapCell = this->CapXForm->GetOutput()->GetCell(0);
  ...
  svtkCell* rightCapCell = this->CapXForm->GetOutput()->GetCell(1);
...
//----------------------------------------------------------------------
void svtkSliderRepresentation2D::WidgetInteraction(double eventPos[2])
{
...
//----------------------------------------------------------------------
svtkCoordinate* svtkSliderRepresentation2D::GetPoint2Coordinate()
{
  return this->Point2Coordinate;
}

//----------------------------------------------------------------------
void svtkSliderRepresentation2D::PlaceWidget(double* svtkNotUsed(bds[6]))
{
...
//----------------------------------------------------------------------
double svtkSliderRepresentation2D::ComputePickPosition(double eventPos[2])
{
  ...
  // slider).
  svtkLine::DistanceToLine(event, x1, x2, this->PickedT, closestPoint);
...
//----------------------------------------------------------------------
void svtkSliderRepresentation2D::Highlight(int highlight)
{
  if (highlight)
  {
...
//----------------------------------------------------------------------
void svtkSliderRepresentation2D::BuildRepresentation()
{
      ...
      this->Renderer->GetSVTKWindow()->GetMTime() > this->BuildTime))
  {
    ...
    this->XForm->RotateZ(svtkMath::DegreesFromRadians(theta));
...
//----------------------------------------------------------------------
void svtkSliderRepresentation2D::GetActors2D(svtkPropCollection* pc)
{
...
//----------------------------------------------------------------------
void svtkSliderRepresentation2D::ReleaseGraphicsResources(svtkWindow* w)
{
...
//----------------------------------------------------------------------
int svtkSliderRepresentation2D::RenderOpaqueGeometry(svtkViewport* viewport)
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
int svtkSliderRepresentation2D::RenderOverlay(svtkViewport* viewport)
{
  this->BuildRepresentation();
...
//----------------------------------------------------------------------
void svtkSliderRepresentation2D::PrintSelf(ostream& os, svtkIndent indent)
{
