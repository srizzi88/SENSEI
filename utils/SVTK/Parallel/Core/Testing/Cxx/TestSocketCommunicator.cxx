...
=========================================================================*/
// This test tests svtkSocketCommunicator.
...
int main(int argc, char* argv[])
{
  ...
  svtkNew<svtkSocketController> controller;
  controller->Initialize(&argc, &argv);

  svtkSocketCommunicator* comm = svtkSocketCommunicator::SafeDownCast(controller->GetCommunicator());
  ...
  int idata = 0;
  double ddata = 0;
  svtkNew<svtkDoubleArray> dArray;
  svtkNew<svtkPolyData> pData;
