...
static void CleanUp(svtkSmartPointer<svtkSocketCommunicator> comm,
...
int main(int argc, char** argv)
{
  ...
  for (i = 0; i < scMsgLength; i++)
  {
    if (datait[i] != static_cast<svtkIdType>(i))
    {
  ...
  // Test sending svtkDataObject
  SVTK_CREATE(svtkUnstructuredGridReader, ugrid);
  char* fname = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/blow.svtk");
  ...
  SVTK_CREATE(svtkBYUReader, pd);
  fname = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/teapot.g");
  ...
  SVTK_CREATE(svtkRectilinearGridReader, rgrid);
  fname = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/RectGrid2.svtk");
  ...
  SVTK_CREATE(svtkMultiBlockPLOT3DReader, pl3d);
  fname = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/combxyz.bin");
  ...
  SVTK_CREATE(svtkPNMReader, imageData);
  fname = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/earth.ppm");
