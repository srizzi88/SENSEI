/*=========================================================================
  ...
  =========================================================================*/
/**
 * @class   svtkPDirectory
 *
 * svtkPDirectory provides a portable way of finding the names of the files
 ...
 * Directory and svtkDirectory though there are slight mismatches between the
 * two. This is a blocking collective operation.
 */

#ifndef svtkPDirectory_h
#define svtkPDirectory_h
...
class SVTKPARALLELCORE_EXPORT svtkPDirectory : public svtkObject
{
public:
  static svtkPDirectory* New();
  svtkTypeMacro(svtkPDirectory, svtkObject);
   ...
   * of this is that Directory uses Load() and svtkDirectory uses Open()
   ...
   */
  svtkIdType GetNumberOfFiles() const;

  /**
   * Return the file at the given index, the indexing is 0 based
   */
  const char* GetFile(svtkIdType index) const;
   ...
   */
  svtkGetObjectMacro(Files, svtkStringArray);
  //@}
...
protected:
  svtkPDirectory();
  ~svtkPDirectory() override;

private:
  // Array of Files
  svtkStringArray* Files; // SVTK array of files

  // Path to Open'ed directory
  std::string Path;

  svtkPDirectory(const svtkPDirectory&) = delete;
  void operator=(const svtkPDirectory&) = delete;
}; // End Class: svtkPDirectory
