/*=========================================================================
  ...
  Module:    svtkDIYExplicitAssigner.cxx
...
//----------------------------------------------------------------------------
svtkDIYExplicitAssigner::svtkDIYExplicitAssigner(
  ...
  : diy::StaticAssigner(comm.size(), local_blocks)
{
  ...
  if (force_power_of_two)
  {
    ...
    const int global_block_counts_pow_2 = svtkMath::NearestPowerOfTwo(global_num_blocks);
  ...
  assert(
    force_power_of_two == false || svtkMath::NearestPowerOfTwo(this->nblocks()) == this->nblocks());
}

//----------------------------------------------------------------------------
int svtkDIYExplicitAssigner::rank(int gid) const
{
  auto iter =
...
//----------------------------------------------------------------------------
void svtkDIYExplicitAssigner::local_gids(int rank, std::vector<int>& gids) const
{
