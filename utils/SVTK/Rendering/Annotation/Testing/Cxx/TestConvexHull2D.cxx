...
{
  return fuzzyCompare1Dweak(a[0], b[0]) && fuzzyCompare1Dweak(a[1], b[1]);
}
...
int TestConvexHull2D(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkPoints> inPoints = svtkSmartPointer<svtkPoints>::New();
  ...
  svtkConvexHull2D::CalculateConvexHull(inPoints, outPoints, 2.0);
  ...
  inPoints = svtkSmartPointer<svtkPoints>::New();
  outPoints = svtkSmartPointer<svtkPoints>::New();
