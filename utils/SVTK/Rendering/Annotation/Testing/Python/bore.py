...
mapArc = svtk.svtkPolyDataMapper()
mapArc.SetInputConnection(ap.GetOutputPort())
arcActor = svtk.svtkActor()
arcActor.SetMapper(mapArc)
arcActor.GetProperty().SetColor(0,1,0)
track2 = svtk.svtkPolyDataReader()
track2.SetFileName("" + str(SVTK_DATA_ROOT) + "/Data/track2.binary.svtk")
ap2 = svtk.svtkArcPlotter()
