/*=========================================================================
  ...
  Module:    svtkLegendScaleActor.cxx
...
svtkStandardNewMacro(svtkLegendScaleActor);

//----------------------------------------------------------------------
svtkLegendScaleActor::svtkLegendScaleActor()
{
  ...
  this->RightAxis = svtkAxisActor2D::New();
  ...
  this->TopAxis = svtkAxisActor2D::New();
  ...
  this->LeftAxis = svtkAxisActor2D::New();
  ...
  this->BottomAxis = svtkAxisActor2D::New();
  ...
  this->Legend = svtkPolyData::New();
  this->LegendPoints = svtkPoints::New();
  this->Legend->SetPoints(this->LegendPoints);
  this->LegendMapper = svtkPolyDataMapper2D::New();
  this->LegendMapper->SetInputData(this->Legend);
  this->LegendActor = svtkActor2D::New();
  this->LegendActor->SetMapper(this->LegendMapper);

  // Create the legend
  svtkIdType pts[4];
  this->LegendPoints->SetNumberOfPoints(10);
  svtkCellArray* legendPolys = svtkCellArray::New();
  ...
  this->LegendTitleProperty = svtkTextProperty::New();
  ...
  this->LegendLabelProperty = svtkTextProperty::New();
  ...
  this->Coordinate = svtkCoordinate::New();
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::GetActors2D(svtkPropCollection* pc)
{
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::ReleaseGraphicsResources(svtkWindow* w)
{
...
//----------------------------------------------------------------------
int svtkLegendScaleActor::RenderOpaqueGeometry(svtkViewport* viewport)
{
...
//----------------------------------------------------------------------
int svtkLegendScaleActor::RenderOverlay(svtkViewport* viewport)
{
  int renderedSomething = 0;
  if (this->RightAxisVisibility)
  {
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::BuildRepresentation(svtkViewport* viewport)
{
  ...
  //         this->Renderer->GetSVTKWindow()->GetMTime() > this->BuildTime) )
  {
    ...
    else // distance between points
    {
      ...
      double* xL = this->RightAxis->GetPositionCoordinate()->GetComputedWorldValue(viewport);
      double* xR = this->RightAxis->GetPosition2Coordinate()->GetComputedWorldValue(viewport);
      d = sqrt(svtkMath::Distance2BetweenPoints(xL, xR));
    ...
    if (this->LegendVisibility)
    {
      ...
      xR[1] = x[1];
      xR[2] = x[2];
      double len = sqrt(svtkMath::Distance2BetweenPoints(xL, xR));
      char buf[256];
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::AllAnnotationsOn()
{
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::AllAnnotationsOff()
{
  if (!this->RightAxisVisibility && !this->TopAxisVisibility && !this->LeftAxisVisibility &&
    !this->BottomAxisVisibility && !this->LegendVisibility)
  {
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::AllAxesOn()
{
  if (this->RightAxisVisibility && this->TopAxisVisibility && this->LeftAxisVisibility &&
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::AllAxesOff()
{
  if (!this->RightAxisVisibility && !this->TopAxisVisibility && !this->LeftAxisVisibility &&
    !this->BottomAxisVisibility)
  {
...
//----------------------------------------------------------------------
void svtkLegendScaleActor::PrintSelf(ostream& os, svtkIndent indent)
{
