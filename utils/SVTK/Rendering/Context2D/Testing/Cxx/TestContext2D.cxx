...
namespace
{
class ContextItem : public svtkContextItem
{
public:
  ContextItem()
    : Succeeded(true)
  ...
  svtkTypeMacro(ContextItem, svtkContextItem);
...
//----------------------------------------------------------------------------
svtkStandardNewMacro(ContextItem);
...
//----------------------------------------------------------------------------
bool ContextItem::Paint(svtkContext2D* painter)
{
  ...
  // Left justification
  painter->GetTextProp()->SetJustification(SVTK_TEXT_LEFT);
  ...
  painter->GetTextProp()->SetJustification(SVTK_TEXT_CENTERED);
  painter->ComputeStringBounds(text, unjustifiedBounds);
  ...
  // Right justification
  painter->GetTextProp()->SetJustification(SVTK_TEXT_RIGHT);
  painter->ComputeStringBounds(text, unjustifiedBounds);
