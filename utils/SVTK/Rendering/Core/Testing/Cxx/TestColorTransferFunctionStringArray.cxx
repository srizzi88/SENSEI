...
int TestColorTransferFunctionStringArray(int svtkNotUsed(argc), char* svtkNotUsed(argv)[])
{
  ...
  svtkSmartPointer<svtkColorTransferFunction> tfer = svtkSmartPointer<svtkColorTransferFunction>::New();
  tfer->IndexedLookupOn();

  // Need to set some nodes to avoid prematurely returning from
  // svtkColorTransferFunction::MapScalarsThroughTable2()
