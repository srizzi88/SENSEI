...
=========================================================================*/
//
// This example tests picking a svtkFollower and svtkProp3DFollower
//
...
// -----------------------------------------------------------------------
// This does the actual work: updates the svtkPline implicit function.
// This in turn causes the pipeline to update and clip the object.
// Callback for the interaction
class svtkPickFollowerCallback : public svtkCommand
{
public:
  static svtkPickFollowerCallback* New() { return new svtkPickFollowerCallback; }
  void Execute(svtkObject* caller, unsigned long, void*) override
  {
    //      svtkPropPicker *picker = reinterpret_cast<svtkPropPicker*>(caller);
    svtkCellPicker* picker = reinterpret_cast<svtkCellPicker*>(caller);
  ...
  svtkPickFollowerCallback() = default;
};
...
int TestFollowerPicking(int argc, char* argv[])
{
  ...
  // Picking callback
  SVTK_CREATE(svtkPickFollowerCallback, myCallback);

  //  SVTK_CREATE(svtkPropPicker,picker);
  SVTK_CREATE(svtkCellPicker, picker);
  picker->AddObserver(svtkCommand::EndPickEvent, myCallback);
  ...
  int retVal = svtkRegressionTestImageThreshold(renWin, 10);
