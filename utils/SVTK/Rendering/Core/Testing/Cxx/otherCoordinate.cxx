...
// .NAME
// .SECTION Description
// this program tests svtkCoordinate
...
void ToAll(ostream& strm, svtkCoordinate* c1, svtkViewport* ren1, double* from)
{
  double* value;
  int* ivalue;
...
{
  // actual test
  strm << "Testing svtkCoordinate" << endl;
  svtkCoordinate* c1 = svtkCoordinate::New();
  svtkCoordinate* c2 = svtkCoordinate::New();
  svtkRenderWindow* renWin = svtkRenderWindow::New();
  svtkRenderer* ren1 = svtkRenderer::New();
  svtkCamera* camera = svtkCamera::New();
  double from[3];
...
int otherCoordinate(int, char*[])
{
  ...
  return Test(svtkmsg_with_warning_C4701);
}
