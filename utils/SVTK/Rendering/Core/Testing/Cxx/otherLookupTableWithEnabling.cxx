...
void TestOLT(svtkLookupTableWithEnabling* lut1)
{
  // actual test
...
{
  svtkLookupTableWithEnabling* lut1 = svtkLookupTableWithEnabling::New();
  lut1->SetAlpha(1.0);
  ...
  svtkLookupTableWithEnabling* lut2 = svtkLookupTableWithEnabling::New();
  lut2->SetAlpha(1.0);
