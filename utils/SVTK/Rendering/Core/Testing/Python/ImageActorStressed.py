...
gsOne = svtk.svtkImageEllipsoidSource()
...
gsThree = svtk.svtkImageEllipsoidSource()
...
# are powers of two
gsFour = svtk.svtkImageEllipsoidSource()
...
gsFive = svtk.svtkImageEllipsoidSource()
