...
coneMapper2 = svtk.svtkPolyDataMapper()
...
reader.SetFileName(SVTK_DATA_ROOT + "/Data/alphachannel.png")
reader.Update()

sphere = svtk.svtkTexturedSphereSource()

texture = svtk.svtkTexture()
texture.SetInputConnection(reader.GetOutputPort())

coneMapper3 = svtk.svtkPolyDataMapper()
coneMapper3.SetInputConnection(sphere.GetOutputPort())

coneActorTexture = svtk.svtkActor()
...
style = svtk.svtkInteractorStyleTrackballCamera()
