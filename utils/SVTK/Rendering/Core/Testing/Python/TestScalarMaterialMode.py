...
ren, actor, mapper = add(interpolate_scalars_before_mapping=1, ambient=0.49,
        diffuse=0.51, material_mode=svtk.SVTK_MATERIALMODE_DEFAULT)
...
ren, actor, mapper = add(interpolate_scalars_before_mapping=1, ambient=0.49,
        diffuse=0.51, material_mode=svtk.SVTK_MATERIALMODE_AMBIENT)
...
ren, actor, mapper = add(interpolate_scalars_before_mapping=1, ambient=0.49,
        diffuse=0.51, material_mode=svtk.SVTK_MATERIALMODE_DIFFUSE)
...
ren, actor, mapper = add(interpolate_scalars_before_mapping=1, ambient=0.49,
        diffuse=0.51, material_mode=svtk.SVTK_MATERIALMODE_AMBIENT_AND_DIFFUSE)
