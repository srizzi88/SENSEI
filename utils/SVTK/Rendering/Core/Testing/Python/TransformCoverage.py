...
# this test covers a lot of the code in svtkAbstractTransform that
...
#--------------------------
tLinear = svtk.svtkTransform()
tPerspective = svtk.svtkPerspectiveTransform()
tGeneral = svtk.svtkGeneralTransform()
