 ...
 *
 * svtkCamera is a virtual camera for 3D rendering. It provides methods
...
class svtkCameraCallbackCommand;

class SVTKRENDERINGCORE_EXPORT svtkCamera : public svtkObject
{
public:
  svtkTypeMacro(svtkCamera, svtkObject);
  ...
  svtkGetVector3Macro(Position, double);
  //@}
  ...
  svtkGetVector3Macro(ViewUp, double);
  //@}
   ...
   */
  svtkGetVector3Macro(DirectionOfProjection, double);
  //@}
   ...
   * is true.
   */
  void SetParallelProjection(svtkTypeBool flag);
  svtkGetMacro(ParallelProjection, svtkTypeBool);
  svtkBooleanMacro(ParallelProjection, svtkTypeBool);
  //@}
   ...
   * is true.
   */
  void SetUseHorizontalViewAngle(svtkTypeBool flag);
  svtkGetMacro(UseHorizontalViewAngle, svtkTypeBool);
  svtkBooleanMacro(UseHorizontalViewAngle, svtkTypeBool);
  //@}
  ...
  svtkGetMacro(ParallelScale, double);
  //@}
  ...
  svtkGetVector2Macro(WindowCenter, double);
  //@}
   ...
   */
  void ApplyTransform(svtkTransform* t);
   ...
   */
  svtkGetVector3Macro(ViewPlaneNormal, double);
  //@}
  ...
  svtkGetVector3Macro(ViewShear, double);
  //@}
   ...
   */
  svtkSetMacro(EyeAngle, double);
  svtkGetMacro(EyeAngle, double);
  //@}
   ...
   */
  svtkSetMacro(FocalDisk, double);
  svtkGetMacro(FocalDisk, double);
  //@}
   ...
   */
  svtkSetMacro(FocalDistance, double);
  svtkGetMacro(FocalDistance, double);
  //@}
   ...
   * is true.
   */
  svtkSetMacro(UseOffAxisProjection, svtkTypeBool);
  svtkGetMacro(UseOffAxisProjection, svtkTypeBool);
  svtkBooleanMacro(UseOffAxisProjection, svtkTypeBool);
  //@}
   ...
   */
  svtkSetVector3Macro(ScreenBottomLeft, double);
  svtkGetVector3Macro(ScreenBottomLeft, double);
  //@}
   ...
   * Default is (1.0, -1.0, -1.0).
   */
  svtkSetVector3Macro(ScreenBottomRight, double);
  svtkGetVector3Macro(ScreenBottomRight, double);
  //@}
   ...
   * Default is (1.0, 1.0, -1.0).
   */
  svtkSetVector3Macro(ScreenTopRight, double);
  svtkGetVector3Macro(ScreenTopRight, double);
  //@}
   ...
   * Default is 0.06.
   */
  svtkSetMacro(EyeSeparation, double);
  svtkGetMacro(EyeSeparation, double);
  //@}
   ...
   * Default is identity.
   */
  void SetEyeTransformMatrix(svtkMatrix4x4* matrix);
  svtkGetObjectMacro(EyeTransformMatrix, svtkMatrix4x4);
  //@}
   ...
   */
  void SetModelTransformMatrix(svtkMatrix4x4* matrix);
  svtkGetObjectMacro(ModelTransformMatrix, svtkMatrix4x4);
  //@}
   ...
   */
  virtual svtkMatrix4x4* GetModelViewTransformMatrix();

  /**
   * Return the model view transform.
   */
  virtual svtkTransform* GetModelViewTransformObject();
   ...
   */
  virtual svtkMatrix4x4* GetViewTransformMatrix();
   ...
   * convenience.
   */
  virtual svtkTransform* GetViewTransformObject();
   ...
   * @{
   */
  virtual void SetExplicitProjectionTransformMatrix(svtkMatrix4x4*);
  svtkGetObjectMacro(ExplicitProjectionTransformMatrix, svtkMatrix4x4);
  /**@}*/
   ...
   * @{
   */
  svtkSetMacro(UseExplicitProjectionTransformMatrix, bool);
  svtkGetMacro(UseExplicitProjectionTransformMatrix, bool);
  svtkBooleanMacro(UseExplicitProjectionTransformMatrix, bool);
  /**@}*/
   ...
   */
  virtual svtkMatrix4x4* GetProjectionTransformMatrix(double aspect, double nearz, double farz);
   ...
   * @sa ExplicitProjectionTransformMatrix
   */
  virtual svtkPerspectiveTransform* GetProjectionTransformObject(
   ...
   * @sa ExplicitProjectionTransformMatrix
   */
  virtual svtkMatrix4x4* GetCompositeProjectionTransformMatrix(
    double aspect, double nearz, double farz);
   ...
   * @sa ExplicitProjectionTransformMatrix
   */
  virtual svtkMatrix4x4* GetProjectionTransformMatrix(svtkRenderer* ren);
   ...
   */
  void SetUserViewTransform(svtkHomogeneousTransform* transform);
  svtkGetObjectMacro(UserViewTransform, svtkHomogeneousTransform);
  //@}
   ...
   */
  void SetUserTransform(svtkHomogeneousTransform* transform);
  svtkGetObjectMacro(UserTransform, svtkHomogeneousTransform);
  //@}
   ...
   * svtkCamera, which is created through New()
   */
   ...
   */
  svtkMTimeType GetViewingRaysMTime();
   ...
   */
  double* GetOrientation() SVTK_SIZEHINT(3);
  double* GetOrientationWXYZ() SVTK_SIZEHINT(4);
  //@}

  /**
   * This method is called automatically whenever necessary, it
   * should never be used outside of svtkCamera.cxx.
   */
   ...
   */
  svtkMatrix4x4* GetCameraLightTransformMatrix();

  /**
   * Update the viewport
   */
  virtual void UpdateViewport(svtkRenderer* svtkNotUsed(ren)) {}

  //@{
  /**
   * Set the Left Eye setting
   */
  svtkSetMacro(LeftEye, int);
  svtkGetMacro(LeftEye, int);
  //@}
   ...
   */
  void ShallowCopy(svtkCamera* source);
   ...
   * \pre not_this: source!=this
   */
  void DeepCopy(svtkCamera* source);
   ...
   */
  svtkSetMacro(UseScissor, bool);
  svtkGetMacro(UseScissor, bool);
  //@}

  //@{
  /**
   * Set/Get the svtkRect value of the scissor
   */
  void SetScissorRect(svtkRecti scissorRect);
  void GetScissorRect(svtkRecti& scissorRect);
  //@}
...
protected:
   ...
   * \pre not_this: source!=this
   */
  void PartialCopy(svtkCamera* source);
  ...
  double EyeAngle;
  svtkTypeBool ParallelProjection;
  ...
  double ViewShear[3];
  svtkTypeBool UseHorizontalViewAngle;

  svtkTypeBool UseOffAxisProjection;
  ...
  svtkMatrix4x4* WorldToScreenMatrix;
  svtkTimeStamp WorldToScreenMatrixMTime;

  svtkMatrix4x4* EyeTransformMatrix;

  svtkMatrix4x4* ModelTransformMatrix;

  svtkHomogeneousTransform* UserTransform;
  svtkHomogeneousTransform* UserViewTransform;

  svtkMatrix4x4* ExplicitProjectionTransformMatrix;
  bool UseExplicitProjectionTransformMatrix;

  svtkTransform* ViewTransform;
  svtkPerspectiveTransform* ProjectionTransform;
  svtkPerspectiveTransform* Transform;
  svtkTransform* CameraLightTransform;

  svtkTransform* ModelViewTransform;

  double FocalDisk;
  double FocalDistance;

  svtkCameraCallbackCommand* UserViewTransformCallbackCommand;
  friend class svtkCameraCallbackCommand;
  ...
  svtkTimeStamp ViewingRaysMTime;
  bool FreezeFocalPoint;
  bool UseScissor;

  svtkRecti ScissorRect;

  // Arbitrary extra information associated with this camera.
  svtkInformation* Information;

private:
  svtkCamera(const svtkCamera&) = delete;
  void operator=(const svtkCamera&) = delete;
};
