/*=========================================================================
  ...
  Module:    svtkColorTransferFunction.h
 ...
 *
 *
 * svtkColorTransferFunction is a color mapping in RGB or HSV space that
 ...
 * between nodes.
 * See the description of class svtkPiecewiseFunction for an explanation of
...
#ifndef svtkColorTransferFunction_h
#define svtkColorTransferFunction_h
...
#define SVTK_CTF_RGB 0
#define SVTK_CTF_HSV 1
#define SVTK_CTF_LAB 2
#define SVTK_CTF_DIVERGING 3
#define SVTK_CTF_LAB_CIEDE2000 4
#define SVTK_CTF_STEP 5

#define SVTK_CTF_LINEAR 0
#define SVTK_CTF_LOG10 1

class SVTKRENDERINGCORE_EXPORT svtkColorTransferFunction : public svtkScalarsToColors
{
public:
  static svtkColorTransferFunction* New();
  svtkTypeMacro(svtkColorTransferFunction, svtkScalarsToColors);
  void DeepCopy(svtkScalarsToColors* f) override;
  void ShallowCopy(svtkColorTransferFunction* f);
   ...
   */
  double* GetColor(double x) SVTK_SIZEHINT(3) { return svtkScalarsToColors::GetColor(x); }
   ...
   */
  double* GetRange() SVTK_SIZEHINT(2) override { return this->Range; }
   ...
   * black.
   */
  svtkSetClampMacro(Clamping, svtkTypeBool, 0, 1);
   ...
   * match the current functionality of svtkLookupTable).  In Lab/CIEDE2000 mode,
   ...
   */
  svtkSetClampMacro(ColorSpace, int, SVTK_CTF_RGB, SVTK_CTF_STEP);
  void SetColorSpaceToRGB() { this->SetColorSpace(SVTK_CTF_RGB); }
  void SetColorSpaceToHSV() { this->SetColorSpace(SVTK_CTF_HSV); }
  void SetColorSpaceToLab() { this->SetColorSpace(SVTK_CTF_LAB); }
  void SetColorSpaceToLabCIEDE2000() { this->SetColorSpace(SVTK_CTF_LAB_CIEDE2000); }
  void SetColorSpaceToDiverging() { this->SetColorSpace(SVTK_CTF_DIVERGING); }
  void SetColorSpaceToStep() { this->SetColorSpace(SVTK_CTF_STEP); }
  svtkGetMacro(ColorSpace, int);
  svtkSetMacro(HSVWrap, svtkTypeBool);
  svtkGetMacro(HSVWrap, svtkTypeBool);
  svtkBooleanMacro(HSVWrap, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(Scale, int);
  void SetScaleToLinear() { this->SetScale(SVTK_CTF_LINEAR); }
  void SetScaleToLog10() { this->SetScale(SVTK_CTF_LOG10); }
   ...
   * range [0,1].
   */
  svtkSetVector3Macro(NanColor, double);
  svtkGetVector3Macro(NanColor, double);
  //@}
   ...
   */
  svtkSetMacro(NanOpacity, double);
  svtkGetMacro(NanOpacity, double);
  //@}
   ...
   */
  svtkSetVector3Macro(BelowRangeColor, double);
  svtkGetVector3Macro(BelowRangeColor, double);
  //@}
   ...
   * encountered. This is an RGB 3-tuple of doubles in the range [0, 1].
   */
  svtkSetVector3Macro(AboveRangeColor, double);
  svtkGetVector3Macro(AboveRangeColor, double);
  //@}
   ...
   */
  svtkSetMacro(AllowDuplicateScalars, svtkTypeBool);
  svtkGetMacro(AllowDuplicateScalars, svtkTypeBool);
  svtkBooleanMacro(AllowDuplicateScalars, svtkTypeBool);
  //@}
...
protected:
  ...
  ~svtkColorTransferFunction() override;

  svtkColorTransferFunctionInternals* Internal;
   ...
   */
  svtkTypeBool AllowDuplicateScalars;
   ...
   * in this subclass of svtkScalarsToColors.
   */
...
private:
  svtkColorTransferFunction(const svtkColorTransferFunction&) = delete;
  void operator=(const svtkColorTransferFunction&) = delete;
};
