/*=========================================================================
  ...
  Module:    svtkDiscretizableColorTransferFunction.cxx
...
class svtkDiscretizableColorTransferFunction::svtkInternals
{
public:
  std::vector<svtkTuple<double, 4> > IndexedColors;
};

svtkStandardNewMacro(svtkDiscretizableColorTransferFunction);
svtkCxxSetObjectMacro(
  svtkDiscretizableColorTransferFunction, ScalarOpacityFunction, svtkPiecewiseFunction);
//-----------------------------------------------------------------------------
svtkDiscretizableColorTransferFunction::svtkDiscretizableColorTransferFunction()
...
//-----------------------------------------------------------------------------
svtkMTimeType svtkDiscretizableColorTransferFunction::GetMTime()
{
  svtkMTimeType mtime = this->Superclass::GetMTime();
  if (this->ScalarOpacityFunction)
  {
    svtkMTimeType somtime = this->ScalarOpacityFunction->GetMTime();
    mtime = somtime > mtime ? somtime : mtime;
  }
  if (this->LookupTable)
  {
    svtkMTimeType ltmtime = this->LookupTable->GetMTime();
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::SetNumberOfIndexedColors(unsigned int count)
{
  if (static_cast<unsigned int>(this->Internals->IndexedColors.size()) != count)
  {
    this->Internals->IndexedColors.resize(count, svtkTuple<double, 4>(0.0));
    this->Modified();
  }
}

//-----------------------------------------------------------------------------
unsigned int svtkDiscretizableColorTransferFunction::GetNumberOfIndexedColors()
{
  return static_cast<unsigned int>(this->Internals->IndexedColors.size());
}

//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::SetIndexedColor(
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::GetIndexedColor(svtkIdType i, double rgba[4])
{
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::SetUseLogScale(int useLogScale)
{
...
//-----------------------------------------------------------------------------
int svtkDiscretizableColorTransferFunction::IsOpaque()
{
  return !this->EnableOpacityMapping;
}

int svtkDiscretizableColorTransferFunction::IsOpaque(
  svtkAbstractArray* scalars, int colorMode, int component)
{
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::Build()
{
  ...
  // svtkScalarsToColors::SetAnnotations(..,..);
  ...
  if (this->IndexedLookup)
  {
    if (this->GetNumberOfIndexedColors() > 0)
    {
      ...
      svtkIdType count = this->GetNumberOfAnnotatedValues();
  ...
  else if (this->Discretize)
  {
    ...
    if (this->UseLogScale)
    {
      ...
      if (!logRangeValid && this->LookupTable->GetScale() == SVTK_SCALE_LOG10)
      {
        this->LookupTable->SetScaleToLinear();
      }
    }
    ...
    if (this->UseLogScale && logRangeValid && this->LookupTable->GetScale() == SVTK_SCALE_LINEAR)
    {
      this->LookupTable->SetScaleToLog10();
    }
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::SetAlpha(double alpha)
{
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::SetNanColor(double r, double g, double b)
{
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::SetNanOpacity(double a)
{
  double color[3];
...
//-----------------------------------------------------------------------------
const unsigned char* svtkDiscretizableColorTransferFunction::MapValue(double v)
{
  this->Build();
...
//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::GetColor(double v, double rgb[3])
{
  this->Build();
  if (this->Discretize || this->IndexedLookup)
  {
...
//-----------------------------------------------------------------------------
double svtkDiscretizableColorTransferFunction::GetOpacity(double v)
{
...
template <class T>
static void svtkDiscretizableColorTransferFunctionMapOpacity(
  svtkDiscretizableColorTransferFunction* self, T* input, unsigned char* output, int length,
  int inIncr, int outFormat)
{
  ...
  unsigned int stride = (outFormat == SVTK_RGBA ? 4 : 2);
...
//----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::MapScalarsThroughTable2(void* input,
  ...
  int outputFormat)
{
    ...
    this->EnableOpacityMapping == true && this->ScalarOpacityFunction.GetPointer() != nullptr)
  {
    ...
    {
      svtkTemplateMacro(svtkDiscretizableColorTransferFunctionMapOpacity(
        this, static_cast<SVTK_TT*>(input), output, numberOfValues, inputIncrement, outputFormat));
      default:
...
//----------------------------------------------------------------------------
svtkIdType svtkDiscretizableColorTransferFunction::GetNumberOfAvailableColors()
{
...
//----------------------------------------------------------------------------
svtkPiecewiseFunction* svtkDiscretizableColorTransferFunction::GetScalarOpacityFunction() const
{
  return this->ScalarOpacityFunction;
}

//-----------------------------------------------------------------------------
void svtkDiscretizableColorTransferFunction::PrintSelf(ostream& os, svtkIndent indent)
{
