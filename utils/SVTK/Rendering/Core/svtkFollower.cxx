...
svtkStandardNewMacro(svtkFollower);

svtkCxxSetObjectMacro(svtkFollower, Camera, svtkCamera);

//----------------------------------------------------------------------
// Creates a follower with no camera set
svtkFollower::svtkFollower()
{
  this->Camera = nullptr;
...
//----------------------------------------------------------------------------
void svtkFollower::ComputeMatrix()
{
...
//----------------------------------------------------------------------
void svtkFollower::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------
int svtkFollower::RenderOpaqueGeometry(svtkViewport* vp)
{
  if (!this->Mapper)
  {
    return 0;
...
//-----------------------------------------------------------------------------
int svtkFollower::RenderTranslucentPolygonalGeometry(svtkViewport* vp)
{
  if (!this->Mapper)
  {
    return 0;
...
//-----------------------------------------------------------------------------
void svtkFollower::ReleaseGraphicsResources(svtkWindow* w)
{
...
svtkTypeBool svtkFollower::HasTranslucentPolygonalGeometry()
{
  if (!this->Mapper)
  {
    return 0;
...
void svtkFollower::Render(svtkRenderer* ren)
{
...
//----------------------------------------------------------------------
void svtkFollower::ShallowCopy(svtkProp* prop)
{
  svtkFollower* f = svtkFollower::SafeDownCast(prop);
  if (f != nullptr)
  {
