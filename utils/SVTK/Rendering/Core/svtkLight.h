 ...
 *
 * svtkLight is a virtual light for 3D rendering. It provides methods to locate
...
class SVTKRENDERINGCORE_EXPORT svtkLight : public svtkObject
{
public:
  svtkTypeMacro(svtkLight, svtkObject);
  ...
  svtkGetVectorMacro(AmbientColor, double, 3);
  svtkSetVector3Macro(DiffuseColor, double);
  svtkGetVectorMacro(DiffuseColor, double, 3);
  svtkSetVector3Macro(SpecularColor, double);
  svtkGetVectorMacro(SpecularColor, double, 3);
   ...
   * svtkGetTransformedPosition() instead of svtkGetPosition().
   */
   ...
   * svtkGetTransformedFocalPoint() instead of svtkGetFocalPoint().
   */
  svtkSetVector3Macro(FocalPoint, double);
   ...
   */
  svtkSetMacro(Intensity, double);
  svtkGetMacro(Intensity, double);
  //@}
   ...
   */
  svtkSetMacro(Switch, svtkTypeBool);
  svtkGetMacro(Switch, svtkTypeBool);
  svtkBooleanMacro(Switch, svtkTypeBool);
  //@}
   ...
   */
  svtkSetMacro(Positional, svtkTypeBool);
  svtkGetMacro(Positional, svtkTypeBool);
  svtkBooleanMacro(Positional, svtkTypeBool);
  //@}
   ...
   */
  svtkSetClampMacro(Exponent, double, 0.0, 128.0);
  svtkGetMacro(Exponent, double);
  //@}
   ...
   */
  svtkSetVector3Macro(AttenuationValues, double);
  svtkGetVectorMacro(AttenuationValues, double, 3);
  //@}
  ...
  svtkGetObjectMacro(TransformMatrix, svtkMatrix4x4);
  //@}
  ...
  double* GetTransformedPosition() SVTK_SIZEHINT(3);
  //@}
  ...
  double* GetTransformedFocalPoint() SVTK_SIZEHINT(3);
  //@}
  ...
  svtkGetMacro(LightType, int);

  void SetLightTypeToHeadlight() { this->SetLightType(SVTK_LIGHT_TYPE_HEADLIGHT); }
  void SetLightTypeToSceneLight() { this->SetLightType(SVTK_LIGHT_TYPE_SCENE_LIGHT); }
  void SetLightTypeToCameraLight() { this->SetLightType(SVTK_LIGHT_TYPE_CAMERA_LIGHT); }
  //@}
   ...
   */
  svtkSetMacro(ShadowAttenuation, float);
  svtkGetMacro(ShadowAttenuation, float);
  //@}
...
private:
  svtkLight(const svtkLight&) = delete;
  void operator=(const svtkLight&) = delete;
};
