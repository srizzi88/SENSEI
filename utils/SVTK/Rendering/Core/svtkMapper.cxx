...
static int svtkMapperGlobalResolveCoincidentTopology = SVTK_RESOLVE_OFF;
static double svtkMapperGlobalResolveCoincidentTopologyZShift = 0.01;
static int svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFaces = 1;

static double svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFactor = 0.0;
static double svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetUnits = 0.0;
static double svtkMapperGlobalResolveCoincidentTopologyLineOffsetFactor = 0.0;
static double svtkMapperGlobalResolveCoincidentTopologyLineOffsetUnits = -4.0;
static double svtkMapperGlobalResolveCoincidentTopologyPointOffsetUnits = -8.0;

// Construct with initial range (0,1).
svtkMapper::svtkMapper()
  : ArrayName(nullptr)
{
  this->Colors = nullptr;
  this->Static = 0;
...
svtkDataSet* svtkMapper::GetInput()
{
...
void svtkMapper::SetResolveCoincidentTopology(int val)
{
  if (val == svtkMapperGlobalResolveCoincidentTopology)
  {
    return;
  }
  svtkMapperGlobalResolveCoincidentTopology = val;
}

int svtkMapper::GetResolveCoincidentTopology()
{
  return svtkMapperGlobalResolveCoincidentTopology;
}

void svtkMapper::SetResolveCoincidentTopologyToDefault()
{
  svtkMapperGlobalResolveCoincidentTopology = SVTK_RESOLVE_OFF;
}

void svtkMapper::SetResolveCoincidentTopologyZShift(double val)
{
  if (val == svtkMapperGlobalResolveCoincidentTopologyZShift)
  {
    return;
  }
  svtkMapperGlobalResolveCoincidentTopologyZShift = val;
}

double svtkMapper::GetResolveCoincidentTopologyZShift()
{
  return svtkMapperGlobalResolveCoincidentTopologyZShift;
}

void svtkMapper::SetResolveCoincidentTopologyPolygonOffsetParameters(double factor, double units)
{
  if (factor == svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFactor &&
    units == svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetUnits)
  {
    return;
  }
  svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFactor = factor;
  svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetUnits = units;
}

void svtkMapper::GetResolveCoincidentTopologyPolygonOffsetParameters(double& factor, double& units)
{
  factor = svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFactor;
  units = svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetUnits;
}

void svtkMapper::SetRelativeCoincidentTopologyPolygonOffsetParameters(double factor, double units)
{
...
void svtkMapper::GetRelativeCoincidentTopologyPolygonOffsetParameters(double& factor, double& units)
{
  factor = this->CoincidentPolygonFactor;
  units = this->CoincidentPolygonOffset;
}

void svtkMapper::GetCoincidentTopologyPolygonOffsetParameters(double& factor, double& units)
{
  factor =
    svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFactor + this->CoincidentPolygonFactor;
  units =
    svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetUnits + this->CoincidentPolygonOffset;
}

void svtkMapper::SetResolveCoincidentTopologyLineOffsetParameters(double factor, double units)
{
  if (factor == svtkMapperGlobalResolveCoincidentTopologyLineOffsetFactor &&
    units == svtkMapperGlobalResolveCoincidentTopologyLineOffsetUnits)
  {
    return;
  }
  svtkMapperGlobalResolveCoincidentTopologyLineOffsetFactor = factor;
  svtkMapperGlobalResolveCoincidentTopologyLineOffsetUnits = units;
}

void svtkMapper::GetResolveCoincidentTopologyLineOffsetParameters(double& factor, double& units)
{
  factor = svtkMapperGlobalResolveCoincidentTopologyLineOffsetFactor;
  units = svtkMapperGlobalResolveCoincidentTopologyLineOffsetUnits;
}

void svtkMapper::SetRelativeCoincidentTopologyLineOffsetParameters(double factor, double units)
{
...
void svtkMapper::GetRelativeCoincidentTopologyLineOffsetParameters(double& factor, double& units)
{
  factor = this->CoincidentLineFactor;
  units = this->CoincidentLineOffset;
}

void svtkMapper::GetCoincidentTopologyLineOffsetParameters(double& factor, double& units)
{
  factor = svtkMapperGlobalResolveCoincidentTopologyLineOffsetFactor + this->CoincidentLineFactor;
  units = svtkMapperGlobalResolveCoincidentTopologyLineOffsetUnits + this->CoincidentLineOffset;
}

void svtkMapper::SetResolveCoincidentTopologyPointOffsetParameter(double units)
{
  if (units == svtkMapperGlobalResolveCoincidentTopologyPointOffsetUnits)
  {
    return;
  }
  svtkMapperGlobalResolveCoincidentTopologyPointOffsetUnits = units;
}

void svtkMapper::GetResolveCoincidentTopologyPointOffsetParameter(double& units)
{
  units = svtkMapperGlobalResolveCoincidentTopologyPointOffsetUnits;
}

void svtkMapper::SetRelativeCoincidentTopologyPointOffsetParameter(double units)
{
...
void svtkMapper::GetRelativeCoincidentTopologyPointOffsetParameter(double& units)
{
  units = this->CoincidentPointOffset;
}

void svtkMapper::GetCoincidentTopologyPointOffsetParameter(double& units)
{
  units = svtkMapperGlobalResolveCoincidentTopologyPointOffsetUnits + this->CoincidentPointOffset;
}

void svtkMapper::SetResolveCoincidentTopologyPolygonOffsetFaces(int faces)
{
  svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFaces = faces;
}

int svtkMapper::GetResolveCoincidentTopologyPolygonOffsetFaces()
{
  return svtkMapperGlobalResolveCoincidentTopologyPolygonOffsetFaces;
}

// Overload standard modified time function. If lookup table is modified,
// then this object is modified as well.
svtkMTimeType svtkMapper::GetMTime()
{
  // svtkMTimeType mTime=this->MTime.GetMTime();
  svtkMTimeType mTime = svtkAbstractMapper::GetMTime();
  svtkMTimeType lutMTime;
...
void svtkMapper::ShallowCopy(svtkAbstractMapper* mapper)
{
  svtkMapper* m = svtkMapper::SafeDownCast(mapper);
  if (m != nullptr)
  {
    ...
    if (m->GetArrayAccessMode() == SVTK_GET_ARRAY_BY_ID)
    {
  ...
  // Now do superclass
  this->svtkAbstractMapper3D::ShallowCopy(mapper);
}

// a side effect of this is that this->Colors is also set
// to the return value
svtkUnsignedCharArray* svtkMapper::MapScalars(double alpha)
{
  svtkDataSet* input = this->GetInput();
...
// a side effect of this is that this->Colors is also set
// to the return value
svtkUnsignedCharArray* svtkMapper::MapScalars(double alpha, int& cellFlag)
{
  svtkDataSet* input = this->GetInput();
  return this->MapScalars(input, alpha, cellFlag);
}
...
int svtkMapper::CanUseTextureMapForColoring(svtkDataObject* input)
{
  ...
  {
    int cellFlag = 0;
    svtkDataSet* ds = static_cast<svtkDataSet*>(input);
...
svtkUnsignedCharArray* svtkMapper::MapScalars(svtkDataSet* input, double alpha)
{
  int cellFlag = 0;
  return this->MapScalars(input, alpha, cellFlag);
}
...
// a side effect of this is that this->Colors is also set
// to the return value
svtkUnsignedCharArray* svtkMapper::MapScalars(svtkDataSet* input, double alpha, int& cellFlag)
{
  svtkAbstractArray* scalars = svtkAbstractMapper::GetAbstractScalars(
...
void svtkMapper::SelectColorArray(int arrayNum)
{
  this->ColorByArrayComponent(arrayNum, -1);
}

void svtkMapper::SelectColorArray(const char* arrayName)
{
  this->ColorByArrayComponent(arrayName, -1);
}

void svtkMapper::ColorByArrayComponent(int arrayNum, int component)
{
...
void svtkMapper::ColorByArrayComponent(const char* arrayName, int component)
{
  if (!arrayName ||
...
void svtkMapper::SetLookupTable(svtkScalarsToColors* lut)
{
...
svtkScalarsToColors* svtkMapper::GetLookupTable()
{
  if (this->LookupTable == nullptr)
  {
    this->CreateDefaultLookupTable();
...
void svtkMapper::CreateDefaultLookupTable()
{
  if (this->LookupTable)
  {
    this->LookupTable->UnRegister(this);
  ...
  svtkAbstractArray* abstractArray = svtkAbstractMapper::GetAbstractScalars(this->GetInput(),
  ...
  if (abstractArray && !dataArray)
  {
    ...
    svtkVariantArray* prominentValues = svtkVariantArray::New();
    abstractArray->GetProminentComponentValues(0, prominentValues);
    svtkIdType numProminentValues = prominentValues->GetNumberOfValues();
    table->SetNumberOfTableValues(numProminentValues);
    for (svtkIdType i = 0; i < numProminentValues; ++i)
    {
      svtkVariant& variant = prominentValues->GetValue(i);
      this->LookupTable->SetAnnotation(variant, variant.ToString());
    }
    prominentValues->Delete();

    // Set colors for annotations
    svtkColorSeries* colorSeries = svtkColorSeries::New();
    colorSeries->SetColorScheme(svtkColorSeries::BREWER_QUALITATIVE_PAIRED);
    colorSeries->BuildLookupTable(table, svtkColorSeries::CATEGORICAL);
    colorSeries->Delete();
  }
}
...
const char* svtkMapper::GetColorModeAsString()
{
  if (this->ColorMode == SVTK_COLOR_MODE_MAP_SCALARS)
  {
    return "MapScalars";
  }
  else
...
const char* svtkMapper::GetScalarModeAsString()
{
  ...
  else if (this->ScalarMode == SVTK_SCALAR_MODE_USE_FIELD_DATA)
  {
    return "UseFieldData";
  }
  else
...
//-----------------------------------------------------------------------------
bool svtkMapper::HasOpaqueGeometry()
{
...
//-----------------------------------------------------------------------------
bool svtkMapper::HasTranslucentPolygonalGeometry()
{
  // scalar visibility?
  int cellFlag = 0; // not used
  svtkAbstractArray* abstractArray = svtkAbstractMapper::GetAbstractScalars(this->GetInput(),
...
{
  if (svtkMath::IsNan(scalar_value))
  {
...
//-----------------------------------------------------------------------------
template <class T>
void CreateColorTextureCoordinates(T* input, float* output, svtkIdType numScalars, int numComps,
  ...
  bool use_log_scale)
{
  ...
  {
    for (svtkIdType scalarIdx = 0; scalarIdx < numScalars; ++scalarIdx)
    {
      double sum = 0;
      ...
      if (use_log_scale)
      {
        magnitude = svtkLookupTable::ApplyLogScale(magnitude, table_range, range);
      }
  ...
  else
  {
    ...
    for (svtkIdType scalarIdx = 0; scalarIdx < numScalars; ++scalarIdx)
    {
      ...
      if (use_log_scale)
      {
        input_value = svtkLookupTable::ApplyLogScale(input_value, table_range, range);
      }
...
void svtkMapper::MapScalarsToTexture(svtkAbstractArray* scalars, double alpha)
{
  double range[2];
  ...
  if (use_log_scale)
  {
    ...
    svtkLookupTable::GetLogRange(range, range);
  }
    ...
    this->LookupTable->GetAlpha() != alpha)
  {
    ...
    // In the future, we could extend svtkScalarsToColors.
    svtkIdType numberOfColors = this->LookupTable->GetNumberOfAvailableColors();
    numberOfColors += 2;
    ...
    svtkDoubleArray* tmp = svtkDoubleArray::New();
    ...
    // Dimension on NaN.
    double nan = svtkMath::Nan();
    for (int i = 0; i < numberOfColors; ++i)
    {
      *ptr = nan;
      ++ptr;
    }
    this->ColorTextureMap = svtkImageData::New();
    ...
    this->LookupTable->GetMTime() > this->ColorCoordinates->GetMTime())
  {
    ...
    svtkIdType num = scalars->GetNumberOfTuples();
    this->ColorCoordinates = svtkFloatArray::New();
    ...
    if (this->LookupTable->GetVectorMode() == svtkScalarsToColors::MAGNITUDE &&
    ...
    {
      svtkTemplateMacro(CreateColorTextureCoordinates(static_cast<SVTK_TT*>(input), output, num,
        numComps, scalarComponent, range, this->LookupTable->GetRange(),
        this->LookupTable->GetNumberOfAvailableColors(), use_log_scale));
      case SVTK_BIT:
        svtkErrorMacro("Cannot color by bit array.");
        break;
      default:
        svtkErrorMacro(<< "Unknown input ScalarType");
        return;
    }
  }
}

void svtkMapper::PrintSelf(ostream& os, svtkIndent indent)
{
  ...
  if (svtkMapperGlobalResolveCoincidentTopology == SVTK_RESOLVE_OFF)
  {
    os << "Off" << endl;
  }
  else if (svtkMapperGlobalResolveCoincidentTopology == SVTK_RESOLVE_POLYGON_OFFSET)
  {
...
//-------------------------------------------------------------------
void svtkMapper::ClearColorArrays()
{
  if (this->Colors)
  {
    this->Colors->Delete();
...
//-------------------------------------------------------------------
svtkUnsignedCharArray* svtkMapper::GetColorMapColors()
{
  return this->Colors;
}

//-------------------------------------------------------------------
svtkFloatArray* svtkMapper::GetColorCoordinates()
{
  return this->ColorCoordinates;
}

//-------------------------------------------------------------------
svtkImageData* svtkMapper::GetColorTextureMap()
{
