/*=========================================================================
  ...
  Module:    svtkPolyDataMapper2D.cxx
...
svtkAbstractObjectFactoryNewMacro(svtkPolyDataMapper2D);
//----------------------------------------------------------------------------

svtkCxxSetObjectMacro(svtkPolyDataMapper2D, TransformCoordinate, svtkCoordinate);

//----------------------------------------------------------------------------
svtkPolyDataMapper2D::svtkPolyDataMapper2D()
{
  this->Colors = nullptr;
...
//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::ShallowCopy(svtkAbstractMapper* mapper)
{
  svtkPolyDataMapper2D* m = svtkPolyDataMapper2D::SafeDownCast(mapper);
  if (m != nullptr)
  {
  ...
  // Now do superclass
  this->svtkMapper2D::ShallowCopy(mapper);
}
...
//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::SetInputData(svtkPolyData* input)
{
...
svtkPolyData* svtkPolyDataMapper2D::GetInput()
{
...
svtkMTimeType svtkPolyDataMapper2D::GetMTime()
{
...
// to the return value
svtkUnsignedCharArray* svtkPolyDataMapper2D::MapScalars(double alpha)
{
  ...
  {
    svtkAbstractArray* scalars = svtkAbstractMapper::GetAbstractScalars(this->GetInput(),
    ...
    if (scalars)
    {
      ...
      // Not having "New" or "Make" in the name breaks SVTK conventions but, ...
...
//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::ColorByArrayComponent(int arrayNum, int component)
{
...
//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::ColorByArrayComponent(const char* arrayName, int component)
{
...
void svtkPolyDataMapper2D::SetLookupTable(svtkScalarsToColors* lut)
{
...
//----------------------------------------------------------------------------
svtkScalarsToColors* svtkPolyDataMapper2D::GetLookupTable()
{
  if (this->LookupTable == nullptr)
  {
    this->CreateDefaultLookupTable();
...
//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::CreateDefaultLookupTable()
{
  if (this->LookupTable)
  {
    this->LookupTable->UnRegister(this);
...
const char* svtkPolyDataMapper2D::GetColorModeAsString()
{
  return (this->ColorMode == SVTK_COLOR_MODE_MAP_SCALARS) ? "MapScalars" : "Default";
}

//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::SetColorModeToDefault()
{
  this->SetColorMode(SVTK_COLOR_MODE_DEFAULT);
}

//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::SetColorModeToMapScalars()
{
  this->SetColorMode(SVTK_COLOR_MODE_MAP_SCALARS);
}

//----------------------------------------------------------------------------
void svtkPolyDataMapper2D::SetColorModeToDirectScalars()
{
  this->SetColorMode(SVTK_COLOR_MODE_DIRECT_SCALARS);
}

//----------------------------------------------------------------------------
int svtkPolyDataMapper2D::FillInputPortInformation(int svtkNotUsed(port), svtkInformation* info)
{
