/*=========================================================================
  ...
  Module:    svtkStereoCompositor.cxx
...
svtkStandardNewMacro(svtkStereoCompositor);
//----------------------------------------------------------------------------
svtkStereoCompositor::svtkStereoCompositor() {}

//----------------------------------------------------------------------------
svtkStereoCompositor::~svtkStereoCompositor() {}

//----------------------------------------------------------------------------
bool svtkStereoCompositor::Validate(svtkUnsignedCharArray* rgbLeftNResult,
  svtkUnsignedCharArray* rgbRight, const int* size /*=nullptr*/)
{
  assert(rgbLeftNResult != nullptr || rgbRight != nullptr);
  if (rgbLeftNResult->GetNumberOfComponents() != 3 || rgbRight->GetNumberOfComponents() != 3)
  {
    svtkErrorMacro("svtkStereoCompositor only support 3 component arrays.");
    return false;
  }

  if (rgbLeftNResult->GetNumberOfTuples() != rgbRight->GetNumberOfTuples())
  {
    svtkErrorMacro("Mismatch in number of tuples between left and right eye images.");
    return false;
  }

  if (size != nullptr &&
    rgbLeftNResult->GetNumberOfTuples() != static_cast<svtkIdType>(size[0] * size[1]))
  {
    svtkErrorMacro("Mismatch number of tuples and image size.");
    return false;
  }
...
//----------------------------------------------------------------------------
bool svtkStereoCompositor::RedBlue(
  svtkUnsignedCharArray* rgbLeftNResult, svtkUnsignedCharArray* rgbRight)
{
  ...
  svtkSMPTools::For(0, rgbLeftNResult->GetNumberOfTuples(),
    [rgbLeftNResult, rgbRight](svtkIdType first, svtkIdType last) {
...
//----------------------------------------------------------------------------
bool svtkStereoCompositor::Anaglyph(svtkUnsignedCharArray* rgbLeftNResult,
  svtkUnsignedCharArray* rgbRight, float colorSaturation, const int colorMask[2])
{
  if (!this->Validate(rgbLeftNResult, rgbRight))
  {
    return false;
  ...
  svtkSMPTools::For(0, rgbLeftNResult->GetNumberOfTuples(), [&](svtkIdType first, svtkIdType last) {
...
//----------------------------------------------------------------------------
bool svtkStereoCompositor::Interlaced(
...
//----------------------------------------------------------------------------
bool svtkStereoCompositor::Dresden(
  svtkUnsignedCharArray* rgbLeftNResult, svtkUnsignedCharArray* rgbRight, const int size[2])
{
  if (!this->Validate(rgbLeftNResult, rgbRight, size))
  {
...
//----------------------------------------------------------------------------
bool svtkStereoCompositor::Checkerboard(
  svtkUnsignedCharArray* rgbLeftNResult, svtkUnsignedCharArray* rgbRight, const int size[2])
{
  if (!this->Validate(rgbLeftNResult, rgbRight, size))
  {
...
//----------------------------------------------------------------------------
bool svtkStereoCompositor::SplitViewportHorizontal(
  svtkUnsignedCharArray* rgbLeftNResult, svtkUnsignedCharArray* rgbRight, const int size[2])
{
  if (!this->Validate(rgbLeftNResult, rgbRight, size))
  {
...
//----------------------------------------------------------------------------
void svtkStereoCompositor::PrintSelf(ostream& os, svtkIndent indent)
{
