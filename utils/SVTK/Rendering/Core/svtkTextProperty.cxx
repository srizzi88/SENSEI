...
svtkStandardNewMacro(svtkTextProperty);

//----------------------------------------------------------------------------
svtkTextProperty::svtkTextProperty()
{
  this->Color[0] = 1.0;
  this->Color[1] = 1.0;
  this->Color[2] = 1.0;
  ...
  this->Justification = SVTK_TEXT_LEFT;
  this->VerticalJustification = SVTK_TEXT_BOTTOM;
...
//----------------------------------------------------------------------------
void svtkTextProperty::ShallowCopy(svtkTextProperty* tprop)
{
  if (!tprop)
  {
    return;
...
//----------------------------------------------------------------------------
void svtkTextProperty::GetShadowColor(double color[3])
{
#if 1
...
//----------------------------------------------------------------------------
void svtkTextProperty::PrintSelf(ostream& os, svtkIndent indent)
{
