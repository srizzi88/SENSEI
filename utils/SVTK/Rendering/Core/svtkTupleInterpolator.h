/*=========================================================================
  ...
  Module:    svtkTupleInterpolator.h
 ...
 * be linear in form, or via a subclasses of svtkSpline.
 *
...
#ifndef svtkTupleInterpolator_h
#define svtkTupleInterpolator_h
...
class SVTKRENDERINGCORE_EXPORT svtkTupleInterpolator : public svtkObject
{
public:
  svtkTypeMacro(svtkTupleInterpolator, svtkObject);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Instantiate the class.
   */
  static svtkTupleInterpolator* New();
   ...
   * of svtkSpline to use. Note that the actual interpolating splines are
   ...
   * interpolate.
   */
  void SetInterpolatingSpline(svtkSpline*);
  svtkGetObjectMacro(InterpolatingSpline, svtkSpline);
  //@}

protected:
  svtkTupleInterpolator();
  ~svtkTupleInterpolator() override;
  ...
  svtkSpline* InterpolatingSpline;

  // Internal variables for interpolation functions
  void InitializeInterpolation();
  svtkPiecewiseFunction** Linear;
  svtkSpline** Spline;

private:
  svtkTupleInterpolator(const svtkTupleInterpolator&) = delete;
  void operator=(const svtkTupleInterpolator&) = delete;
};
