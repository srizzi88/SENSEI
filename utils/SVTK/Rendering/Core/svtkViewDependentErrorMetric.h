/*=========================================================================
  ...
  Module:    svtkViewDependentErrorMetric.h
...
=========================================================================*/
/**
 * @class   svtkViewDependentErrorMetric
...
#ifndef svtkViewDependentErrorMetric_h
#define svtkViewDependentErrorMetric_h
...
class SVTKRENDERINGCORE_EXPORT svtkViewDependentErrorMetric : public svtkGenericSubdivisionErrorMetric
{
public:
  /**
   ...
   */
  static svtkViewDependentErrorMetric* New();

  //@{
  /**
   * Standard SVTK type and error macros.
   */
  svtkTypeMacro(svtkViewDependentErrorMetric, svtkGenericSubdivisionErrorMetric);
   ...
   */
  svtkGetMacro(PixelTolerance, double);
  //@}
...
protected:
  ...
  ~svtkViewDependentErrorMetric() override;
...
private:
  svtkViewDependentErrorMetric(const svtkViewDependentErrorMetric&) = delete;
  void operator=(const svtkViewDependentErrorMetric&) = delete;
};
