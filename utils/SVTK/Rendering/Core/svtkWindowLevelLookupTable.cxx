/*=========================================================================
  ...
  Module:    svtkWindowLevelLookupTable.cxx
...
=========================================================================*/
#include "svtkWindowLevelLookupTable.h"
#include "svtkObjectFactory.h"

#include <cmath>

svtkStandardNewMacro(svtkWindowLevelLookupTable);

//----------------------------------------------------------------------------
svtkWindowLevelLookupTable::svtkWindowLevelLookupTable(int sze, int ext)
...
// MaximumTableValue.
void svtkWindowLevelLookupTable::Build()
{
...
void svtkWindowLevelLookupTable::SetInverseVideo(svtkTypeBool iv)
{
...
//----------------------------------------------------------------------------
void svtkWindowLevelLookupTable::PrintSelf(ostream& os, svtkIndent indent)
{
  ...
  os << indent << "MinimumTableValue : (" << this->MinimumTableValue[0] << ", "
     << this->MinimumTableValue[1] << ", " << this->MinimumTableValue[2] << ", "
     << this->MinimumTableValue[3] << ")\n";
  os << indent << "MaximumTableValue : (" << this->MaximumTableValue[0] << ", "
