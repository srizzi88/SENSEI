...
//-----------------------------------------------------------------------------
svtkStandardNewMacro(svtkExternalLight);

//-----------------------------------------------------------------------------
svtkExternalLight::svtkExternalLight()
{
  ...
  this->LightType = SVTK_LIGHT_TYPE_HEADLIGHT;
}
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetPosition(double position1, double position2, double position3)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetFocalPoint(double focalpoint1, double focalpoint2, double focalpoint3)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetAmbientColor(double color1, double color2, double color3)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetDiffuseColor(double color1, double color2, double color3)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetSpecularColor(double color1, double color2, double color3)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetIntensity(double intensity)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetConeAngle(double angle)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetAttenuationValues(double value1, double value2, double value3)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetExponent(double exp)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::SetPositional(svtkTypeBool p)
{
...
//-----------------------------------------------------------------------------
void svtkExternalLight::PrintSelf(ostream& os, svtkIndent indent)
{
