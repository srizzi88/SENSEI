...
int TestFreeTypeTextMapper(int argc, char* argv[])
{
  ...
  // $...$ without other text.
  svtkNew<svtkTextMapper> mapper13;
  svtkNew<svtkActor2D> actor13;
  ...
  svtkNew<svtkTextMapper> mapper14;
  svtkNew<svtkActor2D> actor14;
  ...
  svtkNew<svtkTextMapper> mapper15;
  svtkNew<svtkActor2D> actor15;
  actor15->SetMapper(mapper15);
  mapper15->GetTextProperty()->SetFontFile(uncodeFontFile.c_str());
  mapper15->GetTextProperty()->SetFontFamily(SVTK_FONT_FILE);
  ...
  svtkNew<svtkTextMapper> mapper16;
  svtkNew<svtkActor2D> actor16;
  actor16->SetMapper(mapper16);
  mapper16->GetTextProperty()->SetFontFile(uncodeFontFile.c_str());
  mapper16->GetTextProperty()->SetFontFamily(SVTK_FONT_FILE);
