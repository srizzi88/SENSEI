...
int TestMathTextFreeTypeTextRenderer(int argc, char* argv[])
{
  ...
  if (tren == nullptr)
  {
    std::cerr << "Object factory cannot find svtkTextRenderer override.\n";
    return EXIT_FAILURE;
  }

  if (strcmp(tren->GetClassName(), "svtkMathTextFreeTypeTextRenderer") != 0)
  {
    std::cerr << "Object factory returning unrecognized svtkTextRenderer "
                 "override: "
  ...
  svtkNew<svtkTextActor> actor15;
  actor15->GetTextProperty()->SetFontFamily(SVTK_FONT_FILE);
