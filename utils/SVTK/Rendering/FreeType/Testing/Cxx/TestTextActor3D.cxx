...
} // end namespace svtkTestTextActor3D

//----------------------------------------------------------------------------
int TestTextActor3D(int, char*[])
{
  using namespace svtkTestTextActor3D;
  ...
  svtkNew<svtkTextActor3D> nullInputActor;
  nullInputActor->SetInput(nullptr);
  ren->AddActor(nullInputActor);

  svtkNew<svtkTextActor3D> emptyInputActor;
  emptyInputActor->SetInput("");
  ren->AddActor(emptyInputActor);

  svtkNew<svtkTextActor3D> spaceActor;
  spaceActor->SetInput(" ");
  ren->AddActor(spaceActor);

  svtkNew<svtkTextActor3D> tabActor;
  tabActor->SetInput("\t");
  ren->AddActor(tabActor);

  svtkNew<svtkTextActor3D> newlineActor;
