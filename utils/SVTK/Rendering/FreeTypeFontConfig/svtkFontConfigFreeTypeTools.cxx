/*=========================================================================
  ...
  Module:    svtkFontConfigFreeTypeTools.cxx
...
#include "svtkFontConfigFreeTypeTools.h"
...
svtkStandardNewMacro(svtkFontConfigFreeTypeTools);

namespace
{
// The FreeType face requester callback:
FT_CALLBACK_DEF(FT_Error)
svtkFontConfigFreeTypeToolsFaceRequester(
  FTC_FaceID face_id, FT_Library lib, FT_Pointer request_data, FT_Face* face)
{
  // Get a pointer to the current svtkFontConfigFreeTypeTools object
  svtkFontConfigFreeTypeTools* self = reinterpret_cast<svtkFontConfigFreeTypeTools*>(request_data);
  ...
  bool faceIsSet = self->GetForceCompiledFonts() || tprop->GetFontFamily() == SVTK_FONT_FILE
    ? false
...
void svtkFontConfigFreeTypeTools::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

svtkFontConfigFreeTypeTools::svtkFontConfigFreeTypeTools() {}

svtkFontConfigFreeTypeTools::~svtkFontConfigFreeTypeTools() {}

FT_Error svtkFontConfigFreeTypeTools::CreateFTCManager()
{
  return FTC_Manager_New(*this->GetLibrary(), this->MaximumNumberOfFaces,
    this->MaximumNumberOfSizes, this->MaximumNumberOfBytes, svtkFontConfigFreeTypeToolsFaceRequester,
    static_cast<FT_Pointer>(this), this->CacheManager);
}

bool svtkFontConfigFreeTypeTools::LookupFaceFontConfig(
  svtkTextProperty* tprop, FT_Library lib, FT_Face* face)
{
  if (!FcInit())
  {
    return false;
  ...
  if (!error)
  {
    svtkDebugWithObjectMacro(svtkFreeTypeTools::GetInstance(),
