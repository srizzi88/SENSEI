...
int PNGCompare(int argc, char* argv[])
{
  ...
  // Set up testing object (modeled after svtkTestingInteractor::Start())
  ...
  testing->AddArgument(svtkTestingInteractor::ValidBaseline.c_str());

  // Regression test the image
  int result = testing->RegressionTest(testImageFileName, svtkTestingInteractor::ErrorThreshold);

  svtkTestingInteractor::TestReturnStatus = result;

  if (result == svtkTesting::PASSED)
  {
