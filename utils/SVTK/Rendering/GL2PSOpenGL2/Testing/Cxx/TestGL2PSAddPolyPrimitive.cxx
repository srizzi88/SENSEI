...
{
  std::string filename =
    svtkTestingInteractor::TempDirectory + std::string("/TestGL2PSAddPolyPrimitive.ps");
  FILE* stream = svtksys::SystemTools::Fopen(filename, "wb");
  if (stream == nullptr)
  {
  ...
  GLint result = gl2psBeginPage("AddPolyPrimitive Test", "SVTK", viewport, GL2PS_PS,
