...
=========================================================================*/
/**
 * @class   svtkLICNoiseHelper
 *
 * A small collection of noise routines for LIC
 */

#ifndef svtkLICNoiseHelper_h
#define svtkLICNoiseHelper_h
...
*/
class svtkLICRandomNumberGeneratorInterface
{
public:
  svtkLICRandomNumberGeneratorInterface() { this->RNG = svtkMinimalStandardRandomSequence::New(); }

  ~svtkLICRandomNumberGeneratorInterface() { this->RNG->Delete(); }
...
private:
  void operator=(const svtkLICRandomNumberGeneratorInterface&) = delete;
  svtkLICRandomNumberGeneratorInterface(const svtkLICRandomNumberGeneratorInterface&) = delete;

private:
  svtkMinimalStandardRandomSequence* RNG;
};
...
*/
class svtkLICRandomNoise2D
{
public:
  svtkLICRandomNoise2D() {}

  //@{
  /**
   * Generate a patch of random gray scale values along with an
   * alpha channel (in svtk array format). The data should be
  ...
  static svtkImageData* GetNoiseResource();
...
private:
  svtkLICRandomNumberGeneratorInterface ValueGen;
  svtkLICRandomNumberGeneratorInterface ProbGen;
};

#endif
#endif
// SVTK-HeaderTest-Exclude: svtkLICNoiseHelper.h
