 ...
 *
 * Pass svtkLabelHierarchy objects to a svtkLabelPlacementMapper filter for dynamic,
...
#ifndef svtkLabelHierarchy_h
#define svtkLabelHierarchy_h
...
class SVTKRENDERINGLABEL_EXPORT svtkLabelHierarchy : public svtkPointSet
{
public:
  static svtkLabelHierarchy* New();
  svtkTypeMacro(svtkLabelHierarchy, svtkPointSet);
  void PrintSelf(ostream& os, svtkIndent indent) override;

  /**
   * Override SetPoints so we can reset the hierarchy when the points change.
   */
  void SetPoints(svtkPoints*) override;
   ...
   */
  virtual void SetPriorities(svtkDataArray* arr);
  svtkGetObjectMacro(Priorities, svtkDataArray);
  //@}
   ...
   */
  virtual void SetLabels(svtkAbstractArray* arr);
  svtkGetObjectMacro(Labels, svtkAbstractArray);
  //@}
   ...
   */
  virtual void SetOrientations(svtkDataArray* arr);
  svtkGetObjectMacro(Orientations, svtkDataArray);
  //@}
   ...
   */
  virtual void SetIconIndices(svtkIntArray* arr);
  svtkGetObjectMacro(IconIndices, svtkIntArray);
  //@}
   ...
   */
  virtual void SetSizes(svtkDataArray* arr);
  svtkGetObjectMacro(Sizes, svtkDataArray);
  //@}
   ...
   */
  virtual void SetBoundedSizes(svtkDataArray* arr);
  svtkGetObjectMacro(BoundedSizes, svtkDataArray);
  //@}
   ...
   * buckets.
   */
  SVTK_NEWINSTANCE svtkLabelHierarchyIterator* NewIterator(int type, svtkRenderer* ren, svtkCamera* cam,
  ...
  //@{
  /**
   * Inherited members (from svtkDataSet)
   */
  svtkIdType GetNumberOfCells() override;
  using svtkDataSet::GetCell;
  svtkCell* GetCell(svtkIdType) override;
  void GetCell(svtkIdType, svtkGenericCell*) override;
  int GetCellType(svtkIdType) override;
  void GetCellPoints(svtkIdType, svtkIdList*) override;
  void GetPointCells(svtkIdType, svtkIdList*) override;
  svtkIdType FindCell(double*, svtkCell*, svtkIdType, double, int&, double*, double*) override;
  svtkIdType FindCell(
    double*, svtkCell*, svtkGenericCell*, svtkIdType, double, int&, double*, double*) override;
   ...
   */
  svtkGetObjectMacro(CenterPts, svtkPoints);
  //@}
   ...
   * without overlap.
   */
  svtkGetObjectMacro(CoincidentPoints, svtkCoincidentPoints);
  //@}
...
protected:
  svtkLabelHierarchy();
  ~svtkLabelHierarchy() override;

  int TargetLabelCount;
  int MaximumDepth;
  svtkDataArray* Priorities;
  svtkAbstractArray* Labels;
  svtkDataArray* Orientations;
  svtkIntArray* IconIndices;
  svtkDataArray* Sizes;
  svtkDataArray* BoundedSizes;
  svtkCoincidentPoints* CoincidentPoints;
  svtkPoints* CenterPts;
  svtkTextProperty* TextProperty;

  Implementation* Impl;

  friend class svtkLabelHierarchyFrustumIterator;
  friend class svtkLabelHierarchyFullSortIterator;
  friend class implementation;

private:
  svtkLabelHierarchy(const svtkLabelHierarchy&) = delete;
  void operator=(const svtkLabelHierarchy&) = delete;
};

#endif // svtkLabelHierarchy_h
