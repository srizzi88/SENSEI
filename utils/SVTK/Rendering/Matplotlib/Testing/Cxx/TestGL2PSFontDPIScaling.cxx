...
int TestGL2PSFontDPIScaling(int argc, char* argv[])
{
  ...
  svtkNew<svtkTextActor> actor16;
  actor16->GetTextProperty()->SetFontFile(uncodeFontFile.c_str());
  actor16->GetTextProperty()->SetFontFamily(SVTK_FONT_FILE);
  ...
  std::string fileprefix =
    svtkTestingInteractor::TempDirectory + std::string("/TestGL2PSFontDPIScaling");
