...
namespace svtkGL2PSTestMathTextActor
{
...
} // end namespace svtkGL2PSTestMathTextActor3D

//----------------------------------------------------------------------------
int TestGL2PSMathTextActor(int, char*[])
{
  using namespace svtkGL2PSTestMathTextActor;
  ...
  for (size_t row = 0; row < 3; ++row)
  {
    for (size_t col = 0; col < 3; ++col)
    {
      ...
      actor->GetTextProperty()->SetBackgroundColor(0.0, 1. - col * .26, 1. - row * .26);
  ...
  std::string fileprefix =
    svtkTestingInteractor::TempDirectory + std::string("/TestGL2PSMathTextActor");
