...
namespace svtkTestGL2PSMathTextActor3D
{
...
} // end namespace svtkTestGL2PSMathTextActor3D

//----------------------------------------------------------------------------
int TestGL2PSMathTextActor3D(int, char*[])
{
  using namespace svtkTestGL2PSMathTextActor3D;
  ...
  std::string fileprefix =
    svtkTestingInteractor::TempDirectory + std::string("/TestGL2PSMathTextActor3D");
