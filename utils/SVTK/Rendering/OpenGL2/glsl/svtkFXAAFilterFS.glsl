...
=========================================================================*/
// Fragment shader for svtkOpenGLFXAAFilter.
//
...
// Replacement stub for svtkShaderProgram::Substitute:
//SVTK::DebugOptions::Def

//========================== Tuning Define: ====================================

// Which edge search implementation to use. If defined, use SVTK's endpoint
// algorithm, otherwise use NVIDIA's.
//
// NVIDIA is faster, but gives poor results on single pixel lines (e.g.
// svtkPolyDataMapper's wireframe/edges). SVTK is slower, but gives nicer results
// on single pixel lines.
//#define FXAA_USE_HIGH_QUALITY_ENDPOINTS;

// Replacement stub for svtkShaderProgram::Substitute:
//SVTK::EndpointAlgo::Def
...
// See the svtkOpenGLFXAAFilter class documentation for details on these.
...
// - svtkEndpointSearch: Modified endpoint search that does more texture lookups,
...
//================== SVTK's Endpoint Search Implementation ======================

int svtkEndpointSearch(vec2 posC, float lumC, float lumHC, float lengthSign,
                      vec2 tcPixel, bool horzSpan, out vec2 posEdgeAA)
{
  /*****************************************************************************
   * End of Edge Search                                                        *
...
void main()
{
  ...
  int endpointResult = svtkEndpointSearch(tcC, lumC, lumHC, lengthSign,
