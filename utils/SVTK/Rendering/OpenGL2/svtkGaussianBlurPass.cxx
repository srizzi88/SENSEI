/*=========================================================================
  ...
  Module:    svtkGaussianBlurPass.cxx
...
// only for svtkGaussianBlurPass developers.
//#define SVTK_GAUSSIAN_BLUR_PASS_DEBUG

#ifdef SVTK_GAUSSIAN_BLUR_PASS_DEBUG
...
#include "svtkGaussianBlurPassFS.h"
#include "svtkGaussianBlurPassVS.h"

svtkStandardNewMacro(svtkGaussianBlurPass);

// ----------------------------------------------------------------------------
svtkGaussianBlurPass::svtkGaussianBlurPass()
{
...
svtkGaussianBlurPass::~svtkGaussianBlurPass()
{
  ...
  {
    svtkErrorMacro(<< "Pass2 should have been deleted in ReleaseGraphicsResources().");
  }
}

// ----------------------------------------------------------------------------
void svtkGaussianBlurPass::PrintSelf(ostream& os, svtkIndent indent)
{
...
// \pre s_exists: s!=0
void svtkGaussianBlurPass::Render(const svtkRenderState* s)
{
  ...
  if (this->DelegatePass != nullptr)
  {
    ...
    if (this->Pass2 == nullptr)
    {
      this->Pass2 = svtkTextureObject::New();
    ...
    if (!this->BlurProgram)
    {
      ...
      std::string VSSource = svtkGaussianBlurPassVS;
      std::string FSSource = svtkGaussianBlurPassFS;
      std::string GSSource;
...
// resources.
// \pre w_exists: w!=0
void svtkGaussianBlurPass::ReleaseGraphicsResources(svtkWindow* w)
{
