/*=========================================================================
  ...
  Module:    svtkOSOpenGLRenderWindow.h
 ...
 *
 * svtkOSOpenGLRenderWindow is a concrete implementation of the abstract class
 * svtkOpenGLRenderWindow. svtkOSOpenGLRenderWindow interfaces to the OffScreen
 ...
 * Application programmers should normally use svtkRenderWindow instead of the
 * OpenGL specific version.
 */

#ifndef svtkOSOpenGLRenderWindow_h
#define svtkOSOpenGLRenderWindow_h
...
class SVTKRENDERINGOPENGL2_EXPORT svtkOSOpenGLRenderWindow : public svtkOpenGLRenderWindow
{
public:
  static svtkOSOpenGLRenderWindow* New();
  svtkTypeMacro(svtkOSOpenGLRenderWindow, svtkOpenGLRenderWindow);
   ...
   */
  virtual svtkTypeBool GetEventPending();
...
protected:
  svtkOSOpenGLRenderWindow();
  ~svtkOSOpenGLRenderWindow() override;

  svtkOSOpenGLRenderWindowInternal* Internal;

  svtkTypeBool OwnWindow;
  svtkTypeBool OwnDisplay;
...
private:
  svtkOSOpenGLRenderWindow(const svtkOSOpenGLRenderWindow&) = delete;
  void operator=(const svtkOSOpenGLRenderWindow&) = delete;
};
