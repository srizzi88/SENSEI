...
svtkStandardNewMacro(svtkPBRLUTTexture);

//------------------------------------------------------------------------------
void svtkPBRLUTTexture::PrintSelf(ostream& os, svtkIndent indent)
{
...
//------------------------------------------------------------------------------
void svtkPBRLUTTexture::Load(svtkRenderer* ren)
{
  ...
  if (this->GetMTime() > this->LoadTime.GetMTime())
  {
    ...
    this->TextureObject->Allocate2D(this->LUTSize, this->LUTSize, 2, SVTK_FLOAT);
