...
svtkStandardNewMacro(svtkShader);

svtkShader::svtkShader()
{
  this->Dirty = true;
  this->Handle = 0;
  this->ShaderType = svtkShader::Unknown;
}

svtkShader::~svtkShader() = default;

void svtkShader::SetType(Type type)
{
  this->ShaderType = type;
  this->Dirty = true;
}

void svtkShader::SetSource(const std::string& source)
{
  this->Source = source;
  this->Dirty = true;
}

bool svtkShader::Compile()
{
...
// ----------------------------------------------------------------------------
void svtkShader::PrintSelf(ostream& os, svtkIndent indent)
{
