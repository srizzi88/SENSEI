 ...
 *
 * 1) Build SVTK with the advanced cmake option SVTK_USE_OPENGL_DELAYED_LOAD
 *    turned on.
 *
 ...
 *
 * 3) Make sure you include svtkTestOpenGLVersion.exe with your application
...
// SVTK-HeaderTest-Exclude: svtkTestOpenGLVersion.h
