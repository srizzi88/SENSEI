...
#ifndef svtkToneMappingPass_h
#define svtkToneMappingPass_h
...
class SVTKRENDERINGOPENGL2_EXPORT svtkToneMappingPass : public svtkImageProcessingPass
{
public:
  static svtkToneMappingPass* New();
  svtkTypeMacro(svtkToneMappingPass, svtkImageProcessingPass);
   ...
   */
  svtkSetClampMacro(ToneMappingType, int, 0, 3);
  svtkGetMacro(ToneMappingType, int);
  //@}
   ...
   * Default is 1.0
   */
  svtkGetMacro(Exposure, float);
  svtkSetMacro(Exposure, float);
  //@}
   ...
   * Default is 1.6773
   */
  svtkSetClampMacro(Contrast, float, 0.0001f, SVTK_FLOAT_MAX);
  svtkGetMacro(Contrast, float);
  //@}
   ...
   * Default is 0.9714
   */
  svtkSetClampMacro(Shoulder, float, 0.0001, 1.f);
  svtkGetMacro(Shoulder, float);
  //@}
   ...
   */
  svtkSetClampMacro(MidIn, float, 0.0001, 1.f);
  svtkGetMacro(MidIn, float);
  //@}
   ...
   * Default is 0.18 (in percent gray)
   */
  svtkSetClampMacro(MidOut, float, 0.0001, 1.f);
  svtkGetMacro(MidOut, float);
  //@}
   ...
   * Defalut is 11.0785
   */
  svtkSetClampMacro(HdrMax, float, 1.f, SVTK_FLOAT_MAX);
  svtkGetMacro(HdrMax, float);
  //@}
   ...
   * Default is true
   */
  svtkSetMacro(UseACES, bool);
  svtkGetMacro(UseACES, bool);
  //@}

protected:
  svtkToneMappingPass() = default;
  ~svtkToneMappingPass() override;
  ...
  svtkMTimeType PreComputeMTime = 0;
...
private:
  svtkToneMappingPass(const svtkToneMappingPass&) = delete;
  void operator=(const svtkToneMappingPass&) = delete;
};
