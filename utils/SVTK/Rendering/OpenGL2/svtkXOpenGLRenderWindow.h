/*=========================================================================
  ...
  Module:    svtkXOpenGLRenderWindow.h
 ...
 *
 * svtkXOpenGLRenderWindow is a concrete implementation of the abstract class
...
#ifndef svtkXOpenGLRenderWindow_h
#define svtkXOpenGLRenderWindow_h
...
class SVTKRENDERINGOPENGL2_EXPORT svtkXOpenGLRenderWindow : public svtkOpenGLRenderWindow
{
public:
  static svtkXOpenGLRenderWindow* New();
  svtkTypeMacro(svtkXOpenGLRenderWindow, svtkOpenGLRenderWindow);
...
protected:
  svtkXOpenGLRenderWindow();
  ~svtkXOpenGLRenderWindow() override;

  svtkXOpenGLRenderWindowInternal* Internal;
...
private:
  svtkXOpenGLRenderWindow(const svtkXOpenGLRenderWindow&) = delete;
  void operator=(const svtkXOpenGLRenderWindow&) = delete;
};
