...
Module:    svtkOpenVRPanelRepresentation.cxx
...
svtkStandardNewMacro(svtkOpenVRPanelRepresentation);

//----------------------------------------------------------------------------
svtkOpenVRPanelRepresentation::svtkOpenVRPanelRepresentation()
{
  ...
  this->TextActor->SetUserMatrix(svtkMatrix4x4::New());
  ...
  this->InteractionState = svtkOpenVRPanelRepresentation::Outside;
...
void svtkOpenVRPanelRepresentation::SetCoordinateSystemToWorld()
{
...
void svtkOpenVRPanelRepresentation::SetCoordinateSystemToHMD()
{
...
void svtkOpenVRPanelRepresentation::SetCoordinateSystemToLeftController()
{
...
void svtkOpenVRPanelRepresentation::SetCoordinateSystemToRightController()
{
...
int svtkOpenVRPanelRepresentation::ComputeComplexInteractionState(
  svtkRenderWindowInteractor*, svtkAbstractWidget*, unsigned long, void* calldata, int)
{
  if (!this->AllowAdjustment || this->InteractionState == svtkOpenVRPanelRepresentation::Moving)
  {
  ...
  if (edd)
  {
    ...
    {
      this->InteractionState = svtkOpenVRPanelRepresentation::Moving;
    }
    else
    {
      this->InteractionState = svtkOpenVRPanelRepresentation::Outside;
...
void svtkOpenVRPanelRepresentation::StartComplexInteraction(
...
void svtkOpenVRPanelRepresentation::ComplexInteraction(
  svtkRenderWindowInteractor*, svtkAbstractWidget*, unsigned long, void* calldata)
{
  svtkEventData* edata = static_cast<svtkEventData*>(calldata);
  svtkEventDataDevice3D* edd = edata->GetAsEventDataDevice3D();
  if (edd)
  {
    ...
    // Process the motion
    if (this->InteractionState == svtkOpenVRPanelRepresentation::Moving)
    {
...
void svtkOpenVRPanelRepresentation::EndComplexInteraction(
...
void svtkOpenVRPanelRepresentation::UpdatePose(
  double* p1, double* orient1, double* p2, double* orient2)
{
  ...
  if (this->CoordinateSystem == HMD)
  {
    svtkMatrix4x4* mat = this->TextActor->GetUserMatrix();
    mat->Register(this);
...
//----------------------------------------------------------------------------
void svtkOpenVRPanelRepresentation::ReleaseGraphicsResources(svtkWindow* w)
{
  this->TextActor->ReleaseGraphicsResources(w);
}

//----------------------------------------------------------------------------
void svtkOpenVRPanelRepresentation::ComputeMatrix(svtkRenderer* ren)
{
  ...
  {
    svtkOpenVRRenderWindow* rw = static_cast<svtkOpenVRRenderWindow*>(ren->GetSVTKWindow());

    if (this->CoordinateSystem == HMD)
    {
      svtkTransform* vt = cam->GetViewTransformObject();
    ...
    if (this->CoordinateSystem == LeftController)
    {
      ...
      rw->GetTrackedDevicePose(svtkEventDataDevice::LeftController, &tdPose);
      if (tdPose && tdPose->bPoseIsValid)
      {
        svtkNew<svtkMatrix4x4> poseMatrixWorld;
        static_cast<svtkOpenVRRenderWindowInteractor*>(rw->GetInteractor())
    ...
    {
      vr::TrackedDevicePose_t* tdPose;
      rw->GetTrackedDevicePose(svtkEventDataDevice::RightController, &tdPose);
      if (tdPose && tdPose->bPoseIsValid)
      {
        svtkNew<svtkMatrix4x4> poseMatrixWorld;
        static_cast<svtkOpenVRRenderWindowInteractor*>(rw->GetInteractor())
...
//----------------------------------------------------------------------------
int svtkOpenVRPanelRepresentation::RenderOpaqueGeometry(svtkViewport* v)
{
  ...
  if (true /* HMD coords */)
  {
    svtkRenderer* ren = static_cast<svtkRenderer*>(v);
...
//-----------------------------------------------------------------------------
int svtkOpenVRPanelRepresentation::RenderTranslucentPolygonalGeometry(svtkViewport* v)
{
  if (!this->GetVisibility())
  {
    return 0;
...
//-----------------------------------------------------------------------------
svtkTypeBool svtkOpenVRPanelRepresentation::HasTranslucentPolygonalGeometry()
{
  if (!this->GetVisibility())
  {
    return 0;
...
//----------------------------------------------------------------------------
void svtkOpenVRPanelRepresentation::PlaceWidget(double bds[6])
{
  this->TextActor->GetUserMatrix()->Identity();
  if (this->CoordinateSystem == World)
  {
...
void svtkOpenVRPanelRepresentation::PlaceWidgetExtended(
  const double* bds, const double* normal, const double* upvec, double scale)
{
  ...
  svtkVector3d nup(upvec);
  nup.Normalize();
  svtkVector3d nvpn(normal);
  nvpn.Normalize();
  svtkVector3d nvright = nup.Cross(nvpn);
  nvright.Normalize();
...
//----------------------------------------------------------------------------
void svtkOpenVRPanelRepresentation::BuildRepresentation()
{
...
//----------------------------------------------------------------------------
void svtkOpenVRPanelRepresentation::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void svtkOpenVRPanelRepresentation::SetText(const char* text)
{
  if (this->Text == text)
  {
    return;
