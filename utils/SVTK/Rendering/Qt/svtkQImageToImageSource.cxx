/*=========================================================================
  ...
  Module:    svtkQImageToImageSource.cxx
...
svtkStandardNewMacro(svtkQImageToImageSource);

//----------------------------------------------------------------------------
svtkQImageToImageSource::svtkQImageToImageSource()
{
...
//----------------------------------------------------------------------------
int svtkQImageToImageSource::RequestData(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  if (!QApplication::instance())
  {
    svtkErrorMacro("You must initialize QApplication before using this filter.");
    return 0;
  }
  ...
  {
    svtkErrorMacro("Qt Image was not set.");
    return 0;
  }
  ...
  output->AllocateScalars(SVTK_UNSIGNED_CHAR, 4);
  ...
  array->SetVoidArray(data, 4 * width * height, 0, svtkUnsignedCharArray::SVTK_DATA_ARRAY_DELETE);
  return 1;
}

//----------------------------------------------------------------------------
int svtkQImageToImageSource::RequestInformation(svtkInformation* svtkNotUsed(request),
  svtkInformationVector** svtkNotUsed(inputVector), svtkInformationVector* outputVector)
{
  // get the info objects
  svtkInformation* outInfo = outputVector->GetInformationObject(0);
...
//----------------------------------------------------------------------------
void svtkQImageToImageSource::PrintSelf(ostream& os, svtkIndent indent)
{
