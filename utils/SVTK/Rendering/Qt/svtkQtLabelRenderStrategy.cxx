/*=========================================================================
  ...
  Module:    svtkQtLabelRenderStrategy.cxx
...
#include "svtkQtLabelRenderStrategyInternals.h"
...
svtkStandardNewMacro(svtkQtLabelRenderStrategy);
...
//----------------------------------------------------------------------------
svtkQtLabelRenderStrategy::svtkQtLabelRenderStrategy()
{
  ...
  this->QImageToImage = svtkQImageToImageSource::New();
...
void svtkQtLabelRenderStrategy::ReleaseGraphicsResources(svtkWindow* window)
{
...
//----------------------------------------------------------------------------
void svtkQtLabelRenderStrategy::StartFrame()
{
  ...
  {
    svtkErrorMacro("RenderWindow must be set.");
    return;
  }
...
//----------------------------------------------------------------------------
void svtkQtLabelRenderStrategy::ComputeLabelBounds(
...
//----------------------------------------------------------------------------
void svtkQtLabelRenderStrategy::RenderLabel(
  int x[2], svtkTextProperty* tprop, svtkUnicodeString label, int maxWidth)
{
  if (!QApplication::instance())
  {
    svtkErrorMacro("You must initialize a QApplication before using this class.");
...
//----------------------------------------------------------------------------
void svtkQtLabelRenderStrategy::RenderLabel(int x[2], svtkTextProperty* tprop, svtkUnicodeString label)
{
  if (!QApplication::instance())
  {
    svtkErrorMacro("You must initialize a QApplication before using this class.");
...
//----------------------------------------------------------------------------
void svtkQtLabelRenderStrategy::EndFrame()
{
  // svtkTimerLog* timer = svtkTimerLog::New();
  // timer->StartTimer();
...
//----------------------------------------------------------------------------
void svtkQtLabelRenderStrategy::PrintSelf(ostream& os, svtkIndent indent)
{
