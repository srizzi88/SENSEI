...
int TestGPUVolumeRayCastMapper(int argc, char* argv[])
{
  ...
  if (valid)
  {
    retVal = !(svtkTesting::InteractorEventLoop(argc, argv, iren, TestGPUVolumeRayCastMapperLog));
  }
  else
  {
