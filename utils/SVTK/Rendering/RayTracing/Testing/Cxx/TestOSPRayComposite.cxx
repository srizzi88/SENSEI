...
public:
  ...
  void CreatePipeline(svtkRenderer* renderer)
  {
    ...
    svtkSmartPointer<svtkPolyDataMapper> pdm = svtkSmartPointer<svtkPolyDataMapper>::New();
    svtkSmartPointer<svtkActor> actor = svtkSmartPointer<svtkActor>::New();

    svtkSmartPointer<svtkSphereSource> src = svtkSmartPointer<svtkSphereSource>::New();
...
void MyProcess::Execute()
{
  ...
  else
  {
    ...
    this->ReturnValue = svtkTesting::PASSED;
  }
