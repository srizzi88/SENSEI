/*=========================================================================
  ...
  Module:    svtkOSPRayCameraNode.cxx
...
//============================================================================
svtkStandardNewMacro(svtkOSPRayCameraNode);

//----------------------------------------------------------------------------
svtkOSPRayCameraNode::svtkOSPRayCameraNode() {}

//----------------------------------------------------------------------------
svtkOSPRayCameraNode::~svtkOSPRayCameraNode() {}

//----------------------------------------------------------------------------
void svtkOSPRayCameraNode::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void svtkOSPRayCameraNode::Render(bool prepass)
{
  if (prepass)
  {
    ...
    svtkCamera* cam = static_cast<svtkCamera*>(this->Renderable);
    ...
    if (stereo)
    {
      ...
      // or results from svtk proper to ensure 1:1 match with GL
      if (!right)
      {
