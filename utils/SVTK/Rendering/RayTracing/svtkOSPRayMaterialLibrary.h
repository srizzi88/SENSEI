/*=========================================================================
  ...
  Module:    svtkOSPRayMaterialLibrary.h
 ...
 * @brief   a collection of materials for svtk apps to draw from
 *
 ...
 *
 * @sa svtkOSPRayMaterialHelpers
 */

#ifndef svtkOSPRayMaterialLibrary_h
#define svtkOSPRayMaterialLibrary_h
...
class SVTKRENDERINGRAYTRACING_EXPORT svtkOSPRayMaterialLibrary : public svtkObject
{
public:
  static svtkOSPRayMaterialLibrary* New();
  svtkTypeMacro(svtkOSPRayMaterialLibrary, svtkObject);
   ...
   * Returns a texture.
   */
  svtkTexture* GetTexture(const std::string& nickname, const std::string& varname);
   ...
   **/
  void AddTexture(const std::string& nickname, const std::string& texturename, svtkTexture* tex);
...
protected:
  ...
  virtual ~svtkOSPRayMaterialLibrary();
...
private:
  svtkOSPRayMaterialLibrary(const svtkOSPRayMaterialLibrary&) = delete;
  void operator=(const svtkOSPRayMaterialLibrary&) = delete;

  svtkOSPRayMaterialLibraryInternals* Internal;
};
