/*=========================================================================
  ...
  Module:    svtkCocoaTkUtilities.mm
...
#import "svtkCocoaTkUtilities.h"
#import "svtkObjectFactory.h"
#import "svtkTcl.h"

svtkStandardNewMacro(svtkCocoaTkUtilities);

void svtkCocoaTkUtilities::PrintSelf(ostream& os, svtkIndent indent)
{
...
void* svtkCocoaTkUtilities::GetDrawableView(Tk_Window window)
{
