/*=========================================================================
  ...
  Module:    svtkAndroidRenderWindowInteractor.cxx
...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "SVTK", __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "SVTK", __VA_ARGS__))

svtkStandardNewMacro(svtkAndroidRenderWindowInteractor);

void (*svtkAndroidRenderWindowInteractor::ClassExitMethod)(void*) = (void (*)(void*))nullptr;
void* svtkAndroidRenderWindowInteractor::ClassExitMethodArg = (void*)nullptr;
void (*svtkAndroidRenderWindowInteractor::ClassExitMethodArgDelete)(
  void*) = (void (*)(void*))nullptr;

//----------------------------------------------------------------------------
// Construct object so that light follows camera motion.
svtkAndroidRenderWindowInteractor::svtkAndroidRenderWindowInteractor()
{
...
//----------------------------------------------------------------------------
void svtkAndroidRenderWindowInteractor::StartEventLoop()
{
    ...
    if (ident == ALOOPER_POLL_TIMEOUT)
    {
      ...
      if (this->AndroidApplication->window && this->Enabled)
      {
        ...
        if (width != this->Size[0] || height != this->Size[1])
        {
          ...
          this->RenderWindow->Render();
          svtkErrorMacro("Config Resized to " << width << " by " << height);
        }
      }
    }
...
{
  svtkAndroidRenderWindowInteractor* self = (svtkAndroidRenderWindowInteractor*)app->userData;
  self->HandleCommand(cmd);
}

void svtkAndroidRenderWindowInteractor::HandleCommand(int32_t cmd)
{
...
const char* svtkAndroidRenderWindowInteractor::GetKeySym(int keyCode)
{
...
void svtkAndroidRenderWindowInteractor::HandleKeyEvent(
...
void svtkAndroidRenderWindowInteractor::HandleMotionEvent(
...
int32_t svtkAndroidRenderWindowInteractor::HandleInput(AInputEvent* event)
{
  if (!this->Enabled)
  {
    return 0;
...
//----------------------------------------------------------------------------
void svtkAndroidRenderWindowInteractor::Initialize()
{
...
//----------------------------------------------------------------------------
void svtkAndroidRenderWindowInteractor::Enable()
{
  if (this->Enabled)
  {
    return;
...
//----------------------------------------------------------------------------
void svtkAndroidRenderWindowInteractor::Disable()
{
  if (!this->Enabled)
  {
    return;
...
//----------------------------------------------------------------------------
void svtkAndroidRenderWindowInteractor::TerminateApp(void)
{
...
//----------------------------------------------------------------------------
int svtkAndroidRenderWindowInteractor::InternalCreateTimer(
...
//----------------------------------------------------------------------------
int svtkAndroidRenderWindowInteractor::InternalDestroyTimer(int platformTimerId)
{
  // todo
  return 0;
}
...
void svtkAndroidRenderWindowInteractor::SetClassExitMethod(void (*f)(void*), void* arg)
{
  if (f != svtkAndroidRenderWindowInteractor::ClassExitMethod ||
    arg != svtkAndroidRenderWindowInteractor::ClassExitMethodArg)
  {
    // delete the current arg if there is a delete method
    if ((svtkAndroidRenderWindowInteractor::ClassExitMethodArg) &&
      (svtkAndroidRenderWindowInteractor::ClassExitMethodArgDelete))
    {
      (*svtkAndroidRenderWindowInteractor::ClassExitMethodArgDelete)(
        svtkAndroidRenderWindowInteractor::ClassExitMethodArg);
    }
    svtkAndroidRenderWindowInteractor::ClassExitMethod = f;
    svtkAndroidRenderWindowInteractor::ClassExitMethodArg = arg;
...
void svtkAndroidRenderWindowInteractor::SetClassExitMethodArgDelete(void (*f)(void*))
{
  if (f != svtkAndroidRenderWindowInteractor::ClassExitMethodArgDelete)
  {
    svtkAndroidRenderWindowInteractor::ClassExitMethodArgDelete = f;
...
//----------------------------------------------------------------------------
void svtkAndroidRenderWindowInteractor::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
void svtkAndroidRenderWindowInteractor::ExitCallback()
{
