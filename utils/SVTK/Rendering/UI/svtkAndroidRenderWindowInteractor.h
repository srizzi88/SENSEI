/*=========================================================================
  ...
  Module:    svtkAndroidRenderWindowInteractor.h
...
=========================================================================*/
/**
 * @class   svtkAndroidRenderWindowInteractor
...
#ifndef svtkAndroidRenderWindowInteractor_h
#define svtkAndroidRenderWindowInteractor_h
...
class SVTKRENDERINGUI_EXPORT svtkAndroidRenderWindowInteractor : public svtkRenderWindowInteractor
{
public:
  /**
   * Construct object so that light follows camera motion.
   */
  static svtkAndroidRenderWindowInteractor* New();

  svtkTypeMacro(svtkAndroidRenderWindowInteractor, svtkRenderWindowInteractor);
...
protected:
  svtkAndroidRenderWindowInteractor();
  ~svtkAndroidRenderWindowInteractor() override;
...
private:
  svtkAndroidRenderWindowInteractor(const svtkAndroidRenderWindowInteractor&) = delete;
  void operator=(const svtkAndroidRenderWindowInteractor&) = delete;
};
