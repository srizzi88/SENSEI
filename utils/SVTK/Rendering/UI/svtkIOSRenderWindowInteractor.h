/*=========================================================================
  ...
  Module:    svtkIOSRenderWindowInteractor.h
 ...
 *
 *
 * The interactor interfaces with svtkIOSRenderWindow and svtkIOSGLView
 * to trap messages from the IOS window manager and send them to svtk.
 *
...
#ifndef svtkIOSRenderWindowInteractor_h
#define svtkIOSRenderWindowInteractor_h

#include "svtkRenderWindowInteractor.h"
#include "svtkRenderingUIModule.h" // For export macro

class SVTKRENDERINGUI_EXPORT svtkIOSRenderWindowInteractor : public svtkRenderWindowInteractor
{
public:
  /**
   * Construct object so that light follows camera motion.
   */
  static svtkIOSRenderWindowInteractor* New();

  svtkTypeMacro(svtkIOSRenderWindowInteractor, svtkRenderWindowInteractor);
...
protected:
  svtkIOSRenderWindowInteractor();
  ~svtkIOSRenderWindowInteractor() override;
...
private:
  svtkIOSRenderWindowInteractor(const svtkIOSRenderWindowInteractor&) = delete;
  void operator=(const svtkIOSRenderWindowInteractor&) = delete;
