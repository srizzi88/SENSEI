/*=========================================================================
  ...
  Module:    svtkWin32RenderWindowInteractor.h
...
=========================================================================*/
/**
 * @class   svtkWin32RenderWindowInteractor
...
#ifndef svtkWin32RenderWindowInteractor_h
#define svtkWin32RenderWindowInteractor_h
...
class SVTKRENDERINGUI_EXPORT svtkWin32RenderWindowInteractor : public svtkRenderWindowInteractor
{
public:
  /**
   * Construct object so that light follows camera motion.
   */
  static svtkWin32RenderWindowInteractor* New();

  svtkTypeMacro(svtkWin32RenderWindowInteractor, svtkRenderWindowInteractor);
   ...
   */
  svtkSetMacro(InstallMessageProc, int);
  svtkGetMacro(InstallMessageProc, int);
  svtkBooleanMacro(InstallMessageProc, int);
  //@}
  ...
  friend SVTKRENDERINGUI_EXPORT LRESULT CALLBACK svtkHandleMessage(
    HWND hwnd, UINT uMsg, WPARAM w, LPARAM l);
  friend SVTKRENDERINGUI_EXPORT LRESULT CALLBACK svtkHandleMessage2(
    HWND hwnd, UINT uMsg, WPARAM w, LPARAM l, svtkWin32RenderWindowInteractor* me);
...
protected:
  svtkWin32RenderWindowInteractor();
  ~svtkWin32RenderWindowInteractor() override;
...
private:
  svtkWin32RenderWindowInteractor(const svtkWin32RenderWindowInteractor&) = delete;
  void operator=(const svtkWin32RenderWindowInteractor&) = delete;
};
