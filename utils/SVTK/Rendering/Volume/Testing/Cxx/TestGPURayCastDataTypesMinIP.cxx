...
int TestGPURayCastDataTypesMinIP(int argc, char* argv[])
{
  ...
  data.opacity[2][0]->AddPoint(SVTK_UNSIGNED_INT_MAX, 0);
  ...
  data.opacity[2][2]->AddPoint(SVTK_UNSIGNED_INT_MAX, 0);
  ...
  data.opacity[2][1]->AddPoint(SVTK_INT_MIN, 1);
  data.opacity[2][1]->AddPoint(SVTK_INT_MAX, 0);
  ...
  data.opacity[2][3]->AddPoint(SVTK_INT_MIN, 1);
  data.opacity[2][3]->AddPoint(SVTK_INT_MAX, 0);
