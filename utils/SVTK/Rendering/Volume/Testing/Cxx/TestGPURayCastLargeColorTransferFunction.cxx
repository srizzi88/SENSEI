...
=========================================================================*/
// This test verifies that the svtkGPUVolumeRayCastMapper doesn't unexpectedly
...
int TestGPURayCastLargeColorTransferFunction(int argc, char* argv[])
{
  ...
  svtkSmartPointer<svtkPiecewiseFunction> opacity = svtkSmartPointer<svtkPiecewiseFunction>::New();
  ...
  svtkSmartPointer<svtkXMLImageDataReader> reader = svtkSmartPointer<svtkXMLImageDataReader>::New();
...
#ifdef GPU_MAPPER
  svtkSmartPointer<svtkGPUVolumeRayCastMapper> volumeMapper =
    svtkSmartPointer<svtkGPUVolumeRayCastMapper>::New();
#else
  svtkSmartPointer<svtkFixedPointVolumeRayCastMapper> volumeMapper =
    svtkSmartPointer<svtkFixedPointVolumeRayCastMapper>::New();
#endif

  volumeMapper->SetInputData(reader->GetOutput());

  svtkSmartPointer<svtkVolumeProperty> volumeProperty = svtkSmartPointer<svtkVolumeProperty>::New();
  ...
  svtkSmartPointer<svtkTransform> xf = svtkSmartPointer<svtkTransform>::New();
  xf->RotateY(-90.0);
  xf->RotateX(180);
