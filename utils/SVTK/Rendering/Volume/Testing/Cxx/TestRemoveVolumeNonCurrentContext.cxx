...
// render window with svtkGPUVolumeRayCastMapper
...
//-----------------------------------------------------------------------------
class TestRemoveVolumeNonCurrentContextCallback : public svtkCommand
{
public:
...
{
  const char* volumeFile = svtkTestUtilities::ExpandDataFileName(argc, argv, "Data/ironProt.svtk");
  svtkNew<svtkStructuredPointsReader> pointsReader;
  ...
  svtkNew<svtkSmartVolumeMapper> smartMapper1;
  ...
  svtkNew<svtkSmartVolumeMapper> smartMapper2;
  ...
  svtkNew<TestRemoveVolumeNonCurrentContextCallback> callback;
  ...
  //  int retval = svtkTesting::Test(argc, argv, renderWindow1, 15);
