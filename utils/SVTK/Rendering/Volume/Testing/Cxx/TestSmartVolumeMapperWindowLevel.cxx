...
int TestSmartVolumeMapperWindowLevel(int argc, char* argv[])
{
  ...
  svtkNew<svtkSmartVolumeMapper> mapper1;
  mapper1->SetInputConnection(reader->GetOutputPort());
  mapper1->SetRequestedRenderModeToDefault();

  svtkNew<svtkSmartVolumeMapper> mapper2;
  mapper2->SetInputConnection(reader->GetOutputPort());

  svtkNew<svtkSmartVolumeMapper> mapper3;
  ...
  return svtkTesting::InteractorEventLoop(argc, argv, iren, TestSmartVolumeMapperWindowLevelLog);
}
