/*=========================================================================
  ...
  Module:    svtkFiniteDifferenceGradientEstimator.cxx
...
svtkStandardNewMacro(svtkFiniteDifferenceGradientEstimator);

// This is the templated function that actually computes the EncodedNormal
// and the GradientMagnitude
template <class T>
void svtkComputeGradients(
  svtkFiniteDifferenceGradientEstimator* estimator, T* data_ptr, int thread_id, int thread_count)
{
  ...
  svtkDirectionEncoder* direction_encoder;
  int zeroPad;
...
// Construct a svtkFiniteDifferenceGradientEstimator
svtkFiniteDifferenceGradientEstimator::svtkFiniteDifferenceGradientEstimator()
{
  this->SampleSpacingInVoxels = 1;
}

// Destruct a svtkFiniteDifferenceGradientEstimator - free up any memory used
svtkFiniteDifferenceGradientEstimator::~svtkFiniteDifferenceGradientEstimator() = default;

static SVTK_THREAD_RETURN_TYPE svtkSwitchOnDataType(void* arg)
{
  svtkFiniteDifferenceGradientEstimator* estimator;
  int thread_count;
  int thread_id;
  ...
  estimator =
    (svtkFiniteDifferenceGradientEstimator*)(((svtkMultiThreader::ThreadInfo*)(arg))->UserData);
  ...
  {
    svtkTemplateMacro(svtkComputeGradients(
      estimator, static_cast<SVTK_TT*>(scalars->GetVoidPointer(0)), thread_id, thread_count));
    default:
      svtkGenericWarningMacro("unable to encode scalar type!");
  }
...
// Input.
void svtkFiniteDifferenceGradientEstimator::UpdateNormals()
{
  svtkDebugMacro(<< "Updating Normals!");
  this->Threader->SetNumberOfThreads(this->NumberOfThreads);

  this->Threader->SetSingleMethod(svtkSwitchOnDataType, this);

  this->Threader->SingleMethodExecute();
}

// Print the svtkFiniteDifferenceGradientEstimator
void svtkFiniteDifferenceGradientEstimator::PrintSelf(ostream& os, svtkIndent indent)
{
