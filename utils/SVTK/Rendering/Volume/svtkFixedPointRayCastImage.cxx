...
svtkStandardNewMacro(svtkFixedPointRayCastImage);

// Construct a new svtkFixedPointRayCastImage with default values
svtkFixedPointRayCastImage::svtkFixedPointRayCastImage()
{
...
// Destruct a svtkFixedPointRayCastImage - clean up any memory used
svtkFixedPointRayCastImage::~svtkFixedPointRayCastImage()
{
  delete[] this->Image;
  delete[] this->ZBuffer;
...
// Allocate memory
void svtkFixedPointRayCastImage::AllocateImage()
{
  delete[] this->Image;
  this->Image = nullptr;
...
// Clear image to 0
void svtkFixedPointRayCastImage::ClearImage()
{
...
void svtkFixedPointRayCastImage::AllocateZBuffer()
{
...
float svtkFixedPointRayCastImage::GetZBufferValue(int x, int y)
{
  if (!this->UseZBuffer)
  {
    return 1.0;
...
void svtkFixedPointRayCastImage::PrintSelf(ostream& os, svtkIndent indent)
{
