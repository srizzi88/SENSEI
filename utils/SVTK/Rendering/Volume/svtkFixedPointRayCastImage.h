/*=========================================================================
  ...
  Module:    svtkFixedPointRayCastImage.h
 ...
 * svtkFixedPointVolumeRayCastMapper so that multiple mappers can share
...
#ifndef svtkFixedPointRayCastImage_h
#define svtkFixedPointRayCastImage_h

#include "svtkObject.h"
#include "svtkRenderingVolumeModule.h" // For export macro

class SVTKRENDERINGVOLUME_EXPORT svtkFixedPointRayCastImage : public svtkObject
{
public:
  static svtkFixedPointRayCastImage* New();
  svtkTypeMacro(svtkFixedPointRayCastImage, svtkObject);
   ...
   */
  svtkSetVector2Macro(ImageViewportSize, int);
   ...
   */
  svtkSetVector2Macro(ImageMemorySize, int);
  svtkGetVectorMacro(ImageMemorySize, int, 2);
  //@}
   ...
   */
  svtkSetVector2Macro(ImageInUseSize, int);
   ...
   */
  svtkSetVector2Macro(ImageOrigin, int);
   ...
   */
  svtkSetMacro(ImageSampleDistance, float);
   ...
   */
  svtkSetVector2Macro(ZBufferSize, int);
  svtkGetVectorMacro(ZBufferSize, int, 2);
  //@}
   ...
   */
  svtkSetVector2Macro(ZBufferOrigin, int);
  svtkGetVectorMacro(ZBufferOrigin, int, 2);
  //@}
   ...
   */
  svtkSetClampMacro(UseZBuffer, svtkTypeBool, 0, 1);
  svtkGetMacro(UseZBuffer, svtkTypeBool);
  svtkBooleanMacro(UseZBuffer, svtkTypeBool);
  //@}
...
protected:
  svtkFixedPointRayCastImage();
  ~svtkFixedPointRayCastImage() override;
  ...
  svtkTypeBool UseZBuffer;

  // This is the actual ZBuffer data in floats
  float* ZBuffer;

private:
  svtkFixedPointRayCastImage(const svtkFixedPointRayCastImage&) = delete;
  void operator=(const svtkFixedPointRayCastImage&) = delete;
};
