/*=========================================================================
  ...
  Module:    svtkRecursiveSphereDirectionEncoder.cxx
...
svtkStandardNewMacro(svtkRecursiveSphereDirectionEncoder);
...
// sphere.
svtkRecursiveSphereDirectionEncoder::svtkRecursiveSphereDirectionEncoder()
{
...
// Destruct a svtkRecursiveSphereDirectionEncoder - free up any memory used
svtkRecursiveSphereDirectionEncoder::~svtkRecursiveSphereDirectionEncoder()
{
...
int svtkRecursiveSphereDirectionEncoder::GetEncodedDirection(float n[3])
{
  float t;
  int value;
  int xindex, yindex;
...
float* svtkRecursiveSphereDirectionEncoder::GetDecodedGradient(int value)
{
  if (this->IndexTableRecursionDepth != this->RecursionDepth)
  {
    this->InitializeIndexTable();
...
int svtkRecursiveSphereDirectionEncoder::GetNumberOfEncodedDirections()
{
...
float* svtkRecursiveSphereDirectionEncoder::GetDecodedGradientTable()
{
  if (this->IndexTableRecursionDepth != this->RecursionDepth)
  {
    this->InitializeIndexTable();
...
void svtkRecursiveSphereDirectionEncoder::InitializeIndexTable()
{
...
// Print the svtkRecursiveSphereDirectionEncoder
void svtkRecursiveSphereDirectionEncoder::PrintSelf(ostream& os, svtkIndent indent)
{
