/*=========================================================================
  ...
  Module:    svtkVolumeRayCastSpaceLeapingImageFilter.cxx
...
#ifdef svtkVolumeRayCastSpaceLeapingImageFilter_DEBUG
...
#define SVTK_SL_BLK 4

//----------------------------------------------------------------------------
svtkStandardNewMacro(svtkVolumeRayCastSpaceLeapingImageFilter);
svtkCxxSetObjectMacro(svtkVolumeRayCastSpaceLeapingImageFilter, CurrentScalars, svtkDataArray);

//----------------------------------------------------------------------------
svtkVolumeRayCastSpaceLeapingImageFilter::svtkVolumeRayCastSpaceLeapingImageFilter()
{
...
//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter::PrintSelf(ostream& os, svtkIndent indent)
{
...
//----------------------------------------------------------------------------
int svtkVolumeRayCastSpaceLeapingImageFilter::RequestUpdateExtent(
  svtkInformation* svtkNotUsed(request), svtkInformationVector** inputVector,
  svtkInformationVector* svtkNotUsed(outputVector))
{
  ...
  inInfo->Set(svtkStreamingDemandDrivenPipeline::UPDATE_EXTENT(), wholeExtent, 6);

  return 1;
}

//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::SetCache(svtkImageData* cache)
{
...
//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::InternalRequestUpdateExtent(
  int* inExt, int* wholeExtent)
{
  ...
  for (int i = 0; i < 3; i++)
  {
    ...
    inExt[2 * i + 1] = (dim[i] < 2) ? (0) : (static_cast<int>((dim[i] - 2) / SVTK_SL_BLK));
  }
}

//----------------------------------------------------------------------------
static void svtkVolumeRayCastSpaceLeapingImageFilterClearOutput(
  svtkImageData* outData, int outExt[6], int nComponents)
{
...
//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::ComputeInputExtentsForOutput(
...
template <class T>
void svtkVolumeRayCastSpaceLeapingImageFilterMinMaxExecute(
  svtkVolumeRayCastSpaceLeapingImageFilter* self, svtkImageData* inData, svtkImageData* outData,
  int outExt[6], T)
{

  // the number of independent components for which we need to keep track of
  // min/max
  svtkDataArray* scalars = self->GetCurrentScalars();
  ...
  int inDim[3];
  int outWholeDim[3];
  svtkVolumeRayCastSpaceLeapingImageFilter::ComputeInputExtentsForOutput(
  ...
  const svtkIdType outInc0 = 3 * nComponents;
  const svtkIdType outInc1 = outInc0 * outWholeDim[0];
  const svtkIdType outInc2 = outInc1 * outWholeDim[1];
...
template <class T>
void svtkVolumeRayCastSpaceLeapingImageFilterMaxGradientMagnitudeExecute(
  svtkVolumeRayCastSpaceLeapingImageFilter* self, svtkImageData* inData, svtkImageData* outData,
  int outExt[6], T)
{
  // the number of independent components for which we need to keep track of
...
// - Fill in the maximum gradient magnitude space leaping information.
template <class T>
void svtkVolumeRayCastSpaceLeapingImageFilterMinMaxAndMaxGradientMagnitudeExecute(
  svtkVolumeRayCastSpaceLeapingImageFilter* self, svtkImageData* inData, svtkImageData* outData,
  int outExt[6], T)
{
  // the number of independent components for which we need to keep track of
...
//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::FillScalarAndGradientOpacityFlags(
  svtkImageData* outData, int outExt[6])
{
...
//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::FillScalarOpacityFlags(
  svtkImageData* outData, int outExt[6])
{
  // Get increments to march through the output
...
//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter::ThreadedRequestData(
  svtkInformation* svtkNotUsed(request), svtkInformationVector** svtkNotUsed(inputVector),
  svtkInformationVector* svtkNotUsed(outputVector), svtkImageData*** inData, svtkImageData** outData,
  int outExt[6], int svtkNotUsed(id))
{
#ifdef svtkVolumeRayCastSpaceLeapingImageFilter_DEBUG
  ...
  {
    svtkVolumeRayCastSpaceLeapingImageFilterClearOutput(outData[0], outExt, nComponents);
  }
  ...
  if (this->ComputeMinMax && !this->ComputeGradientOpacity)
  {
    ...
    switch (scalarType)
    {
      svtkTemplateMacro(svtkVolumeRayCastSpaceLeapingImageFilterMinMaxExecute(
        this, inData[0][0], outData[0], outExt, static_cast<SVTK_TT>(0)));
      default:
  ...
  else if (this->ComputeGradientOpacity && !this->ComputeMinMax)
  {
    ...
    switch (scalarType)
    {
      svtkTemplateMacro(svtkVolumeRayCastSpaceLeapingImageFilterMaxGradientMagnitudeExecute(
        this, inData[0][0], outData[0], outExt, static_cast<SVTK_TT>(0)));
      default:
        svtkErrorMacro("Unknown scalar type");
        return;
  ...
  else if (this->ComputeGradientOpacity && this->ComputeMinMax)
  {
    ...
    switch (scalarType)
    {
      svtkTemplateMacro(svtkVolumeRayCastSpaceLeapingImageFilterMinMaxAndMaxGradientMagnitudeExecute(
        this, inData[0][0], outData[0], outExt, static_cast<SVTK_TT>(0)));
      default:
        svtkErrorMacro("Unknown scalar type");
        return;
...
int svtkVolumeRayCastSpaceLeapingImageFilter::RequestData(
...
//----------------------------------------------------------------------------
int svtkVolumeRayCastSpaceLeapingImageFilter::RequestInformation(
  svtkInformation* request, svtkInformationVector** inputVector, svtkInformationVector* outputVector)
{
  this->svtkImageAlgorithm::RequestInformation(request, inputVector, outputVector);
  ...
  svtkDataObject::SetPointDataActiveScalarInfo(
    outInfo, SVTK_UNSIGNED_SHORT, 3 * this->GetNumberOfIndependentComponents());
  ...
  inInfo->Get(svtkStreamingDemandDrivenPipeline::WHOLE_EXTENT(), inWholeExtent);
  ...
  outInfo->Set(svtkStreamingDemandDrivenPipeline::UPDATE_EXTENT(), outWholeExt, 6);

  return 1;
}

//----------------------------------------------------------------------------
int svtkVolumeRayCastSpaceLeapingImageFilter ::GetNumberOfIndependentComponents()
{
  // the number of independent components for which we need to keep track of
  // min/max
...
//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::ComputeFirstNonZeroOpacityIndices()
{
  // Find the first non-zero scalar opacity and gradient opacity points on
  // the respective transfer functions
...
//----------------------------------------------------------------------------
unsigned short* svtkVolumeRayCastSpaceLeapingImageFilter ::GetMinNonZeroScalarIndex()
{
  return this->MinNonZeroScalarIndex;
}

//----------------------------------------------------------------------------
unsigned char* svtkVolumeRayCastSpaceLeapingImageFilter ::GetMinNonZeroGradientMagnitudeIndex()
{
  return this->MinNonZeroGradientMagnitudeIndex;
}

//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::SetGradientMagnitude(
...
//----------------------------------------------------------------------------
unsigned char** svtkVolumeRayCastSpaceLeapingImageFilter ::GetGradientMagnitude()
{
  return this->GradientMagnitude;
}

//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::SetScalarOpacityTable(int c, unsigned short* t)
{
  this->ScalarOpacityTable[c] = t;
}

//----------------------------------------------------------------------------
void svtkVolumeRayCastSpaceLeapingImageFilter ::SetGradientOpacityTable(int c, unsigned short* t)
{
  this->GradientOpacityTable[c] = t;
}

//----------------------------------------------------------------------------
unsigned short* svtkVolumeRayCastSpaceLeapingImageFilter ::GetMinMaxVolume(int size[4])
{
  if (svtkImageData* output = this->GetOutput())
  {
    int dims[3];
...
//----------------------------------------------------------------------------
// Fill in the min-max space leaping information.
svtkIdType svtkVolumeRayCastSpaceLeapingImageFilter ::ComputeOffset(
  const int ext[6], const int wholeExt[6], int nComponents)
{
  ...
  svtkIdType offset = ext[4] - wholeExt[4];
  offset *= wDim[1];
...
// as an internal ivar of the svtkFixedPointVolumeRayCastMapper.
void svtkVolumeRayCastSpaceLeapingImageFilter ::AllocateOutputData(
  svtkImageData* output, svtkInformation* outInfo, int* uExtent)
{
  ...
  if (this->Cache)
  {
      ...
      this->Cache->GetNumberOfScalarComponents() == output->GetNumberOfScalarComponents())
    {
      ...
      // This is absolutely scary code, if used as a standard SVTK imaging filter,
      // but since the filter will be used only as an iVar of
      // svtkFixedPointVolumeRayCastMapper, we need a caching mechanism to avoid
...
//----------------------------------------------------------------------------
svtkImageData* svtkVolumeRayCastSpaceLeapingImageFilter ::AllocateOutputData(
  svtkDataObject* output, svtkInformation* outInfo)
{
  // Call the superclass method
  return svtkImageAlgorithm::AllocateOutputData(output, outInfo);
}

//----------------------------------------------------------------------------
#ifdef svtkVolumeRayCastSpaceLeapingImageFilter_DEBUG
void svtkVolumeRayCastSpaceLeapingImageFilter ::WriteMinMaxVolume(
  int component, unsigned short* minMaxVolume, int minMaxVolumeSize[4], const char* filename)
{
  ...
  svtkIdType nVoxels = minMaxVolumeSize[0];
  nVoxels *= minMaxVolumeSize[1] nVoxels *= minMaxVolumeSize[2];

  for (svtkIdType i = 0; i < nVoxels; ++i, pSrc += inc, ++pDst)
  {
    *pDst = *pSrc;
  }
