...
# filtering for names of the SVTK naming convention was then applied.
...
WindowsMangle = WindowsMangle+'svtkGet.*Macro\s*\(\s*('
sep = ''
...
WindowsMangle = WindowsMangle+'svtkSet.*Macro\s*\(\s*('
sep = ''
