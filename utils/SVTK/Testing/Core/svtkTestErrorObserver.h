...
=========================================================================*/
#ifndef svtkTestErrorObserver_h
#define svtkTestErrorObserver_h
...
namespace svtkTest
{
class ErrorObserver : public ::svtkCommand
{
public:
  svtkTypeMacro(ErrorObserver, svtkCommand);
  ...
  void Execute(svtkObject* svtkNotUsed(caller), unsigned long event, void* calldata) override
  {
    switch (event)
    {
      case svtkCommand::ErrorEvent:
        ErrorMessage += static_cast<char*>(calldata);
        this->Error = true;
        break;
      case svtkCommand::WarningEvent:
...
#endif
// SVTK-HeaderTest-Exclude: svtkTestErrorObserver.h
