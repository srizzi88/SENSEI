...
=========================================================================*/
/**
 * @class   svtkTestUtilities
 * @brief   Utility functions used for regression testing.
 *
 * svtkTestUtilities provides methods to perform common testing operations.
 ...
 * root directory for SVTK Data, expanding a filename with this root directory.
 */

#ifndef svtkTestUtilities_h
#define svtkTestUtilities_h
...
struct svtkTestUtilities
{
  /**
   * Function necessary for accessing the root directory for SVTK data. Try the
   * -D command line argument or SVTK_DATA_ROOT or a default value. The returned
   ...
   * command line argument (-D path) or SVTK_DATA_ROOT env. variable. If slash
...
inline char* svtkTestUtilities::GetDataRoot(int argc, char* argv[])
{
  return svtkTestUtilities::GetArgOrEnvOrDefault(
    "-D", argc, argv, "SVTK_DATA_ROOT", "../../../../SVTKData");
}

inline char* svtkTestUtilities::ExpandDataFileName(
  int argc, char* argv[], const char* fname, int slash)
{
  return svtkTestUtilities::ExpandFileNameWithArgOrEnvOrDefault(
    "-D", argc, argv, "SVTK_DATA_ROOT", "../../../../SVTKData", fname, slash);
}

inline char* svtkTestUtilities::GetArgOrEnvOrDefault(
  const char* arg, int argc, char* argv[], const char* env, const char* def)
{
  int index = -1;
...
inline char* svtkTestUtilities::ExpandFileNameWithArgOrEnvOrDefault(const char* arg, int argc,
  char* argv[], const char* env, const char* def, const char* fname, int slash)
{
  char* fullName;

  char* value = svtkTestUtilities::GetArgOrEnvOrDefault(arg, argc, argv, env, def);
  if (value)
  {
...
#endif // svtkTestUtilities_h
// SVTK-HeaderTest-Exclude: svtkTestUtilities.h
