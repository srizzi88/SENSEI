...
set(HEADERS_LIBPROJ
        ...
        proj_api.h
        geodesic.h
        svtk_libproj_mangle.h
        "${CMAKE_CURRENT_BINARY_DIR}/svtklibproj_export.h"
)
...
if (FALSE) # XXX(kitware): SVTK handles output names.
proj_target_output_name(${PROJ_CORE_TARGET} PROJ_CORE_TARGET_OUTPUT_NAME)
endif ()

if (FALSE) # XXX(kitware): use SVTK's module system.
...
svtk_module_add_module(SVTK::libproj
  SOURCES ${ALL_LIBPROJ_SOURCES}
  HEADERS ${ALL_LIBPROJ_HEADERS}
  HEADERS_SUBDIR "svtklibproj/src")
set(PROJ_CORE_TARGET libproj)

include(GenerateExportHeader)
generate_export_header(libproj
  EXPORT_MACRO_NAME svtklibproj_EXPORT
  EXPORT_FILE_NAME  svtklibproj_export.h)
endif ()


if (FALSE) # XXX(kitware): Not necessary for SVTK.
if(WIN32)
...
# install
##############################################
if (FALSE) # XXX(kitware): SVTK handles installation.
