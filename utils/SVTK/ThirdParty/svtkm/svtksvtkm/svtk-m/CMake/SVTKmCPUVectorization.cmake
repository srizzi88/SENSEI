...
if(TARGET svtkm_vectorization_flags)
  return()
endif()

add_library(svtkm_vectorization_flags INTERFACE)
if(NOT SVTKm_INSTALL_ONLY_LIBRARIES)
  install(TARGETS svtkm_vectorization_flags EXPORT ${SVTKm_EXPORT_NAME})
endif()

# We currently don't know the vectorization flags for MSVC. But we want
# the svtkm_vectorization_flags target to exist so we have a consistent
# interface.
...
set_property(GLOBAL PROPERTY SVTKm_NATIVE_FLAGS ${native_flags})
set_property(GLOBAL PROPERTY SVTKm_AVX_FLAGS ${avx_flags})
set_property(GLOBAL PROPERTY SVTKm_AVX2_FLAGS ${avx2_flags})

set_property(GLOBAL PROPERTY SVTKm_KNL_FLAGS ${knl_flags})
set_property(GLOBAL PROPERTY SVTKm_SKYLAKE_FLAGS ${skylake_flags})
...
# nice interface
#
set(SVTKm_Vectorization "none" CACHE STRING "Level of compiler vectorization support")
set_property(CACHE SVTKm_Vectorization PROPERTY STRINGS ${vec_levels})
if (NOT ${SVTKm_Vectorization} STREQUAL "none")
  set(SVTKM_VECTORIZATION_ENABLED "ON")
endif()
...
#
set(flags)
if(SVTKm_Vectorization STREQUAL "native")
  get_property(flags GLOBAL PROPERTY SVTKm_NATIVE_FLAGS)
elseif(SVTKm_Vectorization STREQUAL "avx")
  get_property(flags GLOBAL PROPERTY SVTKm_AVX_FLAGS)
elseif(SVTKm_Vectorization STREQUAL "avx2")
  get_property(flags GLOBAL PROPERTY SVTKm_AVX2_FLAGS)
elseif(SVTKm_Vectorization STREQUAL "avx512-skx")
  get_property(flags GLOBAL PROPERTY SVTKm_SKYLAKE_FLAGS)
elseif(SVTKm_Vectorization STREQUAL "avx512-knl")
  get_property(flags GLOBAL PROPERTY SVTKm_KNL_FLAGS)
endif()

target_compile_options(svtkm_vectorization_flags
  INTERFACE $<$<COMPILE_LANGUAGE:CXX>:${flags}>
  )

if(TARGET svtkm::cuda AND flags AND NOT CMAKE_CUDA_HOST_COMPILER)
