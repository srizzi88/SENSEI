...
## This CMake script checks source files for the appropriate SVTKM copyright
## statement, which is stored in SVTKm_SOURCE_DIR/CMake/SVTKmCopyrightStatement.txt.
## To run this script, execute CMake as follows:
##
## cmake -DSVTKm_SOURCE_DIR=<SVTKm_SOURCE_DIR> -P <SVTKm_SOURCE_DIR>/CMake/SVTKMCheckCopyright.cmake
##
...
if (NOT SVTKm_SOURCE_DIR)
  message(SEND_ERROR "SVTKm_SOURCE_DIR not defined.")
endif (NOT SVTKm_SOURCE_DIR)

set(copyright_file ${SVTKm_SOURCE_DIR}/CMake/SVTKmCopyrightStatement.txt)

if (NOT EXISTS ${copyright_file})
  message(SEND_ERROR "Cannot find SVTKMCopyrightStatement.txt.")
endif (NOT EXISTS ${copyright_file})

set(license_file ${SVTKm_SOURCE_DIR}/LICENSE.txt)
...
foreach (glob_expression ${FILES_TO_CHECK})
  file(GLOB_RECURSE file_list
    RELATIVE "${SVTKm_SOURCE_DIR}"
    "${SVTKm_SOURCE_DIR}/${glob_expression}"
    )
  ...
  foreach (file ${file_list})
    ...
    if (NOT skip)
      check_copyright("${SVTKm_SOURCE_DIR}/${file}")
    endif (NOT skip)
  endforeach (file)
