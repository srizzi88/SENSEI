...
function(svtkm_check_sanitizer_build)
  ...
  if (${SANITIZER_BUILD} GREATER -1)
    ...
    set (SANITIZER_BLACKLIST "${SVTKm_BINARY_DIR}/sanitizer_blacklist.txt")
    configure_file (
      "${SVTKm_SOURCE_DIR}/Utilities/DynamicAnalysis/sanitizer_blacklist.txt.in"
      ${SANITIZER_BLACKLIST}
      @ONLY
      )
