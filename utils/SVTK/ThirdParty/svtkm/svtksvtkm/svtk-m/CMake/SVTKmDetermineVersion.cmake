...
# Used to determine the version for SVTK-m source using "git describe", if git
...
#   var_prefix : prefix for variables e.g. "SVTKm".
function(determine_version source_dir git_command var_prefix)
  if ("$Format:$" STREQUAL "")
    ...
    # this function.
    return ()
  elseif (NOT SVTKm_GIT_DESCRIBE AND
    ...
    # note, output may be set to empty if SVTKm_GIT_DESCRIBE is not defined.
    set(output "${SVTKm_GIT_DESCRIBE}")
  endif()
