...
#
# cmake -D SVTKm_BINARY_DIR=<top-of-build-tree> -D SVTKm_SOURCE_DIR=<top-of-source-tree> -P <this-script>
#

set(FILES
  svtkm/internal/Configure.h
  CMakeCache.txt
  CMakeFiles/CMakeError.log
  )

function(print_file filename)
  set(full_filename "${SVTKm_BINARY_DIR}/${filename}")
  message("
...
execute_process(
  ...
  WORKING_DIRECTORY "${SVTKm_SOURCE_DIR}"
