...
#ifndef svtk_m_Assert_h
#define svtk_m_Assert_h

#include <svtkm/internal/Configure.h>

#include <cassert>

/// \def SVTKM_ASSERT(condition)
///
...
///
/// The SVTKM_NO_ASSERT cmake and preprocessor option allows debugging builds
...
#define SVTKM_ASSERT(condition) (void)(condition)
#elif !defined(NDEBUG) && !defined(SVTKM_NO_ASSERT)
//Only assert if we are in debug mode and don't have SVTKM_NO_ASSERT defined
#define SVTKM_ASSERT(condition) assert(condition)
#else
#define SVTKM_ASSERT(condition) (void)(condition)
#endif

#endif //svtk_m_Assert_h
