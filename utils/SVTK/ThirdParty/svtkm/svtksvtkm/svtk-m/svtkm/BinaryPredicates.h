...
//============================================================================
#ifndef svtk_m_BinaryPredicates_h
#define svtk_m_BinaryPredicates_h
...
struct NotEqual
{
  ...
  SVTKM_EXEC_CONT bool operator()(const T& x, const U& y) const
  {
    return x != y;
  }
};
...
#endif //svtk_m_BinaryPredicates_h
