...
//============================================================================
#ifndef svtk_m_cont_Invoker_h
#define svtk_m_cont_Invoker_h
...
using scatter_or_mask = std::integral_constant<bool,
                                               svtkm::worklet::internal::is_mask<T>::value ||
                                                 svtkm::worklet::internal::is_scatter<T>::value>;
}
...
struct Invoker
{
  ...
  ///
  explicit Invoker()
    : DeviceId(svtkm::cont::DeviceAdapterTagAny{})
  {
  }
  ...
  ///
  explicit Invoker(svtkm::cont::DeviceAdapterId device)
    : DeviceId(device)
  {
  }
  ...
  ///
  svtkm::cont::DeviceAdapterId GetDevice() const { return DeviceId; }
