...
//============================================================================
#ifndef svtk_m_cont_arg_ControlSignatureTagBase_h
#define svtk_m_cont_arg_ControlSignatureTagBase_h
...
/// SVTKM_IS_CONTROL_SIGNATURE_TAG macro and allows checking the validity of a
/// \c ControlSignature.
///
...
struct ControlSignatureTagCheck
{
  static constexpr bool Valid =
    std::is_base_of<svtkm::cont::arg::ControlSignatureTagBase, ControlSignatureTag>::value;
};
...
///
#define SVTKM_IS_CONTROL_SIGNATURE_TAG(tag)                                                         \
  SVTKM_STATIC_ASSERT_MSG(::svtkm::cont::arg::internal::ControlSignatureTagCheck<tag>::Valid,        \
                         "Provided a type that is not a valid ControlSignature tag.")
}
}
} // namespace svtkm::cont::arg

#endif //svtk_m_cont_arg_ControlSignatureTagBase_h
