...
//============================================================================
#ifndef svtk_m_cont_arg_Transport_h
#define svtk_m_cont_arg_Transport_h
...
#ifdef SVTKM_DOXYGEN_ONLY
{
  ...
  SVTKM_CONT ExecObjectType operator()(const ContObjectType contData,
                                      const InputDomainType& inputDomain svtkm::Id outputSize) const;
};
...
#endif //svtk_m_cont_arg_Transport_h
