...
//============================================================================
#ifndef svtk_m_cont_cuda_ChooseCudaDevice_h
#define svtk_m_cont_cuda_ChooseCudaDevice_h
...
static int FindFastestDeviceId()
{
  ...
  SVTKM_CUDA_CALL(cudaGetDeviceCount(&numberOfDevices));

  std::vector<compute_info> devices;
  for (int i = 0; i < numberOfDevices; ++i)
  {
    cudaDeviceProp properties;
    SVTKM_CUDA_CALL(cudaGetDeviceProperties(&properties, i));
