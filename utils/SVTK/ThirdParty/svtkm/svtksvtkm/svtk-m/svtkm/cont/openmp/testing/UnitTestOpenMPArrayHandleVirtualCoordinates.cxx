...
#include <svtkm/cont/testing/TestingArrayHandleVirtualCoordinates.h>
...
int UnitTestOpenMPArrayHandleVirtualCoordinates(int argc, char* argv[])
{
  ...
  return svtkm::cont::testing::TestingArrayHandleVirtualCoordinates<
    svtkm::cont::DeviceAdapterTagOpenMP>::Run(argc, argv);
}
