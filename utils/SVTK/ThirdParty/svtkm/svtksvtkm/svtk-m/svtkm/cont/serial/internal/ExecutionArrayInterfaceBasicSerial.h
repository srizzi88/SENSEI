...
//============================================================================
#ifndef svtk_m_cont_serial_internal_ExecutionArrayInterfaceBasicSerial_h
#define svtk_m_cont_serial_internal_ExecutionArrayInterfaceBasicSerial_h
...
template <>
struct SVTKM_CONT_EXPORT ExecutionArrayInterfaceBasic<DeviceAdapterTagSerial> final
