...
//============================================================================
#ifndef svtk_m_exec_BoundaryState_h
#define svtk_m_exec_BoundaryState_h
...
{
  SVTKM_EXEC
  BoundaryState(const svtkm::Id3& ijk, const svtkm::Id3& pdims)
    : IJK(ijk)
  ...
  /// a size of 5x5x5.
  ///
  SVTKM_EXEC bool IsRadiusInXBoundary(svtkm::IdComponent radius) const
  {
    SVTKM_ASSERT(radius >= 0);
    return (((this->IJK[0] - radius) >= 0) && ((this->IJK[0] + radius) < this->PointDimensions[0]));
  }
  SVTKM_EXEC bool IsRadiusInYBoundary(svtkm::IdComponent radius) const
  {
    SVTKM_ASSERT(radius >= 0);
    return (((this->IJK[1] - radius) >= 0) && ((this->IJK[1] + radius) < this->PointDimensions[1]));
  }
  SVTKM_EXEC bool IsRadiusInZBoundary(svtkm::IdComponent radius) const
  {
    SVTKM_ASSERT(radius >= 0);
  ...
  /// a size of 5x5x5.
  ///
  SVTKM_EXEC bool IsRadiusInBoundary(svtkm::IdComponent radius) const
  {
  ...
  /// Y, or Z direction.
  ///
  SVTKM_EXEC bool IsNeighborInXBoundary(svtkm::IdComponent offset) const
  {
    return (((this->IJK[0] + offset) >= 0) && ((this->IJK[0] + offset) < this->PointDimensions[0]));
  }
  SVTKM_EXEC bool IsNeighborInYBoundary(svtkm::IdComponent offset) const
  {
    return (((this->IJK[1] + offset) >= 0) && ((this->IJK[1] + offset) < this->PointDimensions[1]));
  }
  SVTKM_EXEC bool IsNeighborInZBoundary(svtkm::IdComponent offset) const
  {
  ...
  ///
  SVTKM_EXEC bool IsNeighborInBoundary(const svtkm::IdComponent3& neighbor) const
  {
  ...
  ///
  SVTKM_EXEC svtkm::IdComponent3 MinNeighborIndices(svtkm::IdComponent radius) const
  {
    SVTKM_ASSERT(radius >= 0);
    svtkm::IdComponent3 minIndices;

    for (svtkm::IdComponent component = 0; component < 3; ++component)
    {
      ...
      {
        minIndices[component] = static_cast<svtkm::IdComponent>(-this->IJK[component]);
      }
    }
  ...
  /// Returns the minimum neighborhood indices that are within the bounds of the data.
  ///
  SVTKM_EXEC svtkm::IdComponent3 MaxNeighborIndices(svtkm::IdComponent radius) const
  {
    SVTKM_ASSERT(radius >= 0);
    svtkm::IdComponent3 maxIndices;
    ...
    for (svtkm::IdComponent component = 0; component < 3; ++component)
    {
      ...
      {
        maxIndices[component] = static_cast<svtkm::IdComponent>(this->PointDimensions[component] -
  ...
  /// returned.
  ///
  SVTKM_EXEC svtkm::Id3 NeighborIndexToFullIndexClamp(const svtkm::IdComponent3& neighbor) const
  {
    svtkm::Id3 fullIndex = this->IJK + neighbor;

    return svtkm::Max(svtkm::Id3(0), svtkm::Min(this->PointDimensions - svtkm::Id3(1), fullIndex));
  }

  SVTKM_EXEC svtkm::Id3 NeighborIndexToFullIndexClamp(svtkm::IdComponent neighborI,
                                                    svtkm::IdComponent neighborJ,
                                                    svtkm::IdComponent neighborK) const
  {
    return this->NeighborIndexToFullIndexClamp(svtkm::make_Vec(neighborI, neighborJ, neighborK));
  }
  //@}
  ...
  ///
  SVTKM_EXEC svtkm::IdComponent3 ClampNeighborIndex(const svtkm::IdComponent3& neighbor) const
  {
    const svtkm::Id3 fullIndex = this->IJK + neighbor;
    const svtkm::Id3 clampedFullIndex =
      svtkm::Max(svtkm::Id3(0), svtkm::Min(this->PointDimensions - svtkm::Id3(1), fullIndex));
    return svtkm::IdComponent3{ clampedFullIndex - this->IJK };
  }

  SVTKM_EXEC svtkm::IdComponent3 ClampNeighborIndex(svtkm::IdComponent neighborI,
                                                  svtkm::IdComponent neighborJ,
                                                  svtkm::IdComponent neighborK) const
  {
    return this->ClampNeighborIndex(svtkm::make_Vec(neighborI, neighborJ, neighborK));
  }
  //@}
  ...
  /// boundary is returned.
  ///
  SVTKM_EXEC svtkm::Id NeighborIndexToFlatIndexClamp(const svtkm::IdComponent3& neighbor) const
  {
    svtkm::Id3 full = this->NeighborIndexToFullIndexClamp(neighbor);

    return (full[2] * this->PointDimensions[1] + full[1]) * this->PointDimensions[0] + full[0];
  }

  SVTKM_EXEC svtkm::Id NeighborIndexToFlatIndexClamp(svtkm::IdComponent neighborI,
                                                   svtkm::IdComponent neighborJ,
                                                   svtkm::IdComponent neighborK) const
  {
    return this->NeighborIndexToFlatIndexClamp(svtkm::make_Vec(neighborI, neighborJ, neighborK));
  }
  //@}
...
#endif //svtk_m_exec_BoundaryState_h
