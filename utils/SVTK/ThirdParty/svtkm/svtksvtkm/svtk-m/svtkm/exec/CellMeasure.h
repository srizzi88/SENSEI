...
//============================================================================
#ifndef svtk_m_exec_CellMeasure_h
#define svtk_m_exec_CellMeasure_h
/*!\file
...
SVTKM_EXEC OutType CellMeasure(const svtkm::IdComponent& numPts,
...
template <typename OutType, typename PointCoordVecType>
SVTKM_EXEC OutType ComputeMeasure(const svtkm::IdComponent&,
...
#endif // svtk_m_exec_CellMeasure_h
