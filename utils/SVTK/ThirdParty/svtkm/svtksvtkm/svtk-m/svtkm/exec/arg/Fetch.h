...
//============================================================================
#ifndef svtk_m_exec_arg_Fetch_h
#define svtk_m_exec_arg_Fetch_h
...
/// svtkm::exec::arg namespace), which defines the type of thread-local indices
