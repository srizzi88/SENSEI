...
//============================================================================
#ifndef svtk_m_exec_arg_ThreadIndicesExtrude_h
#define svtk_m_exec_arg_ThreadIndicesExtrude_h
...
class ThreadIndicesTopologyMap<svtkm::exec::ConnectivityExtrude<Device>>
{

  using ConnectivityType = svtkm::exec::ConnectivityExtrude<Device>;
...
public:
  ...
  SVTKM_EXEC ThreadIndicesTopologyMap(svtkm::Id threadIndex,
                                     svtkm::Id svtkmNotUsed(inputIndex),
                                     svtkm::IdComponent svtkmNotUsed(visitIndex),
                                     svtkm::Id svtkmNotUsed(outputIndex),
  ...
  SVTKM_SUPPRESS_EXEC_WARNINGS
  SVTKM_EXEC
  ThreadIndicesTopologyMap(const svtkm::Id3& threadIndex,
                           const ConnectivityType& connectivity,
                           svtkm::Id globalThreadIndexOffset = 0)
  {
  ...
  ///
  SVTKM_EXEC
  CellShapeTag GetCellShape() const { return svtkm::CellShapeTagWedge{}; }
...
// Specialization for extrude types.
template <typename Device>
class ThreadIndicesTopologyMap<svtkm::exec::ReverseConnectivityExtrude<Device>>
{
  using ConnectivityType = svtkm::exec::ReverseConnectivityExtrude<Device>;
...
public:
  ...
  SVTKM_SUPPRESS_EXEC_WARNINGS
  SVTKM_EXEC
  ThreadIndicesTopologyMap(svtkm::Id& threadIndex,
                           svtkm::Id svtkmNotUsed(inputIndex),
                           svtkm::IdComponent svtkmNotUsed(visitIndex),
                           svtkm::Id svtkmNotUsed(outputIndex),
                           const ConnectivityType& connectivity,
  ...
  ///
  SVTKM_EXEC
  CellShapeTag GetCellShape() const { return svtkm::CellShapeTagVertex{}; }
...
#include <svtkm/exec/arg/FetchExtrude.h>
