...
//============================================================================
#ifndef svtk_m_exec_arg_WorkIndex_h
#define svtk_m_exec_arg_WorkIndex_h
...
///
struct WorkIndex : svtkm::exec::arg::ExecutionSignatureTagBase
{
  ...
  using AspectTag = svtkm::exec::arg::AspectTagWorkIndex;
};

template <typename FetchTag, typename ThreadIndicesType, typename ExecObjectType>
struct Fetch<FetchTag, svtkm::exec::arg::AspectTagWorkIndex, ThreadIndicesType, ExecObjectType>
{
...
#endif //svtk_m_exec_arg_WorkIndex_h
