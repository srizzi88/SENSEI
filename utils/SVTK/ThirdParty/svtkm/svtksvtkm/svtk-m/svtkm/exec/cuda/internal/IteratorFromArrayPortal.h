...
//============================================================================
#ifndef svtk_m_exec_cuda_internal_IteratorFromArrayPortal_h
#define svtk_m_exec_cuda_internal_IteratorFromArrayPortal_h
...
public:
  ...
  SVTKM_EXEC
  svtkm::internal::ArrayPortalValueReference<ArrayPortalType> operator[](
    std::ptrdiff_t idx) const //NEEDS to be signed
  {
    return svtkm::internal::ArrayPortalValueReference<ArrayPortalType>(
      this->Portal, this->Index + static_cast<svtkm::Id>(idx));
  }
...
private:
  ...
  SVTKM_EXEC
  svtkm::internal::ArrayPortalValueReference<ArrayPortalType> dereference() const
  {
    return svtkm::internal::ArrayPortalValueReference<ArrayPortalType>(this->Portal, this->Index);
  }
  ...
  SVTKM_EXEC_CONT
  void advance(std::ptrdiff_t delta) { this->Index += static_cast<svtkm::Id>(delta); }
...
//
//But for svtk-m we pass in facade objects, which are passed by value, but
...
template <typename T>
struct is_non_const_reference<svtkm::internal::ArrayPortalValueReference<T>>
...
#endif //svtk_m_exec_cuda_internal_IteratorFromArrayPortal_h
