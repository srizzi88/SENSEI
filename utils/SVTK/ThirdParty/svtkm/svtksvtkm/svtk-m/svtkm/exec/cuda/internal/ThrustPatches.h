...
//============================================================================
#ifndef svtk_m_exec_cuda_internal_ThrustPatches_h
#define svtk_m_exec_cuda_internal_ThrustPatches_h
...
#define ALIGN_RE_T(RT)                                                                             \
  ...
  template <>                                                                                      \
  inline __host__ __device__ RT* aligned_reinterpret_cast(svtkm::UInt8* u)                          \
  {                                                                                                \
    return reinterpret_cast<RT*>(reinterpret_cast<void*>(u));                                      \
  }                                                                                                \
...
#define ALIGN_RE_VEC(RT)                                                                           \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<RT, 2>* aligned_reinterpret_cast(void* u)                   \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<RT, 2>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<RT, 3>* aligned_reinterpret_cast(void* u)                   \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<RT, 3>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<RT, 4>* aligned_reinterpret_cast(void* u)                   \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<RT, 4>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<svtkm::Vec<RT, 3>, 2>* aligned_reinterpret_cast(void* u)     \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<svtkm::Vec<RT, 3>, 2>*>(reinterpret_cast<void*>(u));          \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<svtkm::Vec<RT, 9>, 2>* aligned_reinterpret_cast(void* u)     \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<svtkm::Vec<RT, 9>, 2>*>(reinterpret_cast<void*>(u));          \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<RT, 2>* aligned_reinterpret_cast(svtkm::UInt8* u)            \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<RT, 2>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<RT, 3>* aligned_reinterpret_cast(svtkm::UInt8* u)            \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<RT, 3>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<RT, 4>* aligned_reinterpret_cast(svtkm::UInt8* u)            \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<RT, 4>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<svtkm::Vec<RT, 2>, 2>* aligned_reinterpret_cast(             \
    svtkm::UInt8* u)                                                                                \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<svtkm::Vec<RT, 2>, 2>*>(reinterpret_cast<void*>(u));          \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<svtkm::Vec<RT, 3>, 2>* aligned_reinterpret_cast(             \
    svtkm::UInt8* u)                                                                                \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<svtkm::Vec<RT, 3>, 2>*>(reinterpret_cast<void*>(u));          \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<svtkm::Vec<RT, 4>, 2>* aligned_reinterpret_cast(             \
    svtkm::UInt8* u)                                                                                \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<svtkm::Vec<RT, 4>, 2>*>(reinterpret_cast<void*>(u));          \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Vec<svtkm::Vec<RT, 9>, 2>* aligned_reinterpret_cast(             \
    svtkm::UInt8* u)                                                                                \
  {                                                                                                \
    return reinterpret_cast<svtkm::Vec<svtkm::Vec<RT, 9>, 2>*>(reinterpret_cast<void*>(u));          \
  }                                                                                                \
...
#define ALIGN_RE_PAIR(T, U)                                                                        \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Pair<T, U>* aligned_reinterpret_cast(void* u)                   \
  {                                                                                                \
    return reinterpret_cast<svtkm::Pair<T, U>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  template <>                                                                                      \
  inline __host__ __device__ svtkm::Pair<T, U>* aligned_reinterpret_cast(svtkm::UInt8* u)            \
  {                                                                                                \
    return reinterpret_cast<svtkm::Pair<T, U>*>(reinterpret_cast<void*>(u));                        \
  }                                                                                                \
  struct SwallowSemicolon

#ifndef SVTKM_DONT_FIX_THRUST
ALIGN_RE_T(bool);
ALIGN_RE_T(char);
ALIGN_RE_T(svtkm::Int8);
ALIGN_RE_T(svtkm::UInt8);
ALIGN_RE_T(svtkm::Int16);
ALIGN_RE_T(svtkm::UInt16);
ALIGN_RE_T(svtkm::Int32);
ALIGN_RE_T(svtkm::UInt32);
// Need these for svtk. don't need long long, since those are used for [U]Int64.
ALIGN_RE_T(long);
ALIGN_RE_T(unsigned long);
ALIGN_RE_T(svtkm::Int64);
ALIGN_RE_T(svtkm::UInt64);
ALIGN_RE_T(svtkm::Float32);
ALIGN_RE_T(svtkm::Float64);
#endif

ALIGN_RE_VEC(char);
ALIGN_RE_VEC(svtkm::Int8);
ALIGN_RE_VEC(svtkm::UInt8);
ALIGN_RE_VEC(svtkm::Int16);
ALIGN_RE_VEC(svtkm::UInt16);
ALIGN_RE_VEC(svtkm::Int32);
ALIGN_RE_VEC(svtkm::UInt32);
// Need these for svtk. don't need long long, since those are used for [U]Int64.
ALIGN_RE_VEC(long);
ALIGN_RE_VEC(unsigned long);
ALIGN_RE_VEC(svtkm::Int64);
ALIGN_RE_VEC(svtkm::UInt64);
ALIGN_RE_VEC(svtkm::Float32);
ALIGN_RE_VEC(svtkm::Float64);

ALIGN_RE_PAIR(svtkm::Int32, svtkm::Int32);
ALIGN_RE_PAIR(svtkm::Int32, svtkm::Int64);
ALIGN_RE_PAIR(svtkm::Int32, svtkm::Float32);
ALIGN_RE_PAIR(svtkm::Int32, svtkm::Float64);

ALIGN_RE_PAIR(svtkm::Int64, svtkm::Int32);
ALIGN_RE_PAIR(svtkm::Int64, svtkm::Int64);
ALIGN_RE_PAIR(svtkm::Int64, svtkm::Float32);
ALIGN_RE_PAIR(svtkm::Int64, svtkm::Float64);
...
destructive_accumulate_n(ConcurrentGroup& g,
                         ...
                         Size n,
                         T init,
                         svtkm::exec::cuda::internal::WrappedBinaryOperator<T, F> binary_op)
{
...
#endif //svtk_m_exec_cuda_internal_ThrustPatches_h
