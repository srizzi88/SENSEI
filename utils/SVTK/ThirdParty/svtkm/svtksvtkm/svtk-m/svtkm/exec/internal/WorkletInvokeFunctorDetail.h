...
#ifndef svtk_m_exec_internal_WorkletInvokeFunctorDetail_h
#define svtk_m_exec_internal_WorkletInvokeFunctorDetail_h

#if !defined(svtk_m_exec_internal_TaskSingular_h) && \
    !defined(svtk_m_exec_internal_TaskTiling_h) &&  \
    !defined(svtk_m_exec_cuda_internal_TaskStrided_h) && \
    !defined(SVTKM_TEST_HEADER_BUILD)
...
#if SVTKM_MAX_FUNCTION_PARAMETERS != 20
...
template <typename ThreadIndicesType,
          typename Invocation,
          svtkm::IdComponent ExecutionParameterIndex>
struct InvocationToFetch
{
  ...
  static constexpr svtkm::IdComponent ControlParameterIndex = ExecutionSignatureTag::INDEX;
  ...
  using type = svtkm::exec::arg::Fetch<FetchTag, AspectTag, ThreadIndicesType, ExecObjectType>;

  SVTKM_EXEC static ExecObjectType GetParameterImpl(const Invocation&, std::true_type)
  {
    return typename Invocation::DeviceAdapterTag();
  }

  SVTKM_EXEC static ExecObjectType GetParameterImpl(const Invocation& invocation, std::false_type)
  {
    return svtkm::internal::ParameterGet<ControlParameterIndex>(invocation.Parameters);
  }

  SVTKM_EXEC static ExecObjectType GetParameter(const Invocation& invocation)
  {
...
template <typename WorkletType,
          ...
          svtkm::IdComponent InputDomainIndex,
          ...
          typename R,
          typename P1>
SVTKM_EXEC void DoWorkletInvokeFunctor(
  const WorkletType& worklet,
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1)>,
                                   InputDomainIndex,
...
{
  using Invocation =  svtkm::internal::Invocation<ParameterInterface,
                                                 ControlInterface,
                                                 svtkm::internal::FunctionInterface<R(P1)>,
                                                 InputDomainIndex,
                                                 OutputToInputMapType,
  ...
  // the actual type that SVTK-m creates in the execution environment. Make sure
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
{
  using Invocation =
    svtkm::internal::Invocation<ParameterInterface,
                               ControlInterface,
                               svtkm::internal::FunctionInterface<void(P1)>,
                               InputDomainIndex,
                               OutputToInputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<R(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
SVTKM_EXEC void DoWorkletInvokeFunctor(
  ...
  const svtkm::internal::Invocation<ParameterInterface,
                                   ControlInterface,
                                   svtkm::internal::FunctionInterface<void(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20)>,
                                   InputDomainIndex,
                                   OutputToInputMapType,
                                   VisitArrayType,
                                   ThreadToOutputMapType,
...
} // namespace svtkm::exec::internal::detail

#endif //svtk_m_exec_internal_WorkletInvokeFunctorDetail_h
