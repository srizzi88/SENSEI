...
#ifndef svtk_m_filter_DotProduct_h
#define svtk_m_filter_DotProduct_h
...
class DotProduct : public svtkm::filter::FilterField<DotProduct>
{
public:
  ...
  SVTKM_CONT const std::string& GetPrimaryFieldName() const { return this->SecondaryFieldName; }
  ...
  SVTKM_CONT const std::string& GetSecondaryFieldName() const { return this->GetActiveFieldName(); }
...
#include <svtkm/filter/DotProduct.hxx>

#endif // svtk_m_filter_DotProduct_h
