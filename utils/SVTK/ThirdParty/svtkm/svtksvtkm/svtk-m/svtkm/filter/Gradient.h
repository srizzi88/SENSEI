...
#ifndef svtk_m_filter_Gradient_h
#define svtk_m_filter_Gradient_h
...
class Gradient : public svtkm::filter::FilterCell<Gradient>
{
public:
...
#include <svtkm/filter/Gradient.hxx>

#endif // svtk_m_filter_Gradient_h
