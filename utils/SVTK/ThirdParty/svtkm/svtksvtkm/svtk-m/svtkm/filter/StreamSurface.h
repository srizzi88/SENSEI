...
#ifndef svtk_m_filter_StreamSurface_h
#define svtk_m_filter_StreamSurface_h
...
class StreamSurface : public svtkm::filter::FilterDataSetWithField<StreamSurface>
{
public:
  ...
  SVTKM_CONT
  void SetSeeds(svtkm::cont::ArrayHandle<svtkm::Particle>& seeds) { this->Seeds = seeds; }
...
private:
  ...
  svtkm::worklet::StreamSurface Worklet;
};
}
} // namespace svtkm::filter

#include <svtkm/filter/StreamSurface.hxx>

#endif // svtk_m_filter_StreamSurface_h
