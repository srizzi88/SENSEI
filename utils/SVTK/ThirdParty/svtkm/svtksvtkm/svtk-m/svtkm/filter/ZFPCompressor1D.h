...
#ifndef svtk_m_filter_ZFPCompressor1D_h
#define svtk_m_filter_ZFPCompressor1D_h
...
class ZFPCompressor1D : public svtkm::filter::FilterField<ZFPCompressor1D>
{
public:
...
#include <svtkm/filter/ZFPCompressor1D.hxx>

#endif // svtk_m_filter_ZFPCompressor1D_h
