...
#ifndef svtk_m_filter_ZFPCompressor3D_h
#define svtk_m_filter_ZFPCompressor3D_h
...
class ZFPCompressor3D : public svtkm::filter::FilterField<ZFPCompressor3D>
{
public:
...
#include <svtkm/filter/ZFPCompressor3D.hxx>

#endif // svtk_m_filter_ZFPCompressor3D_h
