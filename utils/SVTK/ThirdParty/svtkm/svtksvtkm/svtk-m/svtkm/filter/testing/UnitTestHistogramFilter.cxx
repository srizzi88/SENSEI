...
//
void VerifyHistogram(const svtkm::cont::DataSet& result,
                     svtkm::Id numberOfBins,
                     const svtkm::Range& range,
                     svtkm::Float64 delta,
                     bool output = true)
{
  SVTKM_TEST_ASSERT(result.HasField("histogram"), "Output field missing");
...
{
  return svtkm::cont::testing::Testing::Run(TestHistogram, argc, argv);
}
