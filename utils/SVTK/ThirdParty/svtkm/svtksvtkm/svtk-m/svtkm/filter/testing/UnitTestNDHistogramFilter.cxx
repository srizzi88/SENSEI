...
void RunTest()
{
  ...
  svtkm::filter::NDHistogram ndHistFilter;
  ...
  svtkm::cont::DataSet outputData = ndHistFilter.Execute(ds);
  ...
  // Check result
  svtkm::Id nonSparseBins = outputData.GetField(0).GetNumberOfValues();
  SVTKM_TEST_ASSERT(nonSparseBins == gtNonSparseBins, "Incorrect ND-histogram Filter results");

  svtkm::cont::ArrayHandle<svtkm::Id> binId0;
  outputData.GetField("fieldA").GetData().CopyTo(binId0);
  svtkm::cont::ArrayHandle<svtkm::Id> binId1;
  outputData.GetField("fieldB").GetData().CopyTo(binId1);
  svtkm::cont::ArrayHandle<svtkm::Id> binId2;
  ...
  {
    svtkm::Id idx0 = binId0.GetPortalControl().Get(i);
    svtkm::Id idx1 = binId1.GetPortalControl().Get(i);
    svtkm::Id idx2 = binId2.GetPortalControl().Get(i);
