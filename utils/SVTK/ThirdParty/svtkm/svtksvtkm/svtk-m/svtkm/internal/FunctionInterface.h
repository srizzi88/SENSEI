...
//============================================================================
#ifndef svtk_m_internal_FunctionInterface_h
#define svtk_m_internal_FunctionInterface_h

#include <svtkm/Types.h>

#include <svtkm/internal/FunctionInterfaceDetailPre.h>
...
///
/// To make SVTK-m easier for the end user developer, the
...
///
/// \code{.cpp}
/// svtkm::internal::FunctionInterface<void(svtkm::IdComponent,double,char)> functionInterface =
///     svtkm::internal::make_FunctionInterface<void>(1, 2.5, 'a');
/// \endcode
///
...
public:
  ...
  template <svtkm::IdComponent ParameterIndex>
  ...
  ///   template<typename T, svtkm::IdComponent Index>
  ///   SVTKM_CONT
  ///   const T *operator()(const T &x, svtkm::internal::IndexTag<Index>) const {
  ///     return &x;
  ///   }
  /// };
  ///
  /// template<typename FunctionSignature>
  /// typename svtkm::internal::FunctionInterface<FunctionSignature>::template StaticTransformType<MyTransformFunctor>::type
  /// ImportantStuff(const svtkm::internal::FunctionInterface<FunctionSignature> &funcInterface)
  /// {
  ...
  ///
  template <typename Transform>
  SVTKM_CONT typename StaticTransformType<Transform>::type StaticTransformCont(
...
/// void Foo(const svtkm::internal::FunctionInterface<FunctionSignature> &fInterface)
/// {
///   bar( ParameterGet<2>(fInterface) );
/// }
/// \endcode
///
template <svtkm::IdComponent ParameterIndex, typename FunctionSignature>
SVTKM_EXEC_CONT auto ParameterGet(const FunctionInterface<FunctionSignature>& fInterface)
  -> decltype(detail::ParameterGet(fInterface.Parameters,
                                   svtkm::internal::IndexTag<ParameterIndex>{}))
{
  return detail::ParameterGet(fInterface.Parameters, svtkm::internal::IndexTag<ParameterIndex>{});
}
...
///
/// \code{.cpp}
/// svtkm::internal::FunctionInterface<void(int,double,char)> functionInterface =
///     svtkm::internal::make_FunctionInterface<void>(1, 2.5, 'a');
/// \endcode
///
...
#include <svtkm/internal/FunctionInterfaceDetailPost.h>

#endif //svtk_m_internal_FunctionInterface_h
