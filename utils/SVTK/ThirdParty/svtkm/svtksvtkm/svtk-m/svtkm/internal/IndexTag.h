...
//============================================================================
#ifndef svtk_m_internal_StaticIndex_h
#define svtk_m_internal_StaticIndex_h
...
struct IndexTag
{
  static constexpr svtkm::IdComponent INDEX = Index;
};
}
} // namespace svtkm::internal

#endif //svtk_m_internal_StaticIndex_h
