...
//============================================================================
#ifndef svtk_m_internal_Invocation_h
#define svtk_m_internal_Invocation_h
...
template <typename ParameterInterface_,
          ...
          svtkm::IdComponent InputDomainIndex_,
          typename OutputToInputMapType_ = svtkm::internal::NullType,
          typename VisitArrayType_ = svtkm::internal::NullType,
          typename ThreadToOutputMapType_ = svtkm::internal::NullType,
          typename DeviceAdapterTag_ = svtkm::internal::NullType>
struct Invocation
{
  ...
  ///
  static constexpr svtkm::IdComponent InputDomainIndex = InputDomainIndex_;
  ...
  ///
  template <typename NewParameterInterface>
  SVTKM_CONT typename ChangeParametersType<NewParameterInterface>::type ChangeParameters(
  ...
  ///
  template <svtkm::IdComponent NewInputDomainIndex>
  ...
  ///
  template <svtkm::IdComponent NewInputDomainIndex>
  SVTKM_EXEC_CONT typename ChangeInputDomainIndexType<NewInputDomainIndex>::type
  ...
  ///
  template <typename NewOutputToInputMapType>
  SVTKM_CONT typename ChangeOutputToInputMapType<NewOutputToInputMapType>::type
  ...
  ///
  template <typename NewVisitArrayType>
  SVTKM_CONT typename ChangeVisitArrayType<NewVisitArrayType>::type ChangeVisitArray(
  ...
  ///
  template <typename NewThreadToOutputMapType>
  SVTKM_CONT typename ChangeThreadToOutputMapType<NewThreadToOutputMapType>::type
  ...
  ///
  template <typename NewDeviceAdapterTag>
  SVTKM_CONT typename ChangeDeviceAdapterTagType<NewDeviceAdapterTag>::type ChangeDeviceAdapterTag(
  ...
  {
    return svtkm::internal::ParameterGet<InputDomainIndex>(this->Parameters);
  }
...
///
template <svtkm::IdComponent InputDomainIndex,
...
SVTKM_CONT svtkm::internal::Invocation<ParameterInterface,
                                     ControlInterface,
                                     ExecutionInterface,
                                     InputDomainIndex,
                                     OutputToInputMapType,
...
make_Invocation(const ParameterInterface& params,
                ...
                ThreadToOutputMapType threadToOutputMap)
{
  return svtkm::internal::Invocation<ParameterInterface,
                                    ControlInterface,
                                    ExecutionInterface,
                                    InputDomainIndex,
                                    OutputToInputMapType,
...
{
  return svtkm::internal::make_Invocation<InputDomainIndex>(params,
                                                           ControlInterface(),
                                                           ExecutionInterface(),
...
#endif //svtk_m_internal_Invocation_h
