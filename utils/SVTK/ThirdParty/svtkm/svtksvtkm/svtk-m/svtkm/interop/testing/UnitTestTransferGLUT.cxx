...
#if defined(SVTKM_GCC) && defined(SVTKM_POSIX) && !defined(__APPLE__)
//
...
#include <iostream>
#include <pthread.h>
#define SVTKM_NVIDIA_PTHREAD_WORKAROUND 1
static int svtkm_force_linking_to_pthread_to_fix_nvidia_libgl_bug()
{
...
#if defined(SVTKM_NVIDIA_PTHREAD_WORKAROUND)
  std::cout << ::svtkm_force_linking_to_pthread_to_fix_nvidia_libgl_bug();
#endif
