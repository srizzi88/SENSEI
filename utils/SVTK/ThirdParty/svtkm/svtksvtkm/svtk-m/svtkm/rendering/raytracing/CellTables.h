...
//============================================================================
#ifndef svtk_m_rendering_raytracing_CellTables_h
#define svtk_m_rendering_raytracing_CellTables_h
...
struct CellTables
{
  ...
  SVTKM_EXEC svtkm::Int32 CellTypeLookUp(svtkm::Int32 x) const
  {
    SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::Int32 lookup[15] = {
      4, // 0 Nothing
      4, // 1 Vertex
  ...
  // FaceLookUp
  SVTKM_EXEC svtkm::Int32 FaceLookUp(svtkm::Int32 x, svtkm::Int32 y) const
  {
    SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::Int32 faces[5][3] = {
  ...
  SVTKM_EXEC svtkm::Int32 ShapesFaceList(svtkm::Int32 x, svtkm::Int32 y) const
  {
    SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::Int32 shapes[20][5] = {                    //hex
                                                              { 4, 0, 1, 5, 4 }, //face 0
                                                              { 4, 1, 2, 6, 5 },
                                                              { 4, 3, 7, 6, 2 },
                                                              { 4, 0, 4, 7, 3 },
  ...
  SVTKM_EXEC svtkm::Int32 ZooTable(svtkm::Int32 x, svtkm::Int32 y) const
  {
    SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::Int32 zoo[30][4] = {
      { 0, 0, 1, 5 }, // hex
  ...
  //
  SVTKM_EXEC svtkm::Int32 ZooLookUp(svtkm::Int32 x, svtkm::Int32 y) const
  {
    SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::Int32 zoo[5][2] = {
