...
struct VecFromPortalTestFunctor
{
  ...
  void operator()(T) const
  {
    ...
    {
      for (svtkm::IdComponent length = 0; length < ARRAY_SIZE - offset; length++)
      {
...
{
  svtkm::testing::Testing::TryTypes(VecFromPortalTestFunctor(), svtkm::TypeListCommon());
}
...
{
  return svtkm::testing::Testing::Run(UnitTestVecFromPortalNamespace::VecFromPortalTest, argc, argv);
}
