#ifndef SVTKMDIY_MPI_DATATYPES_HPP
#define SVTKMDIY_MPI_DATATYPES_HPP
...
#define SVTKMDIY_MPI_DATATYPE_MAP(cpp_type, mpi_type) \
  ...
  SVTKMDIY_MPI_DATATYPE_MAP(char,                  MPI_BYTE);
  SVTKMDIY_MPI_DATATYPE_MAP(unsigned char,         MPI_BYTE);
  SVTKMDIY_MPI_DATATYPE_MAP(bool,                  MPI_BYTE);
  SVTKMDIY_MPI_DATATYPE_MAP(int,                   MPI_INT);
  SVTKMDIY_MPI_DATATYPE_MAP(unsigned,              MPI_UNSIGNED);
  SVTKMDIY_MPI_DATATYPE_MAP(long,                  MPI_LONG);
  SVTKMDIY_MPI_DATATYPE_MAP(unsigned long,         MPI_UNSIGNED_LONG);
  SVTKMDIY_MPI_DATATYPE_MAP(long long,             MPI_LONG_LONG_INT);
  SVTKMDIY_MPI_DATATYPE_MAP(unsigned long long,    MPI_UNSIGNED_LONG_LONG);
  SVTKMDIY_MPI_DATATYPE_MAP(float,                 MPI_FLOAT);
  SVTKMDIY_MPI_DATATYPE_MAP(double,                MPI_DOUBLE);
