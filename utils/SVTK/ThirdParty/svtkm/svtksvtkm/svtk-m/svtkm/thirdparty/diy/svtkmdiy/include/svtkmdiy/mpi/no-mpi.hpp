#ifndef SVTKMDIY_MPI_NO_MPI_HPP
#define SVTKMDIY_MPI_NO_MPI_HPP
...
#define SVTKM_DIY_NO_MPI_DATATYPE(cpp_type, mpi_type) \
  static const MPI_Datatype mpi_type = sizeof(cpp_type);
SVTKM_DIY_NO_MPI_DATATYPE(char,                  MPI_BYTE);
SVTKM_DIY_NO_MPI_DATATYPE(int,                   MPI_INT);
SVTKM_DIY_NO_MPI_DATATYPE(unsigned,              MPI_UNSIGNED);
SVTKM_DIY_NO_MPI_DATATYPE(long,                  MPI_LONG);
SVTKM_DIY_NO_MPI_DATATYPE(unsigned long,         MPI_UNSIGNED_LONG);
SVTKM_DIY_NO_MPI_DATATYPE(long long,             MPI_LONG_LONG_INT);
SVTKM_DIY_NO_MPI_DATATYPE(unsigned long long,    MPI_UNSIGNED_LONG_LONG);
SVTKM_DIY_NO_MPI_DATATYPE(float,                 MPI_FLOAT);
SVTKM_DIY_NO_MPI_DATATYPE(double,                MPI_DOUBLE);
#endif
...
#define DIY_UNSUPPORTED_MPI_CALL(name) \
  throw std::runtime_error("`" #name "` not supported when SVTKM_DIY_NO_MPI is defined.");
#endif
