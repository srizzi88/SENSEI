...
//============================================================================
#ifndef svtk_m_worklet_zfp_1d_compressor_h
#define svtk_m_worklet_zfp_1d_compressor_h
...
#include <svtkm/worklet/zfp/ZFPEncode1.h>
...
public:
    ...
    const svtkm::Id dims)
  {
    ...
    const svtkm::Id totalBlocks = (paddedDims / four);
    ...
    //    Timer timer;
    svtkm::worklet::DispatcherMapField<zfp::Encode1> compressDispatcher(
...
#endif //  svtk_m_worklet_zfp_1d_compressor_h
