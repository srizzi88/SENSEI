...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_cellmetrics_CellDimensionMetric_h
#define svtk_m_worklet_cellmetrics_CellDimensionMetric_h
...
SVTKM_EXEC OutType CellDimensionMetric(const svtkm::IdComponent& numPts,
                                      ...
                                      const svtkm::exec::FunctorBase& worklet)
{
  ...
  OutType aspect = (OutType).5 * svtkm::Pow(volume, two) /
    (svtkm::Pow(gradop[0][0], two) + svtkm::Pow(gradop[1][0], two) + svtkm::Pow(gradop[2][0], two) +
     svtkm::Pow(gradop[3][0], two) + svtkm::Pow(gradop[4][0], two) + svtkm::Pow(gradop[5][0], two) +
     svtkm::Pow(gradop[6][0], two) + svtkm::Pow(gradop[7][0], two) + svtkm::Pow(gradop[0][1], two) +
     svtkm::Pow(gradop[1][1], two) + svtkm::Pow(gradop[2][1], two) + svtkm::Pow(gradop[3][1], two) +
     svtkm::Pow(gradop[4][1], two) + svtkm::Pow(gradop[5][1], two) + svtkm::Pow(gradop[6][1], two) +
     svtkm::Pow(gradop[7][1], two) + svtkm::Pow(gradop[0][2], two) + svtkm::Pow(gradop[1][2], two) +
     svtkm::Pow(gradop[2][2], two) + svtkm::Pow(gradop[3][2], two) + svtkm::Pow(gradop[4][2], two) +
     svtkm::Pow(gradop[5][2], two) + svtkm::Pow(gradop[6][2], two) + svtkm::Pow(gradop[7][2], two));

  return svtkm::Sqrt(aspect);
}
...
#endif // svtk_m_worklet_cellmetrics_CellDimensionMetric_h
