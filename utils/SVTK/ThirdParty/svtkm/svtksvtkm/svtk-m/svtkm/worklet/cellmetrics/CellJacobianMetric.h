...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_cellmetrics_Jacobian_h
#define svtk_m_worklet_cellmetrics_Jacobian_h
...
SVTKM_EXEC OutType CellJacobianMetric(const svtkm::IdComponent& numPts,
                                     ...
                                     const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar q = svtkm::Min(alpha0, svtkm::Min(alpha1, svtkm::Min(alpha2, alpha3)));
    ...
    svtkm::Min(
      ...
      svtkm::Min(
        ...
        svtkm::Min(
          alpha3,
          svtkm::Min(alpha4,
                    svtkm::Min(alpha5, svtkm::Min(alpha6, svtkm::Min(alpha7, alpha8Div64))))))));
                                     ...
                                     const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar q = svtkm::Dot(svtkm::Cross(L2, L0), L3);
...
#endif // svtk_m_worklet_cellmetrics_CellJacobianMetric_h
