...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_cellmetrics_CellMaxAngleMetric_h
#define svtk_m_worklet_cellmetrics_CellMaxAngleMetric_h
...
SVTKM_EXEC OutType CellMaxAngleMetric(const svtkm::IdComponent& numPts,
                                     ...
                                     const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar q = svtkm::Max(q0, svtkm::Max(q1, q2));
...
#endif // svtk_m_worklet_cellmetrics_CellMaxAngleMetric_h
