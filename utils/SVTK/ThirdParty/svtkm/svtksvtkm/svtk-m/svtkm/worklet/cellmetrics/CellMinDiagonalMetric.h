...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_cellmetrics_Min_Diagonal_h
#define svtk_m_worklet_cellmetrics_Min_Diagonal_h
...
SVTKM_EXEC OutType CellMinDiagonalMetric(const svtkm::IdComponent& numPts,
                                        ...
                                        const svtkm::exec::FunctorBase& worklet)
{
  ...
  for (i = 1; i < 4; i++)
  {
    diagonal = svtkm::Min(diagonal, diag[i]);
  }
