...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_CellShapeMetric_h
#define svtk_m_worklet_CellShapeMetric_h
/*
...
SVTKM_EXEC OutType CellShapeMetric(const svtkm::IdComponent& numPts,
                                  ...
                                  const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar condition =
    svtkm::worklet::cellmetrics::CellConditionMetric<Scalar, CollectionOfPoints>(
      numPts, pts, svtkm::CellShapeTagTriangle(), worklet);
                                  ...
                                  const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar l0Squared =
    svtkm::Pow(GetQuadL0Magnitude<Scalar, Vector, CollectionOfPoints>(pts), 2);
  const Scalar l1Squared =
    svtkm::Pow(GetQuadL1Magnitude<Scalar, Vector, CollectionOfPoints>(pts), 2);
  const Scalar l2Squared =
    svtkm::Pow(GetQuadL2Magnitude<Scalar, Vector, CollectionOfPoints>(pts), 2);
  const Scalar l3Squared =
    svtkm::Pow(GetQuadL3Magnitude<Scalar, Vector, CollectionOfPoints>(pts), 2);

  const Scalar min = svtkm::Min(
    (alpha0 / (l0Squared + l3Squared)),
    svtkm::Min((alpha1 / (l1Squared + l0Squared)),
              svtkm::Min((alpha2 / (l2Squared + l1Squared)), (alpha3 / (l3Squared + l2Squared)))));
                                  ...
                                  const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar rtTwo = (Scalar)(svtkm::Sqrt(2.0));
  const Scalar three(3.0);
  const Scalar jacobian =
    svtkm::worklet::cellmetrics::CellJacobianMetric<Scalar, CollectionOfPoints>(
      numPts, pts, svtkm::CellShapeTagTetra(), worklet);
  ...
  const Scalar l0l0 = svtkm::Dot(l0, l0);
  const Scalar l2l2 = svtkm::Dot(l2, l2);
  const Scalar l3l3 = svtkm::Dot(l3, l3);
  const Scalar l0negl2 = svtkm::Dot(l0, negl2);
  const Scalar l0l3 = svtkm::Dot(l0, l3);
  const Scalar negl2l3 = svtkm::Dot(negl2, l3);

  const Scalar numerator = three * svtkm::Pow(jacobian * rtTwo, twoThirds);
                                  ...
                                  const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar alpha0 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(0));
  const Scalar alpha1 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(1));
  const Scalar alpha2 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(2));
  const Scalar alpha3 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(3));
  const Scalar alpha4 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(4));
  const Scalar alpha5 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(5));
  const Scalar alpha6 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(6));
  const Scalar alpha7 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(7));
  const Scalar alpha8 = GetHexAlphai<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(8));

  const Scalar A0squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(0));
  const Scalar A1squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(1));
  const Scalar A2squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(2));
  const Scalar A3squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(3));
  const Scalar A4squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(4));
  const Scalar A5squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(5));
  const Scalar A6squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(6));
  const Scalar A7squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(7));
  const Scalar A8squared =
    GetHexAiNormSquared<Scalar, Vector, CollectionOfPoints>(pts, svtkm::Id(8));
  ...
  Scalar min = svtkm::Pow(alpha0, twoThirds) / A0squared;
  Scalar temp = svtkm::Pow(alpha1, twoThirds) / A1squared;
  min = temp < min ? temp : min;

  temp = svtkm::Pow(alpha2, twoThirds) / A2squared;
  min = temp < min ? temp : min;

  temp = svtkm::Pow(alpha3, twoThirds) / A3squared;
  min = temp < min ? temp : min;

  temp = svtkm::Pow(alpha4, twoThirds) / A4squared;
  min = temp < min ? temp : min;

  temp = svtkm::Pow(alpha5, twoThirds) / A5squared;
  min = temp < min ? temp : min;

  temp = svtkm::Pow(alpha6, twoThirds) / A6squared;
  min = temp < min ? temp : min;

  temp = svtkm::Pow(alpha7, twoThirds) / A7squared;
  min = temp < min ? temp : min;

  temp = svtkm::Pow(alpha8, twoThirds) / A8squared;
  min = temp < min ? temp : min;
  // determine the shape
  Scalar q(3 * min);
  return q;
...
#endif // svtk_m_worklet_CellShapeMetric_h
