...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_cellmetrics_CellStretchMetric_h
#define svtk_m_worklet_cellmetrics_CellStretchMetric_h
...
SVTKM_EXEC OutType CellStretchMetric(const svtkm::IdComponent& numPts,
                                    ...
                                    const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar root2 = svtkm::Sqrt(Scalar(2.0));
                                    ...
                                    const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar root3 = svtkm::Sqrt(Scalar(3.0));
...
#endif // svtk_m_worklet_cellmetrics_CellStretchMetric_h
