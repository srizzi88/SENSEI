...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_CellWarpageMetric_h
#define svtk_m_worklet_CellWarpageMetric_h
...
SVTKM_EXEC OutType CellWarpageMetric(const svtkm::IdComponent& numPts,
                                    ...
                                    const svtkm::exec::FunctorBase& worklet)
{
  ...
  const Scalar n0dotn2 = svtkm::Dot(N0Mag, N2Mag);
  const Scalar n1dotn3 = svtkm::Dot(N1Mag, N3Mag);
  const Scalar min = svtkm::Min(n0dotn2, n1dotn3);

  const Scalar minCubed = svtkm::Pow(min, 3);
...
#endif // svtk_m_worklet_CellWarpage_Metric_h
