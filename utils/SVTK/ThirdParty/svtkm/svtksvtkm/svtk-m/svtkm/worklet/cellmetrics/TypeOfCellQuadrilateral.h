...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_cellmetrics_TypeOfCellQuadrilateral
#define svtk_m_worklet_cellmetrics_TypeOfCellQuadrilateral
/**
...
SVTKM_EXEC Vector GetQuadL0(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadL1(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadL2(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadL3(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadL0Magnitude(const CollectionOfPoints& pts)
{
  const Scalar l0 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetQuadL0<Scalar, Vector, CollectionOfPoints>(pts)));
  return l0;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadL1Magnitude(const CollectionOfPoints& pts)
{
  const Scalar l1 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetQuadL1<Scalar, Vector, CollectionOfPoints>(pts)));
  return l1;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadL2Magnitude(const CollectionOfPoints& pts)
{
  const Scalar l2 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetQuadL2<Scalar, Vector, CollectionOfPoints>(pts)));
  return l2;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadL3Magnitude(const CollectionOfPoints& pts)
{
  const Scalar l3 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetQuadL3<Scalar, Vector, CollectionOfPoints>(pts)));
  return l3;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadLMax(const CollectionOfPoints& pts)
{
  ...
  const Scalar lmax = svtkm::Max(l0, svtkm::Max(l1, svtkm::Max(l2, l3)));
  return lmax;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadLMin(const CollectionOfPoints& pts)
{
  const Scalar l0 = GetQuadL0Magnitude<Scalar, Vector, CollectionOfPoints>(pts);
  const Scalar l1 = GetQuadL1Magnitude<Scalar, Vector, CollectionOfPoints>(pts);
  const Scalar l2 = GetQuadL2Magnitude<Scalar, Vector, CollectionOfPoints>(pts);
  const Scalar l3 = GetQuadL3Magnitude<Scalar, Vector, CollectionOfPoints>(pts);
  const Scalar lmin = svtkm::Min(l0, svtkm::Min(l1, svtkm::Min(l2, l3)));
  return lmin;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadD0(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadD1(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadD0Magnitude(const CollectionOfPoints& pts)
{
  const Scalar d0 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetQuadD0<Scalar, Vector, CollectionOfPoints>(pts)));
  return d0;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadD1Magnitude(const CollectionOfPoints& pts)
{
  const Scalar d1 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetQuadD1<Scalar, Vector, CollectionOfPoints>(pts)));
  return d1;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadDMax(const CollectionOfPoints& pts)
{
  ...
  const Scalar dmax = svtkm::Max(d0, d1);
  return dmax;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadX0(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadX1(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN0(const CollectionOfPoints& pts)
{
  ...
  const Vector N0 = svtkm::Cross(A, B);
  return N0;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN1(const CollectionOfPoints& pts)
{
  ...
  const Vector N1 = svtkm::Cross(A, B);
  return N1;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN2(const CollectionOfPoints& pts)
{
  ...
  const Vector N2 = svtkm::Cross(A, B);
  return N2;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN3(const CollectionOfPoints& pts)
{
  ...
  const Vector N3 = svtkm::Cross(A, B);
  return N3;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadNc(const CollectionOfPoints& pts)
{
  ...
  const Vector Nc = svtkm::Cross(A, B);
  return Nc;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN0Normalized(const CollectionOfPoints& pts)
{
  return svtkm::Normal(GetQuadN0<Scalar, Vector, CollectionOfPoints>(pts));
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN1Normalized(const CollectionOfPoints& pts)
{
  return svtkm::Normal(GetQuadN1<Scalar, Vector, CollectionOfPoints>(pts));
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN2Normalized(const CollectionOfPoints& pts)
{
  return svtkm::Normal(GetQuadN2<Scalar, Vector, CollectionOfPoints>(pts));
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadN3Normalized(const CollectionOfPoints& pts)
{
  return svtkm::Normal(GetQuadN3<Scalar, Vector, CollectionOfPoints>(pts));
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetQuadNcNormalized(const CollectionOfPoints& pts)
{
  return svtkm::Normal(GetQuadNc<Scalar, Vector, CollectionOfPoints>(pts));
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadAlpha0(const CollectionOfPoints& pts)
{
  ...
  return svtkm::Dot(normalizedCenterNormal, N0);
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadAlpha1(const CollectionOfPoints& pts)
{
  const Vector normalizedCenterNormal =
    GetQuadNcNormalized<Scalar, Vector, CollectionOfPoints>(pts);
  const Vector N1 = GetQuadN1<Scalar, Vector, CollectionOfPoints>(pts);
  return svtkm::Dot(normalizedCenterNormal, N1);
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadAlpha2(const CollectionOfPoints& pts)
{
  const Vector normalizedCenterNormal =
    GetQuadNcNormalized<Scalar, Vector, CollectionOfPoints>(pts);
  const Vector N2 = GetQuadN2<Scalar, Vector, CollectionOfPoints>(pts);
  return svtkm::Dot(normalizedCenterNormal, N2);
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadAlpha3(const CollectionOfPoints& pts)
{
  const Vector normalizedCenterNormal =
    GetQuadNcNormalized<Scalar, Vector, CollectionOfPoints>(pts);
  const Vector N3 = GetQuadN3<Scalar, Vector, CollectionOfPoints>(pts);
  return svtkm::Dot(normalizedCenterNormal, N3);
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetQuadArea(const CollectionOfPoints& pts)
{
