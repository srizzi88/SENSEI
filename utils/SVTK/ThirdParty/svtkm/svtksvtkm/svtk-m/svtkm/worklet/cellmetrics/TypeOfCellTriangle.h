...
//  this software.
//============================================================================
#ifndef svtk_m_worklet_cellmetrics_TypeOfCellTriangle
#define svtk_m_worklet_cellmetrics_TypeOfCellTriangle
/**
...
SVTKM_EXEC Vector GetTriangleL0(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetTriangleL1(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Vector GetTriangleL2(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleL0Magnitude(const CollectionOfPoints& pts)
{
  const Scalar l0 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetTriangleL0<Scalar, Vector, CollectionOfPoints>(pts)));
  return l0;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleL1Magnitude(const CollectionOfPoints& pts)
{
  const Scalar l1 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetTriangleL1<Scalar, Vector, CollectionOfPoints>(pts)));
  return l1;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleL2Magnitude(const CollectionOfPoints& pts)
{
  const Scalar l2 =
    svtkm::Sqrt(svtkm::MagnitudeSquared(GetTriangleL2<Scalar, Vector, CollectionOfPoints>(pts)));
  return l2;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleLMax(const CollectionOfPoints& pts)
{
  ...
  const Scalar lmax = svtkm::Max(l0, svtkm::Max(l1, l2));
  return lmax;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleLMin(const CollectionOfPoints& pts)
{
  const Scalar l0 = GetTriangleL0Magnitude<Scalar, Vector, CollectionOfPoints>(pts);
  const Scalar l1 = GetTriangleL1Magnitude<Scalar, Vector, CollectionOfPoints>(pts);
  const Scalar l2 = GetTriangleL2Magnitude<Scalar, Vector, CollectionOfPoints>(pts);
  const Scalar lmin = svtkm::Min(l0, svtkm::Min(l1, l2));
  return lmin;
}
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleArea(const CollectionOfPoints& pts)
{
  ...
  const Scalar crossProductMagnitude = svtkm::Sqrt(svtkm::MagnitudeSquared(svtkm::Cross(L0, L1)));
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleInradius(const CollectionOfPoints& pts)
{
 ...
 */
template <typename Scalar, typename Vector, typename CollectionOfPoints>
SVTKM_EXEC Scalar GetTriangleCircumradius(const CollectionOfPoints& pts)
{
