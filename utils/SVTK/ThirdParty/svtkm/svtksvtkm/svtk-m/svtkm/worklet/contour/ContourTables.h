...
//============================================================================
#ifndef svtk_m_ContourTable_h
#define svtk_m_ContourTable_h
...
// clang-format off
SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent NumVerticesPerCellTable[] = {
...
SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent NumTrianglesTableOffset[] = {
  0, //  CELL_SHAPE_EMPTY = 0,
  0, //  CELL_SHAPE_VERTEX = 1,
  0, //  CELL_SHAPE_POLY_VERTEX = 2,
  0, //  CELL_SHAPE_LINE = 3,
...
SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent NumTrianglesTable[] = {
...
SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent EdgeTable[] = {
...
SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent EdgeTableOffset[] = {
  0, //  CELL_SHAPE_EMPTY = 0,
  0, //  CELL_SHAPE_VERTEX = 1,
  0, //  CELL_SHAPE_POLY_VERTEX = 2,
  0, //  CELL_SHAPE_LINE = 3,
...
SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent TriangleTable[] = {
#define X -1
  // CELL_SHAPE_TETRA, 16 cases, 7 edges/cases, 112 entries total
  // FIXME, this is different winding rule than SVTK
  X, X, X, X, X, X, X,
  0, 3, 2, X, X, X, X,
  0, 1, 4, X, X, X, X,
  1, 4, 2, 2, 4, 3, X,
...
SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent TriangleTableOffset[] = {
  0, //  CELL_SHAPE_EMPTY = 0,
  0, //  CELL_SHAPE_VERTEX = 1,
  0, //  CELL_SHAPE_POLY_VERTEX = 2,
  0, //  CELL_SHAPE_LINE = 3,
...
// clang-format on
class CellClassifyTable : public svtkm::cont::ExecutionObjectBase
{
public:
  ...
  public:
    SVTKM_EXEC
    svtkm::IdComponent GetNumVerticesPerCell(svtkm::Id shape) const
    {
      return this->NumVerticesPerCellPortal.Get(shape);
    }

    SVTKM_EXEC
    svtkm::IdComponent GetNumTriangles(svtkm::Id shape, svtkm::IdComponent caseNumber) const
    {
      svtkm::IdComponent offset = this->NumTrianglesTableOffsetPortal.Get(shape);
      return this->NumTrianglesTablePortal.Get(offset + caseNumber);
    }

  private:
    typename svtkm::cont::ArrayHandle<svtkm::IdComponent>::ExecutionTypes<DeviceAdapter>::PortalConst
  ...
  CellClassifyTable()
    : NumVerticesPerCellArray(
        svtkm::cont::make_ArrayHandle(NumVerticesPerCellTable, svtkm::NUMBER_OF_CELL_SHAPES))
    , NumTrianglesTableOffsetArray(
        svtkm::cont::make_ArrayHandle(NumTrianglesTableOffset, svtkm::NUMBER_OF_CELL_SHAPES))
    , NumTrianglesTableArray(
        svtkm::cont::make_ArrayHandle(NumTrianglesTable,
...
private:
  svtkm::cont::ArrayHandle<svtkm::IdComponent> NumVerticesPerCellArray;
  svtkm::cont::ArrayHandle<svtkm::IdComponent> NumTrianglesTableOffsetArray;
  svtkm::cont::ArrayHandle<svtkm::IdComponent> NumTrianglesTableArray;
};

class TriangleGenerationTable : public svtkm::cont::ExecutionObjectBase
{
public:
  template <typename DeviceAdapter>
  class ExecObject
  ...
  public:
    SVTKM_EXEC
    svtkm::Pair<svtkm::IdComponent, svtkm::IdComponent> GetEdgeVertices(
      svtkm::Id shape,
      svtkm::IdComponent caseNumber,
      svtkm::IdComponent triangleNumber,
      svtkm::IdComponent vertexNumber) const
    {
      SVTKM_STATIC_CONSTEXPR_ARRAY svtkm::IdComponent NumEntriesPerCase[] = {
        0,  //  CELL_SHAPE_EMPTY = 0,
        0,  //  CELL_SHAPE_VERTEX = 1,
        0,  //  CELL_SHAPE_POLY_VERTEX = 2,
        0,  //  CELL_SHAPE_LINE = 3,
      ...
      svtkm::IdComponent triOffset = TriangleTableOffsetPortal.Get(shape) +
        NumEntriesPerCase[shape] * caseNumber + triangleNumber * 3;
      svtkm::IdComponent edgeIndex = TriangleTablePortal.Get(triOffset + vertexNumber);
      svtkm::IdComponent edgeOffset = EdgeTableOffsetPortal.Get(shape);
  ...
  TriangleGenerationTable()
    : EdgeTableArray(
        svtkm::cont::make_ArrayHandle(EdgeTable, sizeof(EdgeTable) / sizeof(EdgeTable[0])))
    , EdgeTableOffsetArray(
        svtkm::cont::make_ArrayHandle(EdgeTableOffset,
                                     sizeof(EdgeTableOffset) / sizeof(EdgeTableOffset[0])))
    , TriangleTableArray(
        svtkm::cont::make_ArrayHandle(TriangleTable,
                                     sizeof(TriangleTable) / sizeof(TriangleTable[0])))
    , TriangleTableOffsetArray(
        svtkm::cont::make_ArrayHandle(TriangleTableOffset,
                                     sizeof(TriangleTableOffset) / sizeof(TriangleTableOffset[0])))
  {
  }

private:
  svtkm::cont::ArrayHandle<svtkm::IdComponent> EdgeTableArray;
  svtkm::cont::ArrayHandle<svtkm::IdComponent> EdgeTableOffsetArray;
  svtkm::cont::ArrayHandle<svtkm::IdComponent> TriangleTableArray;
  svtkm::cont::ArrayHandle<svtkm::IdComponent> TriangleTableOffsetArray;
};
}
}
}
#endif // svtk_m_ContourTable_h
