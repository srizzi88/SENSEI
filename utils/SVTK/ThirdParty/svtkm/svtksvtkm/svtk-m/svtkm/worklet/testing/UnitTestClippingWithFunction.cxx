...
using Coord3D = svtkm::Vec<svtkm::FloatDefault, 3>;
...
void TestClippingExplicit()
{
  ...
  const svtkm::Float32 expectedScalars[] = { 1, 2, 1, 0, 0.5, 0.5, 0.5 };
...
void TestClippingStructured()
{
  ...
  const svtkm::Id expectedConnectivity[] = { 9,  10, 3, 1, 1, 3, 0, 11, 9,  1, 5, 5, 1, 2,
  ...
  const svtkm::Float32 expectedScalars[] = { 1, 1, 1, 1, 0, 1, 1, 1, 1, 0.5, 0.5, 0.5, 0.5 };
...
{
  svtkm::Vec<svtkm::FloatDefault, 3> center(1, 1, 0);
  ...
  const svtkm::Float32 expectedScalars[] = { 1, 1, 1, 1, 0, 1, 1, 1, 1, 0.25, 0.25, 0.25, 0.25 };
  std::vector<svtkm::Float32> expectedCellvar = { -100.f, -100.f, 100.f, 100.f,
                                                 30.f,   30.f,   -30.f, -30.f };
...
{
  return svtkm::cont::testing::Testing::Run(TestClippingWithFunction, argc, argv);
}
