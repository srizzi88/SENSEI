...
SVTKTHEORA_EXPORT const char *th_version_string(void);
...
SVTKTHEORA_EXPORT ogg_uint32_t th_version_number(void);
...
SVTKTHEORA_EXPORT ogg_int64_t th_granule_frame(void *_encdec,ogg_int64_t _granpos);
 ...
 * \retval -1 The given granule position was invalid (i.e. negative).*/
SVTKTHEORA_EXPORT double th_granule_time(void *_encdec,ogg_int64_t _granpos);
...
SVTKTHEORA_EXPORT int th_packet_isheader(ogg_packet *_op);
...
SVTKTHEORA_EXPORT int th_packet_iskeyframe(ogg_packet *_op);
/*@}*/
...
SVTKTHEORA_EXPORT void th_comment_init(th_comment *_tc);
...
SVTKTHEORA_EXPORT void th_comment_add(th_comment *_tc, char *_comment);
/**Add a comment to an initialized #th_comment structure.
 * \note Neither th_comment_add() nor th_comment_add_tag() support
 *  comments containing null values, although the bitstream format does
 *  support them.
...
SVTKTHEORA_EXPORT void th_comment_add_tag(th_comment *_tc,char *_tag,char *_val);
...
SVTKTHEORA_EXPORT char *th_comment_query(th_comment *_tc,char *_tag,int _count);
...
SVTKTHEORA_EXPORT int th_comment_query_count(th_comment *_tc,char *_tag);
...
SVTKTHEORA_EXPORT void th_comment_clear(th_comment *_tc);
/*@}*/
/*@}*/
