 ...
 */
SVTKTHEORA_EXPORT int th_decode_headerin(th_info *_info,th_comment *_tc,
...
SVTKTHEORA_EXPORT th_dec_ctx *th_decode_alloc(const th_info *_info,
...
SVTKTHEORA_EXPORT void th_setup_free(th_setup_info *_setup);
...
SVTKTHEORA_EXPORT int th_decode_ctl(th_dec_ctx *_dec,int _req,void *_buf,
 size_t _buf_sz);
...
SVTKTHEORA_EXPORT int th_decode_packetin(th_dec_ctx *_dec,const ogg_packet *_op,
 ...
 */
SVTKTHEORA_EXPORT int th_decode_ycbcr_out(th_dec_ctx *_dec,
 th_ycbcr_buffer _ycbcr);
/**Frees an allocated decoder instance.
 * \param _dec A #th_dec_ctx handle.*/
SVTKTHEORA_EXPORT void th_decode_free(th_dec_ctx *_dec);
/*@}*/
/*@}*/
