...
#include "svtk_tiff_mangle.h"
#include "tiffconf.h"

#ifdef _WIN32
#if TIFF_SHARED_LIBS
#ifdef tiff_EXPORTS
#define svtktiff_EXPORT __declspec(dllexport)
#else
#define svtktiff_EXPORT __declspec(dllimport)
#endif
#else
#define svtktiff_EXPORT
#endif
#else
#define svtktiff_EXPORT extern
#endif
