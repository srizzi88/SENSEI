...
extern "C" {
#endif
svtktiff_EXPORT int _TIFFgetMode(const char* mode, const char* module);
svtktiff_EXPORT int _TIFFNoRowEncode(TIFF* tif, uint8* pp, tmsize_t cc, uint16 s);
svtktiff_EXPORT int _TIFFNoStripEncode(TIFF* tif, uint8* pp, tmsize_t cc, uint16 s);
svtktiff_EXPORT int _TIFFNoTileEncode(TIFF*, uint8* pp, tmsize_t cc, uint16 s);
svtktiff_EXPORT int _TIFFNoRowDecode(TIFF* tif, uint8* pp, tmsize_t cc, uint16 s);
svtktiff_EXPORT int _TIFFNoStripDecode(TIFF* tif, uint8* pp, tmsize_t cc, uint16 s);
svtktiff_EXPORT int _TIFFNoTileDecode(TIFF*, uint8* pp, tmsize_t cc, uint16 s);
svtktiff_EXPORT void _TIFFNoPostDecode(TIFF* tif, uint8* buf, tmsize_t cc);
svtktiff_EXPORT int _TIFFNoPreCode(TIFF* tif, uint16 s);
svtktiff_EXPORT int _TIFFNoSeek(TIFF* tif, uint32 off);
svtktiff_EXPORT void _TIFFSwab16BitData(TIFF* tif, uint8* buf, tmsize_t cc);
svtktiff_EXPORT void _TIFFSwab24BitData(TIFF* tif, uint8* buf, tmsize_t cc);
svtktiff_EXPORT void _TIFFSwab32BitData(TIFF* tif, uint8* buf, tmsize_t cc);
svtktiff_EXPORT void _TIFFSwab64BitData(TIFF* tif, uint8* buf, tmsize_t cc);
svtktiff_EXPORT int TIFFFlushData1(TIFF* tif);
svtktiff_EXPORT int TIFFDefaultDirectory(TIFF* tif);
svtktiff_EXPORT void _TIFFSetDefaultCompressionState(TIFF* tif);
svtktiff_EXPORT int _TIFFRewriteField(TIFF *, uint16, TIFFDataType, tmsize_t, void *);
svtktiff_EXPORT int TIFFSetCompressionScheme(TIFF* tif, int scheme);
svtktiff_EXPORT int TIFFSetDefaultCompressionState(TIFF* tif);
svtktiff_EXPORT uint32 _TIFFDefaultStripSize(TIFF* tif, uint32 s);
svtktiff_EXPORT void _TIFFDefaultTileSize(TIFF* tif, uint32* tw, uint32* th);
svtktiff_EXPORT int _TIFFDataSize(TIFFDataType type);

svtktiff_EXPORT void _TIFFsetByteArray(void**, void*, uint32);
svtktiff_EXPORT void _TIFFsetString(char**, char*);
svtktiff_EXPORT void _TIFFsetShortArray(uint16**, uint16*, uint32);
svtktiff_EXPORT void _TIFFsetLongArray(uint32**, uint32*, uint32);
svtktiff_EXPORT void _TIFFsetFloatArray(float**, float*, uint32);
svtktiff_EXPORT void _TIFFsetDoubleArray(double**, double*, uint32);

svtktiff_EXPORT void _TIFFprintAscii(FILE*, const char*);
svtktiff_EXPORT void _TIFFprintAsciiTag(FILE*, const char*, const char*);

svtktiff_EXPORT TIFFErrorHandler _TIFFwarningHandler;
svtktiff_EXPORT TIFFErrorHandler _TIFFerrorHandler;
svtktiff_EXPORT TIFFErrorHandlerExt _TIFFwarningHandlerExt;
svtktiff_EXPORT TIFFErrorHandlerExt _TIFFerrorHandlerExt;

svtktiff_EXPORT uint32 _TIFFMultiply32(TIFF*, uint32, uint32, const char*);
svtktiff_EXPORT uint64 _TIFFMultiply64(TIFF*, uint64, uint64, const char*);
svtktiff_EXPORT tmsize_t _TIFFMultiplySSize(TIFF*, tmsize_t, tmsize_t, const char*);
svtktiff_EXPORT tmsize_t _TIFFCastUInt64ToSSize(TIFF*, uint64, const char*);
svtktiff_EXPORT void* _TIFFCheckMalloc(TIFF*, tmsize_t, tmsize_t, const char*);
svtktiff_EXPORT void* _TIFFCheckRealloc(TIFF*, void*, tmsize_t, tmsize_t, const char*);

svtktiff_EXPORT double _TIFFUInt64ToDouble(uint64);
svtktiff_EXPORT float _TIFFUInt64ToFloat(uint64);

svtktiff_EXPORT float _TIFFClampDoubleToFloat(double);

svtktiff_EXPORT tmsize_t
...
svtktiff_EXPORT int _TIFFSeekOK(TIFF* tif, toff_t off);

svtktiff_EXPORT int TIFFInitDumpMode(TIFF*, int);
#ifdef PACKBITS_SUPPORT
svtktiff_EXPORT int TIFFInitPackBits(TIFF*, int);
#endif
#ifdef CCITT_SUPPORT
svtktiff_EXPORT int TIFFInitCCITTRLE(TIFF*, int), TIFFInitCCITTRLEW(TIFF*, int);
svtktiff_EXPORT int TIFFInitCCITTFax3(TIFF*, int), TIFFInitCCITTFax4(TIFF*, int);
#endif
#ifdef THUNDER_SUPPORT
svtktiff_EXPORT int TIFFInitThunderScan(TIFF*, int);
#endif
#ifdef NEXT_SUPPORT
svtktiff_EXPORT int TIFFInitNeXT(TIFF*, int);
#endif
#ifdef LZW_SUPPORT
svtktiff_EXPORT int TIFFInitLZW(TIFF*, int);
#endif
#ifdef OJPEG_SUPPORT
svtktiff_EXPORT int TIFFInitOJPEG(TIFF*, int);
#endif
#ifdef JPEG_SUPPORT
svtktiff_EXPORT int TIFFInitJPEG(TIFF*, int);
svtktiff_EXPORT int TIFFJPEGIsFullStripRequired(TIFF*);
#endif
#ifdef JBIG_SUPPORT
svtktiff_EXPORT int TIFFInitJBIG(TIFF*, int);
#endif
#ifdef ZIP_SUPPORT
svtktiff_EXPORT int TIFFInitZIP(TIFF*, int);
#endif
#ifdef PIXARLOG_SUPPORT
svtktiff_EXPORT int TIFFInitPixarLog(TIFF*, int);
#endif
#ifdef LOGLUV_SUPPORT
svtktiff_EXPORT int TIFFInitSGILog(TIFF*, int);
#endif
#ifdef LZMA_SUPPORT
svtktiff_EXPORT int TIFFInitLZMA(TIFF*, int);
#endif
#ifdef ZSTD_SUPPORT
svtktiff_EXPORT int TIFFInitZSTD(TIFF*, int);
#endif
#ifdef WEBP_SUPPORT
svtktiff_EXPORT int TIFFInitWebP(TIFF*, int);
#endif
#ifdef VMS
svtktiff_EXPORT const TIFFCodec _TIFFBuiltinCODECS[];
#else
svtktiff_EXPORT TIFFCodec _TIFFBuiltinCODECS[];
#endif
