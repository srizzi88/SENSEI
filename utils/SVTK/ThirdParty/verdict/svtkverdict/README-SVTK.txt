The ThirdParty/verdict/svtkverdict directory contains a reduced
...
appropriate date and version number:
 ...
 GIT_AUTHOR_NAME='SVTK Developers' \
 GIT_AUTHOR_EMAIL='svtk-developers@svtk.org' \
...
Merge the verdict-upstream branch as a subtree:
 ...
 git merge -s recursive -X subtree=ThirdParty/verdict/svtkverdict \
           verdict-upstream
