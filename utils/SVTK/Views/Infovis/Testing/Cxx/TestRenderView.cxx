...
class TestRenderViewUpdater : public svtkCommand
{
public:
...
{
  SVTK_CREATE(svtkAnnotationLink, link);
  SVTK_CREATE(TestRenderViewUpdater, updater);

  SVTK_CREATE(svtkSphereSource, sphere);
  SVTK_CREATE(svtkCubeSource, cube);
  cube->SetCenter(2, 0, 0);

  SVTK_CREATE(svtkTransformFilter, transform);
  SVTK_CREATE(svtkTransform, trans);
  trans->Translate(0, 2, 0);
  transform->SetTransform(trans);
  transform->SetInputConnection(sphere->GetOutputPort());

  // Render view 1
  SVTK_CREATE(svtkRenderView, view);
  view->DisplayHoverTextOff();
  view->GetRenderWindow()->SetMultiSamples(0);
  updater->AddView(view);

  // Sphere 1
  SVTK_CREATE(svtkRenderedSurfaceRepresentation, sphereRep1);
  ...
  // Cube 1
  SVTK_CREATE(svtkRenderedSurfaceRepresentation, cubeRep1);
