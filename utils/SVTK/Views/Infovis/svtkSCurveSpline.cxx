...
svtkStandardNewMacro(svtkSCurveSpline);

//----------------------------------------------------------------------------
// Construct a SCurve Spline.
svtkSCurveSpline::svtkSCurveSpline()
{
  this->NodeWeight = 0.0;
}
...
double svtkSCurveSpline::Evaluate(double t)
{
  int index;
  double* intervals;
  double* coefficients;
...
//----------------------------------------------------------------------------
void svtkSCurveSpline::DeepCopy(svtkSpline* s)
{
  svtkSCurveSpline* spline = svtkSCurveSpline::SafeDownCast(s);
...
//----------------------------------------------------------------------------
void svtkSCurveSpline::PrintSelf(ostream& os, svtkIndent indent)
{
