...
svtkStandardNewMacro(svtkQtTableView);

//----------------------------------------------------------------------------
svtkQtTableView::svtkQtTableView()
{
  this->ApplyColors = svtkSmartPointer<svtkApplyColors>::New();
  this->DataObjectToTable = svtkSmartPointer<svtkDataObjectToTable>::New();
  this->AddSelectedColumn = svtkSmartPointer<svtkAddMembershipArray>::New();
  ...
  this->AddSelectedColumn->SetFieldType(svtkAddMembershipArray::VERTEX_DATA);
  this->FieldType = svtkQtTableView::VERTEX_DATA;
  this->AddSelectedColumn->SetOutputArrayName("svtkAddMembershipArray membership");
...
//----------------------------------------------------------------------------
QWidget* svtkQtTableView::GetWidget()
{
  return this->TableView;
}

//----------------------------------------------------------------------------
void svtkQtTableView::SetShowVerticalHeaders(bool state)
{
  if (state)
  {
...
//----------------------------------------------------------------------------
void svtkQtTableView::SetShowHorizontalHeaders(bool state)
{
  if (state)
  {
...
//----------------------------------------------------------------------------
void svtkQtTableView::SetEnableDragDrop(bool state)
{
  this->TableView->setDragEnabled(state);
}

//----------------------------------------------------------------------------
void svtkQtTableView::SetSortingEnabled(bool state)
{
  this->TableView->setSortingEnabled(state);
}

//----------------------------------------------------------------------------
void svtkQtTableView::SetFieldType(int type)
{
...
//----------------------------------------------------------------------------
void svtkQtTableView::SetColumnVisibility(const QString& name, bool s)
{
...
//----------------------------------------------------------------------------
void svtkQtTableView::SetShowAll(bool s)
{
  if (this->ShowAll != s)
  {
    this->ShowAll = s;
...
void svtkQtTableView::SetApplyRowColors(bool value)
{
...
void svtkQtTableView::SetSortSelectionToTop(bool value)
{
...
//----------------------------------------------------------------------------
void svtkQtTableView::SetSplitMultiComponentColumns(bool value)
{
  this->TableAdapter->SetSplitMultiComponentColumns(value);
}

//----------------------------------------------------------------------------
bool svtkQtTableView::GetSplitMultiComponentColumns()
{
  return this->TableAdapter->GetSplitMultiComponentColumns();
}

void svtkQtTableView::AddRepresentationInternal(svtkDataRepresentation* rep)
{
  ...
  {
    svtkSmartPointer<svtkSelection> empty = svtkSmartPointer<svtkSelection>::New();
    svtkSmartPointer<svtkSelectionNode> emptyNode = svtkSmartPointer<svtkSelectionNode>::New();
    emptyNode->SetContentType(svtkSelectionNode::INDICES);
...
void svtkQtTableView::RemoveRepresentationInternal(svtkDataRepresentation* rep)
{
  svtkAlgorithmOutput *selConn, *annConn, *conn;
  conn = rep->GetInputConnection();
  selConn = rep->GetInternalSelectionOutputPort();
...
void svtkQtTableView::SetColorByArray(bool b)
{
  this->ApplyColors->SetUsePointLookupTable(b);
}

bool svtkQtTableView::GetColorByArray()
{
  return this->ApplyColors->GetUsePointLookupTable();
}

void svtkQtTableView::SetColorArrayName(const char* name)
{
...
const char* svtkQtTableView::GetColorArrayName()
{
  return this->GetColorArrayNameInternal();
}

//----------------------------------------------------------------------------
void svtkQtTableView::slotQtSelectionChanged(
...
//----------------------------------------------------------------------------
void svtkQtTableView::SetSVTKSelection()
{
  ...
  if (selection->GetNode(0)->GetSelectionList()->GetNumberOfTuples())
  {
    ...
    this->TableView->selectionModel()->select(
    ...
    if (this->SortSelectionToTop)
    {
      ...
      {
        QString colName = this->TableAdapter->headerData(j, Qt::Horizontal).toString();
        if (colName == "svtkAddMembershipArray membership")
        {
...
void svtkQtTableView::Update()
{
    ...
    atime > this->LastSelectionMTime)
  {
    ...
    if (this->SortSelectionToTop)
    {
      ...
      this->TableAdapter->SetSVTKDataObject(this->AddSelectedColumn->GetOutput());
    }
    else
    {
      this->TableAdapter->SetSVTKDataObject(this->DataObjectToTable->GetOutput());
    }
  ...
  {
    QString colName = this->TableAdapter->headerData(j, Qt::Horizontal).toString();
    if (colName == "svtkApplyColors color" || colName == "svtkAddMembershipArray membership")
    {
      this->TableView->hideColumn(j);
    }
    /*
...
void svtkQtTableView::SetSelectionBehavior(int type)
{
  switch (type)
  {
    case SELECT_ITEMS:
...
int svtkQtTableView::GetSelectionBehavior()
{
...
void svtkQtTableView::GetSelectedItems(svtkIdTypeArray* arr)
{
  if (!arr)
  {
    return;
...
void svtkQtTableView::ApplyViewTheme(svtkViewTheme* theme)
{
...
//----------------------------------------------------------------------------
void svtkQtTableView::PrintSelf(ostream& os, svtkIndent indent)
{
