 ...
 * into the SVTK view framework. Not much here yet, but in the future there
...
class SVTKVIEWSQT_EXPORT svtkQtView
  : public QObject
  , public svtkView
{
  Q_OBJECT
public:
  svtkTypeMacro(svtkQtView, svtkView);
...
private:
  svtkQtView(const svtkQtView&) = delete;
  void operator=(const svtkQtView&) = delete;
};

#endif
// SVTK-HeaderTest-Exclude: svtkQtView.h
