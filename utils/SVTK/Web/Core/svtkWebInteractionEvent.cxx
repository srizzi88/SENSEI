/*=========================================================================
  ...
  Module:    svtkWebInteractionEvent.cxx
...
svtkStandardNewMacro(svtkWebInteractionEvent);
//----------------------------------------------------------------------------
svtkWebInteractionEvent::svtkWebInteractionEvent()
  : Buttons(0)
  , Modifiers(0)
  , KeyCode(0)
  , X(0.0)
...
//----------------------------------------------------------------------------
svtkWebInteractionEvent::~svtkWebInteractionEvent() = default;

//----------------------------------------------------------------------------
void svtkWebInteractionEvent::PrintSelf(ostream& os, svtkIndent indent)
{
