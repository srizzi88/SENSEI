r"""
    ...
    svtk web applications.  It provides the ability to run an arbitrary
...
# =============================================================================
# Uses svtkTesting to compare images.  According to comments in the svtkTesting
...
def compare_images(test_img, baseline_img, tmp_dir="."):
    """
    This function creates a svtkTesting object, and specifies the name of the
    baseline image file, using a fully qualified path (baseline_img must be
    fully qualified).  Then it calls the svtkTesting method which compares the
...
# =============================================================================
# Extend BrowserBasedWebTest to handle svtk-style image comparison
# =============================================================================
class ImageComparatorWebTest(BrowserBasedWebTest):
    ...
    postprocess phase with a call to svtk image comparison functionality.
...
# is a subclass of svtk.web.testing.WebTest, so we should write some
...
# paraview or svtk web application service.
# =============================================================================
