...
svtkStandardNewMacro(svtkWebGLDataSet);

std::string svtkWebGLDataSet::GetMD5()
{
  return this->MD5;
}

svtkWebGLDataSet::svtkWebGLDataSet()
{
...
void svtkWebGLDataSet::SetVertices(float* v, int size)
{
  delete[] this->vertices;
  this->vertices = v;
...
void svtkWebGLDataSet::SetIndexes(short* i, int size)
{
  delete[] this->indexes;
  this->indexes = i;
...
void svtkWebGLDataSet::SetNormals(float* n)
{
  delete[] this->normals;
  this->normals = n;
  this->hasChanged = true;
...
void svtkWebGLDataSet::SetColors(unsigned char* c)
{
  delete[] this->colors;
  this->colors = c;
  this->hasChanged = true;
...
void svtkWebGLDataSet::SetPoints(float* p, int size)
{
  delete[] this->points;
  this->points = p;
...
void svtkWebGLDataSet::SetTCoords(float* t)
{
  delete[] this->tcoords;
  this->tcoords = t;
  this->hasChanged = true;
...
unsigned char* svtkWebGLDataSet::GetBinaryData()
{
  this->hasChanged = false;
  return this->binary;
}

int svtkWebGLDataSet::GetBinarySize()
{
  return this->binarySize;
}

void svtkWebGLDataSet::SetMatrix(float* m)
{
  this->Matrix = m;
  this->hasChanged = true;
}

void svtkWebGLDataSet::GenerateBinaryData()
{
  ...
  svtkWebGLExporter::ComputeMD5((const unsigned char*)this->binary, this->binarySize, this->MD5);
  this->hasChanged = true;
}

void svtkWebGLDataSet::SetType(WebGLObjectTypes t)
{
  this->webGLType = t;
}

bool svtkWebGLDataSet::HasChanged()
{
  return this->hasChanged;
}

void svtkWebGLDataSet::PrintSelf(ostream& os, svtkIndent indent)
{
