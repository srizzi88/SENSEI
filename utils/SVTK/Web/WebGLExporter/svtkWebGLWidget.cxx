...
svtkStandardNewMacro(svtkWebGLWidget);

svtkWebGLWidget::svtkWebGLWidget()
{
...
unsigned char* svtkWebGLWidget::GetBinaryData(int svtkNotUsed(part))
{
  this->hasChanged = false;
  return this->binaryData;
}

int svtkWebGLWidget::GetBinarySize(int svtkNotUsed(part))
{
  return this->binarySize;
}

void svtkWebGLWidget::GenerateBinaryData()
{
  delete[] this->binaryData;
  ...
  svtkWebGLExporter::ComputeMD5(this->binaryData, total, this->MD5);
  this->hasChanged = this->MD5.compare(oldMD5) != 0;
}

int svtkWebGLWidget::GetNumberOfParts()
{
  return 1;
}

void svtkWebGLWidget::PrintSelf(ostream& os, svtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

void svtkWebGLWidget::GetDataFromColorMap(svtkActor2D* actor)
{
  ...
  // Colors
  svtkDiscretizableColorTransferFunction* lookup =
    svtkDiscretizableColorTransferFunction::SafeDownCast(scalarbar->GetLookupTable());
