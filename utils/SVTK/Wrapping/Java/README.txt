...
$ mkdir build-sb
$ cd build-sb
$ cmake -DUSE_SVTK_MASTER:BOOL=ON -DBUILD_SVTK7:BOOL=ON -DGENERATE_JAVA_PACKAGE:BOOL=ON -DENABLE_svtk:BOOL=ON -DCMAKE_BUILD_TYPE:STRING=Release -DSVTK_JAVA_SOURCE_VERSION:STRING=1.8 -DSVTK_JAVA_TARGET_VERSION:STRING=1.8 -DJAVA_AWT_INCLUDE_PATH:PATH=/usr/lib/jvm/java/include -DJAVA_AWT_LIBRARY:FILEPATH=/usr/lib/jvm/jre/lib/amd64/libjawt.so -DJAVA_INCLUDE_PATH:PATH=/usr/lib/jvm/java/include -DJAVA_INCLUDE_PATH2:PATH=/usr/lib/jvm/java/include/linux -DJAVA_JVM_LIBRARY:FILEPATH=/usr/lib/jvm/jre/lib/amd64/server/libjvm.so -DJava_IDLJ_EXECUTABLE:FILEPATH=/usr/bin/idlj -DJava_JARSIGNER_EXECUTABLE:FILEPATH=/usr/bin/jarsigner -DJava_JAR_EXECUTABLE:FILEPATH=/usr/bin/jar -DJava_JAVAC_EXECUTABLE:FILEPATH=/usr/bin/javac -DJava_JAVADOC_EXECUTABLE:FILEPATH=/usr/bin/javadoc -DJava_JAVAH_EXECUTABLE:FILEPATH=/usr/bin/javah -DJava_JAVA_EXECUTABLE:FILEPATH=/usr/bin/java -DJOGL_GLUE:FILEPATH=/home/kitware/.m2/repository/org/jogamp/gluegen/gluegen-rt/2.3.2/gluegen-rt-2.3.2.jar -DJOGL_LIB:FILEPATH=/home/kitware/.m2/repository/org/jogamp/jogl/jogl-all/2.3.2/jogl-all-2.3.2.jar ../svtk-superbuild/

$ make
$ cd install
$ java -cp svtk-7.1.jar:/home/kitware/.m2/repository/org/jogamp/gluegen/gluegen-rt/2.3.2/gluegen-rt-2.3.2.jar:/home/kitware/.m2/repository/org/jogamp/jogl/jogl-all/2.3.2/jogl-all-2.3.2.jar -Djava.library.path=./natives-Linux-64bit svtk.sample.Demo
...
mkdir build-sb
cd build-sb
cmake  -DUSE_SVTK_MASTER:BOOL=ON  -DBUILD_SVTK7:BOOL=ON  -DGENERATE_JAVA_PACKAGE:BOOL=ON  -DENABLE_svtk:BOOL=ON  -DCMAKE_BUILD_TYPE:STRING=Release  -DSVTK_JAVA_SOURCE_VERSION:STRING=1.8  -DSVTK_JAVA_TARGET_VERSION:STRING=1.8  -DJAVA_AWT_INCLUDE_PATH:PATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\include  -DJAVA_AWT_LIBRARY:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\jre\bin\jawt.dll  -DJAVA_INCLUDE_PATH:PATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\include  -DJAVA_INCLUDE_PATH2:PATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\include\win32  -DJAVA_JVM_LIBRARY:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\jre\bin\server\jvm.dll  -DJava_IDLJ_EXECUTABLE:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\bin\idlj.exe -DJava_JARSIGNER_EXECUTABLE:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\bin\jarsigner.exe -DJava_JAR_EXECUTABLE:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\bin\jar.exe -DJava_JAVAC_EXECUTABLE:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\bin\javac.exe -DJava_JAVADOC_EXECUTABLE:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\bin\javadoc.exe -DJava_JAVAH_EXECUTABLE:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\bin\javah.exe -DJava_JAVA_EXECUTABLE:FILEPATH=C:\Users\utkarsh\svtk-java\jdk1.8.0_121\bin\java.exe -DJOGL_GLUE:FILEPATH=C:\Users\utkarsh\.m2\repository\org\jogamp\gluegen\gluegen-rt\2.3.2\gluegen-rt-2.3.2.jar -DJOGL_LIB:FILEPATH=C:\Users\utkarsh\.m2\repository\org\jogamp\jogl\jogl-all\2.3.2\jogl-all-2.3.2.jar ../svtk-superbuild/

C:\Users\utkarsh\svtk-java\jdk1.8.0_121\
