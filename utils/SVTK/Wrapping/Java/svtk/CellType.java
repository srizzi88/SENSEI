...
/**
 * Provide a mapping to SVTK CellType enum
 *
...
public enum CellType {
  ...
  /**
   * @return the id that SVTK is using to identify it cell type.
   */
  public int GetId() {
    return id;
  }
  ...
  /**
   * @param svtkCellId
   * @return an instance of CellType based on the svtk cell id.
   */
  public static CellType GetCellType(int svtkCellId) {
    if (MAPPING == null) {
      // build it lazyly
      int max = 0;
