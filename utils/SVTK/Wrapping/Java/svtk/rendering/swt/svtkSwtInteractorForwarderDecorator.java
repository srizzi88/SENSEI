 ...
 * into the svtkInteractorForwarder proper AWT event.
 *
 ...
 */
public class svtkSwtInteractorForwarderDecorator extends svtkInteractorForwarder
implements MouseListener, MouseMoveListener, MouseTrackListener, MouseWheelListener, KeyListener {

  svtkInteractorForwarder forwarder;
  Label dummyComponent;

  public svtkSwtInteractorForwarderDecorator(svtkComponent<?> component, svtkInteractorForwarder forwarder) {
    super(component);
