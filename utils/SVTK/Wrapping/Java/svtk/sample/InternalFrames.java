...
public class InternalFrames extends JFrame {
  ...
  public InternalFrames() {
    super("SVTK Internal Frame Demo");
  ...
  private class Desktop extends JDesktopPane {
    ...
    public Desktop() {
      ...
      this.add(new SVTKFrame(10, 10));
      this.add(new SVTKFrame(500, 10));
    }
  }
  ...
  private class Tabbed extends JTabbedPane {
    ...
    public Tabbed() {
      this.addTab("svtk1", new SVTKCanvas());
      this.addTab("svtk2", new SVTKCanvas());
  ...
  private class SVTKFrame extends JInternalFrame {
    private static final long serialVersionUID = 1L;

    public SVTKFrame(int x, int y) {
      super("SVTK Window", true, true, true, true);
      ...
      this.getContentPane().add(new SVTKCanvas(), BorderLayout.CENTER);
      this.pack();
      this.setVisible(true);
    }
  }
  ...
  private class MenuMgr extends JMenuBar {
    ...
    public MenuMgr() {
      ...
      menu = new JMenu("File");
      menu.add(new CreateWindowAction("Create New SVTK Window"));
  ...
  private class CreateWindowAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent ev) {
      theDesktop.add(new SVTKFrame(340, 200), new Integer(layer));
    }
  }
