 ...
 * monitor what kind of svtkObject and how many have been removed and kept during
 * the Garbage collection call.
 *
 * @author sebastien jourdain - sebastien.jourdain@kitware.com
 */
public class svtkReferenceInformation {
  ...
  public svtkReferenceInformation(int nbToFree, int nbToKeep, int totalSize) {
    this.numberOfObjectsToFree = nbToFree;
    this.numberOfObjectsStillReferenced = nbToKeep;
    this.keepTrackOfClassNames = false;
  }

  public svtkReferenceInformation(boolean keepTrackOfClassNames) {
  ...
  public String toString() {
    ...
    builder.append("SVTK Gabage Collection: free(");
