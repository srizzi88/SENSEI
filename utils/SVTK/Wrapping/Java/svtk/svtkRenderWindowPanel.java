...
/**
 * svtkRenderWindowPanel is a svtkCanvas which allows additional svtkRenderers to
 * be added. svtkPanel and svtkCanvas force you to add actors to the internal
 * svtkRenderer. svtkRenderWindowPanel always renders, even if the internal
 * renderer has no visible actors.
 *
 * @author Kitware
 */
public class svtkRenderWindowPanel extends svtkCanvas {
  private static final long serialVersionUID = 1L;

  public svtkRenderWindowPanel() {
    cam = new svtkCamera();
    lgt = new svtkLight();
  }

  public svtkRenderWindowPanel(svtkRenderWindow win) {
    super(win);
    cam = new svtkCamera();
    lgt = new svtkLight();
  }
