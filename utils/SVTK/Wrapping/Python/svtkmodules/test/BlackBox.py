from svtkmodules.util import svtkMethodParser


class Tester:
    def __init__(self, debug=0):
        self.setDebug(debug)
        self.parser = svtkMethodParser.VtkDirMethodParser()
        self.obj = None

    def setDebug(self, val):
        """Sets debug value of the svtkMethodParser.  1 is verbose and
        0 is not.  0 is default."""
        svtkMethodParser.DEBUG = val
