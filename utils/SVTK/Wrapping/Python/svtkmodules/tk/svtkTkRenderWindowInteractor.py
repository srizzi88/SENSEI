...
A fully functional SVTK widget for tkinter that uses
svtkGenericRenderWindowInteractor.  The widget is called
svtkTkRenderWindowInteractor.  The initialization part of this code is
similar to that of the svtkTkRenderWidget.
...
class svtkTkRenderWindowInteractor(tkinter.Widget):
    """ A svtkTkRenderWidndowInteractor for Python.
...
#----------------------------------------------------------------------------
def svtkRenderWindowInteractorConeExample():
    ...
    pane = svtkTkRenderWindowInteractor(root, width=300, height=300)
    pane.Initialize()
...
if __name__ == "__main__":
    svtkRenderWindowInteractorConeExample()
