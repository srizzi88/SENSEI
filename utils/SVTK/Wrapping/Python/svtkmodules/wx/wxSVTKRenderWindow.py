...
wxSVTKRenderWindow(parent, ID, stereo=0, [wx keywords]):
...
__Handle:              Handle to the window containing the svtkRenderWindow
...
class wxSVTKRenderWindow(baseClass):
    """
    ...
    def OnPaint(self, event):
        """Handles the wx.EVT_PAINT event for wxSVTKRenderWindow.
        """
        dc = wx.PaintDC(self)
        self.Render()

    def _OnSize(self, event):
        """Handles the wx.EVT_SIZE event for wxSVTKRenderWindow.
        """
    ...
    def OnKeyDown(self, event):
        """Handles the wx.EVT_KEY_DOWN events for wxSVTKRenderWindow.
        """
    ...
    def GetPicker(self):
        """Returns the current picker (svtkCellPicker).
        """
        return self._Picker
...
#----------------------------------------------------------------------------
def wxSVTKRenderWindowConeExample():
    ...
    # create the widget
    frame = wx.Frame(None, -1, "wxSVTKRenderWindow", size=(400,400))
    widget = wxSVTKRenderWindow(frame, -1)
