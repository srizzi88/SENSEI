...
Creation:
 ...
 wxSVTKRenderWindowInteractor(parent, ID, stereo=0, [wx keywords]):
...
Behaviour:
 ...
 Uses __getattr__ to make the wxSVTKRenderWindowInteractor behave just
 like a svtkGenericRenderWindowInteractor.
...
class wxSVTKRenderWindowInteractor(baseClass):
    """
    A wxRenderWindow for wxPython.
    Use GetRenderWindow() to get the svtkRenderWindow.
    ...
    # stereo visual.  E.g.:
    # wxSVTKRenderWindowInteractor.USE_STEREO = True
    # myRWI = wxSVTKRenderWindowInteractor(parent, -1)
    USE_STEREO = False
    ...
    def __init__(self, parent, ID, *args, **kw):
        ...
        if baseClass.__name__ == 'GLCanvas':
            ...
            # that the glXContext in this case is NOT allocated by SVTK,
        ...
        self._Iren.SetRenderWindow( svtkRenderWindow() )
        ...
        # successfully been run (and set up the SVTK/WX display links)
        ...
        self._cursor_map = {0: wx.CURSOR_ARROW, # SVTK_CURSOR_DEFAULT
                            1: wx.CURSOR_ARROW, # SVTK_CURSOR_ARROW
                            2: wx.CURSOR_SIZENESW, # SVTK_CURSOR_SIZENE
                            3: wx.CURSOR_SIZENWSE, # SVTK_CURSOR_SIZENWSE
                            4: wx.CURSOR_SIZENESW, # SVTK_CURSOR_SIZESW
                            5: wx.CURSOR_SIZENWSE, # SVTK_CURSOR_SIZESE
                            6: wx.CURSOR_SIZENS, # SVTK_CURSOR_SIZENS
                            7: wx.CURSOR_SIZEWE, # SVTK_CURSOR_SIZEWE
                            8: wx.CURSOR_SIZING, # SVTK_CURSOR_SIZEALL
                            9: wx.CURSOR_HAND, # SVTK_CURSOR_HAND
                            10: wx.CURSOR_CROSS, # SVTK_CURSOR_CROSSHAIR
                           }
    ...
    def GetDisplayId(self):
        ...
        that can be used by SVTK Python.
        ...
        representation to pass to SVTK.
        """
        d = None
        ...
        try:
            ...
            if d:
                ...
                # SVTK wants it as: _xxxxxxxx_p_void (SWIG pointer)
    ...
    def OnMotion(self,event):
        ...
        # we call this early in case any of the SVTK code raises an
        # exception.
        event.Skip()
    ...
    def OnButtonDown(self,event):
        ...
        # the initial focus, resulting in the wxSVTKRWI ignoring keypresses
        # until we focus elsewhere and then refocus the wxSVTKRWI frame
        # we do it this early in case any of the following SVTK code
        # raises an exception.
        event.Skip()
    ...
    def GetRenderWindow(self):
        """Returns the render window (svtkRenderWindow).
        """
        return self._Iren.GetRenderWindow()

    def Render(self):
        """Actually renders the SVTK scene on screen.
        """
        RenderAllowed = 1
    ...
    def SetRenderWhenDisabled(self, newValue):
        ...
        a SVTK object to have progress bars and other GUI elements updated -
        ...
        However, this often triggers an OnPaint() method for wxSVTKRWIs,
...
#--------------------------------------------------------------------
def wxSVTKRenderWindowInteractorConeExample():
    ...
    # create the top-level frame, sizer and wxSVTKRWI
    frame = wx.Frame(None, -1, "wxSVTKRenderWindowInteractor", size=(400,400))
    widget = wxSVTKRenderWindowInteractor(frame, -1)
...
if __name__ == "__main__":
    wxSVTKRenderWindowInteractorConeExample()
