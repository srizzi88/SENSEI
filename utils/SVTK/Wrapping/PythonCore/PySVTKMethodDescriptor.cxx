/*=========================================================================
  ...
  Module:    PySVTKMethodDescriptor.cxx
...
PyObject* PySVTKMethodDescriptor_New(PyTypeObject* pytype, PyMethodDef* meth)
{
  PyMethodDescrObject* descr =
    (PyMethodDescrObject*)PyType_GenericAlloc(&PySVTKMethodDescriptor_Type, 0);
...
static void PySVTKMethodDescriptor_Delete(PyObject* ob)
{
...
static PyObject* PySVTKMethodDescriptor_Repr(PyObject* ob)
{
  PyMethodDescrObject* descr = (PyMethodDescrObject*)ob;
#ifdef SVTK_PY3K
...
static int PySVTKMethodDescriptor_Traverse(PyObject* ob, visitproc visit, void* arg)
{
  PyMethodDescrObject* descr = (PyMethodDescrObject*)ob;
...
static PyObject* PySVTKMethodDescriptor_Call(PyObject* ob, PyObject* args, PyObject* kwds)
{
  PyMethodDescrObject* descr = (PyMethodDescrObject*)ob;
...
static PyObject* PySVTKMethodDescriptor_Get(PyObject* self, PyObject* obj, PyObject*)
{
...
static PyObject* PySVTKMethodDescriptor_GetDoc(PyObject* ob, void*)
{
  PyMethodDescrObject* descr = (PyMethodDescrObject*)ob;
...
static PyGetSetDef PySVTKMethodDescriptor_GetSet[] = {
#if PY_VERSION_HEX >= 0x03070000
  { "__doc__", PySVTKMethodDescriptor_GetDoc, nullptr, nullptr, nullptr },
#else
  { const_cast<char*>("__doc__"), PySVTKMethodDescriptor_GetDoc, nullptr, nullptr, nullptr },
#endif
  { nullptr, nullptr, nullptr, nullptr, nullptr }
};

static PyMemberDef PySVTKMethodDescriptor_Members[] = {
#if PY_VERSION_HEX >= 0x03070000
...
//--------------------------------------------------------------------
// clang-format off
PyTypeObject PySVTKMethodDescriptor_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "svtkmodules.svtkCommonCore.method_descriptor", // tp_name
  sizeof(PyMethodDescrObject),             // tp_basicsize
  0,                                       // tp_itemsize
  PySVTKMethodDescriptor_Delete,            // tp_dealloc
  0,                                       // tp_vectorcall_offset
  nullptr,                                 // tp_getattr
  nullptr,                                 // tp_setattr
  nullptr,                                 // tp_compare
  PySVTKMethodDescriptor_Repr,              // tp_repr
  nullptr,                                 // tp_as_number
  nullptr,                                 // tp_as_sequence
  nullptr,                                 // tp_as_mapping
  nullptr,                                 // tp_hash
  PySVTKMethodDescriptor_Call,              // tp_call
  nullptr,                                 // tp_string
  ...
  nullptr,                                 // tp_doc
  PySVTKMethodDescriptor_Traverse,          // tp_traverse
  nullptr,                                 // tp_clear
  ...
  nullptr,                                 // tp_iternext
  nullptr,                                 // tp_methods
  PySVTKMethodDescriptor_Members,           // tp_members
  PySVTKMethodDescriptor_GetSet,            // tp_getset
  nullptr,                                 // tp_base
  nullptr,                                 // tp_dict
  PySVTKMethodDescriptor_Get,               // tp_descr_get
