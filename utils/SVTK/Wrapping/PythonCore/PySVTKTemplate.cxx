...
static const char* PySVTKTemplate_Doc =
...
PyObject* PySVTKTemplate_KeyFromName(PyObject* self, PyObject* arg);
PyObject* PySVTKTemplate_NameFromKey(PyObject* self, PyObject* key);

//--------------------------------------------------------------------
// Methods for python

static PyObject* PySVTKTemplate_HasKey(PyObject* ob, PyObject* args)
{
  PyObject* key = nullptr;
  if (PyArg_ParseTuple(args, "O:has_key", &key))
  {
    PyObject* rval = nullptr;
    PyObject* name = PySVTKTemplate_NameFromKey(ob, key);
    if (name)
    {
...
static PyObject* PySVTKTemplate_Keys(PyObject* ob, PyObject* args)
{
  if (PyArg_ParseTuple(args, ":keys"))
  {
    ...
    {
      key = PySVTKTemplate_KeyFromName(ob, key);
      if (key)
      {
        PyList_Append(l, key);
        Py_DECREF(key);
...
static PyObject* PySVTKTemplate_Values(PyObject* ob, PyObject* args)
{
...
static PyObject* PySVTKTemplate_Items(PyObject* ob, PyObject* args)
{
...
static PyObject* PySVTKTemplate_Get(PyObject* ob, PyObject* args)
{
  PyObject* key = nullptr;
  ...
  if (PyArg_ParseTuple(args, "O|O:get", &key, &def))
  {
    PyObject* rval = nullptr;
    PyObject* dict = PyModule_GetDict(ob);
    key = PySVTKTemplate_NameFromKey(ob, key);
    if (key)
    {
...
static PyMethodDef PySVTKTemplate_Methods[] = {
  { "has_key", PySVTKTemplate_HasKey, METH_VARARGS,
    "T.has_key(args) -> True only the template args are allowed." },
  { "keys", PySVTKTemplate_Keys, METH_VARARGS, "T.keys() -> list of allowed template args." },
  { "values", PySVTKTemplate_Values, METH_VARARGS,
    "T.values() -> list of provided template instantiations." },
  { "items", PySVTKTemplate_Items, METH_VARARGS, "T.items() -> list of (args,types) pairs." },
  { "get", PySVTKTemplate_Get, METH_VARARGS,
...
static Py_ssize_t PySVTKTemplate_Size(PyObject* ob)
{
  Py_ssize_t l = 0;
  PyObject* dict = PyModule_GetDict(ob);
  Py_ssize_t pos = 0;
...
static PyObject* PySVTKTemplate_GetItem(PyObject* ob, PyObject* key)
{
  PyObject* r = nullptr;
  PyObject* dict = PyModule_GetDict(ob);
  PyObject* name = PySVTKTemplate_NameFromKey(ob, key);
...
//--------------------------------------------------------------------
static PyMappingMethods PySVTKTemplate_AsMapping = {
  PySVTKTemplate_Size,    // mp_length
  PySVTKTemplate_GetItem, // mp_subscript
  nullptr,               // mp_ass_subscript
};

//--------------------------------------------------------------------
static PyObject* PySVTKTemplate_Repr(PyObject* self)
{
  return PyString_FromFormat("<template %s>", PyModule_GetName(self));
}

//--------------------------------------------------------------------
static PyObject* PySVTKTemplate_Call(PyObject*, PyObject*, PyObject*)
{
...
//--------------------------------------------------------------------
// clang-format off
PyTypeObject PySVTKTemplate_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  "svtkmodules.svtkCommonCore.template", // tp_name
  0,                        // tp_basicsize
  0,                        // tp_itemsize
  nullptr,                  // tp_dealloc
  ...
  nullptr,                  // tp_setattr
  nullptr,                  // tp_compare
  PySVTKTemplate_Repr,       // tp_repr
  nullptr,                  // tp_as_number
  nullptr,                  // tp_as_sequence
  &PySVTKTemplate_AsMapping, // tp_as_mapping
  nullptr,                  // tp_hash
  PySVTKTemplate_Call,       // tp_call
  nullptr,                  // tp_string
  PyObject_GenericGetAttr,  // tp_getattro
  nullptr,                  // tp_setattro
  nullptr,                  // tp_as_buffer
  Py_TPFLAGS_DEFAULT,       // tp_flags
  PySVTKTemplate_Doc,        // tp_doc
  nullptr,                  // tp_traverse
  nullptr,                  // tp_clear
  ...
  nullptr,                  // tp_iter
  nullptr,                  // tp_iternext
  PySVTKTemplate_Methods,    // tp_methods
  nullptr,                  // tp_members
  nullptr,                  // tp_getset
...
PyObject* PySVTKTemplate_KeyFromName(PyObject* self, PyObject* o)
{
  ...
  for (i = 0; *cp != 'E' && *cp != '\0' && i < 16; i++)
  {
    ...
    else
    {
      ...
      else if (*cp >= '1' && *cp <= '9')
      {
        ...
        if (j == 16 && strncmp(cp, "svtkUnicodeString", 16) == 0)
        {
          ptype = "unicode";
          j = 7;
        }
        else if (j == 12 && strncmp(cp, "svtkStdString", 12) == 0)
        {
          ptype = "str";
          j = 3;
        }
