...
=========================================================================*/
/*-----------------------------------------------------------------------
The svtkPythonArgs class was created in Oct 2010 by David Gobbi for.
...
/**
 * @class   svtkPythonArgs
 */

#ifndef svtkPythonArgs_h
#define svtkPythonArgs_h

#include "PySVTKEnum.h"
#include "PySVTKObject.h"
#include "PySVTKTemplate.h"
...
class SVTKWRAPPINGPYTHONCORE_EXPORT svtkPythonArgs
{
public:
  //@{
  /**
   * Constructor for parsing args of a svtkObjectBase object.
   */
  svtkPythonArgs(PyObject* self, PyObject* args, const char* methodname)
    : Args(args)
   ...
   */
  svtkPythonArgs(PyObject* args, const char* methodname)
    : Args(args)
    , MethodName(methodname)
  {
    this->N = PyTuple_GET_SIZE(args);
   ...
   */
  static svtkObjectBase* GetSelfPointer(PyObject* self, PyObject* args);
  ...
  {
    bool b;
    v = svtkPythonArgs::GetArgAsPythonObject(o, b);
    return b;
  }
  //@}
  ...
  //@{
  /**
   * Get the next argument as a svtkObjectBase derived type.
   ...
   */
  template <class T>
  bool GetSVTKObject(T*& v, const char* classname)
  {
    bool b;
    v = (T*)this->GetArgAsSVTKObject(classname, b);
    return b;
  }
  template <class T>
  bool GetSVTKObject(PyObject* o, T*& v, const char* classname)
  {
    bool b;
    v = (T*)svtkPythonArgs::GetArgAsSVTKObject(o, classname, b);
    return b;
  }
  //@}
  ...
  {
    v = static_cast<T*>(svtkPythonArgs::GetArgAsSpecialObject(arg, classname, &o));
    return (v != nullptr);
  }
  //@}
  ...
  {
    v = static_cast<T*>(svtkPythonArgs::GetArgAsSpecialObject(o, classname, nullptr));
    return (v != nullptr);
  }
  //@}
  ...
  {
    bool r;
    v = static_cast<T>(svtkPythonArgs::GetArgAsEnum(o, enumname, r));
    return r;
  }
  //@}
  ...
  static bool GetBuffer(PyObject* o, const unsigned long long*& v, Py_buffer* buf);
  ...
  bool GetValue(svtkUnicodeString& v);
  static bool GetValue(PyObject* o, svtkUnicodeString& v);
  //@}
  ...
  bool GetArray(svtkUnicodeString* v, size_t n);
  //@}
  ...
  bool SetArgValue(int i, const svtkUnicodeString& v);
  ...
  /**
   * Build a svtkObjectBase object, use GetClassName() to get its type.
   * If a null pointer is given, then None will be returned.
   */
  static PyObject* BuildSVTKObject(const void* v);

  /**
   * Build a non-svtkObjectBase object of the specified type.
   */
  ...
  {
    return svtkPythonArgs::BuildEnumValue(static_cast<int>(v), enumname);
  }
  ...
  static PyObject* BuildValue(const svtkUnicodeString& v);
  //@}
  ...
  static PyObject* BuildTuple(const svtkUnicodeString* v, size_t n);
  //@}
...
protected:
   ...
   * Get the next argument as an object of the given type.
   */
  svtkObjectBase* GetArgAsSVTKObject(const char* classname, bool& valid);
  static svtkObjectBase* GetArgAsSVTKObject(PyObject* o, const char* classname, bool& valid);
  //@}
...
private:
  ...
  int M;        // 1 if Self is a PySVTKClass and first arg is the PySVTKObject
...
// Get "self" from a PySVTKObject, which contains a svtkObjectBase object.
inline svtkObjectBase* svtkPythonArgs::GetSelfPointer(PyObject* self, PyObject* args)
{
  if (PyType_Check(self))
  {
    self = svtkPythonArgs::GetSelfFromFirstArg(self, args);
  }
  return (self ? ((PySVTKObject*)self)->svtk_ptr : nullptr);
}

// Get "self" from a PySVTKSpecialObject.
inline void* svtkPythonArgs::GetSelfSpecialPointer(PyObject* self, PyObject* args)
{
  if (PyType_Check(self))
  {
    self = svtkPythonArgs::GetSelfFromFirstArg(self, args);
  }
  return (self ? ((PySVTKSpecialObject*)self)->svtk_ptr : nullptr);
}

// Get "self" from a PySVTKSpecialObject (for methods with no args).
inline void* svtkPythonArgs::GetSelfSpecialPointer(PyObject* self)
{
  return ((PySVTKSpecialObject*)self)->svtk_ptr;
}
...
// Verify the arg count for a method with optional arguments.
inline bool svtkPythonArgs::CheckArgCount(Py_ssize_t nmin, Py_ssize_t nmax)
{
...
// Verify the arg count for a method with optional arguments.
inline bool svtkPythonArgs::CheckArgCount(Py_ssize_t n)
{
  Py_ssize_t nargs = this->N - this->M;
  if (nargs == n)
  {
...
inline bool svtkPythonArgs::CheckPrecond(bool c, const char* text)
{
  if (!c)
  {
...
inline bool svtkPythonArgs::IsPureVirtual()
{
  if (IsBound())
  {
    return false;
...
inline bool svtkPythonArgs::ErrorOccurred()
{
...
inline PyObject* svtkPythonArgs::BuildNone()
{
  Py_INCREF(Py_None);
  return Py_None;
}

inline PyObject* svtkPythonArgs::BuildSVTKObject(const void* v)
{
  return svtkPythonUtil::GetObjectFromPointer(static_cast<svtkObjectBase*>(const_cast<void*>(v)));
}

inline PyObject* svtkPythonArgs::BuildSpecialObject(const void* v, const char* classname)
{
  return PySVTKSpecialObject_CopyNew(classname, v);
}

inline PyObject* svtkPythonArgs::BuildValue(const void* a)
{
  if (a)
  {
    const char* s = svtkPythonUtil::ManglePointer(a, "p_void");
...
inline PyObject* svtkPythonArgs::BuildValue(const char* a, size_t l)
{
...
inline PyObject* svtkPythonArgs::BuildValue(const char* a)
{
  if (a)
  {
    return svtkPythonArgs::BuildValue(a, strlen(a));
  }
  Py_INCREF(Py_None);
  return Py_None;
}

inline PyObject* svtkPythonArgs::BuildValue(const std::string& a)
{
  return svtkPythonArgs::BuildValue(a.data(), a.size());
}

inline PyObject* svtkPythonArgs::BuildValue(const svtkUnicodeString& a)
{
  std::string s;
  a.utf8_str(s);
...
inline PyObject* svtkPythonArgs::BuildValue(char a)
{
  char b[2];
  b[0] = a;
  b[1] = '\0';
...
inline PyObject* svtkPythonArgs::BuildValue(double a)
{
  return PyFloat_FromDouble(a);
}

inline PyObject* svtkPythonArgs::BuildValue(bool a)
{
  return PyBool_FromLong((long)a);
}

inline PyObject* svtkPythonArgs::BuildValue(int a)
{
  return PyInt_FromLong(a);
}

inline PyObject* svtkPythonArgs::BuildValue(unsigned int a)
{
...
inline PyObject* svtkPythonArgs::BuildValue(long a)
{
  return PyInt_FromLong(a);
}

inline PyObject* svtkPythonArgs::BuildValue(unsigned long a)
{
...
inline PyObject* svtkPythonArgs::BuildValue(long long a)
{
  return PyLong_FromLongLong(a);
}

inline PyObject* svtkPythonArgs::BuildValue(unsigned long long a)
{
  return PyLong_FromUnsignedLongLong(a);
}

inline PyObject* svtkPythonArgs::BuildBytes(const char* a, size_t n)
{
...
#define svtkPythonArgsTemplateMacro(decl)                                                           \
  decl<bool>;                                                                                      \
  decl<float>;                                                                                     \
  decl<double>;                                                                                    \
  decl<char>;                                                                                      \
...
#if defined(SVTK_USE_EXTERN_TEMPLATE) && !defined(svtkPythonArgs_cxx)
svtkPythonArgsTemplateMacro(extern template class SVTKWRAPPINGPYTHONCORE_EXPORT svtkPythonArgs::Array);
#endif

#endif
// SVTK-HeaderTest-Exclude: svtkPythonArgs.h
