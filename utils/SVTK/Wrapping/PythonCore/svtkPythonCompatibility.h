/*=========================================================================
  ...
  Module:    svtkPythonCompatibility.h
...
/*-----------------------------------------------------------------------
  ...
  It must be included after svtkPython.h.
-----------------------------------------------------------------------*/
#ifndef svtkPythonCompatibility_h
#define svtkPythonCompatibility_h

// define our main check macro SVTK_PY3K
...
#define SVTK_PYUNICODE_ENC "surrogateescape"
...
#if PY_VERSION_HEX < 0x03030000
#define SVTK_PYBUFFER_INITIALIZER                                                                   \
  {                                                                                                \
...
#define SVTK_WRAP_PYTHON_SUPPRESS_UNINITIALIZED 0, 0, 0, 0,
#elif PY_VERSION_HEX >= 0x03080000
#define SVTK_WRAP_PYTHON_SUPPRESS_UNINITIALIZED 0, 0, 0, 0, 0,
#elif PY_VERSION_HEX >= 0x03040000
#define SVTK_WRAP_PYTHON_SUPPRESS_UNINITIALIZED 0, 0, 0,
#else
#define SVTK_WRAP_PYTHON_SUPPRESS_UNINITIALIZED 0, 0,
#endif
...
#define SVTK_WRAP_PYTHON_SUPPRESS_UNINITIALIZED 0, 0,
#else
#define SVTK_WRAP_PYTHON_SUPPRESS_UNINITIALIZED 0,
#endif

#endif
#endif
// SVTK-HeaderTest-Exclude: svtkPythonCompatibility.h
