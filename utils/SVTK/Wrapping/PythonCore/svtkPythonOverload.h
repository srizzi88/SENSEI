...
/**
 * @class   svtkPythonOverload
 */

#ifndef svtkPythonOverload_h
#define svtkPythonOverload_h

#include "svtkPython.h"
#include "svtkWrappingPythonCoreModule.h" // For export macro

class SVTKWRAPPINGPYTHONCORE_EXPORT svtkPythonOverload
{
public:
  /**
...
#endif
// SVTK-HeaderTest-Exclude: svtkPythonOverload.h
