...
/**
 ...
 a SVTK hierarchy file.  The file contains entries like the
 following (one per line in the file):

 classname [ : superclass ] ; header.h ; svtkKit [; flags]

 For each typedef, the output file will have a line like this:

 name = &[2][3]* const type ; header.h ; svtkKit [; flags]

 For each enum, the output file will have:

 enumname : enum ; header.h ; svtkKit [; flags]

*/

#ifndef svtkParseHierarchy_h
#define svtkParseHierarchy_h
...
#endif
/* SVTK-HeaderTest-Exclude: svtkParseHierarchy.h */
