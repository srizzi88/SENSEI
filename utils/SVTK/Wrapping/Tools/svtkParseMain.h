...
/**
 svtkParseMain.h provides argument parsing for the wrapper executables.

 Usage: svtkWrap [options] infile ...
 ...
 --version         print the SVTK version number and exit
...
#ifndef svtkParseMain_h
#define svtkParseMain_h
...
#endif
/* SVTK-HeaderTest-Exclude: svtkParseMain.h */
