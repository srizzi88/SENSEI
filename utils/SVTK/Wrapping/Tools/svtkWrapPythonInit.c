...
{
  const char* prefix = "";
  const char* dllexp = "SVTK_ABI_EXPORT ";

  fprintf(fout, "// Generated by svtkWrapPythonInit in SVTK/Wrapping\n");
  fprintf(fout, "#include \"svtkPython.h\"\n");
  fprintf(fout, "#include \"svtkPythonCompatibility.h\"\n");
  fprintf(fout, "#include \"svtkSystemIncludes.h\"\n");
  fprintf(fout,
  ...
  char** depends, int numFiles, char** files, FILE* fout)
{
  ...
  fprintf(fout, "// Generated by svtkWrapPythonInit in SVTK/Wrapping\n");
  fprintf(fout, "#include \"svtkPythonUtil.h\"\n");
  fprintf(fout, "#include \"svtkSystemIncludes.h\"\n");
  ...
  {
    fprintf(fout, "extern \"C\" { PyObject *PySVTKAddFile_%s(PyObject *dict); }\n", files[i]);
  }
  ...
  if (numDepends > 0)
  {
    ...
    fprintf(fout, "  {\n");
    fprintf(fout, "    if (!svtkPythonUtil::ImportModule(depends[i], d))\n");
    fprintf(fout, "    {\n");
    fprintf(fout,
  ...
  for (i = 0; i < numFiles; i++)
  {
    fprintf(fout, "  PySVTKAddFile_%s(d);\n", files[i]);
  }

  fprintf(fout, "\n");
  fprintf(fout, "  svtkPythonUtil::AddModule(\"%s\");\n\n", libName);
...
int main(int argc, char* argv[])
{
  ...
  if (strcmp(libName, "svtkCommonCore") == 0 || strcmp(libName, "svtkCommonKit") == 0)
  {
    files[numFiles] = strdup("PySVTKExtras");
    numFiles++;
  }
